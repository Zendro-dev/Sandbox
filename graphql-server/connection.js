 ...
 */
async function setupCassandraDriver() {
...
const addConnectionInstances = async () => {
  ...
  for (let key of Object.keys(storageConfig)) {
    ...
    if (
      ...
      connectionInstances.set(key, {
        storageType,
        connection: await setupCassandraDriver(),
      });
