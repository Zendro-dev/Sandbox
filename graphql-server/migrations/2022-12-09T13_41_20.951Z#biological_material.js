...
module.exports = {
    ...
    up: async (zendro) => {
        try {
            ...
            const storageHandler = await zendro.adapters.biological_material_local.storageHandler;
    ...
    down: async (zendro) => {
        try {
            ...
            const storageHandler = await zendro.adapters.biological_material_local.storageHandler;
            const recordsExists = await zendro.adapters.biological_material_local.count();
