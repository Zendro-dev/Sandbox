...
module.exports = {
    ...
    up: async (zendro) => {
        try {
            ...
            const storageHandler = await zendro.adapters.observed_variable_local.storageHandler;
    ...
    down: async (zendro) => {
        try {
            ...
            const storageHandler = await zendro.adapters.observed_variable_local.storageHandler;
            const recordsExists = await zendro.adapters.observed_variable_local.count();
