...
module.exports = {
    ...
    up: async (zendro) => {
        try {
            ...
            const storageHandler = await zendro.adapters.observation_unit_local.storageHandler;
    ...
    down: async (zendro) => {
        try {
            ...
            const storageHandler = await zendro.adapters.observation_unit_local.storageHandler;
            const recordsExists = await zendro.adapters.observation_unit_local.count();
