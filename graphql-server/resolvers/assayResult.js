...
/**
 * assayResult.prototype.materialsFilter - Check user authorization and return certain number, specified in pagination argument, of records
 ...
 */
assayResult.prototype.materialsFilter = function({
    search,
    order,
    pagination
}, context) {
...
/**
 * assayResult.prototype.countFilteredMaterials - Count number of associated records that holds the conditions specified in the search argument
 *
 * @param  {object} {search} description
 * @param  {object} context  Provided to every resolver holds contextual information like the resquest query and user info.
 * @return {type}          Number of associated records that holds the conditions specified in the search argument
 */
assayResult.prototype.countFilteredMaterials = function({
    search
}, context) {
...
/**
 * assayResult.prototype.materialsConnection - Check user authorization and return certain number, specified in pagination argument, of records
 * associated with the current instance, this records should also
 * holds the condition of search argument, all of them sorted as specified by the order argument.
 *
 * @param  {object} search     Search argument for filtering associated records
 ...
 */
assayResult.prototype.materialsConnection = function({
    search,
    order,
    pagination
}, context) {
 ...
 * @param {BenignErrorReporter} benignErrorReporter Error Reporter used for reporting Errors from remote zendro services
 */
assayResult.prototype.add_materials = async function(input, benignErrorReporter) {

    await assayResult.add_material_ids(this.getIdValue(), input.addMaterials, benignErrorReporter);
 ...
 * @param {BenignErrorReporter} benignErrorReporter Error Reporter used for reporting Errors from remote zendro services
 */
assayResult.prototype.remove_materials = async function(input, benignErrorReporter) {

    await assayResult.remove_material_ids(this.getIdValue(), input.removeMaterials, benignErrorReporter);
...
async function countAllAssociatedRecords(id, context) {
    ...
    promises_to_many.push(assayResult.countFilteredMaterials({}, context));
...
module.exports = {
    ...
    vueTableAssayResult: async function(_, context) {
        if (await checkAuthorization(context, 'assayResult', 'read') === true) {
            return helper.vueTable(context.request, assayResult, ["id", "assayResult_id", "unit", "value_as_str", "assay_id"]);
        } else {
            throw new Error("You don't have authorization to perform this action");
        }
    },
