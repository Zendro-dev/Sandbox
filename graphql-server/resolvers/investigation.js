...
investigation.prototype.add_fileAttachments = async function(input, benignErrorReporter) {
    ...
    await models.fileAttachment.bulkAssociateFileAttachmentWithInvestigation_id(bulkAssociationInput, benignErrorReporter);
}
...
investigation.prototype.remove_fileAttachments = async function(input, benignErrorReporter) {
    ...
    await models.fileAttachment.bulkDisAssociateFileAttachmentWithInvestigation_id(bulkAssociationInput, benignErrorReporter);
}
