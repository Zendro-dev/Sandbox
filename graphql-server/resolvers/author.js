...
/**
 * author.prototype.booksFilter - Check user authorization and return certain number, specified in pagination argument, of records
...
/**
 * author.prototype.countFilteredBooks - Count number of associated records that holds the conditions specified in the search argument
 *
 * @param  {object} {search} description
 * @param  {object} context  Provided to every resolver holds contextual information like the resquest query and user info.
 * @return {type}          Number of associated records that holds the conditions specified in the search argument
 */
author.prototype.countFilteredBooks = function({
    search
}, context) {
...
/**
 * author.prototype.booksConnection - Check user authorization and return certain number, specified in pagination argument, of records
 * associated with the current instance, this records should also
 * holds the condition of search argument, all of them sorted as specified by the order argument.
 *
 * @param  {object} search     Search argument for filtering associated records
...
author.prototype.add_books = async function(input, benignErrorReporter) {
    ...
    let bulkAssociationInput = input.addBooks.map(associatedRecordId => {
        return {
            fk_books_authors: this.getIdValue(),
            [models.book.idAttribute()]: associatedRecordId
        }
    });
    await models.book.bulkAssociateBookWithFk_books_authors(bulkAssociationInput, benignErrorReporter);
}
...
author.prototype.remove_books = async function(input, benignErrorReporter) {
    ...
    await models.book.bulkDisAssociateBookWithFk_books_authors(bulkAssociationInput, benignErrorReporter);
}
...
async function countAllAssociatedRecords(id, context) {
    ...
    promises_to_many.push(author.countFilteredBooks({}, context));
