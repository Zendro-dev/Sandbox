...
study.prototype.add_fileAttachments = async function(input, benignErrorReporter) {
    ...
    await models.fileAttachment.bulkAssociateFileAttachmentWithStudy_id(bulkAssociationInput, benignErrorReporter);
}
...
study.prototype.remove_fileAttachments = async function(input, benignErrorReporter) {
    ...
    await models.fileAttachment.bulkDisAssociateFileAttachmentWithStudy_id(bulkAssociationInput, benignErrorReporter);
}
