...
protocol.prototype.add_fileAttachments = async function(input, benignErrorReporter) {
    ...
    await protocol.add_fileAttachment_ids(this.getIdValue(), input.addFileAttachments, benignErrorReporter);
...
protocol.prototype.remove_fileAttachments = async function(input, benignErrorReporter) {
    ...
    await protocol.remove_fileAttachment_ids(this.getIdValue(), input.removeFileAttachments, benignErrorReporter);
