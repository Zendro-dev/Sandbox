 ...
 * @param {string} token The token used for authorization
 */
event.prototype.add_observation_units = async function(input, benignErrorReporter, token) {

    await event.add_observation_unit_ids(this.getIdValue(), input.addObservation_units, benignErrorReporter, token);
...
event.prototype.add_study = async function(input, benignErrorReporter, token) {
    await event.add_study_id(this.getIdValue(), input.addStudy, benignErrorReporter, token);
 ...
 * @param {string} token The token used for authorization
 */
event.prototype.remove_observation_units = async function(input, benignErrorReporter, token) {

    await event.remove_observation_unit_ids(this.getIdValue(), input.removeObservation_units, benignErrorReporter, token);
...
event.prototype.remove_study = async function(input, benignErrorReporter, token) {
    if (input.removeStudy == this.study_id) {
        await event.remove_study_id(this.getIdValue(), input.removeStudy, benignErrorReporter, token);
        this.study_id = null;
    }
}
...
module.exports = {
    ...
    bulkAssociateEventWithStudy_id: async function(bulkAssociationInput, context) {
        ...
        return await event.bulkAssociateEventWithStudy_id(bulkAssociationInput.bulkAssociationInput, context.benignErrors, token);
    },
    /**
    ...
    bulkDisAssociateEventWithStudy_id: async function(bulkAssociationInput, context) {
        ...
        return await event.bulkDisAssociateEventWithStudy_id(bulkAssociationInput.bulkAssociationInput, context.benignErrors, token);
    },
