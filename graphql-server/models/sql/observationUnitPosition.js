...
module.exports = class observationUnitPosition extends Sequelize.Model {
    ...
    static associate(models) {
        observationUnitPosition.belongsTo(models.observationUnit, {
            as: 'observationUnit',
    ...
    static async readById(id) {
        let item = await observationUnitPosition.findByPk(id);
        if (item === null) {
            throw new Error(`Record with ID = "${id}" does not exist`);
        }
        item = observationUnitPosition.postReadCast(item)
    ...
    static bulkAddCsv(context) {
        ...
        return `Bulk import of observationUnitPosition records started. You will be send an email to ${helpersAcl.getTokenFromContext(context).email} informing you about success or errors`;
    }
    ...
    /**
     * bulkAssociateObservationUnitPositionWithObservationUnitDbId - bulkAssociaton of given ids
     *
     * @param  {array} bulkAssociationInput Array of associations to add
     * @param  {BenignErrorReporter} benignErrorReporter Error Reporter used for reporting Errors from remote zendro services
     * @return {string} returns message on success
     */
    static async bulkAssociateObservationUnitPositionWithObservationUnitDbId(bulkAssociationInput) {
        let mappedForeignKeys = helper.mapForeignKeysToPrimaryKeyArray(bulkAssociationInput, "observationUnitPositionDbId", "observationUnitDbId");
        var promises = [];
    ...
    /**
     * bulkDisAssociateObservationUnitPositionWithObservationUnitDbId - bulkDisAssociaton of given ids
     *
     * @param  {array} bulkAssociationInput Array of associations to remove
     * @param  {BenignErrorReporter} benignErrorReporter Error Reporter used for reporting Errors from remote zendro services
     * @return {string} returns message on success
     */
    static async bulkDisAssociateObservationUnitPositionWithObservationUnitDbId(bulkAssociationInput) {
        let mappedForeignKeys = helper.mapForeignKeysToPrimaryKeyArray(bulkAssociationInput, "observationUnitPositionDbId", "observationUnitDbId");
        var promises = [];
        mappedForeignKeys.forEach(({
            observationUnitDbId,
