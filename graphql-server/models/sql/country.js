...
module.exports = class country extends Sequelize.Model {
     ...
     */
    static async add_capital_id(country_id, capital_id) {
     ...
     * @param {Id}   capital_id Foreign Key (stored in "Me") of the Association to be updated.
     */
    static async remove_capital_id(country_id, capital_id) {
        let updated = await country.update({
            capital_id: null
        }, {
            where: {
    ...
    /**
     * bulkAssociateCountryWithCapital_id - bulkAssociaton of given ids
     *
     * @param  {array} bulkAssociationInput Array of associations to add
     * @param  {BenignErrorReporter} benignErrorReporter Error Reporter used for reporting Errors from remote zendro services
     * @return {string} returns message on success
     */
    static async bulkAssociateCountryWithCapital_id(bulkAssociationInput) {
        let mappedForeignKeys = helper.mapForeignKeysToPrimaryKeyArray(bulkAssociationInput, "country_id", "capital_id");
        var promises = [];
    ...
    /**
     * bulkDisAssociateCountryWithCapital_id - bulkDisAssociaton of given ids
     *
     * @param  {array} bulkAssociationInput Array of associations to remove
     * @param  {BenignErrorReporter} benignErrorReporter Error Reporter used for reporting Errors from remote zendro services
     * @return {string} returns message on success
     */
    static async bulkDisAssociateCountryWithCapital_id(bulkAssociationInput) {
        let mappedForeignKeys = helper.mapForeignKeysToPrimaryKeyArray(bulkAssociationInput, "country_id", "capital_id");
        var promises = [];
        mappedForeignKeys.forEach(({
            capital_id,
