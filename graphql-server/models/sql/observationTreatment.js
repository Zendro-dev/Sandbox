...
module.exports = class observationTreatment extends Sequelize.Model {
    ...
    static async readById(id) {
        let item = await observationTreatment.findByPk(id);
        if (item === null) {
            throw new Error(`Record with ID = "${id}" does not exist`);
        }
        item = observationTreatment.postReadCast(item)
    ...
    static bulkAddCsv(context) {
        ...
        return `Bulk import of observationTreatment records started. You will be send an email to ${helpersAcl.getTokenFromContext(context).email} informing you about success or errors`;
    }
