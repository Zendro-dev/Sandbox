...
module.exports = class ImageAttachment extends Sequelize.Model {
    ...
    static init(sequelize, DataTypes) {
        return super.init({
            ...
            modelName: "imageAttachment",
            tableName: "imageAttachments",
            sequelize
        });
    }
    ...
    static bulkAddCsv(context) {
        ...
        return `Bulk import of ImageAttachment records started. You will be send an email to ${helpersAcl.getTokenFromContext(context).email} informing you about success or errors`;
    }
    ...
    /**
     * getIdValue - Get the value of the idAttribute ("id", or "internalId") for an instance of ImageAttachment.
     *
    ...
    stripAssociations() {
        let attributes = Object.keys(ImageAttachment.definition.attributes);
        attributes.push('id');
