...
module.exports = class image extends Sequelize.Model {
    ...
    static associate(models) {
        image.belongsTo(models.observationUnit, {
            as: 'observationUnit',
            foreignKey: 'observationUnitDbId'
        });
        image.hasMany(models.observation, {
            as: 'observations',
    ...
    static bulkAddCsv(context) {
        ...
        return `Bulk import of image records started. You will be send an email to ${helpersAcl.getTokenFromContext(context).email} informing you about success or errors`;
    }
    ...
    /**
     * bulkAssociateImageWithObservationUnitDbId - bulkAssociaton of given ids
     *
     * @param  {array} bulkAssociationInput Array of associations to add
     * @param  {BenignErrorReporter} benignErrorReporter Error Reporter used for reporting Errors from remote zendro services
     * @return {string} returns message on success
     */
    static async bulkAssociateImageWithObservationUnitDbId(bulkAssociationInput) {
        let mappedForeignKeys = helper.mapForeignKeysToPrimaryKeyArray(bulkAssociationInput, "imageDbId", "observationUnitDbId");
        var promises = [];
    ...
    /**
     * bulkDisAssociateImageWithObservationUnitDbId - bulkDisAssociaton of given ids
     *
     * @param  {array} bulkAssociationInput Array of associations to remove
     * @param  {BenignErrorReporter} benignErrorReporter Error Reporter used for reporting Errors from remote zendro services
     * @return {string} returns message on success
     */
    static async bulkDisAssociateImageWithObservationUnitDbId(bulkAssociationInput) {
        let mappedForeignKeys = helper.mapForeignKeysToPrimaryKeyArray(bulkAssociationInput, "imageDbId", "observationUnitDbId");
        var promises = [];
        mappedForeignKeys.forEach(({
            observationUnitDbId,
