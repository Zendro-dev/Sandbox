...
module.exports = class city extends Sequelize.Model {
    ...
    static bulkAddCsv(context) {
        ...
        return `Bulk import of city records started. You will be send an email to ${helpersAcl.getTokenFromContext(context).email} informing you about success or errors`;
    }
    ...
    static async add_river_ids(city_id, river_ids, benignErrorReporter, handle_inverse = true) {
        ...
        let record = await super.findByPk(city_id);
        if (record !== null) {
