...
module.exports = class ontologyReference extends Sequelize.Model {
    ...
    static associate(models) {
        ontologyReference.hasMany(models.scale, {
            as: 'scales',
            foreignKey: 'ontologyDbId'
        });
        ontologyReference.hasMany(models.method, {
            as: 'methods',
            foreignKey: 'ontologyDbId'
        });
        ontologyReference.hasMany(models.trait, {
            as: 'traits',
            foreignKey: 'ontologyDbId'
        });
        ontologyReference.hasMany(models.observationVariable, {
    ...
    static async readById(id) {
        let item = await ontologyReference.findByPk(id);
        if (item === null) {
            throw new Error(`Record with ID = "${id}" does not exist`);
        }
        item = ontologyReference.postReadCast(item)
    ...
    static bulkAddCsv(context) {
        ...
        return `Bulk import of ontologyReference records started. You will be send an email to ${helpersAcl.getTokenFromContext(context).email} informing you about success or errors`;
    }
