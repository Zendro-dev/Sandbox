...
module.exports = class capital extends Sequelize.Model {
    ...
    static async batchReadById(keys) {
        let queryArg = {
            operator: "in",
            field: capital.idAttribute(),
            value: keys.join(),
            valueType: "Array",
        };
        let cursorRes = await capital.readAllCursor(queryArg);
        cursorRes = cursorRes.capitals.reduce(
            (map, obj) => ((map[obj[capital.idAttribute()]] = obj), map), {}
        );
        return keys.map(
            (key) =>
    ...
    static readByIdLoader = new DataLoader(capital.batchReadById, {
        cache: false,
    });
     ...
     * @return {object} The requested record as an object with the type capital, or an error object if the validation after reading fails
     * @throws {Error} If the requested record does not exist
     */
    static async readById(id) {
        return await capital.readByIdLoader.load(id);
    }
    /**
    ...
    /**
     * base64Encode - Encode  capital to a base 64 String
     *
     * @return {string} The capital object, encoded in a base 64 String
     */
    base64Encode() {
    ...
    /**
     * stripAssociations - Instance method for getting all attributes of capital.
     *
     * @return {object} The attributes of capital in object form
     */
    stripAssociations() {
    ...
    /**
     * externalIdsArray - Get all attributes of capital that are marked as external IDs.
     *
     * @return {Array<String>} An array of all attributes of capital that are marked as external IDs
     */
    ...
    /**
     * externalIdsObject - Get all external IDs of capital.
     *
