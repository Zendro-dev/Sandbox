...
module.exports = class person {
    ...
    static async add_investigation_ids(id, investigation_ids, benignErrorReporter, handle_inverse = true) {
        let responsibleAdapter = this.adapterForIri(id);
        return await adapters[responsibleAdapter].add_investigation_ids(id, investigation_ids, benignErrorReporter, handle_inverse);
    }
    /**
    ...
    static async remove_investigation_ids(id, investigation_ids, benignErrorReporter, handle_inverse = true) {
        let responsibleAdapter = this.adapterForIri(id);
        return await adapters[responsibleAdapter].remove_investigation_ids(id, investigation_ids, benignErrorReporter, handle_inverse);
    }
    /**
