...
let registry = ["publisher_instance1", "publisher_instance2"];
...
module.exports = class publisher {
    ...
    static get registeredAdapters() {
        return ["publisher_instance1", "publisher_instance2"].reduce((a, c) => {
            a[c] = adapters[c];
            return a;
        }, {});
    }
    ...
    static mapBulkAssociationInputToAdapters(bulkAssociationInput) {
        ...
        bulkAssociationInput.map((idMap) => {
            let responsibleAdapter = this.adapterForIri(idMap.publisher_id);
    ...
    static readAllCursor(search, order, pagination, authorizedAdapters, benignErrorReporter, searchAuthorizedAdapters) {
        ...
        return Promise.allSettled(promises)
            ...
            .then(async nodes => {
                ...
                let graphQLConnection = helper.toGraphQLConnectionObject(paginated_records, this, hasNextPage, hasPreviousPage, "publishers");
    ...
    stripAssociations() {
        let attributes = Object.keys(publisher.definition.attributes);
    ...
    static idAttribute() {
        let internalId = publisher.definition.id.name;
        return internalId;
    }
    ...
    static idAttributeType() {
        return publisher.definition.id.type;
    }

    /**
     * getIdValue - Get the value of the idAttribute ("id", or "internalId") for an instance of publisher.
     *
     * @return {type} id value
     */

    getIdValue() {
        return this[publisher.idAttribute()]
    }
    ...
    static async addOne(input, benignErrorReporter) {
        ...
        let responsibleAdapter = this.adapterForIri(input.publisher_id);
        //use default BenignErrorReporter if no BenignErrorReporter defined
        benignErrorReporter = errorHelper.getDefaultBenignErrorReporterIfUndef(benignErrorReporter);
        return adapters[responsibleAdapter].addOne(input, benignErrorReporter).then(result => new publisher(result));
    }
    ...
    static async updateOne(input, benignErrorReporter) {
        ...
        //use default BenignErrorReporter if no BenignErrorReporter defined
        benignErrorReporter = errorHelper.getDefaultBenignErrorReporterIfUndef(benignErrorReporter);
        return adapters[responsibleAdapter].updateOne(input, benignErrorReporter).then(result => new publisher(result));
