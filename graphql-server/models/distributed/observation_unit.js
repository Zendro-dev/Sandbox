...
module.exports = class observation_unit {
    ...
    static async addOne(input, benignErrorReporter) {
        ...
        //use default BenignErrorReporter if no BenignErrorReporter defined
        benignErrorReporter = errorHelper.getDefaultBenignErrorReporterIfUndef(benignErrorReporter);
        return adapters[responsibleAdapter].addOne(input, benignErrorReporter).then(result => new observation_unit(result));
    }
    ...
    static async updateOne(input, benignErrorReporter) {
        ...
        //use default BenignErrorReporter if no BenignErrorReporter defined
        benignErrorReporter = errorHelper.getDefaultBenignErrorReporterIfUndef(benignErrorReporter);
        return adapters[responsibleAdapter].updateOne(input, benignErrorReporter).then(result => new observation_unit(result));
    ...
    static async add_event_ids(id, event_ids, benignErrorReporter, handle_inverse = true) {
        let responsibleAdapter = this.adapterForIri(id);
        return await adapters[responsibleAdapter].add_event_ids(id, event_ids, benignErrorReporter, handle_inverse);
    }
    /**
    ...
    static async add_factor_ids(id, factor_ids, benignErrorReporter, handle_inverse = true) {
        let responsibleAdapter = this.adapterForIri(id);
        return await adapters[responsibleAdapter].add_factor_ids(id, factor_ids, benignErrorReporter, handle_inverse);
    }
    ...
    static async remove_event_ids(id, event_ids, benignErrorReporter, handle_inverse = true) {
        let responsibleAdapter = this.adapterForIri(id);
        return await adapters[responsibleAdapter].remove_event_ids(id, event_ids, benignErrorReporter, handle_inverse);
    }
    /**
    ...
    static async remove_factor_ids(id, factor_ids, benignErrorReporter, handle_inverse = true) {
        let responsibleAdapter = this.adapterForIri(id);
        return await adapters[responsibleAdapter].remove_factor_ids(id, factor_ids, benignErrorReporter, handle_inverse);
    }
    ...
    static async bulkAssociateObservation_unitWithStudy_id(bulkAssociationInput, benignErrorReporter) {
        ...
        Object.keys(mappedBulkAssociateInputToAdapters).forEach(responsibleAdapter => {
            promises.push(adapters[responsibleAdapter].bulkAssociateObservation_unitWithStudy_id(mappedBulkAssociateInputToAdapters[responsibleAdapter], benignErrorReporter))
        });
    ...
    static async bulkDisAssociateObservation_unitWithStudy_id(bulkAssociationInput, benignErrorReporter) {
        ...
        var promises = [];
        Object.keys(mappedBulkAssociateInputToAdapters).forEach(responsibleAdapter => {
            promises.push(adapters[responsibleAdapter].bulkDisAssociateObservation_unitWithStudy_id(mappedBulkAssociateInputToAdapters[responsibleAdapter], benignErrorReporter))
        });
        await Promise.all(promises);
        return "Records successfully updated!";
    }
