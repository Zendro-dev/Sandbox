...
module.exports = class determinacion {

    /**
     * constructor - Creates an instance of the generic model determinacion.
     *
    ...
    /**
     * readById - Search for the determinacion record whose id is equal to the @id received as parameter.
     * Returns an instance of this class (determinacion), with all its properties
     * set from the values of the record fetched.
     * 
     * Returned value:
     *    new determinacion(record)
     * 
     * Thrown on:
     *    * No record found.
     *    * Error.
     ...
     * @see: constructor() of the class determinacion;
     * 
     ...
     * @return {determinacion} Instance of determinacion class.
     */
    static async readById(id, benignErrorReporter) {
        ...
        try {
            ...
            return new determinacion(response.data.data.ejemplar);
            } else {
    ...
    /**
     * countRecords - Count the number of records of model determinacion that match the filters provided
    ...
    static async countRecords(search, benignErrorReporter) {
        ...
        YOUR CODE GOES HERE
        */
        throw new Error('countRecords() is not implemented for model determinacion');
    }
     ...
     * Returns an array of instances of this class (determinacion), where each instance
     * has its properties set from the values of one of the records fetched.
     * 
     * Returned value:
     *    for each record
     *    array.push( new determinacion(record) )
     * 
     * Thrown on:
     *    * Error.
     *    * Operation failed.
     ...
     * is invoked, the server will include any so reported errors in the final response, i.e. the 
     * GraphQL response will have a non empty errors property.
     * @return {[determinacion]}    Array of instances of determinacion class.
     */
    static async readAll(search, order, pagination, benignErrorReporter) {
        ...
        YOUR CODE GOES HERE
        */
        throw new Error('readAll() is not implemented for model determinacion');
    }
    ...
    static async readAllCursor(search, order, pagination, benignErrorReporter) {
        ...
        let records = await determinacion.readAll(options['search'], options['order'], options['pagination'], benignErrorReporter);
        ...
        if (pagination && (pagination.after || pagination.before)) {
            ...
            oppRecords = await determinacion.readAll(oppOptions['search'], oppOptions['order'], oppOptions['pagination'], benignErrorReporter);
        }
    ...
    /**
     * addOne - Creates a new record of model determinacion with the values provided
     * on @input object.
     * Only if record was created successfully, returns an instance of this class 
     * (determinacion), with all its properties set from the new record created.
     ...
     * is invoked, the server will include any so reported errors in the final response, i.e. the 
     * GraphQL response will have a non empty errors property.
     * @return {determinacion} If successfully created, returns an instance of 
     * determinacion class constructed with the new record, otherwise throws an error.
     */
    static async addOne(input, benignErrorReporter) {
        /*
        YOUR CODE GOES HERE
        */
        throw new Error('addOne() is not implemented for model determinacion');
    }

    /**
     * updateOne - Updates the determinacion record whose id is equal to the value
     ...
     * (determinacion), with all its properties set from the record updated.
     ...
     * 
     * Returned value:
     *    new determinacion(updatedRecord)
     * 
     * Thrown on:
     *    * Error.
     *    * Operation failed.
    ...
    static async updateOne(input, benignErrorReporter) {
        ...
        YOUR CODE GOES HERE
        */
        throw new Error('updateOne() is not implemented for model determinacion');
    }
    ...
    static async deleteOne(id, benignErrorReporter) {
        ...
        YOUR CODE GOES HERE
        */
        throw new Error('deleteOne is not implemented for model determinacion');
    }
    ...
    static async bulkAddCsv(context, benignErrorReporter) {
        ...
        YOUR CODE GOES HERE
        */
        throw new Error('bulkAddCsv() is not implemented for model determinacion');
    }
    ...
    static idAttribute() {
        return determinacion.definition.id.name;
    }
    ...
    static idAttributeType() {
        return determinacion.definition.id.type;
    }

    /**
     * getIdValue - Get the value of the idAttribute ("id", or "internalId") for an instance of determinacion.
     *
     * @return {type} id value
     */

    getIdValue() {
        return this[determinacion.idAttribute()]
    }
    ...
    stripAssociations() {
        let attributes = Object.keys(determinacion.definition.attributes);
