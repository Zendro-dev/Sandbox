...
type MaterialEdge{
  ...
  type Query {
    ...
    vueTableMaterial : VueTableMaterial
  ...
  type Mutation {
    addMaterial(material_id: ID!, name: String, description: String, type: String, sourceSet_ids: [String], element_ids: [String]   , addStudies:[ID], addAssays:[ID], addOntologyAnnotation:[ID], addSourceSets:[ID], addElements:[ID], addFileAttachments:[ID] , skipAssociationsExistenceChecks:Boolean = false): material!
    updateMaterial(material_id: ID!, name: String, description: String, type: String, sourceSet_ids: [String], element_ids: [String]   , addStudies:[ID], removeStudies:[ID] , addAssays:[ID], removeAssays:[ID] , addOntologyAnnotation:[ID], removeOntologyAnnotation:[ID] , addSourceSets:[ID], removeSourceSets:[ID] , addElements:[ID], removeElements:[ID] , addFileAttachments:[ID], removeFileAttachments:[ID]  , skipAssociationsExistenceChecks:Boolean = false): material!
