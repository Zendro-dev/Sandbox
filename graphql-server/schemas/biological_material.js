...
type Biological_materialEdge{
  ...
  type Query {
    biological_materials(search: searchBiological_materialInput, order: [ orderBiological_materialInput ], pagination: paginationInput! ): [biological_material]
    readOneBiological_material(id: ID!): biological_material
    countBiological_materials(search: searchBiological_materialInput ): Int
    csvTableTemplateBiological_material: [String]
    ...
    """
    biological_materialsZendroDefinition would return the static Zendro data model definition
    """
    biological_materialsZendroDefinition: GraphQLJSONObject
  }
