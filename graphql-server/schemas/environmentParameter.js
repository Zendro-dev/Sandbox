...
type EnvironmentParameterEdge{
  ...
  input bulkAssociationEnvironmentParameterWithStudyDbIdInput{
    environmentParameterDbId: ID!
    studyDbId: ID!
  }
  ...
  type Mutation {
    ...
    bulkAddEnvironmentParameterCsv: String!
    bulkAssociateEnvironmentParameterWithStudyDbId(bulkAssociationInput: [bulkAssociationEnvironmentParameterWithStudyDbIdInput], skipAssociationsExistenceChecks:Boolean = false): String!
    bulkDisAssociateEnvironmentParameterWithStudyDbId(bulkAssociationInput: [bulkAssociationEnvironmentParameterWithStudyDbIdInput], skipAssociationsExistenceChecks:Boolean = false): String!
  }
`;