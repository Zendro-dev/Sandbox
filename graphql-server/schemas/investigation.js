...
type InvestigationEdge{
  ...
  type Mutation {
    addInvestigation(investigation_id: ID!, title: String, description: String, startDate: Date, endDate: Date   , addStudies:[ID], addOntologyAnnotations:[ID], addFileAttachments:[ID], addContacts:[ID] , skipAssociationsExistenceChecks:Boolean = false): investigation!
    updateInvestigation(investigation_id: ID!, title: String, description: String, startDate: Date, endDate: Date   , addStudies:[ID], removeStudies:[ID] , addOntologyAnnotations:[ID], removeOntologyAnnotations:[ID] , addFileAttachments:[ID], removeFileAttachments:[ID] , addContacts:[ID], removeContacts:[ID]  , skipAssociationsExistenceChecks:Boolean = false): investigation!
