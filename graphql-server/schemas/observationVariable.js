...
type ObservationVariableEdge{
  ...
  input bulkAssociationObservationVariableWithMethodDbIdInput{
    observationVariableDbId: ID!
    methodDbId: ID!
  }  input bulkAssociationObservationVariableWithOntologyDbIdInput{
    observationVariableDbId: ID!
    ontologyDbId: ID!
  }  input bulkAssociationObservationVariableWithScaleDbIdInput{
    observationVariableDbId: ID!
    scaleDbId: ID!
  }  input bulkAssociationObservationVariableWithTraitDbIdInput{
    observationVariableDbId: ID!
    traitDbId: ID!
  }
  ...
  type Mutation {
    ...
    bulkAddObservationVariableCsv: String!
    bulkAssociateObservationVariableWithMethodDbId(bulkAssociationInput: [bulkAssociationObservationVariableWithMethodDbIdInput], skipAssociationsExistenceChecks:Boolean = false): String!
    bulkDisAssociateObservationVariableWithMethodDbId(bulkAssociationInput: [bulkAssociationObservationVariableWithMethodDbIdInput], skipAssociationsExistenceChecks:Boolean = false): String!
bulkAssociateObservationVariableWithOntologyDbId(bulkAssociationInput: [bulkAssociationObservationVariableWithOntologyDbIdInput], skipAssociationsExistenceChecks:Boolean = false): String!
    bulkDisAssociateObservationVariableWithOntologyDbId(bulkAssociationInput: [bulkAssociationObservationVariableWithOntologyDbIdInput], skipAssociationsExistenceChecks:Boolean = false): String!
bulkAssociateObservationVariableWithScaleDbId(bulkAssociationInput: [bulkAssociationObservationVariableWithScaleDbIdInput], skipAssociationsExistenceChecks:Boolean = false): String!
    bulkDisAssociateObservationVariableWithScaleDbId(bulkAssociationInput: [bulkAssociationObservationVariableWithScaleDbIdInput], skipAssociationsExistenceChecks:Boolean = false): String!
bulkAssociateObservationVariableWithTraitDbId(bulkAssociationInput: [bulkAssociationObservationVariableWithTraitDbIdInput], skipAssociationsExistenceChecks:Boolean = false): String!
    bulkDisAssociateObservationVariableWithTraitDbId(bulkAssociationInput: [bulkAssociationObservationVariableWithTraitDbIdInput], skipAssociationsExistenceChecks:Boolean = false): String!
  }
`;