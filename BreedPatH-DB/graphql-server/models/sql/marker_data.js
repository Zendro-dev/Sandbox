...
module.exports = class marker_data extends Sequelize.Model {
    ...
    static init(sequelize, DataTypes) {
        return super.init({
            ...
            modelName: "marker_data",
            tableName: "marker_data",
            sequelize
        });
    }
    ...
    static async readById(id) {
        let item = await marker_data.findByPk(id);
        if (item === null) {
    ...
    static readAll(search, order, pagination) {
        ...
        return super.count(options).then(items => {
            ...
            if (globals.LIMIT_RECORDS < options['limit']) {
                throw new Error(`Request of total marker_data exceeds max limit of ${globals.LIMIT_RECORDS}. Please use pagination.`);
            }
    ...
    static bulkAddCsv(context) {
        ...
        return `Bulk import of marker_data records started. You will be send an email to ${helpersAcl.getTokenFromContext(context).email} informing you about success or errors`;
    }
    ...
    static idAttribute() {
        return marker_data.definition.id.name;
    }
    ...
    static idAttributeType() {
        return marker_data.definition.id.type;
    }

    /**
     * getIdValue - Get the value of the idAttribute ("id", or "internalId") for an instance of marker_data.
     *
     * @return {type} id value
     */

    getIdValue() {
        return this[marker_data.idAttribute()]
    }
    ...
    stripAssociations() {
        let attributes = Object.keys(marker_data.definition.attributes);
        attributes.push('id');
