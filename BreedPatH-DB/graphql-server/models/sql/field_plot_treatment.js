...
module.exports = class field_plot_treatment extends Sequelize.Model {
    ...
    static init(sequelize, DataTypes) {
        return super.init({
            ...
            modelName: "field_plot_treatment",
            tableName: "field_plot_treatments",
            sequelize
        });
    }
    ...
    static async readById(id) {
        let item = await field_plot_treatment.findByPk(id);
        if (item === null) {
    ...
    static readAll(search, order, pagination) {
        ...
        return super.count(options).then(items => {
            ...
            if (globals.LIMIT_RECORDS < options['limit']) {
                throw new Error(`Request of total field_plot_treatments exceeds max limit of ${globals.LIMIT_RECORDS}. Please use pagination.`);
            }
    ...
    static bulkAddCsv(context) {
        ...
        return `Bulk import of field_plot_treatment records started. You will be send an email to ${helpersAcl.getTokenFromContext(context).email} informing you about success or errors`;
    }
    ...
    static idAttribute() {
        return field_plot_treatment.definition.id.name;
    }
    ...
    static idAttributeType() {
        return field_plot_treatment.definition.id.type;
    }

    /**
     * getIdValue - Get the value of the idAttribute ("id", or "internalId") for an instance of field_plot_treatment.
     *
     * @return {type} id value
     */

    getIdValue() {
        return this[field_plot_treatment.idAttribute()]
    }
    ...
    stripAssociations() {
        let attributes = Object.keys(field_plot_treatment.definition.attributes);
        attributes.push('id');
