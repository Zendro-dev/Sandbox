...
module.exports = class field_plot extends Sequelize.Model {
    ...
    static init(sequelize, DataTypes) {
        return super.init({
            ...
            modelName: "field_plot",
            tableName: "field_plots",
            sequelize
        });
    }
    ...
    static async readById(id) {
        let item = await field_plot.findByPk(id);
        if (item === null) {
    ...
    static bulkAddCsv(context) {
        ...
        return `Bulk import of field_plot records started. You will be send an email to ${helpersAcl.getTokenFromContext(context).email} informing you about success or errors`;
    }
    ...
    /**
     * add_genotype_id - field Mutation (model-layer) for to_one associationsArguments to add 
     *
     * @param {Id}   id   IdAttribute of the root model to be updated
     * @param {Id}   genotype_id Foreign Key (stored in "Me") of the Association to be updated. 
     */
    static async add_genotype_id(id, genotype_id) {
     ...
     * @param {Id}   genotype_id Foreign Key (stored in "Me") of the Association to be updated. 
     */
    static async remove_genotype_id(id, genotype_id) {
        let updated = await sequelize.transaction(async transaction => {
            return field_plot.update({
                genotype_id: null
            }, {
    ...
    static idAttribute() {
        return field_plot.definition.id.name;
    }
    ...
    static idAttributeType() {
        return field_plot.definition.id.type;
    }

    /**
     * getIdValue - Get the value of the idAttribute ("id", or "internalId") for an instance of field_plot.
     *
     * @return {type} id value
     */

    getIdValue() {
        return this[field_plot.idAttribute()]
    }
    ...
    stripAssociations() {
        let attributes = Object.keys(field_plot.definition.attributes);
        attributes.push('id');
