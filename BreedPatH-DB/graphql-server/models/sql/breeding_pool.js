...
module.exports = class breeding_pool extends Sequelize.Model {
    ...
    static init(sequelize, DataTypes) {
        return super.init({
            ...
            modelName: "breeding_pool",
            tableName: "breeding_pools",
            sequelize
        });
    }
    ...
    static async readById(id) {
        let item = await breeding_pool.findByPk(id);
        if (item === null) {
    ...
    static bulkAddCsv(context) {
        ...
        return `Bulk import of breeding_pool records started. You will be send an email to ${helpersAcl.getTokenFromContext(context).email} informing you about success or errors`;
    }
    ...
    static idAttribute() {
        return breeding_pool.definition.id.name;
    }
    ...
    static idAttributeType() {
        return breeding_pool.definition.id.type;
    }

    /**
     * getIdValue - Get the value of the idAttribute ("id", or "internalId") for an instance of breeding_pool.
     *
     * @return {type} id value
     */

    getIdValue() {
        return this[breeding_pool.idAttribute()]
    }
    ...
    stripAssociations() {
        let attributes = Object.keys(breeding_pool.definition.attributes);
        attributes.push('id');
