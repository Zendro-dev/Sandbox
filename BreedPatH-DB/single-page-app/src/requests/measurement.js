...
export default {
   ...
   * 
   * Get field_plots connection (cursor based) records associated to the given measurement record
   ...
   * 
   * Get the field_plot-ids associated (by cursor based connection) to the given measurement record 
   * through association 'Field_plot', from GraphQL Server.
   * 
   * @param {String} url GraphQL Server url
   * @param {Number} itemId Model item internalId.
