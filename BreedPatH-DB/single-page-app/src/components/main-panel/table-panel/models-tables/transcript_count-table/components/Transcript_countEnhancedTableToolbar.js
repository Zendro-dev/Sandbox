...
export default function TranscriptCountEnhancedTableToolbar(props) {
                          ...
                          <Grid item xs={12}>
                            <Grid container justify="center">
                              {/* Add */}
                              {
                                ...
                                &&(permissions.transcript_count.includes('create') || permissions.transcript_count.includes('*')))
                                &&(
                                  <Grid item>
                                    <Tooltip title={t('modelPanels.addNew') + " transcript_count"}>
                                      <IconButton
                                        color="primary"
...
TranscriptCountEnhancedTableToolbar.propTypes = {
