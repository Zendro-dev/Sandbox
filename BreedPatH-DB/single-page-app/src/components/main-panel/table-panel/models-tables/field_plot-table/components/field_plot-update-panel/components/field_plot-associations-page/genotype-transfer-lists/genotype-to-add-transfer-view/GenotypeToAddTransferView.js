...
export default function GenotypeToAddTransferView(props) {
  ...
  */
  ...
  const getData = useCallback(() => {
    ...
    */
    let cancelableApiReq = makeCancelable(api.field_plot.getAssociatedGenotypeConnection(graphqlServerUrl, item.id));  
    ...
    cancelableApiReq
      ...
      (response) => {
        ...
        if(!response.data ||!response.data.data) {
          ...
          newError.locations=[{model: 'field_plot', association: 'genotype', table:'A', query: 'readOneField_plot', method: 'getData()', request: 'api.field_plot.getAssociatedGenotypeConnection'}];
        ...
        || typeof readOneField_plot.genotype!== 'object' //can be null
        ) {
          let newError = {};
          let withDetails=true;
          variant.current='error';
        ...
        //get item
        let idso = readOneField_plot.genotype;
        ...
        cancelableApiReqB
          ...
          (response)=> {
            ...
            if(!response.data ||!response.data.data) {
              ...
              variant.current='error';
              newError.message = t('modelPanels.errors.data.e1', 'No data was received from the server.');
              newError.locations=[{model: 'field_plot', association: 'genotype', table:'A', query: 'countGenotypes', method: 'getData()', request: 'api.genotype.getCountItems'}];
              newError.path=['add', 'genotype'];
              newError.extensions = {graphqlResponse:{data:response.data.data, errors:response.data.errors}};
              errors.current.push(newError);
              console.log("Error: ", newError);
            ...
            cancelableApiReqC
              ...
              (response) => {
                ...
                if(!response.data ||!response.data.data) {
                  ...
                  variant.current='error';
                  newError.message = t('modelPanels.errors.data.e1', 'No data was received from the server.');
                  newError.locations=[{model: 'field_plot', association: 'genotype', table:'A', query: 'genotypesConnection', method: 'getData()', request: 'api.genotype.getItemsConnection'}];
                  newError.path=['add', 'genotype'];
                  newError.extensions = {graphqlResponse:{data:response.data.data, errors:response.data.errors}};
                  errors.current.push(newError);
                  console.log("Error: ", newError);
                ...
                if(genotypesConnection === null) {
                  ...
                  */
                  ...
                  if(errors.current.length > 0) {
                    ...
                    newError.locations=[{model: 'field_plot', association: 'genotype', table:'A', method: 'getData()'}];
                    newError.path=['add', 'genotype'];
                    newError.extensions = {graphQL:{data:response.data.data, errors:response.data.errors}};
                    errors.current.push(newError);
                    console.log("Error: ", newError);
      ...
      //error
      .catch((err) => { //error: on api.field_plot.getAssociatedGenotypeConnection
        if(err.isCanceled) {
          return
        } else {
          let newError = {};
    ...
    cancelableApiReq
      ...
      (response) => {
        ...
        if(!response.data ||!response.data.data) {
          ...
          newError.message = t('modelPanels.errors.data.e1', 'No data was received from the server.');
          newError.locations=[{model: 'field_plot', association: 'genotype', table:'B', query: 'countGenotypes', method: 'getDataB()', request: 'api.genotype.getCountItems'}];
          newError.path=['add', 'genotype'];
          newError.extensions = {graphqlResponse:{data:response.data.data, errors:response.data.errors}};
          ...
          cancelableApiReqB
            ...
            (response) => {
              ...
              if(!response.data ||!response.data.data) {
                ...
                variantB.current='error';
                newError.message = t('modelPanels.errors.data.e1', 'No data was received from the server.');
                newError.locations=[{model: 'field_plot', association: 'genotype', table:'B', query: 'genotypesConnection', method: 'getDataB()', request: 'api.genotype.getItemsConnection'}];
                newError.path=['add', 'genotype'];
                newError.extensions = {graphqlResponse:{data:response.data.data, errors:response.data.errors}};
                errorsB.current.push(newError);
                console.log("Error: ", newError);
              ...
              */
              ...
              if(errorsB.current.length > 0) {
                ...
                newError.locations=[{model: 'field_plot', association: 'genotype', table:'B', method: 'getDataB()'}];
                newError.path=['add', 'genotype'];
                newError.extensions = {graphQL:{data:response.data.data, errors:response.data.errors}};
                errorsB.current.push(newError);
                console.log("Error: ", newError);
  ...
  useEffect(() => {
    ...
    if(lastModelChanged.field_plot&&
        ...
        lastModelChanged.field_plot[String(item.id)].changedAssociations.genotype&&
        (lastModelChanged.field_plot[String(item.id)].changedAssociations.genotype.added ||
         lastModelChanged.field_plot[String(item.id)].changedAssociations.genotype.removed)) {
          
          //remove any dis-associated internalId from idsToAdd[]
          let idsRemoved = lastModelChanged.field_plot[String(item.id)].changedAssociations.genotype.idsRemoved;
          if(idsRemoved) {
