...
import FieldPlotTreatmentToRemoveTransferViewToolbar from './components/Field_plot_treatmentToRemoveTransferViewToolbar';
import FieldPlotTreatmentToRemoveTransferViewCursorPagination from './components/Field_plot_treatmentToRemoveTransferViewCursorPagination';
...
export default function FieldPlotTreatmentToRemoveTransferView(props) {
...
const showMessageB = useCallback((message, withDetail) => {
    ...
    cancelableApiReq
      ...
      (response) => {
        ...
        if(!response.data ||!response.data.data) {
          ...
          newError.path=['remove', 'field_plot_treatment'];
  ...
  useEffect(() => {
     ...
     * Actions:
     * if A:
     * - remove the internalId of the 'field_plot_treatment' from idsToRemove[].
     * - reload both transfer tables.
     * - return
     * 
     * else if B:
        ...
        <Grid item xs={12} sm={5} >
          {(item!==undefined) && (
            <Card className={classes.card}>
              ...
              {/* Toolbar */}
              <FieldPlotTreatmentToRemoveTransferViewToolbar
              ...
              {/* Pagination */}
              <FieldPlotTreatmentToRemoveTransferViewCursorPagination
                count={count}
...
FieldPlotTreatmentToRemoveTransferView.propTypes = {
