...
import NucAcidLibraryResultsToRemoveTransferView from './nuc_acid_library_results-to-remove-transfer-view/Nuc_acid_library_resultsToRemoveTransferView'
    ...
    <div className={classes.root}>
      <Fade in={true} timeout={500}>
        ...
        > 
          ...
          <Grid item xs={12}>
            <NucAcidLibraryResultsToRemoveTransferView
              item={item}
