...
import NucAcidLibraryResultsToRemoveTransferViewToolbar from './components/Nuc_acid_library_resultsToRemoveTransferViewToolbar';
import NucAcidLibraryResultsToRemoveTransferViewCursorPagination from './components/Nuc_acid_library_resultsToRemoveTransferViewCursorPagination';
...
export default function NucAcidLibraryResultsToRemoveTransferView(props) {
    ...
    cancelableApiReq
      ...
      (response) => {
        ...
        if(!response.data ||!response.data.data) {
          ...
          newError.path=['remove', 'nuc_acid_library_results'];
        ...
        <Grid item xs={12} sm={5} >
          {(item!==undefined) && (
            <Card className={classes.card}>
              ...
              {/* Toolbar */}
              <NucAcidLibraryResultsToRemoveTransferViewToolbar
              ...
              {/* Pagination */}
              <NucAcidLibraryResultsToRemoveTransferViewCursorPagination
                count={count}
...
NucAcidLibraryResultsToRemoveTransferView.propTypes = {
