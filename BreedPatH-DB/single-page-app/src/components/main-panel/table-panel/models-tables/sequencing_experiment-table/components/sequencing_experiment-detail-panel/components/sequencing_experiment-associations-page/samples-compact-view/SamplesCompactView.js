...
import SamplesCompactViewToolbar from './components/SamplesCompactViewToolbar';
import SamplesCompactViewCursorPagination from './components/SamplesCompactViewCursorPagination';
...
export default function SamplesCompactView(props) {
    ...
    cancelableApiReq
      ...
      (response) => {
        ...
        if(!response.data ||!response.data.data) {
          ...
          newError.path=['detail', `id:${item.id}`, 'samples'];
          ...
          {(item!==undefined) && (
            <Card className={classes.card}>
              ...
              {(true) && (
                ...
                <SamplesCompactViewCursorPagination
                  count={count}
...
SamplesCompactView.propTypes = {
  item: PropTypes.object.isRequired,
  handleClickOnSamplesRow: PropTypes.func,
};