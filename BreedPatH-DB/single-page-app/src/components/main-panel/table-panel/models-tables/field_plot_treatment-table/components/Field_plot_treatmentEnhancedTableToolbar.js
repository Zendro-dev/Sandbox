...
export default function FieldPlotTreatmentEnhancedTableToolbar(props) {
                          ...
                          <Grid item xs={12}>
                            <Grid container justify="center">
                              {/* Add */}
                              {
                                ...
                                &&(permissions.field_plot_treatment.includes('create') || permissions.field_plot_treatment.includes('*')))
                                &&(
                                  <Grid item>
                                    <Tooltip title={t('modelPanels.addNew') + " field_plot_treatment"}>
                                      <IconButton
                                        color="primary"
                                    ...
                                    >
                                      ...
                                      <Grid item xs={12}>
                                        <Grid container justify='flex-start'>
                                          ...
                                          <input type="hidden" name="model" value='field_plot_treatment' />
                                            <ButtonBase
...
FieldPlotTreatmentEnhancedTableToolbar.propTypes = {
