...
export default function FieldPlotTreatmentUploadFileDialog(props) {
  ...
  const handleSubmit = (event) => {
    if(file.current !== undefined && file.current !== null) {
      ...
      let query = 'mutation{ bulkAddField_plot_treatmentCsv{ id} }'
  ...
  return (
    ...
    >
      <DialogTitle>
      { t('modelPanels.uploading') + ' Field_plot_treatments' }
        <div>
...
FieldPlotTreatmentUploadFileDialog.propTypes = {
