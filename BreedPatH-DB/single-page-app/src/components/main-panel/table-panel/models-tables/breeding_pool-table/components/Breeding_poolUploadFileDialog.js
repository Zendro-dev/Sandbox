...
export default function BreedingPoolUploadFileDialog(props) {
  ...
  const handleSubmit = (event) => {
    if(file.current !== undefined && file.current !== null) {
      ...
      let query = 'mutation{ bulkAddBreeding_poolCsv{ id} }'
  ...
  return (
    ...
    >
      <DialogTitle>
      { t('modelPanels.uploading') + ' Breeding_pools' }
        <div>
...
BreedingPoolUploadFileDialog.propTypes = {
