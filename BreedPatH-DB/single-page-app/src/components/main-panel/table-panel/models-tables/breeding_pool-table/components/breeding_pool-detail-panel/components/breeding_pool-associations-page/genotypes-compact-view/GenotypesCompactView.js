...
import GenotypesCompactViewToolbar from './components/GenotypesCompactViewToolbar';
import GenotypesCompactViewCursorPagination from './components/GenotypesCompactViewCursorPagination';
...
export default function GenotypesCompactView(props) {
    ...
    cancelableApiReq
      ...
      (response) => {
        ...
        if(!response.data ||!response.data.data) {
          ...
          newError.path=['detail', `id:${item.id}`, 'genotypes'];
  ...
  useEffect(() => {
     ...
     * 
     * Conditions:
     * A: the current item 'internalId' attribute is in the removedIds of the updated 'genotype'.
     * B: the current item 'internalId' attribute is in the addedIds of the updated 'genotype'.
     * 
     * Actions:
     * if A:
     * - reload table.
          ...
          {(item!==undefined) && (
            <Card className={classes.card}>
              ...
              {(true) && (
                ...
                <GenotypesCompactViewCursorPagination
                  count={count}
...
GenotypesCompactView.propTypes = {
  item: PropTypes.object.isRequired,
  handleClickOnGenotypesRow: PropTypes.func,
};