...
export default function SequencingExperimentToAddTransferView(props) {
  ...
  */
  ...
  const getData = useCallback(() => {
    ...
    */
    let cancelableApiReq = makeCancelable(api.sample.getAssociatedSequencing_experimentConnection(graphqlServerUrl, item.id));  
    ...
    cancelableApiReq
      ...
      (response) => {
        ...
        if(!response.data ||!response.data.data) {
          ...
          newError.locations=[{model: 'sample', association: 'sequencing_experiment', table:'A', query: 'readOneSample', method: 'getData()', request: 'api.sample.getAssociatedSequencing_experimentConnection'}];
        ...
        || typeof readOneSample.sequencing_experiment!== 'object' //can be null
        ) {
          let newError = {};
          let withDetails=true;
          variant.current='error';
        ...
        //get item
        let idso = readOneSample.sequencing_experiment;
        ...
        cancelableApiReqB
          ...
          (response)=> {
            ...
            if(!response.data ||!response.data.data) {
              ...
              variant.current='error';
              newError.message = t('modelPanels.errors.data.e1', 'No data was received from the server.');
              newError.locations=[{model: 'sample', association: 'sequencing_experiment', table:'A', query: 'countSequencing_experiments', method: 'getData()', request: 'api.sequencing_experiment.getCountItems'}];
              newError.path=['add', 'sequencing_experiment'];
              newError.extensions = {graphqlResponse:{data:response.data.data, errors:response.data.errors}};
              errors.current.push(newError);
              console.log("Error: ", newError);
            ...
            cancelableApiReqC
              ...
              (response) => {
                ...
                if(!response.data ||!response.data.data) {
                  ...
                  variant.current='error';
                  newError.message = t('modelPanels.errors.data.e1', 'No data was received from the server.');
                  newError.locations=[{model: 'sample', association: 'sequencing_experiment', table:'A', query: 'sequencing_experimentsConnection', method: 'getData()', request: 'api.sequencing_experiment.getItemsConnection'}];
                  newError.path=['add', 'sequencing_experiment'];
                  newError.extensions = {graphqlResponse:{data:response.data.data, errors:response.data.errors}};
                  errors.current.push(newError);
                  console.log("Error: ", newError);
                ...
                if(sequencing_experimentsConnection === null) {
                  ...
                  */
                  ...
                  if(errors.current.length > 0) {
                    ...
                    newError.locations=[{model: 'sample', association: 'sequencing_experiment', table:'A', method: 'getData()'}];
                    newError.path=['add', 'sequencing_experiment'];
                    newError.extensions = {graphQL:{data:response.data.data, errors:response.data.errors}};
                    errors.current.push(newError);
                    console.log("Error: ", newError);
      ...
      //error
      .catch((err) => { //error: on api.sample.getAssociatedSequencing_experimentConnection
        if(err.isCanceled) {
          return
        } else {
          let newError = {};
    ...
    cancelableApiReq
      ...
      (response) => {
        ...
        if(!response.data ||!response.data.data) {
          ...
          newError.message = t('modelPanels.errors.data.e1', 'No data was received from the server.');
          newError.locations=[{model: 'sample', association: 'sequencing_experiment', table:'B', query: 'countSequencing_experiments', method: 'getDataB()', request: 'api.sequencing_experiment.getCountItems'}];
          newError.path=['add', 'sequencing_experiment'];
          newError.extensions = {graphqlResponse:{data:response.data.data, errors:response.data.errors}};
          ...
          cancelableApiReqB
            ...
            (response) => {
              ...
              if(!response.data ||!response.data.data) {
                ...
                variantB.current='error';
                newError.message = t('modelPanels.errors.data.e1', 'No data was received from the server.');
                newError.locations=[{model: 'sample', association: 'sequencing_experiment', table:'B', query: 'sequencing_experimentsConnection', method: 'getDataB()', request: 'api.sequencing_experiment.getItemsConnection'}];
                newError.path=['add', 'sequencing_experiment'];
                newError.extensions = {graphqlResponse:{data:response.data.data, errors:response.data.errors}};
                errorsB.current.push(newError);
                console.log("Error: ", newError);
              ...
              */
              ...
              if(errorsB.current.length > 0) {
                ...
                newError.locations=[{model: 'sample', association: 'sequencing_experiment', table:'B', method: 'getDataB()'}];
                newError.path=['add', 'sequencing_experiment'];
                newError.extensions = {graphQL:{data:response.data.data, errors:response.data.errors}};
                errorsB.current.push(newError);
                console.log("Error: ", newError);
  ...
  useEffect(() => {
    ...
    if(lastModelChanged.sample&&
        ...
        lastModelChanged.sample[String(item.id)].changedAssociations.sequencing_experiment&&
        (lastModelChanged.sample[String(item.id)].changedAssociations.sequencing_experiment.added ||
         lastModelChanged.sample[String(item.id)].changedAssociations.sequencing_experiment.removed)) {
          
          //remove any dis-associated internalId from idsToAdd[]
          let idsRemoved = lastModelChanged.sample[String(item.id)].changedAssociations.sequencing_experiment.idsRemoved;
          if(idsRemoved) {
    ...
    /*
     * Case 2: 
     * The peer relation 'samples' for this item was updated.
     * That is to say that this current item was associated or dis-associated with some 'sequencing_experiment',
     * but this action happened on the peer relation 'samples'.
     * 
     * Conditions:
    ...
    if(lastModelChanged.sequencing_experiment) {
      ...
      oens.forEach( (entry) => {
        if(entry[1].changedAssociations&&
          entry[1].changedAssociations.samples) {

            //case A: this item was removed from peer relation.
            if(entry[1].changedAssociations.samples.removed) {
              let idsRemoved = entry[1].changedAssociations.samples.idsRemoved;
              if(idsRemoved) {
            ...
            if(entry[1].changedAssociations.samples.added) {
              let idsAdded = entry[1].changedAssociations.samples.idsAdded;
              if(idsAdded) {
