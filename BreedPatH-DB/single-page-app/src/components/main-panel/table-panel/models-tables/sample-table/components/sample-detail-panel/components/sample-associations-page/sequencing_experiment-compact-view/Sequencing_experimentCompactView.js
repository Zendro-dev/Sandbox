...
export default function SequencingExperimentCompactView(props) {
  ...
  const getData = useCallback(() => {
    ...
    */
    ...
    let cancelableApiReq = makeCancelable(api.sample.getSequencing_experimentConnection(
      graphqlServerUrl, 
      item.id,
      label,
      sublabel,
    ...
    cancelableApiReq
      ...
      (response) => {
        ...
        if(!response.data ||!response.data.data) {
          ...
          newError.locations=[{association: 'sequencing_experiment', query: 'readOneSample', method: 'getData()', request: 'api.sample.getSequencing_experimentConnection'}];
        ...
        //get item
        let it = readOneSample.sequencing_experiment;
      ...
      //error
      .catch((err) => { //error: on api.sample.getSequencing_experimentConnection
        if(err.isCanceled) {
          return;
        } else {
          let newError = {};
