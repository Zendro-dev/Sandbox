...
export default function SampleEnhancedTableToolbar(props) {
                          ...
                          <Grid item xs={12}>
                            <Grid container justify="center">
                              {/* Add */}
                              {
                                ...
                                &&(permissions.sample.includes('create') || permissions.sample.includes('*')))
                                &&(
                                  <Grid item>
                                    <Tooltip title={t('modelPanels.addNew') + " sample"}>
                                      <IconButton
                                        color="primary"
                                    ...
                                    >
                                      ...
                                      <Grid item xs={12}>
                                        <Grid container justify='flex-start'>
                                          ...
                                          <input type="hidden" name="model" value='sample' />
                                            <ButtonBase
...
SampleEnhancedTableToolbar.propTypes = {
