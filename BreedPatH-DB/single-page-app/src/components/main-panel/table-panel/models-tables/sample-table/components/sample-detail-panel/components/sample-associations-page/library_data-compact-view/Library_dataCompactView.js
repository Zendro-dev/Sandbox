...
import LibraryDataCompactViewToolbar from './components/Library_dataCompactViewToolbar';
import LibraryDataCompactViewCursorPagination from './components/Library_dataCompactViewCursorPagination';
...
export default function LibraryDataCompactView(props) {
    ...
    cancelableApiReq
      ...
      (response) => {
        ...
        if(!response.data ||!response.data.data) {
          ...
          newError.path=['detail', `id:${item.id}`, 'library_data'];
  ...
  useEffect(() => {
     ...
     * 
     * Conditions:
     * A: the current item 'internalId' attribute is in the removedIds of the updated 'nuc_acid_library_result'.
     * B: the current item 'internalId' attribute is in the addedIds of the updated 'nuc_acid_library_result'.
     * 
     * Actions:
     * if A:
     * - reload table.
          ...
          {(item!==undefined) && (
            <Card className={classes.card}>
              ...
              {(true) && (
                ...
                <LibraryDataCompactViewCursorPagination
                  count={count}
...
LibraryDataCompactView.propTypes = {
  item: PropTypes.object.isRequired,
  handleClickOnLibrary_dataRow: PropTypes.func,
};