...
import LibraryDataToAddTransferViewToolbar from './components/Library_dataToAddTransferViewToolbar';
import LibraryDataToAddTransferViewCursorPagination from './components/Library_dataToAddTransferViewCursorPagination';
...
export default function LibraryDataToAddTransferView(props) {
  ...
  */
  ...
  const getData = useCallback(() => {
    ...
    */
    let cancelableApiReq = makeCancelable(api.sample.getAssociatedLibrary_dataConnection(graphqlServerUrl, item.id));  
    ...
    cancelableApiReq
      ...
      (response) => {
        ...
        if(!response.data ||!response.data.data) {
          ...
          newError.locations=[{model: 'sample', association: 'library_data', table:'A', query: 'readOneSample', method: 'getData()', request: 'api.sample.getAssociatedLibrary_dataConnection'}];
          newError.path=['add', 'library_data'];
        ...
        || typeof readOneSample.library_dataConnection !== 'object'
        || readOneSample.library_dataConnection === null
        || !Array.isArray(readOneSample.library_dataConnection.edges)) {
          let newError = {};
          let withDetails=true;
          variant.current='error';
        ...
        //get items
        let idso = readOneSample.library_dataConnection.edges.map(o => o.node);
        ...
        cancelableApiReqB
          ...
          (response)=> {
            ...
            if(!response.data ||!response.data.data) {
              ...
              variant.current='error';
              newError.message = t('modelPanels.errors.data.e1', 'No data was received from the server.');
              newError.locations=[{model: 'sample', association: 'library_data', table:'A', query: 'countNuc_acid_library_results', method: 'getData()', request: 'api.nuc_acid_library_result.getCountItems'}];
              newError.path=['add', 'library_data'];
              newError.extensions = {graphqlResponse:{data:response.data.data, errors:response.data.errors}};
              errors.current.push(newError);
              console.log("Error: ", newError);
            ...
            cancelableApiReqC
              ...
              (response) => {
                ...
                if(!response.data ||!response.data.data) {
                  ...
                  variant.current='error';
                  newError.message = t('modelPanels.errors.data.e1', 'No data was received from the server.');
                  newError.locations=[{model: 'sample', association: 'library_data', table:'A', query: 'nuc_acid_library_resultsConnection', method: 'getData()', request: 'api.nuc_acid_library_result.getItemsConnection'}];
                  newError.path=['add', 'library_data'];
                  newError.extensions = {graphqlResponse:{data:response.data.data, errors:response.data.errors}};
                  errors.current.push(newError);
                  console.log("Error: ", newError);
                ...
                if(nuc_acid_library_resultsConnection === null) {
                  ...
                  */
                  ...
                  if(errors.current.length > 0) {
                    ...
                    newError.locations=[{model: 'sample', association: 'library_data', table:'A', method: 'getData()'}];
                    newError.path=['add', 'library_data'];
                    newError.extensions = {graphQL:{data:response.data.data, errors:response.data.errors}};
                    errors.current.push(newError);
                    console.log("Error: ", newError);
      ...
      //error
      .catch((err) => { //error: on api.sample.getAssociatedLibrary_dataConnection
        if(err.isCanceled) {
          return
        } else {
          let newError = {};
    ...
    cancelableApiReq
      ...
      (response) => {
        ...
        if(!response.data ||!response.data.data) {
          ...
          newError.message = t('modelPanels.errors.data.e1', 'No data was received from the server.');
          newError.locations=[{model: 'sample', association: 'library_data', table:'B', query: 'countNuc_acid_library_results', method: 'getDataB()', request: 'api.nuc_acid_library_result.getCountItems'}];
          newError.path=['add', 'library_data'];
          newError.extensions = {graphqlResponse:{data:response.data.data, errors:response.data.errors}};
          ...
          cancelableApiReqB
            ...
            (response) => {
              ...
              if(!response.data ||!response.data.data) {
                ...
                variantB.current='error';
                newError.message = t('modelPanels.errors.data.e1', 'No data was received from the server.');
                newError.locations=[{model: 'sample', association: 'library_data', table:'B', query: 'nuc_acid_library_resultsConnection', method: 'getDataB()', request: 'api.nuc_acid_library_result.getItemsConnection'}];
                newError.path=['add', 'library_data'];
                newError.extensions = {graphqlResponse:{data:response.data.data, errors:response.data.errors}};
                errorsB.current.push(newError);
                console.log("Error: ", newError);
              ...
              */
              ...
              if(errorsB.current.length > 0) {
                ...
                newError.locations=[{model: 'sample', association: 'library_data', table:'B', method: 'getDataB()'}];
                newError.path=['add', 'library_data'];
                newError.extensions = {graphQL:{data:response.data.data, errors:response.data.errors}};
                errorsB.current.push(newError);
                console.log("Error: ", newError);
  ...
  useEffect(() => {
    ...
    /*
     * Case 1: 
     * The relation 'library_data' for this item was updated.
    ...
    if(lastModelChanged.sample&&
        ...
        lastModelChanged.sample[String(item.id)].changedAssociations.library_data&&
        (lastModelChanged.sample[String(item.id)].changedAssociations.library_data.added ||
         lastModelChanged.sample[String(item.id)].changedAssociations.library_data.removed)) {
          
          //remove any dis-associated internalId from idsToAdd[]
          let idsRemoved = lastModelChanged.sample[String(item.id)].changedAssociations.library_data.idsRemoved;
          if(idsRemoved) {
            idsRemoved.forEach( (idRemoved) => {
              ...
              handleUntransfer('library_data', idRemoved);
            });
          }
            ...
            if(entry[1].changedAssociations.sample.added) {
              ...
              if(idsAdded) {
                ...
                if(iof !== -1) {
                  ...
                  handleUntransfer('library_data', idAdded);
  ...
  const handleAddItem = (event, item) => {
    if(lidsToAdd.current.indexOf(item.id) === -1) {
      ...
      //reload B (full)
      resetReloadDataB();
      handleTransfer('library_data', item.id);
    }
  };
  ...
  const handleRemoveItem = (event, item) => {
    ...
    if(iof !== -1) { 
      ...
      //reload B
      reloadDataB();
      handleUntransfer('library_data', item.id);
    }
  };
        ...
        <Grid item xs={12} sm={5} >
          {(item!==undefined) && (
            <Card className={classes.card}>
              ...
              {/* Toolbar */}
              <LibraryDataToAddTransferViewToolbar
              ...
              {/* Pagination */}
              <LibraryDataToAddTransferViewCursorPagination
                count={count}
...
LibraryDataToAddTransferView.propTypes = {
