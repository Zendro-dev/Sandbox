...
export default function NucAcidLibraryResultUploadFileDialog(props) {
  ...
  const handleSubmit = (event) => {
    if(file.current !== undefined && file.current !== null) {
      ...
      let query = 'mutation{ bulkAddNuc_acid_library_resultCsv{ id} }'
  ...
  return (
    ...
    >
      <DialogTitle>
      { t('modelPanels.uploading') + ' Nuc_acid_library_results' }
        <div>
...
NucAcidLibraryResultUploadFileDialog.propTypes = {
