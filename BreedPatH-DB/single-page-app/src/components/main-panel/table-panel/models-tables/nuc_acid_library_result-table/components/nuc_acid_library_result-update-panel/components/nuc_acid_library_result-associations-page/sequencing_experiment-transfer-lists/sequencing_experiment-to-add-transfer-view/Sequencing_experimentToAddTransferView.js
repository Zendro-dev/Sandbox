...
import SequencingExperimentToAddTransferViewToolbar from './components/Sequencing_experimentToAddTransferViewToolbar';
import SequencingExperimentToAddTransferViewCursorPagination from './components/Sequencing_experimentToAddTransferViewCursorPagination';
...
export default function SequencingExperimentToAddTransferView(props) {
  ...
  */
  ...
  const getData = useCallback(() => {
    ...
    /*
      API Request: readOneNuc_acid_library_result
    */
    let cancelableApiReq = makeCancelable(api.nuc_acid_library_result.getAssociatedSequencing_experimentConnection(graphqlServerUrl, item.id));  
    ...
    cancelableApiReq
      ...
      (response) => {
        ...
        if(!response.data ||!response.data.data) {
          ...
          newError.locations=[{model: 'nuc_acid_library_result', association: 'sequencing_experiment', table:'A', query: 'readOneNuc_acid_library_result', method: 'getData()', request: 'api.nuc_acid_library_result.getAssociatedSequencing_experimentConnection'}];
          newError.path=['add', 'sequencing_experiment'];
        ...
        //check: readOneNuc_acid_library_result
        let readOneNuc_acid_library_result = response.data.data.readOneNuc_acid_library_result;
        if(readOneNuc_acid_library_result === null) {
          let newError = {};
          let withDetails=true;
          variant.current='error';
          newError.message = 'readOneNuc_acid_library_result ' + t('modelPanels.errors.data.e2', 'could not be fetched.');
          newError.locations=[{model: 'nuc_acid_library_result', association: 'sequencing_experiment', table:'A', query: 'readOneNuc_acid_library_result', method: 'getData()', request: 'api.nuc_acid_library_result.getAssociatedSequencing_experimentConnection'}];
          newError.path=['add', 'sequencing_experiment'];
          newError.extensions = {graphqlResponse:{data:response.data.data, errors:response.data.errors}};
          errors.current.push(newError);
        ...
        //check: readOneNuc_acid_library_result type
        if(typeof readOneNuc_acid_library_result !== 'object'
        || typeof readOneNuc_acid_library_result.sequencing_experiment!== 'object' //can be null
        ) {
          let newError = {};
          let withDetails=true;
          variant.current='error';
          newError.message = 'readOneNuc_acid_library_result ' + t('modelPanels.errors.data.e4', ' received, does not have the expected format.');
          newError.locations=[{model: 'nuc_acid_library_result', association: 'sequencing_experiment', table:'A', query: 'readOneNuc_acid_library_result', method: 'getData()', request: 'api.nuc_acid_library_result.getAssociatedSequencing_experimentConnection'}];
          newError.path=['add', 'sequencing_experiment'];
          newError.extensions = {graphqlResponse:{data:response.data.data, errors:response.data.errors}};
          errors.current.push(newError);
        ...
        //get item
        let idso = readOneNuc_acid_library_result.sequencing_experiment;

        //check: graphql errors
        if(response.data.errors) {
          let newError = {};
          newError.message = 'readOneNuc_acid_library_result ' + t('modelPanels.errors.data.e3', 'fetched with errors.');
          newError.locations=[{model: 'nuc_acid_library_result', association: 'sequencing_experiment', table:'A', query: 'readOneNuc_acid_library_result', method: 'getData()', request: 'api.nuc_acid_library_result.getAssociatedSequencing_experimentConnection'}];
          newError.path=['add', 'sequencing_experiment'];
        ...
        */
        let cancelableApiReqB = makeCancelable(api.sequencing_experiment.getCountItems(graphqlServerUrl, search, ops));
        ...
        cancelableApiReqB
          ...
          (response)=> {
            ...
            if(!response.data ||!response.data.data) {
              ...
              variant.current='error';
              newError.message = t('modelPanels.errors.data.e1', 'No data was received from the server.');
              newError.locations=[{model: 'nuc_acid_library_result', association: 'sequencing_experiment', table:'A', query: 'countSequencing_experiments', method: 'getData()', request: 'api.sequencing_experiment.getCountItems'}];
              newError.path=['add', 'sequencing_experiment'];
              newError.extensions = {graphqlResponse:{data:response.data.data, errors:response.data.errors}};
              errors.current.push(newError);
              console.log("Error: ", newError);
            ...
            */
            ...
            let cancelableApiReqC = makeCancelable(api.sequencing_experiment.getItemsConnection(
              graphqlServerUrl,
              search,
              null, //orderBy
              null, //orderDirection
            ...
            cancelableApiReqC
              ...
              (response) => {
                ...
                if(!response.data ||!response.data.data) {
                  ...
                  variant.current='error';
                  newError.message = t('modelPanels.errors.data.e1', 'No data was received from the server.');
                  newError.locations=[{model: 'nuc_acid_library_result', association: 'sequencing_experiment', table:'A', query: 'sequencing_experimentsConnection', method: 'getData()', request: 'api.sequencing_experiment.getItemsConnection'}];
                  newError.path=['add', 'sequencing_experiment'];
                  newError.extensions = {graphqlResponse:{data:response.data.data, errors:response.data.errors}};
                  errors.current.push(newError);
                  console.log("Error: ", newError);
                ...
                if(sequencing_experimentsConnection === null) {
                  ...
                  */
                  ...
                  if(errors.current.length > 0) {
                    ...
                    newError.locations=[{model: 'nuc_acid_library_result', association: 'sequencing_experiment', table:'A', method: 'getData()'}];
                    newError.path=['add', 'sequencing_experiment'];
                    newError.extensions = {graphQL:{data:response.data.data, errors:response.data.errors}};
                    errors.current.push(newError);
                    console.log("Error: ", newError);
      ...
      //error
      .catch((err) => { //error: on api.nuc_acid_library_result.getAssociatedSequencing_experimentConnection
        if(err.isCanceled) {
          return
        } else {
          let newError = {};
  ...
  const getDataB = useCallback(() => {
    ...
    */
    let cancelableApiReq = makeCancelable(api.sequencing_experiment.getCountItems(graphqlServerUrl, searchB, ops));
    cancelablePromises.current.push(cancelableApiReq);
    cancelableApiReq
      .promise
      .then(
      ...
      (response) => {
        ...
        if(!response.data ||!response.data.data) {
          ...
          newError.message = t('modelPanels.errors.data.e1', 'No data was received from the server.');
          newError.locations=[{model: 'nuc_acid_library_result', association: 'sequencing_experiment', table:'B', query: 'countSequencing_experiments', method: 'getDataB()', request: 'api.sequencing_experiment.getCountItems'}];
          newError.path=['add', 'sequencing_experiment'];
          newError.extensions = {graphqlResponse:{data:response.data.data, errors:response.data.errors}};
        ...
        //ok
        setCountB(countSequencing_experiments);
          ...
          cancelableApiReqB
            ...
            (response) => {
              ...
              if(!response.data ||!response.data.data) {
                ...
                variantB.current='error';
                newError.message = t('modelPanels.errors.data.e1', 'No data was received from the server.');
                newError.locations=[{model: 'nuc_acid_library_result', association: 'sequencing_experiment', table:'B', query: 'sequencing_experimentsConnection', method: 'getDataB()', request: 'api.sequencing_experiment.getItemsConnection'}];
                newError.path=['add', 'sequencing_experiment'];
                newError.extensions = {graphqlResponse:{data:response.data.data, errors:response.data.errors}};
                errorsB.current.push(newError);
                console.log("Error: ", newError);
              ...
              */
              ...
              if(errorsB.current.length > 0) {
                ...
                newError.locations=[{model: 'nuc_acid_library_result', association: 'sequencing_experiment', table:'B', method: 'getDataB()'}];
                newError.path=['add', 'sequencing_experiment'];
                newError.extensions = {graphQL:{data:response.data.data, errors:response.data.errors}};
                errorsB.current.push(newError);
                console.log("Error: ", newError);
  ...
  useEffect(() => {
    ...
    /*
     * Case 1: 
     * The relation 'sequencing_experiment' for this item was updated.
     * That is to say that the current item was associated or dis-associated with some 'sequencing_experiments' (from another place).
     * 
     * Actions:
    ...
    if(lastModelChanged.nuc_acid_library_result&&
        ...
        lastModelChanged.nuc_acid_library_result[String(item.id)].changedAssociations&&
        lastModelChanged.nuc_acid_library_result[String(item.id)].changedAssociations.sequencing_experiment&&
        (lastModelChanged.nuc_acid_library_result[String(item.id)].changedAssociations.sequencing_experiment.added ||
         lastModelChanged.nuc_acid_library_result[String(item.id)].changedAssociations.sequencing_experiment.removed)) {
          
          //remove any dis-associated internalId from idsToAdd[]
          let idsRemoved = lastModelChanged.nuc_acid_library_result[String(item.id)].changedAssociations.sequencing_experiment.idsRemoved;
          if(idsRemoved) {
            idsRemoved.forEach( (idRemoved) => {
              ...
              handleUntransfer('sequencing_experiment', idRemoved);
            });
          }
    ...
    /*
     * Case 2: 
     * The peer relation 'nuc_acid_library_results' for this item was updated.
     * That is to say that this current item was associated or dis-associated with some 'sequencing_experiment',
     * but this action happened on the peer relation 'nuc_acid_library_results'.
     * 
     * Conditions:
     * A: the current item internalId is in the removedIds of the updated 'sequencing_experiment'.
     * B: the current item internalId is in the addedIds of the updated 'sequencing_experiment'.
     * 
     * Actions:
     * if A:
     * - update associatedIds[].
     ...
     * 
     * else if B:
     * - remove the internalId of the 'sequencing_experiment' from idsToAdd[].
     * - update associatedIds[].
     * - reload both transfer tables.
     * - return
     */
    if(lastModelChanged.sequencing_experiment) {
      let oens = Object.entries(lastModelChanged.sequencing_experiment);
      oens.forEach( (entry) => {
        if(entry[1].changedAssociations&&
          entry[1].changedAssociations.nuc_acid_library_results) {

            //case A: this item was removed from peer relation.
            if(entry[1].changedAssociations.nuc_acid_library_results.removed) {
              let idsRemoved = entry[1].changedAssociations.nuc_acid_library_results.idsRemoved;
              if(idsRemoved) {
            ...
            if(entry[1].changedAssociations.nuc_acid_library_results.added) {
              let idsAdded = entry[1].changedAssociations.nuc_acid_library_results.idsAdded;
              if(idsAdded) {
                ...
                if(iof !== -1) {
                  ...
                  handleUntransfer('sequencing_experiment', idAdded);
    ...
    /*
     * Case 3: 
     * The attributes of some 'sequencing_experiment' were modified or the item was deleted.
     * 
     * Conditions:
  ...
  const handleRowClicked = (event, item) => {
    handleClickOnSequencing_experimentRow(event, item);
  };
  ...
  const handleAddItem = (event, item) => {
    if(lidsToAdd.current.indexOf(item.id) === -1) {
      ...
      //reload B (full)
      resetReloadDataB();
      handleTransfer('sequencing_experiment', item.id);
    }
  };
  ...
  const handleRemoveItem = (event, item) => {
    if(lidsToAdd.current.length > 0) {
      ...
      //reload B
      reloadDataB();
      handleUntransfer('sequencing_experiment', item.id);
    }
  };
        ...
        <Grid item xs={12} sm={5} >
          {(item!==undefined) && (
            <Card className={classes.card}>
              ...
              {/* Toolbar */}
              <SequencingExperimentToAddTransferViewToolbar
                title={'Sequencing_experiments'}
                titleIcon={1}
                search={search}
              ...
              {/* Pagination */}
              <SequencingExperimentToAddTransferViewCursorPagination
                count={count}
...
SequencingExperimentToAddTransferView.propTypes = {
