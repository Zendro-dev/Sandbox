...
export default function NucAcidLibraryResultEnhancedTableToolbar(props) {
                          ...
                          <Grid item xs={12}>
                            <Grid container justify="center">
                              {/* Add */}
                              {
                                ...
                                &&(permissions.nuc_acid_library_result.includes('create') || permissions.nuc_acid_library_result.includes('*')))
                                &&(
                                  <Grid item>
                                    <Tooltip title={t('modelPanels.addNew') + " nuc_acid_library_result"}>
                                      <IconButton
                                        color="primary"
                                    ...
                                    >
                                      ...
                                      <Grid item xs={12}>
                                        <Grid container justify='flex-start'>
                                          ...
                                          <input type="hidden" name="model" value='nuc_acid_library_result' />
                                            <ButtonBase
...
NucAcidLibraryResultEnhancedTableToolbar.propTypes = {
