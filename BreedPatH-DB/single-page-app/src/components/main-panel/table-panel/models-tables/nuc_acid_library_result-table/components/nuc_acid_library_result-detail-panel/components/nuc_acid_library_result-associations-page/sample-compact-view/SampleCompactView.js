...
import SampleCompactViewToolbar from './components/SampleCompactViewToolbar';
import SampleCompactViewCursorPagination from './components/SampleCompactViewCursorPagination';
...
export default function SampleCompactView(props) {
  ...
  const getData = useCallback(() => {
    ...
    */
    ...
    let cancelableApiReq = makeCancelable(api.nuc_acid_library_result.getSampleConnection(
      graphqlServerUrl, 
      item.id,
      label,
      sublabel,
    ...
    cancelableApiReq
      ...
      (response) => {
        ...
        if(!response.data ||!response.data.data) {
          ...
          newError.locations=[{association: 'sample', query: 'readOneNuc_acid_library_result', method: 'getData()', request: 'api.nuc_acid_library_result.getSampleConnection'}];
          newError.path=['detail', `id:${item.id}`, 'sample'];
        ...
        //get item
        let it = readOneNuc_acid_library_result.sample;
      ...
      //error
      .catch((err) => { //error: on api.nuc_acid_library_result.getSampleConnection
        if(err.isCanceled) {
          return;
        } else {
          let newError = {};
  ...
  useEffect(() => {
     ...
     * 
     * Conditions:
     * A: the current item 'internalId' attribute is in the removedIds of the updated 'sample'.
     * B: the current item 'internalId' attribute is in the addedIds of the updated 'sample'.
     * 
     * Actions:
     * if A:
     * - reload table.
          ...
          {(item!==undefined) && (
            <Card className={classes.card}>
              ...
              {(false) && (
                ...
                <SampleCompactViewCursorPagination
                  count={count}
...
SampleCompactView.propTypes = {
  item: PropTypes.object.isRequired,
  handleClickOnSampleRow: PropTypes.func,
};