...
export default function MarkerDataUploadFileDialog(props) {
  ...
  const handleSubmit = (event) => {
    if(file.current !== undefined && file.current !== null) {
      ...
      let query = 'mutation{ bulkAddMarker_dataCsv{ id} }'
  ...
  return (
    ...
    >
      <DialogTitle>
      { t('modelPanels.uploading') + ' Marker_data' }
        <div>
...
MarkerDataUploadFileDialog.propTypes = {
