...
import MarkerDataEnhancedTableHead from './components/Marker_dataEnhancedTableHead'
import MarkerDataEnhancedTableToolbar from './components/Marker_dataEnhancedTableToolbar'
import MarkerDataCreatePanel from './components/marker_data-create-panel/Marker_dataCreatePanel'
import MarkerDataUpdatePanel from './components/marker_data-update-panel/Marker_dataUpdatePanel'
import MarkerDataDetailPanel from './components/marker_data-detail-panel/Marker_dataDetailPanel'
import MarkerDataDeleteConfirmationDialog from './components/Marker_dataDeleteConfirmationDialog'
import MarkerDataUploadFileDialog from './components/Marker_dataUploadFileDialog'
import MarkerDataCursorPagination from './components/Marker_dataCursorPagination'
...
//Plotly
import MarkerDataPlotly from '../../../../plots/Marker_dataPlotly';
...
export default function MarkerDataEnhancedTable(props) {
  ...
  const getData = useCallback(() => {
    ...
    */
    let cancelableApiReq = makeCancelable(api.marker_data.getCountItems(graphqlServerUrl, search));
    ...
    cancelableApiReq
      ...
      (response) => {
        ...
        if(!response.data ||!response.data.data) {
          ...
          newError.locations=[{model: 'marker_data', query: 'countMarker_data', method: 'getData()', request: 'api.marker_data.getCountItems'}];
          newError.path=['Marker_data'];
          ...
          cancelableApiReqB
            ...
            (response) => {
              ...
              if(!response.data ||!response.data.data) {
                ...
                variant.current='error';
                newError.message = t('modelPanels.errors.data.e1', 'No data was received from the server.');
                newError.locations=[{model: 'marker_data', query: 'marker_dataConnection', method: 'getData()', request: 'api.marker_data.getItemsConnection'}];
                newError.path=['Marker_data'];
                newError.extensions = {graphqlResponse:{data:response.data.data, errors:response.data.errors}};
                errors.current.push(newError);
                console.log("Error: ", newError);
              ...
              */
              ...
              if(errors.current.length > 0) {
                ...
                newError.locations=[{model: 'marker_data', method: 'getData()'}];
                newError.path=['Marker_data'];
                newError.extensions = {graphQL:{data:response.data.data, errors:response.data.errors}};
                errors.current.push(newError);
                console.log("Error: ", newError);
  ...
  function doDelete(event, item) {
    ...
    /*
      API Request: deleteMarker_data
    */
    let cancelableApiReq = makeCancelable(api.marker_data.deleteItem(graphqlServerUrl, variables));
    cancelablePromises.current.push(cancelableApiReq);
    cancelableApiReq
      .promise
      .then(
      ...
      (response) => {
        ...
        if(!response.data ||!response.data.data) {
          ...
          variant.current='error';
          newError.message = t('modelPanels.errors.data.e1', 'No data was received from the server.');
          newError.locations=[{model: 'marker_data', query: 'deleteMarker_data', method: 'doDelete()', request: 'api.marker_data.deleteItem'}];
          newError.path=['Marker_data', `id:${item.id}`, 'delete'];
          newError.extensions = {graphqlResponse:{data:response.data.data, errors:response.data.errors}};
          errors.current.push(newError);
          console.log("Error: ", newError);
        ...
        //check: deleteMarker_data
        let deleteMarker_data = response.data.data.deleteMarker_data;
        if(deleteMarker_data === null) {
          let newError = {};
          let withDetails=true;
          variant.current='error';
          newError.message = 'deleteMarker_data ' + t('modelPanels.errors.data.e5', 'could not be completed.');
          newError.locations=[{model: 'marker_data', query: 'deleteMarker_data', method: 'doDelete()', request: 'api.marker_data.deleteItem'}];
          newError.path=['Marker_data', `id:${item.id}` ,'delete'];
          newError.extensions = {graphqlResponse:{data:response.data.data, errors:response.data.errors}};
          errors.current.push(newError);
        ...
        /**
         * Type of deleteMarker_data is not validated. Only not null is
        ...
        if(response.data.errors) {
          ...
          let withDetails=true;
          variant.current='info';
          newError.message = 'deleteMarker_data ' + t('modelPanels.errors.data.e6', 'completed with errors.');
          newError.locations=[{model: 'marker_data', query: 'deleteMarker_data', method: 'doDelete()', request: 'api.marker_data.deleteItem'}];
          newError.path=['Marker_data', `id:${item.id}` ,'delete'];
          newError.extensions = {graphQL:{data:response.data.data, errors:response.data.errors}};
          errors.current.push(newError);
      ...
      //error
      .catch((err) => { //error: on api.marker_data.deleteItem
        if(err.isCanceled) {
          return
        } else {
          let newError = {};
  ...
  function getCsvTemplate() {
    ...
    /*
      API Request: csvTableTemplateMarker_data
    */
    let cancelableApiReq = makeCancelable(api.marker_data.tableTemplate(graphqlServerUrl));
    cancelablePromises.current.push(cancelableApiReq);
    cancelableApiReq
      .promise
      .then(
      ...
      (response) => {
        ...
        if(!response.data ||!response.data.data) {
          ...
          variant.current='error';
          newError.message = t('modelPanels.errors.data.e1', 'No data was received from the server.');
          newError.locations=[{model: 'marker_data', query: 'csvTableTemplateMarker_data', method: 'getCsvTemplate()', request: 'api.marker_data.tableTemplate'}];
          newError.path=['Marker_data', 'csvTemplate'];
          newError.extensions = {graphqlResponse:{data:response.data.data, errors:response.data.errors}};
          errors.current.push(newError);
          console.log("Error: ", newError);
        ...
        //check: csvTableTemplateMarker_data
        let csvTableTemplateMarker_data = response.data.data.csvTableTemplateMarker_data;
        if(csvTableTemplateMarker_data === null) {
          let newError = {};
          let withDetails=true;
          variant.current='error';
          newError.message = 'csvTableTemplateMarker_data ' + t('modelPanels.errors.data.e2', 'could not be fetched.');
          newError.locations=[{model: 'marker_data', query: 'csvTableTemplateMarker_data', method: 'getCsvTemplate()', request: 'api.marker_data.tableTemplate'}];
          newError.path=['Marker_data', 'csvTemplate'];
          newError.extensions = {graphqlResponse:{data:response.data.data, errors:response.data.errors}};
          errors.current.push(newError);
        ...
        //check: csvTableTemplateMarker_data type
        if(!Array.isArray(csvTableTemplateMarker_data)) {
          let newError = {};
          let withDetails=true;
          variant.current='error';
          newError.message = 'csvTableTemplateMarker_data ' + t('modelPanels.errors.data.e4', ' received, does not have the expected format.');
          newError.locations=[{model: 'marker_data', query: 'csvTableTemplateMarker_data', method: 'getCsvTemplate()', request: 'api.marker_data.tableTemplate'}];
          newError.path=['Marker_data', 'csvTemplate'];
          newError.extensions = {graphqlResponse:{data:response.data.data, errors:response.data.errors}};
          errors.current.push(newError);
        ...
        if(response.data.errors) {
          ...
          let withDetails=true;
          variant.current='info';
          newError.message = 'csvTableTemplateMarker_data ' + t('modelPanels.errors.data.e3', 'fetched with errors.');
          newError.locations=[{model: 'marker_data', query: 'csvTableTemplateMarker_data', method: 'getCsvTemplate()', request: 'api.marker_data.tableTemplate'}];
          newError.path=['Marker_data', 'csvTemplate'];
          newError.extensions = {graphQL:{data:response.data.data, errors:response.data.errors}};
          errors.current.push(newError);
        ...
        //download
        let file = response.data.data.csvTableTemplateMarker_data.join("\n");
        const url = window.URL.createObjectURL(new Blob([file]));
        const link = document.createElement("a");
        link.href = url;
        link.setAttribute("download", "marker_data-template.csv");
      ...
      //error
      .catch((err) => { //error: on api.marker_data.tableTemplate
        if(err.isCanceled) {
          return
        } else {
          let newError = {};
  ...
  return (
    <div className={classes.root}>
          ...
          <Grid container justify='center'>
            <Grid item xs={12}>
              <Paper className={classes.paper}>
                ...
                {/* Toolbar */}
                <MarkerDataEnhancedTableToolbar
                  permissions={permissions}
                  search={search}
                  showToggleButtons={Boolean(MarkerDataPlotly)}
                                    ...
                                    */}
                                    {
                                      /* acl check */
                                      (permissions&&permissions.marker_data&&Array.isArray(permissions.marker_data)
                                      &&(permissions.marker_data.includes('update') || permissions.marker_data.includes('*')))
                                      &&(
...

                                    {
                                      /* acl check */
                                      (permissions&&permissions.marker_data&&Array.isArray(permissions.marker_data)
                                      &&(permissions.marker_data.includes('delete') || permissions.marker_data.includes('*')))
                                      &&(
                                        <TableCell padding='checkbox' align='center'>
                                    ...
                                    <TableCell
                                      ...
                                      padding="default"
                                    >
                                      {String((item.marker_name!==null)?item.marker_name:'')}
                                    </TableCell>
                                    ...
                                    <TableCell
                                      ...
                                      padding="default"
                                    >
                                      {String((item.nucleotide!==null)?item.nucleotide:'')}
                                    </TableCell>
      ...
      {(deleteConfirmationDialogOpen) && (
        <MarkerDataDeleteConfirmationDialog
          permissions={permissions}
...
MarkerDataEnhancedTable.propTypes = {
