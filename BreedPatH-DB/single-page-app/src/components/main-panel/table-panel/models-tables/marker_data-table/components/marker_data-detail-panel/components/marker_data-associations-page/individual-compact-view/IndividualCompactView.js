...
import IndividualCompactViewToolbar from './components/IndividualCompactViewToolbar';
import IndividualCompactViewCursorPagination from './components/IndividualCompactViewCursorPagination';
...
export default function IndividualCompactView(props) {
  ...
  const getData = useCallback(() => {
    ...
    */
    ...
    let cancelableApiReq = makeCancelable(api.marker_data.getIndividualConnection(
      graphqlServerUrl, 
      item.id,
      label,
      sublabel,
    ...
    cancelableApiReq
      ...
      (response) => {
        ...
        if(!response.data ||!response.data.data) {
          ...
          newError.locations=[{association: 'individual', query: 'readOneMarker_data', method: 'getData()', request: 'api.marker_data.getIndividualConnection'}];
          newError.path=['detail', `id:${item.id}`, 'individual'];
        ...
        //get item
        let it = readOneMarker_data.individual;
      ...
      //error
      .catch((err) => { //error: on api.marker_data.getIndividualConnection
        if(err.isCanceled) {
          return;
        } else {
          let newError = {};
  ...
  useEffect(() => {
     ...
     * 
     * Conditions:
     * A: the current item 'internalId' attribute is in the removedIds of the updated 'individual'.
     * B: the current item 'internalId' attribute is in the addedIds of the updated 'individual'.
     * 
     * Actions:
     * if A:
     * - reload table.
          ...
          {(item!==undefined) && (
            <Card className={classes.card}>
              ...
              {(false) && (
                ...
                <IndividualCompactViewCursorPagination
                  count={count}
...
IndividualCompactView.propTypes = {
  item: PropTypes.object.isRequired,
  handleClickOnIndividualRow: PropTypes.func,
};