...
import MotherCompactViewToolbar from './components/MotherCompactViewToolbar';
import MotherCompactViewCursorPagination from './components/MotherCompactViewCursorPagination';
...
export default function MotherCompactView(props) {
  ...
  const getData = useCallback(() => {
    ...
    */
    ...
    let cancelableApiReq = makeCancelable(api.genotype.getMotherConnection(
      graphqlServerUrl, 
      item.id,
      label,
      sublabel,
    ...
    cancelableApiReq
      ...
      (response) => {
        ...
        if(!response.data ||!response.data.data) {
          ...
          newError.locations=[{association: 'mother', query: 'readOneGenotype', method: 'getData()', request: 'api.genotype.getMotherConnection'}];
          newError.path=['detail', `id:${item.id}`, 'mother'];
      ...
      //error
      .catch((err) => { //error: on api.genotype.getMotherConnection
        if(err.isCanceled) {
          return;
        } else {
          let newError = {};
          ...
          {(item!==undefined) && (
            <Card className={classes.card}>
              ...
              {(false) && (
                ...
                <MotherCompactViewCursorPagination
                  count={count}
...
MotherCompactView.propTypes = {
  item: PropTypes.object.isRequired,
  handleClickOnMotherRow: PropTypes.func,
};