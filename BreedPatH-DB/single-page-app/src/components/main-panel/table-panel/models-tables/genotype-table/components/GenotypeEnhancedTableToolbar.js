...
export default function GenotypeEnhancedTableToolbar(props) {
                          ...
                          <Grid item xs={12}>
                            <Grid container justify="center">
                              {/* Add */}
                              {
                                ...
                                &&(permissions.genotype.includes('create') || permissions.genotype.includes('*')))
                                &&(
                                  <Grid item>
                                    <Tooltip title={t('modelPanels.addNew') + " genotype"}>
                                      <IconButton
                                        color="primary"
                                    ...
                                    >
                                      ...
                                      <Grid item xs={12}>
                                        <Grid container justify='flex-start'>
                                          ...
                                          <input type="hidden" name="model" value='genotype' />
                                            <ButtonBase
...
GenotypeEnhancedTableToolbar.propTypes = {
