...
export default function IndividualToAddTransferView(props) {
  ...
  */
  ...
  const getData = useCallback(() => {
    ...
    */
    let cancelableApiReq = makeCancelable(api.genotype.getAssociatedIndividualConnection(graphqlServerUrl, item.id));  
    ...
    cancelableApiReq
      ...
      (response) => {
        ...
        if(!response.data ||!response.data.data) {
          ...
          newError.locations=[{model: 'genotype', association: 'individual', table:'A', query: 'readOneGenotype', method: 'getData()', request: 'api.genotype.getAssociatedIndividualConnection'}];
        ...
        || typeof readOneGenotype.individual!== 'object' //can be null
        ) {
          let newError = {};
          let withDetails=true;
          variant.current='error';
        ...
        //get item
        let idso = readOneGenotype.individual;
        ...
        cancelableApiReqB
          ...
          (response)=> {
            ...
            if(!response.data ||!response.data.data) {
              ...
              variant.current='error';
              newError.message = t('modelPanels.errors.data.e1', 'No data was received from the server.');
              newError.locations=[{model: 'genotype', association: 'individual', table:'A', query: 'countIndividuals', method: 'getData()', request: 'api.individual.getCountItems'}];
              newError.path=['add', 'individual'];
              newError.extensions = {graphqlResponse:{data:response.data.data, errors:response.data.errors}};
              errors.current.push(newError);
              console.log("Error: ", newError);
            ...
            cancelableApiReqC
              ...
              (response) => {
                ...
                if(!response.data ||!response.data.data) {
                  ...
                  variant.current='error';
                  newError.message = t('modelPanels.errors.data.e1', 'No data was received from the server.');
                  newError.locations=[{model: 'genotype', association: 'individual', table:'A', query: 'individualsConnection', method: 'getData()', request: 'api.individual.getItemsConnection'}];
                  newError.path=['add', 'individual'];
                  newError.extensions = {graphqlResponse:{data:response.data.data, errors:response.data.errors}};
                  errors.current.push(newError);
                  console.log("Error: ", newError);
                ...
                if(individualsConnection === null) {
                  ...
                  */
                  ...
                  if(errors.current.length > 0) {
                    ...
                    newError.locations=[{model: 'genotype', association: 'individual', table:'A', method: 'getData()'}];
                    newError.path=['add', 'individual'];
                    newError.extensions = {graphQL:{data:response.data.data, errors:response.data.errors}};
                    errors.current.push(newError);
                    console.log("Error: ", newError);
      ...
      //error
      .catch((err) => { //error: on api.genotype.getAssociatedIndividualConnection
        if(err.isCanceled) {
          return
        } else {
          let newError = {};
    ...
    cancelableApiReq
      ...
      (response) => {
        ...
        if(!response.data ||!response.data.data) {
          ...
          newError.message = t('modelPanels.errors.data.e1', 'No data was received from the server.');
          newError.locations=[{model: 'genotype', association: 'individual', table:'B', query: 'countIndividuals', method: 'getDataB()', request: 'api.individual.getCountItems'}];
          newError.path=['add', 'individual'];
          newError.extensions = {graphqlResponse:{data:response.data.data, errors:response.data.errors}};
          ...
          cancelableApiReqB
            ...
            (response) => {
              ...
              if(!response.data ||!response.data.data) {
                ...
                variantB.current='error';
                newError.message = t('modelPanels.errors.data.e1', 'No data was received from the server.');
                newError.locations=[{model: 'genotype', association: 'individual', table:'B', query: 'individualsConnection', method: 'getDataB()', request: 'api.individual.getItemsConnection'}];
                newError.path=['add', 'individual'];
                newError.extensions = {graphqlResponse:{data:response.data.data, errors:response.data.errors}};
                errorsB.current.push(newError);
                console.log("Error: ", newError);
              ...
              */
              ...
              if(errorsB.current.length > 0) {
                ...
                newError.locations=[{model: 'genotype', association: 'individual', table:'B', method: 'getDataB()'}];
                newError.path=['add', 'individual'];
                newError.extensions = {graphQL:{data:response.data.data, errors:response.data.errors}};
                errorsB.current.push(newError);
                console.log("Error: ", newError);
  ...
  useEffect(() => {
    ...
    if(lastModelChanged.genotype&&
        ...
        lastModelChanged.genotype[String(item.id)].changedAssociations.individual&&
        (lastModelChanged.genotype[String(item.id)].changedAssociations.individual.added ||
         lastModelChanged.genotype[String(item.id)].changedAssociations.individual.removed)) {
          
          //remove any dis-associated internalId from idsToAdd[]
          let idsRemoved = lastModelChanged.genotype[String(item.id)].changedAssociations.individual.idsRemoved;
          if(idsRemoved) {
