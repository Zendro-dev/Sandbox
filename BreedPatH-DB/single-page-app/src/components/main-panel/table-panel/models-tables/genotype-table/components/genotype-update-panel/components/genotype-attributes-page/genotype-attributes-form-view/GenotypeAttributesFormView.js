...
export default function GenotypeAttributesFormView(props) {
        ...
        <Card className={classes.cardB} elevation={0}>
          ...
          <Card className={classes.card}>
            ...
            */}
            ...
            {/* pedigree_type */}
            <CardContent key='pedigree_type' className={classes.cardContent} >
              <StringField
                itemKey='pedigree_type'
                name='pedigree_type'
                label='pedigree_type'
                text={item.pedigree_type}
                valueOk={valueOkStates.pedigree_type}
                valueAjv={valueAjvStates.pedigree_type}
                handleSetValue={handleSetValue}
              />
            </CardContent>
...
GenotypeAttributesFormView.propTypes = {
