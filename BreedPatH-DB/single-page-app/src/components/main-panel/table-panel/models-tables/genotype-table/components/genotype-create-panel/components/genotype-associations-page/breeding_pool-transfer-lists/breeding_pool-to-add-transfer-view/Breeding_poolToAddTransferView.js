...
export default function BreedingPoolToAddTransferView(props) {
  ...
  */
  ...
  const getData = useCallback(() => {
    ...
    */
    let cancelableApiReq = makeCancelable(api.breeding_pool.getCountItems(graphqlServerUrl, search, ops));
                  ...
                  <List dense component="div" role="list" >
                    {items.map(it => {
                      ...
                      return (
                        ...
                        >
                          <ListItemAvatar>
                            <Tooltip title={ 'breeding_pool' }>
                              <Avatar>{"breeding_pool".slice(0,1)}</Avatar>
                            </Tooltip>
                          </ListItemAvatar>
