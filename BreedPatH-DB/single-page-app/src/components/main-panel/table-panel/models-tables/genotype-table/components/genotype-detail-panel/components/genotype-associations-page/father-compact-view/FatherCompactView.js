...
import FatherCompactViewToolbar from './components/FatherCompactViewToolbar';
import FatherCompactViewCursorPagination from './components/FatherCompactViewCursorPagination';
...
export default function FatherCompactView(props) {
  ...
  const getData = useCallback(() => {
    ...
    */
    ...
    let cancelableApiReq = makeCancelable(api.genotype.getFatherConnection(
      graphqlServerUrl, 
      item.id,
      label,
      sublabel,
    ...
    cancelableApiReq
      ...
      (response) => {
        ...
        if(!response.data ||!response.data.data) {
          ...
          newError.locations=[{association: 'father', query: 'readOneGenotype', method: 'getData()', request: 'api.genotype.getFatherConnection'}];
          newError.path=['detail', `id:${item.id}`, 'father'];
      ...
      //error
      .catch((err) => { //error: on api.genotype.getFatherConnection
        if(err.isCanceled) {
          return;
        } else {
          let newError = {};
          ...
          {(item!==undefined) && (
            <Card className={classes.card}>
              ...
              {(false) && (
                ...
                <FatherCompactViewCursorPagination
                  count={count}
...
FatherCompactView.propTypes = {
  item: PropTypes.object.isRequired,
  handleClickOnFatherRow: PropTypes.func,
};