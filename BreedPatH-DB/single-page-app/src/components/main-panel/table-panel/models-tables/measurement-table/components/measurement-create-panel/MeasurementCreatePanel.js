...
export default function MeasurementCreatePanel(props) {
  ...
  function getInitialValues() {
    ...
    initialValues.float_value = null;
    initialValues.int_value = null;
    initialValues.text_value = null;
  ...
  function getInitialValueOkStates() {
    ...
    */
    ...
    initialValueOkStates.float_value = 0;
    initialValueOkStates.int_value = 0;
    initialValueOkStates.text_value = 0;
