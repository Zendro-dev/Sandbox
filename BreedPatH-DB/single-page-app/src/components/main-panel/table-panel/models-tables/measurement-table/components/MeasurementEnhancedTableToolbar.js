...
export default function MeasurementEnhancedTableToolbar(props) {
                          ...
                          <Grid item xs={12}>
                            <Grid container justify="center">
                              {/* Add */}
                              {
                                ...
                                &&(permissions.measurement.includes('create') || permissions.measurement.includes('*')))
                                &&(
                                  <Grid item>
                                    <Tooltip title={t('modelPanels.addNew') + " measurement"}>
                                      <IconButton
                                        color="primary"
                                    ...
                                    >
                                      ...
                                      <Grid item xs={12}>
                                        <Grid container justify='flex-start'>
                                          ...
                                          <input type="hidden" name="model" value='measurement' />
                                            <ButtonBase
...
MeasurementEnhancedTableToolbar.propTypes = {
