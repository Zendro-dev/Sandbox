...
import FatherToCompactViewToolbar from './components/Father_toCompactViewToolbar';
import FatherToCompactViewCursorPagination from './components/Father_toCompactViewCursorPagination';
...
export default function FatherToCompactView(props) {
  ...
  const getData = useCallback(() => {
    ...
    */
    ...
    let cancelableApiReq = makeCancelable(api.individual.getFather_toConnection(
      graphqlServerUrl, 
      item.id,
      label,
      sublabel,
    ...
    cancelableApiReq
      ...
      (response) => {
        ...
        if(!response.data ||!response.data.data) {
          ...
          newError.locations=[{association: 'father_to', query: 'readOneIndividual', method: 'getData()', request: 'api.individual.getFather_toConnection'}];
          newError.path=['detail', `id:${item.id}`, 'father_to'];
        ...
        //get item
        let it = readOneIndividual.father_to;
      ...
      //error
      .catch((err) => { //error: on api.individual.getFather_toConnection
        if(err.isCanceled) {
          return;
        } else {
          let newError = {};
          ...
          {(item!==undefined) && (
            <Card className={classes.card}>
              ...
              {(false) && (
                ...
                <FatherToCompactViewCursorPagination
                  count={count}
...
FatherToCompactView.propTypes = {
  item: PropTypes.object.isRequired,
  handleClickOnFather_toRow: PropTypes.func,
};