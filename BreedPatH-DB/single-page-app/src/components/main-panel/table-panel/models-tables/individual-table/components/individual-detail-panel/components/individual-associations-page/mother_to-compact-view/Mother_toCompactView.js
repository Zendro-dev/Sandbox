...
import MotherToCompactViewToolbar from './components/Mother_toCompactViewToolbar';
import MotherToCompactViewCursorPagination from './components/Mother_toCompactViewCursorPagination';
...
export default function MotherToCompactView(props) {
  ...
  const getData = useCallback(() => {
    ...
    */
    ...
    let cancelableApiReq = makeCancelable(api.individual.getMother_toConnection(
      graphqlServerUrl, 
      item.id,
      label,
      sublabel,
    ...
    cancelableApiReq
      ...
      (response) => {
        ...
        if(!response.data ||!response.data.data) {
          ...
          newError.locations=[{association: 'mother_to', query: 'readOneIndividual', method: 'getData()', request: 'api.individual.getMother_toConnection'}];
          newError.path=['detail', `id:${item.id}`, 'mother_to'];
        ...
        //get item
        let it = readOneIndividual.mother_to;
      ...
      //error
      .catch((err) => { //error: on api.individual.getMother_toConnection
        if(err.isCanceled) {
          return;
        } else {
          let newError = {};
          ...
          {(item!==undefined) && (
            <Card className={classes.card}>
              ...
              {(false) && (
                ...
                <MotherToCompactViewCursorPagination
                  count={count}
...
MotherToCompactView.propTypes = {
  item: PropTypes.object.isRequired,
  handleClickOnMother_toRow: PropTypes.func,
};