...
import GenotypeToAddTransferViewToolbar from './components/GenotypeToAddTransferViewToolbar';
import GenotypeToAddTransferViewCursorPagination from './components/GenotypeToAddTransferViewCursorPagination';
...
export default function GenotypeToAddTransferView(props) {
  ...
  */
  ...
  const getData = useCallback(() => {
    ...
    */
    let cancelableApiReq = makeCancelable(api.individual.getAssociatedGenotypeConnection(graphqlServerUrl, item.id));  
    ...
    cancelableApiReq
      ...
      (response) => {
        ...
        if(!response.data ||!response.data.data) {
          ...
          newError.locations=[{model: 'individual', association: 'genotype', table:'A', query: 'readOneIndividual', method: 'getData()', request: 'api.individual.getAssociatedGenotypeConnection'}];
          newError.path=['add', 'genotype'];
        ...
        || typeof readOneIndividual.genotype!== 'object' //can be null
        ) {
          let newError = {};
          let withDetails=true;
          variant.current='error';
        ...
        //get item
        let idso = readOneIndividual.genotype;
        ...
        cancelableApiReqB
          ...
          (response)=> {
            ...
            if(!response.data ||!response.data.data) {
              ...
              variant.current='error';
              newError.message = t('modelPanels.errors.data.e1', 'No data was received from the server.');
              newError.locations=[{model: 'individual', association: 'genotype', table:'A', query: 'countGenotypes', method: 'getData()', request: 'api.genotype.getCountItems'}];
              newError.path=['add', 'genotype'];
              newError.extensions = {graphqlResponse:{data:response.data.data, errors:response.data.errors}};
              errors.current.push(newError);
              console.log("Error: ", newError);
            ...
            cancelableApiReqC
              ...
              (response) => {
                ...
                if(!response.data ||!response.data.data) {
                  ...
                  variant.current='error';
                  newError.message = t('modelPanels.errors.data.e1', 'No data was received from the server.');
                  newError.locations=[{model: 'individual', association: 'genotype', table:'A', query: 'genotypesConnection', method: 'getData()', request: 'api.genotype.getItemsConnection'}];
                  newError.path=['add', 'genotype'];
                  newError.extensions = {graphqlResponse:{data:response.data.data, errors:response.data.errors}};
                  errors.current.push(newError);
                  console.log("Error: ", newError);
                ...
                if(genotypesConnection === null) {
                  ...
                  */
                  ...
                  if(errors.current.length > 0) {
                    ...
                    newError.locations=[{model: 'individual', association: 'genotype', table:'A', method: 'getData()'}];
                    newError.path=['add', 'genotype'];
                    newError.extensions = {graphQL:{data:response.data.data, errors:response.data.errors}};
                    errors.current.push(newError);
                    console.log("Error: ", newError);
      ...
      //error
      .catch((err) => { //error: on api.individual.getAssociatedGenotypeConnection
        if(err.isCanceled) {
          return
        } else {
          let newError = {};
    ...
    cancelableApiReq
      ...
      (response) => {
        ...
        if(!response.data ||!response.data.data) {
          ...
          newError.message = t('modelPanels.errors.data.e1', 'No data was received from the server.');
          newError.locations=[{model: 'individual', association: 'genotype', table:'B', query: 'countGenotypes', method: 'getDataB()', request: 'api.genotype.getCountItems'}];
          newError.path=['add', 'genotype'];
          newError.extensions = {graphqlResponse:{data:response.data.data, errors:response.data.errors}};
          ...
          cancelableApiReqB
            ...
            (response) => {
              ...
              if(!response.data ||!response.data.data) {
                ...
                variantB.current='error';
                newError.message = t('modelPanels.errors.data.e1', 'No data was received from the server.');
                newError.locations=[{model: 'individual', association: 'genotype', table:'B', query: 'genotypesConnection', method: 'getDataB()', request: 'api.genotype.getItemsConnection'}];
                newError.path=['add', 'genotype'];
                newError.extensions = {graphqlResponse:{data:response.data.data, errors:response.data.errors}};
                errorsB.current.push(newError);
                console.log("Error: ", newError);
              ...
              */
              ...
              if(errorsB.current.length > 0) {
                ...
                newError.locations=[{model: 'individual', association: 'genotype', table:'B', method: 'getDataB()'}];
                newError.path=['add', 'genotype'];
                newError.extensions = {graphQL:{data:response.data.data, errors:response.data.errors}};
                errorsB.current.push(newError);
                console.log("Error: ", newError);
  ...
  useEffect(() => {
    ...
    /*
     * Case 1: 
     * The relation 'genotype' for this item was updated.
    ...
    if(lastModelChanged.individual&&
        ...
        lastModelChanged.individual[String(item.id)].changedAssociations.genotype&&
        (lastModelChanged.individual[String(item.id)].changedAssociations.genotype.added ||
         lastModelChanged.individual[String(item.id)].changedAssociations.genotype.removed)) {
          
          //remove any dis-associated internalId from idsToAdd[]
          let idsRemoved = lastModelChanged.individual[String(item.id)].changedAssociations.genotype.idsRemoved;
          if(idsRemoved) {
            idsRemoved.forEach( (idRemoved) => {
              ...
              handleUntransfer('genotype', idRemoved);
            });
          }
            ...
            if(entry[1].changedAssociations.individual.added) {
              ...
              if(idsAdded) {
                ...
                if(iof !== -1) {
                  ...
                  handleUntransfer('genotype', idAdded);
  ...
  const handleAddItem = (event, item) => {
    if(lidsToAdd.current.indexOf(item.id) === -1) {
      ...
      //reload B (full)
      resetReloadDataB();
      handleTransfer('genotype', item.id);
    }
  };
  ...
  const handleRemoveItem = (event, item) => {
    if(lidsToAdd.current.length > 0) {
      ...
      //reload B
      reloadDataB();
      handleUntransfer('genotype', item.id);
    }
  };
        ...
        <Grid item xs={12} sm={5} >
          {(item!==undefined) && (
            <Card className={classes.card}>
              ...
              {/* Toolbar */}
              <GenotypeToAddTransferViewToolbar
                title={'Genotypes'}
                titleIcon={1}
                search={search}
              ...
              {/* Pagination */}
              <GenotypeToAddTransferViewCursorPagination
                count={count}
...
GenotypeToAddTransferView.propTypes = {
