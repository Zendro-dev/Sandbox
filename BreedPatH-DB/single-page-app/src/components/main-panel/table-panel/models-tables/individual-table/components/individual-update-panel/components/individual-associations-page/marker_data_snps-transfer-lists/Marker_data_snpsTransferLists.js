...
import MarkerDataSnpsToAddTransferView from './marker_data_snps-to-add-transfer-view/Marker_data_snpsToAddTransferView'
import MarkerDataSnpsToRemoveTransferView from './marker_data_snps-to-remove-transfer-view/Marker_data_snpsToRemoveTransferView'
...
export default function MarkerDataSnpsTransferLists(props) {
    ...
    <div className={classes.root}>
      <Fade in={true} timeout={500}>
        ...
        > 
          ...
          <Grid item xs={12}>
            <MarkerDataSnpsToAddTransferView
              item={item}
              idsToAdd={idsToAdd}
          ...
          <Grid item xs={12}>
            <MarkerDataSnpsToRemoveTransferView
              item={item}
...
MarkerDataSnpsTransferLists.propTypes = {
