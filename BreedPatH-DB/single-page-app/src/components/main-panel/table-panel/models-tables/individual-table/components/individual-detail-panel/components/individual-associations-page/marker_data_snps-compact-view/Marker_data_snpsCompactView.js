...
import MarkerDataSnpsCompactViewToolbar from './components/Marker_data_snpsCompactViewToolbar';
import MarkerDataSnpsCompactViewCursorPagination from './components/Marker_data_snpsCompactViewCursorPagination';
...
export default function MarkerDataSnpsCompactView(props) {
    ...
    cancelableApiReq
      ...
      (response) => {
        ...
        if(!response.data ||!response.data.data) {
          ...
          newError.path=['detail', `id:${item.id}`, 'marker_data_snps'];
  ...
  useEffect(() => {
     ...
     * 
     * Conditions:
     * A: the current item 'internalId' attribute is in the removedIds of the updated 'marker_data'.
     * B: the current item 'internalId' attribute is in the addedIds of the updated 'marker_data'.
     * 
     * Actions:
     * if A:
     * - reload table.
        ...
        <Grid item xs={12} >
          {(item!==undefined) && (
            <Card className={classes.card}>
              ...
              {/* Toolbar */}
              <MarkerDataSnpsCompactViewToolbar 
                title={'Marker_data'}
                search={search}
              ...
              {(true) && (
                ...
                <MarkerDataSnpsCompactViewCursorPagination
                  count={count}
...
MarkerDataSnpsCompactView.propTypes = {
  item: PropTypes.object.isRequired,
  handleClickOnMarker_data_snpsRow: PropTypes.func,
};