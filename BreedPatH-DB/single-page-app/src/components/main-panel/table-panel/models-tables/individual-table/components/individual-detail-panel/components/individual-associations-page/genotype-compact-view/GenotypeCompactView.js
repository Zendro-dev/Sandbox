...
import GenotypeCompactViewToolbar from './components/GenotypeCompactViewToolbar';
import GenotypeCompactViewCursorPagination from './components/GenotypeCompactViewCursorPagination';
...
export default function GenotypeCompactView(props) {
  ...
  const getData = useCallback(() => {
    ...
    */
    ...
    let cancelableApiReq = makeCancelable(api.individual.getGenotypeConnection(
      graphqlServerUrl, 
      item.id,
      label,
      sublabel,
    ...
    cancelableApiReq
      ...
      (response) => {
        ...
        if(!response.data ||!response.data.data) {
          ...
          newError.locations=[{association: 'genotype', query: 'readOneIndividual', method: 'getData()', request: 'api.individual.getGenotypeConnection'}];
          newError.path=['detail', `id:${item.id}`, 'genotype'];
        ...
        //get item
        let it = readOneIndividual.genotype;
      ...
      //error
      .catch((err) => { //error: on api.individual.getGenotypeConnection
        if(err.isCanceled) {
          return;
        } else {
          let newError = {};
          ...
          {(item!==undefined) && (
            <Card className={classes.card}>
              ...
              {(false) && (
                ...
                <GenotypeCompactViewCursorPagination
                  count={count}
...
GenotypeCompactView.propTypes = {
  item: PropTypes.object.isRequired,
  handleClickOnGenotypeRow: PropTypes.func,
};