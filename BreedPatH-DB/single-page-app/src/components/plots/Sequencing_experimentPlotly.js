...
export default function SequencingExperimentPlotly(props) {
  ...
  async function getItemsAttribute(attribute) {
    /**
      * API Request
      */
      api.sequencing_experiment.getItemsAttribute(graphqlServerUrl, attribute)
    .then((response) => {
      
      //check data
      if(response.data.data.sequencing_experimentsConnection) {
        //reduce to {x1:y1, x2:y2, ...}
        let result = response.data.data.sequencing_experimentsConnection.edges.reduce((acc, item) => {
      ...
      if(response.data.errors) {
        ...
        newError.locations=[{model: 'sequencing_experiment', query: 'sequencing_experimentsConnection', method: 'getItemsAttribute()', request: 'api.sequencing_experiment.getItemsAttribute'}];
    ...
    .catch((error) => {
      ...
      newError.locations=[{model: 'sequencing_experiment', query: 'sequencing_experimentsConnection', method: 'getItemsAttribute()', request: 'api.sequencing_experiment.getItemsAttribute'}];
      newError.path=['Sequencing_experiments', 'Plot'];
