...
export default function NucAcidLibraryResultPlotly(props) {
  ...
  async function getItemsAttribute(attribute) {
    /**
      * API Request
      */
      api.nuc_acid_library_result.getItemsAttribute(graphqlServerUrl, attribute)
    .then((response) => {
      
      //check data
      if(response.data.data.nuc_acid_library_resultsConnection) {
        //reduce to {x1:y1, x2:y2, ...}
        let result = response.data.data.nuc_acid_library_resultsConnection.edges.reduce((acc, item) => {
      ...
      if(response.data.errors) {
        ...
        newError.locations=[{model: 'nuc_acid_library_result', query: 'nuc_acid_library_resultsConnection', method: 'getItemsAttribute()', request: 'api.nuc_acid_library_result.getItemsAttribute'}];
    ...
    .catch((error) => {
      ...
      newError.locations=[{model: 'nuc_acid_library_result', query: 'nuc_acid_library_resultsConnection', method: 'getItemsAttribute()', request: 'api.nuc_acid_library_result.getItemsAttribute'}];
      newError.path=['Nuc_acid_library_results', 'Plot'];
