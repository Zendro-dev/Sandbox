...
export default function FieldPlotTreatmentPlotly(props) {
  ...
  async function getItemsAttribute(attribute) {
    /**
      * API Request
      */
      api.field_plot_treatment.getItemsAttribute(graphqlServerUrl, attribute)
    .then((response) => {
      
      //check data
      if(response.data.data.field_plot_treatmentsConnection) {
        //reduce to {x1:y1, x2:y2, ...}
        let result = response.data.data.field_plot_treatmentsConnection.edges.reduce((acc, item) => {
      ...
      if(response.data.errors) {
        ...
        newError.locations=[{model: 'field_plot_treatment', query: 'field_plot_treatmentsConnection', method: 'getItemsAttribute()', request: 'api.field_plot_treatment.getItemsAttribute'}];
    ...
    .catch((error) => {
      ...
      newError.locations=[{model: 'field_plot_treatment', query: 'field_plot_treatmentsConnection', method: 'getItemsAttribute()', request: 'api.field_plot_treatment.getItemsAttribute'}];
      newError.path=['Field_plot_treatments', 'Plot'];
