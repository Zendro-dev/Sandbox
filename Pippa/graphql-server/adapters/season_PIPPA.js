...
module.exports = class season_PIPPA extends Sequelize.Model {
    ...
    static async readById(id) {
        let item = await season_PIPPA.findByPk(id);
        if (item === null) {
    ...
    static idAttribute() {
        return season_PIPPA.definition.id.name;
    }
    ...
    static idAttributeType() {
        return season_PIPPA.definition.id.type;
    }
    ...
    getIdValue() {
        return this[season_PIPPA.idAttribute()]
    }
    ...
    stripAssociations() {
        let attributes = Object.keys(season_PIPPA.definition.attributes);
