...
const definition = {
    ...
    adapterName: 'observationUnitPosition_PIPPA',
    regex: 'pippa',
    attributes: {
        blockNumber: 'String',
        entryNumber: 'String',
...
module.exports = class observationUnitPosition_PIPPA extends Sequelize.Model {
    ...
    static get adapterName() {
        return 'observationUnitPosition_PIPPA';
    }
    ...
    static async readById(id) {
        let item = await observationUnitPosition_PIPPA.findByPk(id);
        if (item === null) {
    ...
    static idAttribute() {
        return observationUnitPosition_PIPPA.definition.id.name;
    }
    ...
    static idAttributeType() {
        return observationUnitPosition_PIPPA.definition.id.type;
    }
    ...
    getIdValue() {
        return this[observationUnitPosition_PIPPA.idAttribute()]
    }
    ...
    stripAssociations() {
        let attributes = Object.keys(observationUnitPosition_PIPPA.definition.attributes);
