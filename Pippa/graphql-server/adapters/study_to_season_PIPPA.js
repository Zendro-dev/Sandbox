...
const definition = {
    ...
    adapterName: 'study_to_season_PIPPA',
    regex: 'pippa',
    attributes: {
        studyDbId: 'String',
        seasonDbId: 'String'
...
module.exports = class study_to_season_PIPPA extends Sequelize.Model {
    ...
    static async readById(id) {
        let item = await study_to_season_PIPPA.findByPk(id);
        if (item === null) {
    ...
    static idAttribute() {
        return study_to_season_PIPPA.definition.id.name;
    }
    ...
    static idAttributeType() {
        return study_to_season_PIPPA.definition.id.type;
    }
    ...
    getIdValue() {
        return this[study_to_season_PIPPA.idAttribute()]
    }
    ...
    stripAssociations() {
        let attributes = Object.keys(study_to_season_PIPPA.definition.attributes);
        attributes.push('id');
