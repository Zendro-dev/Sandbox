...
const definition = {
    ...
    adapterName: 'environmentParameter_PIPPA',
    regex: 'pippa',
    attributes: {
        description: 'String',
...
module.exports = class environmentParameter_PIPPA extends Sequelize.Model {
    ...
    static get adapterName() {
        return 'environmentParameter_PIPPA';
    }
    ...
    static async readById(id) {
        let item = await environmentParameter_PIPPA.findByPk(id);
        if (item === null) {
    ...
    static readAllCursor(search, order, pagination) {
        ...
        return super.count(options).then(countA => {
            ...
            if (!options['order'].map(orderItem => {
                    return orderItem[0]
                }).includes("environmentParameterDbId")) {
                options['order'] = [...options['order'], ...[
                    ["environmentParameterDbId", "ASC"]
                ]];
            }
            ...
            if (pagination) {
                ...
                if (isForwardPagination) {
                    if (pagination.after) {
                        ...
                        options['where'] = {
                            ...options['where'],
                            ...helper.parseOrderCursor(options['order'], decoded_cursor, "environmentParameterDbId", pagination.includeCursor)
                        };
                    }
                } else { //backward
                    if (pagination.before) {
                        ...
                        options['where'] = {
                            ...options['where'],
                            ...helper.parseOrderCursorBefore(options['order'], decoded_cursor, "environmentParameterDbId", pagination.includeCursor)
                        };
                    }
                }
            }
            ...
            return super.count(woptions).then(countB => {
                ...
                if (globals.LIMIT_RECORDS < options['limit']) {
                    throw new Error(`Request of total environmentParameters exceeds max limit of ${globals.LIMIT_RECORDS}. Please use pagination.`);
                }
    ...
    static idAttribute() {
        return environmentParameter_PIPPA.definition.id.name;
    }
    ...
    static idAttributeType() {
        return environmentParameter_PIPPA.definition.id.type;
    }
    ...
    getIdValue() {
        return this[environmentParameter_PIPPA.idAttribute()]
    }
    ...
    stripAssociations() {
        let attributes = Object.keys(environmentParameter_PIPPA.definition.attributes);
