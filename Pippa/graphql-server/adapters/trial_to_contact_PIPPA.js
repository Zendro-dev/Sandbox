...
const definition = {
    ...
    adapterName: 'trial_to_contact_PIPPA',
    regex: 'pippa',
    attributes: {
        trialDbId: 'String',
        contactDbId: 'String'
...
module.exports = class trial_to_contact_PIPPA extends Sequelize.Model {
    ...
    static async readById(id) {
        let item = await trial_to_contact_PIPPA.findByPk(id);
        if (item === null) {
    ...
    static idAttribute() {
        return trial_to_contact_PIPPA.definition.id.name;
    }
    ...
    static idAttributeType() {
        return trial_to_contact_PIPPA.definition.id.type;
    }
    ...
    getIdValue() {
        return this[trial_to_contact_PIPPA.idAttribute()]
    }
    ...
    stripAssociations() {
        let attributes = Object.keys(trial_to_contact_PIPPA.definition.attributes);
        attributes.push('id');
