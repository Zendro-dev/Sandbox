...
module.exports = class method_PIPPA extends Sequelize.Model {
    ...
    static async readById(id) {
        let item = await method_PIPPA.findByPk(id);
        if (item === null) {
    ...
    static idAttribute() {
        return method_PIPPA.definition.id.name;
    }
    ...
    static idAttributeType() {
        return method_PIPPA.definition.id.type;
    }
    ...
    getIdValue() {
        return this[method_PIPPA.idAttribute()]
    }
    ...
    stripAssociations() {
        let attributes = Object.keys(method_PIPPA.definition.attributes);
