...
module.exports = class study_PIPPA extends Sequelize.Model {
    ...
    static async readById(id) {
        let item = await study_PIPPA.findByPk(id);
        if (item === null) {
    ...
    static idAttribute() {
        return study_PIPPA.definition.id.name;
    }
    ...
    static idAttributeType() {
        return study_PIPPA.definition.id.type;
    }
    ...
    getIdValue() {
        return this[study_PIPPA.idAttribute()]
    }
    ...
    stripAssociations() {
        let attributes = Object.keys(study_PIPPA.definition.attributes);
