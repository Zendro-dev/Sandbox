...
module.exports = class contact_PIPPA extends Sequelize.Model {
    ...
    static idAttribute() {
        return contact_PIPPA.definition.id.name;
    }
    ...
    static idAttributeType() {
        return contact_PIPPA.definition.id.type;
    }
    ...
    getIdValue() {
        return this[contact_PIPPA.idAttribute()]
    }
    ...
    stripAssociations() {
        let attributes = Object.keys(contact_PIPPA.definition.attributes);
