...
module.exports = class program_PIPPA extends Sequelize.Model {
    ...
    static async readById(id) {
        let item = await program_PIPPA.findByPk(id);
        if (item === null) {
    ...
    static idAttribute() {
        return program_PIPPA.definition.id.name;
    }
    ...
    static idAttributeType() {
        return program_PIPPA.definition.id.type;
    }
    ...
    getIdValue() {
        return this[program_PIPPA.idAttribute()]
    }
    ...
    stripAssociations() {
        let attributes = Object.keys(program_PIPPA.definition.attributes);
