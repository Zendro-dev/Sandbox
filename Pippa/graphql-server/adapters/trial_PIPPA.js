...
module.exports = class trial_PIPPA extends Sequelize.Model {
    ...
    static async readById(id) {
        let item = await trial_PIPPA.findByPk(id);
        if (item === null) {
    ...
    static idAttribute() {
        return trial_PIPPA.definition.id.name;
    }
    ...
    static idAttributeType() {
        return trial_PIPPA.definition.id.type;
    }
    ...
    getIdValue() {
        return this[trial_PIPPA.idAttribute()]
    }
    ...
    stripAssociations() {
        let attributes = Object.keys(trial_PIPPA.definition.attributes);
