...
module.exports = class study_to_contact_PHENOMIS {

    static get adapterName() {
        return 'study_to_contact_PHENOMIS';
    }
    ...
    static readById(iri) {
        let query = `
          query
            readOneStudy_to_contact
            {
              readOneStudy_to_contact(id:"${iri}")
              {
                id 
                studyDbId 
                contactDbId 
        ...
        return axios.post(remoteCenzontleURL, {
            ...
            if (res && res.data && res.data.data) {
                return res.data.data.readOneStudy_to_contact;
            } else {
    ...
    static countRecords(search) {
        let query = `
      query countStudy_to_contacts($search: searchStudy_to_contactInput){
        countStudy_to_contacts(search: $search)
      }`
        ...
        return axios.post(remoteCenzontleURL, {
            ...
            //check
            if (res && res.data && res.data.data) {
                return res.data.data.countStudy_to_contacts;
            } else {
                throw new Error(`Invalid response from remote cenz-server: ${remoteCenzontleURL}`);
            }
        }).catch(error => {
    ...
    static readAllCursor(search, order, pagination) {
        ...
        let query = `query study_to_contactsConnection($search: searchStudy_to_contactInput $pagination: paginationCursorInput $order: [orderStudy_to_contactInput]){
      study_to_contactsConnection(search:$search pagination:$pagination order:$order){ edges{cursor node{  id  studyDbId
         contactDbId
        ...
        return axios.post(remoteCenzontleURL, {
            ...
            //check
            if (res && res.data && res.data.data) {
                return res.data.data.study_to_contactsConnection;
            } else {
                throw new Error(`Invalid response from remote cenz-server: ${remoteCenzontleURL}`);
            }
        }).catch(error => {
    ...
    static addOne(input) {
        ...
        return axios.post(remoteCenzontleURL, {
            ...
            //check
            if (res && res.data && res.data.data) {
                return res.data.data.addStudy_to_contact;
            } else {
                throw new Error(`Invalid response from remote cenz-server: ${remoteCenzontleURL}`);
            }
        }).catch(error => {
    ...
    static deleteOne(id) {
        ...
        return axios.post(remoteCenzontleURL, {
            ...
            //check
            if (res && res.data && res.data.data) {
                return res.data.data.deleteStudy_to_contact;
            } else {
                throw new Error(`Invalid response from remote cenz-server: ${remoteCenzontleURL}`);
            }
        }).catch(error => {
    ...
    static csvTableTemplate() {
        ...
        return axios.post(remoteCenzontleURL, {
            ...
            //check
            if (res && res.data && res.data.data) {
                return res.data.data.csvTableTemplateStudy_to_contact;
            } else {
                throw new Error(`Invalid response from remote cenz-server: ${remoteCenzontleURL}`);
            }
        }).catch(error => {
