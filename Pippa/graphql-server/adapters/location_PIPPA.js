...
module.exports = class location_PIPPA extends Sequelize.Model {
    ...
    static async readById(id) {
        let item = await location_PIPPA.findByPk(id);
        if (item === null) {
    ...
    static idAttribute() {
        return location_PIPPA.definition.id.name;
    }
    ...
    static idAttributeType() {
        return location_PIPPA.definition.id.type;
    }
    ...
    getIdValue() {
        return this[location_PIPPA.idAttribute()]
    }
    ...
    stripAssociations() {
        let attributes = Object.keys(location_PIPPA.definition.attributes);
