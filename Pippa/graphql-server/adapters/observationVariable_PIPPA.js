...
const definition = {
    ...
    adapterName: 'observationVariable_PIPPA',
    regex: 'pippa',
    attributes: {
...
module.exports = class observationVariable_PIPPA extends Sequelize.Model {
    ...
    static get adapterName() {
        return 'observationVariable_PIPPA';
    }
    ...
    static idAttribute() {
        return observationVariable_PIPPA.definition.id.name;
    }
    ...
    static idAttributeType() {
        return observationVariable_PIPPA.definition.id.type;
    }
    ...
    getIdValue() {
        return this[observationVariable_PIPPA.idAttribute()]
    }
    ...
    stripAssociations() {
        let attributes = Object.keys(observationVariable_PIPPA.definition.attributes);
