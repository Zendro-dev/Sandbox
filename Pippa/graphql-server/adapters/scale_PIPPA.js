...
module.exports = class scale_PIPPA extends Sequelize.Model {
    ...
    static async readById(id) {
        let item = await scale_PIPPA.findByPk(id);
        if (item === null) {
    ...
    static idAttribute() {
        return scale_PIPPA.definition.id.name;
    }
    ...
    static idAttributeType() {
        return scale_PIPPA.definition.id.type;
    }
    ...
    getIdValue() {
        return this[scale_PIPPA.idAttribute()]
    }
    ...
    stripAssociations() {
        let attributes = Object.keys(scale_PIPPA.definition.attributes);
