...
const definition = {
    ...
    adapterName: 'observationTreatment_PIPPA',
    regex: 'pippa',
    attributes: {
        factor: 'String',
        modality: 'String',
...
module.exports = class observationTreatment_PIPPA extends Sequelize.Model {
    ...
    static async readById(id) {
        let item = await observationTreatment_PIPPA.findByPk(id);
        if (item === null) {
    ...
    static idAttribute() {
        return observationTreatment_PIPPA.definition.id.name;
    }
    ...
    static idAttributeType() {
        return observationTreatment_PIPPA.definition.id.type;
    }
    ...
    getIdValue() {
        return this[observationTreatment_PIPPA.idAttribute()]
    }
    ...
    stripAssociations() {
        let attributes = Object.keys(observationTreatment_PIPPA.definition.attributes);
