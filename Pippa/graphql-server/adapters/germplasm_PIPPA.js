...
module.exports = class germplasm_PIPPA extends Sequelize.Model {
    ...
    static async readById(id) {
        let item = await germplasm_PIPPA.findByPk(id);
        if (item === null) {
    ...
    static idAttribute() {
        return germplasm_PIPPA.definition.id.name;
    }
    ...
    static idAttributeType() {
        return germplasm_PIPPA.definition.id.type;
    }
    ...
    getIdValue() {
        return this[germplasm_PIPPA.idAttribute()]
    }
    ...
    stripAssociations() {
        let attributes = Object.keys(germplasm_PIPPA.definition.attributes);
