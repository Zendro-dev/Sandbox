...
module.exports = class trait_PIPPA extends Sequelize.Model {
    ...
    static async readById(id) {
        let item = await trait_PIPPA.findByPk(id);
        if (item === null) {
    ...
    static idAttribute() {
        return trait_PIPPA.definition.id.name;
    }
    ...
    static idAttributeType() {
        return trait_PIPPA.definition.id.type;
    }
    ...
    getIdValue() {
        return this[trait_PIPPA.idAttribute()]
    }
    ...
    stripAssociations() {
        let attributes = Object.keys(trait_PIPPA.definition.attributes);
