...
module.exports = class books_server_a extends Sequelize.Model {
    ...
    static readById(id) {
        ...
        return books_server_a.findOne(options);
    }
    ...
    static idAttribute() {
        return books_server_a.definition.id.name;
    }
    ...
    static idAttributeType() {
        return books_server_a.definition.id.type;
    }
    ...
    getIdValue() {
        return this[books_server_a.idAttribute()]
    }
    ...
    stripAssociations() {
        let attributes = Object.keys(books_server_a.definition.attributes);
