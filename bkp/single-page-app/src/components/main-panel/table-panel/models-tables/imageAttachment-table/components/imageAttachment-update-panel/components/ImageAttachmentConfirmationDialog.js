...
export default function ImageAttachmentConfirmationDialog(props) {
  ...
  return (
    <div>
      <Dialog id='ImageAttachmentConfirmationDialog-update'
        open={open}
      ...
      >
        ...
        <DialogActions>
          ...
          {(acceptText !== '' && acceptText !== null && acceptText !== undefined) &&
            <Button
              id='ImageAttachmentConfirmationDialog-update-button-accept'
              color="primary"
              variant='contained'
          ...
          {(rejectText !== '' && acceptText !== null && acceptText !== undefined) &&
            ...
            <Button
              id='ImageAttachmentConfirmationDialog-update-button-reject'
              color="primary" 
