...
export default function ImageAttachmentConfirmationDialog(props) {
  ...
  return (
    <div>
      <Dialog id='ImageAttachmentConfirmationDialog-create'
        open={open}
      ...
      >
        ...
        <DialogActions>
          ...
          {(acceptText !== '' && acceptText !== null && acceptText !== undefined) &&
            <Button
              id='ImageAttachmentConfirmationDialog-create-button-accept'
              color="primary"
              variant='contained'
          ...
          {(rejectText !== '' && acceptText !== null && acceptText !== undefined) &&
            ...
            <Button
              id='ImageAttachmentConfirmationDialog-create-button-reject'
              color="primary" 
...
ImageAttachmentConfirmationDialog.propTypes = {
