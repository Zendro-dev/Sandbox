...
module.exports = class location_PHENOMIS extends Sequelize.Model {
    ...
    static async readById(id) {
        let item = await location_PHENOMIS.findByPk(id);
        if (item === null) {
            ...
            if (pagination) {
                ...
                if (isForwardPagination) {
                    if (pagination.after) {
                        ...
                        options['where'] = {
                            ...options['where'],
                            ...helper.parseOrderCursor(options['order'], decoded_cursor, "locationDbId", pagination.includeCursor)
                        };
                    }
                } else { //backward
                    if (pagination.before) {
                        ...
                        options['where'] = {
                            ...options['where'],
                            ...helper.parseOrderCursorBefore(options['order'], decoded_cursor, "locationDbId", pagination.includeCursor)
                        };
                    }
                }
            }
    ...
    static idAttribute() {
        return location_PHENOMIS.definition.id.name;
    }
    ...
    static idAttributeType() {
        return location_PHENOMIS.definition.id.type;
    }
    ...
    getIdValue() {
        return this[location_PHENOMIS.idAttribute()]
    }
    ...
    stripAssociations() {
        let attributes = Object.keys(location_PHENOMIS.definition.attributes);
