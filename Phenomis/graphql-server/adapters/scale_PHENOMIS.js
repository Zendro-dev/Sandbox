...
module.exports = class scale_PHENOMIS extends Sequelize.Model {
    ...
    static async readById(id) {
        let item = await scale_PHENOMIS.findByPk(id);
        if (item === null) {
    ...
    static idAttribute() {
        return scale_PHENOMIS.definition.id.name;
    }
    ...
    static idAttributeType() {
        return scale_PHENOMIS.definition.id.type;
    }
    ...
    getIdValue() {
        return this[scale_PHENOMIS.idAttribute()]
    }
    ...
    stripAssociations() {
        let attributes = Object.keys(scale_PHENOMIS.definition.attributes);
