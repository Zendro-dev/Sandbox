...
module.exports = class study_PHENOMIS extends Sequelize.Model {
    ...
    static idAttribute() {
        return study_PHENOMIS.definition.id.name;
    }
    ...
    static idAttributeType() {
        return study_PHENOMIS.definition.id.type;
    }
    ...
    getIdValue() {
        return this[study_PHENOMIS.idAttribute()]
    }
    ...
    stripAssociations() {
        let attributes = Object.keys(study_PHENOMIS.definition.attributes);
