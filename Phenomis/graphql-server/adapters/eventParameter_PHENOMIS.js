...
const definition = {
    ...
    adapterName: 'eventParameter_PHENOMIS',
    regex: 'phenomis',
    attributes: {
        key: 'String',
        rdfValue: 'String',
...
module.exports = class eventParameter_PHENOMIS extends Sequelize.Model {
    ...
    static get adapterName() {
        return 'eventParameter_PHENOMIS';
    }
    ...
    static idAttribute() {
        return eventParameter_PHENOMIS.definition.id.name;
    }
    ...
    static idAttributeType() {
        return eventParameter_PHENOMIS.definition.id.type;
    }
    ...
    getIdValue() {
        return this[eventParameter_PHENOMIS.idAttribute()]
    }
    ...
    stripAssociations() {
        let attributes = Object.keys(eventParameter_PHENOMIS.definition.attributes);
