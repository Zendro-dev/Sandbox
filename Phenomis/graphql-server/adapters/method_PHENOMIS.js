...
module.exports = class method_PHENOMIS extends Sequelize.Model {
    ...
    static async readById(id) {
        let item = await method_PHENOMIS.findByPk(id);
        if (item === null) {
    ...
    static idAttribute() {
        return method_PHENOMIS.definition.id.name;
    }
    ...
    static idAttributeType() {
        return method_PHENOMIS.definition.id.type;
    }
    ...
    getIdValue() {
        return this[method_PHENOMIS.idAttribute()]
    }
    ...
    stripAssociations() {
        let attributes = Object.keys(method_PHENOMIS.definition.attributes);
