...
const definition = {
    ...
    adapterName: 'trial_to_contact_PHENOMIS',
    regex: 'phenomis',
    attributes: {
        trialDbId: 'String',
        contactDbId: 'String'
...
module.exports = class trial_to_contact_PHENOMIS extends Sequelize.Model {
    ...
    static init(sequelize, DataTypes) {
        return super.init({
            ...
            modelName: "trial_to_contact",
            tableName: "trial_to_contacts",
            sequelize
        });
    }

    static get adapterName() {
        return 'trial_to_contact_PHENOMIS';
    }
    ...
    static async readById(id) {
        let item = await trial_to_contact_PHENOMIS.findByPk(id);
        if (item === null) {
        ...
        return super.count(options).then(countA => {
            ...
            return super.count(woptions).then(countB => {
                ...
                if (globals.LIMIT_RECORDS < options['limit']) {
                    throw new Error(`Request of total trial_to_contacts exceeds max limit of ${globals.LIMIT_RECORDS}. Please use pagination.`);
                }
    ...
    static idAttribute() {
        return trial_to_contact_PHENOMIS.definition.id.name;
    }
    ...
    static idAttributeType() {
        return trial_to_contact_PHENOMIS.definition.id.type;
    }
    ...
    getIdValue() {
        return this[trial_to_contact_PHENOMIS.idAttribute()]
    }
    ...
    stripAssociations() {
        let attributes = Object.keys(trial_to_contact_PHENOMIS.definition.attributes);
        attributes.push('id');
