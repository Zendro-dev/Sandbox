...
const definition = {
    ...
    adapterName: 'study_to_contact_PHENOMIS',
    regex: 'phenomis',
    attributes: {
        studyDbId: 'String',
        contactDbId: 'String'
...
module.exports = class study_to_contact_PHENOMIS extends Sequelize.Model {
    ...
    static init(sequelize, DataTypes) {
        return super.init({
            ...
            modelName: "study_to_contact",
            tableName: "study_to_contacts",
            sequelize
        });
    }
    ...
    static async readById(id) {
        let item = await study_to_contact_PHENOMIS.findByPk(id);
        if (item === null) {
        ...
        return super.count(options).then(countA => {
            ...
            return super.count(woptions).then(countB => {
                ...
                if (globals.LIMIT_RECORDS < options['limit']) {
                    throw new Error(`Request of total study_to_contacts exceeds max limit of ${globals.LIMIT_RECORDS}. Please use pagination.`);
                }
    ...
    static idAttribute() {
        return study_to_contact_PHENOMIS.definition.id.name;
    }
    ...
    static idAttributeType() {
        return study_to_contact_PHENOMIS.definition.id.type;
    }
    ...
    getIdValue() {
        return this[study_to_contact_PHENOMIS.idAttribute()]
    }
    ...
    stripAssociations() {
        let attributes = Object.keys(study_to_contact_PHENOMIS.definition.attributes);
        attributes.push('id');
