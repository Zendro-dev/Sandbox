...
const definition = {
    ...
    adapterName: 'ontologyReference_PHENOMIS',
    regex: 'phenomis',
    attributes: {
...
module.exports = class ontologyReference_PHENOMIS extends Sequelize.Model {
    ...
    static async readById(id) {
        let item = await ontologyReference_PHENOMIS.findByPk(id);
        if (item === null) {
    ...
    static idAttribute() {
        return ontologyReference_PHENOMIS.definition.id.name;
    }
    ...
    static idAttributeType() {
        return ontologyReference_PHENOMIS.definition.id.type;
    }
    ...
    getIdValue() {
        return this[ontologyReference_PHENOMIS.idAttribute()]
    }
    ...
    stripAssociations() {
        let attributes = Object.keys(ontologyReference_PHENOMIS.definition.attributes);
