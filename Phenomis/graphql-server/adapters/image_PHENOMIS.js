...
module.exports = class image_PHENOMIS extends Sequelize.Model {
    ...
    static async readById(id) {
        let item = await image_PHENOMIS.findByPk(id);
        if (item === null) {
        ...
        return super.count(options).then(countA => {
            ...
            if (pagination) {
                ...
                if (isForwardPagination) {
                    if (pagination.after) {
                        ...
                        options['where'] = {
                            ...options['where'],
                            ...helper.parseOrderCursor(options['order'], decoded_cursor, "imageDbId", pagination.includeCursor)
                        };
                    }
                } else { //backward
                    if (pagination.before) {
                        ...
                        options['where'] = {
                            ...options['where'],
                            ...helper.parseOrderCursorBefore(options['order'], decoded_cursor, "imageDbId", pagination.includeCursor)
                        };
                    }
                }
            }
            ...
            return super.count(woptions).then(countB => {
                ...
                if (globals.LIMIT_RECORDS < options['limit']) {
                    throw new Error(`Request of total images exceeds max limit of ${globals.LIMIT_RECORDS}. Please use pagination.`);
                }
    ...
    static idAttribute() {
        return image_PHENOMIS.definition.id.name;
    }
    ...
    static idAttributeType() {
        return image_PHENOMIS.definition.id.type;
    }
    ...
    getIdValue() {
        return this[image_PHENOMIS.idAttribute()]
    }
    ...
    stripAssociations() {
        let attributes = Object.keys(image_PHENOMIS.definition.attributes);
