...
module.exports = class program_PHENOMIS extends Sequelize.Model {
    ...
    static async readById(id) {
        let item = await program_PHENOMIS.findByPk(id);
        if (item === null) {
        ...
        return super.count(options).then(countA => {
            ...
            if (pagination) {
                ...
                if (isForwardPagination) {
                    if (pagination.after) {
                        ...
                        options['where'] = {
                            ...options['where'],
                            ...helper.parseOrderCursor(options['order'], decoded_cursor, "programDbId", pagination.includeCursor)
                        };
                    }
                } else { //backward
                    if (pagination.before) {
                        ...
                        options['where'] = {
                            ...options['where'],
                            ...helper.parseOrderCursorBefore(options['order'], decoded_cursor, "programDbId", pagination.includeCursor)
                        };
                    }
                }
            }
            ...
            return super.count(woptions).then(countB => {
                ...
                if (globals.LIMIT_RECORDS < options['limit']) {
                    throw new Error(`Request of total programs exceeds max limit of ${globals.LIMIT_RECORDS}. Please use pagination.`);
                }
    ...
    static csvTableTemplate() {
        return helper.csvTableTemplate(program);
    }
    ...
    static idAttribute() {
        return program_PHENOMIS.definition.id.name;
    }
    ...
    static idAttributeType() {
        return program_PHENOMIS.definition.id.type;
    }
    ...
    getIdValue() {
        return this[program_PHENOMIS.idAttribute()]
    }
    ...
    stripAssociations() {
        let attributes = Object.keys(program_PHENOMIS.definition.attributes);
