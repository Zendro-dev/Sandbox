...
const definition = {
    ...
    adapterName: 'environmentParameter_PHENOMIS',
    regex: 'phenomis',
    attributes: {
        description: 'String',
...
module.exports = class environmentParameter_PHENOMIS extends Sequelize.Model {
    ...
    static async readById(id) {
        let item = await environmentParameter_PHENOMIS.findByPk(id);
        if (item === null) {
    ...
    static idAttribute() {
        return environmentParameter_PHENOMIS.definition.id.name;
    }
    ...
    static idAttributeType() {
        return environmentParameter_PHENOMIS.definition.id.type;
    }
    ...
    getIdValue() {
        return this[environmentParameter_PHENOMIS.idAttribute()]
    }
    ...
    stripAssociations() {
        let attributes = Object.keys(environmentParameter_PHENOMIS.definition.attributes);
