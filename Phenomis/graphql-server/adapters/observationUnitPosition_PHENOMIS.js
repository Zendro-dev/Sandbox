...
const definition = {
    ...
    adapterName: 'observationUnitPosition_PHENOMIS',
    regex: 'phenomis',
    attributes: {
        blockNumber: 'String',
        entryNumber: 'String',
...
module.exports = class observationUnitPosition_PHENOMIS extends Sequelize.Model {
    ...
    static get adapterName() {
        return 'observationUnitPosition_PHENOMIS';
    }
    ...
    static async readById(id) {
        let item = await observationUnitPosition_PHENOMIS.findByPk(id);
        if (item === null) {
    ...
    static readAllCursor(search, order, pagination) {
        ...
        return super.count(options).then(countA => {
            ...
            if (!options['order'].map(orderItem => {
                    return orderItem[0]
                }).includes("observationUnitPositionDbId")) {
                options['order'] = [...options['order'], ...[
                    ["observationUnitPositionDbId", "ASC"]
                ]];
            }
            ...
            if (pagination) {
                ...
                if (isForwardPagination) {
                    if (pagination.after) {
                        ...
                        options['where'] = {
                            ...options['where'],
                            ...helper.parseOrderCursor(options['order'], decoded_cursor, "observationUnitPositionDbId", pagination.includeCursor)
                        };
                    }
                } else { //backward
                    if (pagination.before) {
                        ...
                        options['where'] = {
                            ...options['where'],
                            ...helper.parseOrderCursorBefore(options['order'], decoded_cursor, "observationUnitPositionDbId", pagination.includeCursor)
                        };
                    }
                }
            }
            ...
            return super.count(woptions).then(countB => {
                ...
                if (globals.LIMIT_RECORDS < options['limit']) {
                    throw new Error(`Request of total observationUnitPositions exceeds max limit of ${globals.LIMIT_RECORDS}. Please use pagination.`);
                }
    ...
    static idAttribute() {
        return observationUnitPosition_PHENOMIS.definition.id.name;
    }
    ...
    static idAttributeType() {
        return observationUnitPosition_PHENOMIS.definition.id.type;
    }
    ...
    getIdValue() {
        return this[observationUnitPosition_PHENOMIS.idAttribute()]
    }
    ...
    stripAssociations() {
        let attributes = Object.keys(observationUnitPosition_PHENOMIS.definition.attributes);
