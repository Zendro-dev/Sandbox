...
module.exports = class season_PHENOMIS extends Sequelize.Model {
    ...
    static async readById(id) {
        let item = await season_PHENOMIS.findByPk(id);
        if (item === null) {
        ...
        return super.count(options).then(countA => {
            ...
            if (pagination) {
                ...
                if (isForwardPagination) {
                    if (pagination.after) {
                        ...
                        options['where'] = {
                            ...options['where'],
                            ...helper.parseOrderCursor(options['order'], decoded_cursor, "seasonDbId", pagination.includeCursor)
                        };
                    }
                } else { //backward
                    if (pagination.before) {
                        ...
                        options['where'] = {
                            ...options['where'],
                            ...helper.parseOrderCursorBefore(options['order'], decoded_cursor, "seasonDbId", pagination.includeCursor)
                        };
                    }
                }
            }
            ...
            return super.count(woptions).then(countB => {
                ...
                if (globals.LIMIT_RECORDS < options['limit']) {
                    throw new Error(`Request of total seasons exceeds max limit of ${globals.LIMIT_RECORDS}. Please use pagination.`);
                }
    ...
    static csvTableTemplate() {
        return helper.csvTableTemplate(season);
    }
    ...
    static idAttribute() {
        return season_PHENOMIS.definition.id.name;
    }
    ...
    static idAttributeType() {
        return season_PHENOMIS.definition.id.type;
    }
    ...
    getIdValue() {
        return this[season_PHENOMIS.idAttribute()]
    }
    ...
    stripAssociations() {
        let attributes = Object.keys(season_PHENOMIS.definition.attributes);
