...
module.exports = class event_PHENOMIS extends Sequelize.Model {
    ...
    static async readById(id) {
        let item = await event_PHENOMIS.findByPk(id);
        if (item === null) {
    ...
    static idAttribute() {
        return event_PHENOMIS.definition.id.name;
    }
    ...
    static idAttributeType() {
        return event_PHENOMIS.definition.id.type;
    }
    ...
    getIdValue() {
        return this[event_PHENOMIS.idAttribute()]
    }
    ...
    stripAssociations() {
        let attributes = Object.keys(event_PHENOMIS.definition.attributes);
