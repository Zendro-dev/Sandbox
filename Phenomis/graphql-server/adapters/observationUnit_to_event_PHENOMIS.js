...
const definition = {
    ...
    adapterName: 'observationUnit_to_event_PHENOMIS',
    regex: 'phenomis',
    attributes: {
...
module.exports = class observationUnit_to_event_PHENOMIS extends Sequelize.Model {
    ...
    static async readById(id) {
        let item = await observationUnit_to_event_PHENOMIS.findByPk(id);
        if (item === null) {
    ...
    static idAttribute() {
        return observationUnit_to_event_PHENOMIS.definition.id.name;
    }
    ...
    static idAttributeType() {
        return observationUnit_to_event_PHENOMIS.definition.id.type;
    }
    ...
    getIdValue() {
        return this[observationUnit_to_event_PHENOMIS.idAttribute()]
    }
    ...
    stripAssociations() {
        let attributes = Object.keys(observationUnit_to_event_PHENOMIS.definition.attributes);
        attributes.push('id');
