...
const definition = {
    ...
    adapterName: 'study_to_season_PHENOMIS',
    regex: 'phenomis',
    attributes: {
        studyDbId: 'String',
        seasonDbId: 'String'
...
module.exports = class study_to_season_PHENOMIS extends Sequelize.Model {
    ...
    static init(sequelize, DataTypes) {
        return super.init({
            ...
            modelName: "study_to_season",
            tableName: "study_to_seasons",
            sequelize
        });
    }
    ...
    static async readById(id) {
        let item = await study_to_season_PHENOMIS.findByPk(id);
        if (item === null) {
        ...
        return super.count(options).then(countA => {
            ...
            return super.count(woptions).then(countB => {
                ...
                if (globals.LIMIT_RECORDS < options['limit']) {
                    throw new Error(`Request of total study_to_seasons exceeds max limit of ${globals.LIMIT_RECORDS}. Please use pagination.`);
                }
    ...
    static idAttribute() {
        return study_to_season_PHENOMIS.definition.id.name;
    }
    ...
    static idAttributeType() {
        return study_to_season_PHENOMIS.definition.id.type;
    }
    ...
    getIdValue() {
        return this[study_to_season_PHENOMIS.idAttribute()]
    }
    ...
    stripAssociations() {
        let attributes = Object.keys(study_to_season_PHENOMIS.definition.attributes);
        attributes.push('id');
