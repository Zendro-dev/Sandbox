...
const definition = {
    ...
    adapterName: 'observationTreatment_PHENOMIS',
    regex: 'phenomis',
    attributes: {
        factor: 'String',
        modality: 'String',
...
module.exports = class observationTreatment_PHENOMIS extends Sequelize.Model {
    ...
    static get adapterName() {
        return 'observationTreatment_PHENOMIS';
    }
    ...
    static async readById(id) {
        let item = await observationTreatment_PHENOMIS.findByPk(id);
        if (item === null) {
    ...
    static readAllCursor(search, order, pagination) {
        ...
        return super.count(options).then(countA => {
            ...
            if (!options['order'].map(orderItem => {
                    return orderItem[0]
                }).includes("observationTreatmentDbId")) {
                options['order'] = [...options['order'], ...[
                    ["observationTreatmentDbId", "ASC"]
                ]];
            }
            ...
            if (pagination) {
                ...
                if (isForwardPagination) {
                    if (pagination.after) {
                        ...
                        options['where'] = {
                            ...options['where'],
                            ...helper.parseOrderCursor(options['order'], decoded_cursor, "observationTreatmentDbId", pagination.includeCursor)
                        };
                    }
                } else { //backward
                    if (pagination.before) {
                        ...
                        options['where'] = {
                            ...options['where'],
                            ...helper.parseOrderCursorBefore(options['order'], decoded_cursor, "observationTreatmentDbId", pagination.includeCursor)
                        };
                    }
                }
            }
            ...
            return super.count(woptions).then(countB => {
                ...
                if (globals.LIMIT_RECORDS < options['limit']) {
                    throw new Error(`Request of total observationTreatments exceeds max limit of ${globals.LIMIT_RECORDS}. Please use pagination.`);
                }
    ...
    static idAttribute() {
        return observationTreatment_PHENOMIS.definition.id.name;
    }
    ...
    static idAttributeType() {
        return observationTreatment_PHENOMIS.definition.id.type;
    }
    ...
    getIdValue() {
        return this[observationTreatment_PHENOMIS.idAttribute()]
    }
    ...
    stripAssociations() {
        let attributes = Object.keys(observationTreatment_PHENOMIS.definition.attributes);
