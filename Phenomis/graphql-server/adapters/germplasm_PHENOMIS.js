...
const definition = {
    ...
    adapterName: 'germplasm_PHENOMIS',
    regex: 'phenomis',
    attributes: {
...
module.exports = class germplasm_PHENOMIS extends Sequelize.Model {
    ...
    static async readById(id) {
        let item = await germplasm_PHENOMIS.findByPk(id);
        if (item === null) {
    ...
    static idAttribute() {
        return germplasm_PHENOMIS.definition.id.name;
    }
    ...
    static idAttributeType() {
        return germplasm_PHENOMIS.definition.id.type;
    }
    ...
    getIdValue() {
        return this[germplasm_PHENOMIS.idAttribute()]
    }
    ...
    stripAssociations() {
        let attributes = Object.keys(germplasm_PHENOMIS.definition.attributes);
