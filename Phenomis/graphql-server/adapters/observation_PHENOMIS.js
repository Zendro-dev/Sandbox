...
const definition = {
    ...
    adapterName: 'observation_PHENOMIS',
    regex: 'phenomis',
    attributes: {
        collector: 'String',
...
module.exports = class observation_PHENOMIS extends Sequelize.Model {
    ...
    static async readById(id) {
        let item = await observation_PHENOMIS.findByPk(id);
        if (item === null) {
    ...
    static idAttribute() {
        return observation_PHENOMIS.definition.id.name;
    }
    ...
    static idAttributeType() {
        return observation_PHENOMIS.definition.id.type;
    }
    ...
    getIdValue() {
        return this[observation_PHENOMIS.idAttribute()]
    }
    ...
    stripAssociations() {
        let attributes = Object.keys(observation_PHENOMIS.definition.attributes);
