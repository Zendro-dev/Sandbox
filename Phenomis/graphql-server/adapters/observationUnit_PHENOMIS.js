...
const definition = {
    ...
    adapterName: 'observationUnit_PHENOMIS',
    regex: 'phenomis',
    attributes: {
...
module.exports = class observationUnit_PHENOMIS extends Sequelize.Model {
    ...
    static async readById(id) {
        let item = await observationUnit_PHENOMIS.findByPk(id);
        if (item === null) {
    ...
    static idAttribute() {
        return observationUnit_PHENOMIS.definition.id.name;
    }
    ...
    static idAttributeType() {
        return observationUnit_PHENOMIS.definition.id.type;
    }
    ...
    getIdValue() {
        return this[observationUnit_PHENOMIS.idAttribute()]
    }
    ...
    stripAssociations() {
        let attributes = Object.keys(observationUnit_PHENOMIS.definition.attributes);
