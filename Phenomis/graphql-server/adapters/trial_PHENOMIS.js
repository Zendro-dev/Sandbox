...
module.exports = class trial_PHENOMIS extends Sequelize.Model {
    ...
    static async readById(id) {
        let item = await trial_PHENOMIS.findByPk(id);
        if (item === null) {
    ...
    static idAttribute() {
        return trial_PHENOMIS.definition.id.name;
    }
    ...
    static idAttributeType() {
        return trial_PHENOMIS.definition.id.type;
    }
    ...
    getIdValue() {
        return this[trial_PHENOMIS.idAttribute()]
    }
    ...
    stripAssociations() {
        let attributes = Object.keys(trial_PHENOMIS.definition.attributes);
