...
import ContactToTrialsToAddTransferView from './contactToTrials-to-add-transfer-view/ContactToTrialsToAddTransferView'
import ContactToTrialsToRemoveTransferView from './contactToTrials-to-remove-transfer-view/ContactToTrialsToRemoveTransferView'
...
export default function ContactToTrialsTransferLists(props) {
    ...
    <div>
      <Fade in={true} timeout={500}>
        ...
        > 
          ...
          <Grid item xs={12}>
            <ContactToTrialsToAddTransferView
              item={item}
              idsToAdd={idsToAdd}
          ...
          <Grid item xs={12}>
            <ContactToTrialsToRemoveTransferView
              item={item}
...
ContactToTrialsTransferLists.propTypes = {
