...
import ContactTostudiesToAddTransferView from './contactTostudies-to-add-transfer-view/ContactTostudiesToAddTransferView'
import ContactTostudiesToRemoveTransferView from './contactTostudies-to-remove-transfer-view/ContactTostudiesToRemoveTransferView'
...
export default function ContactTostudiesTransferLists(props) {
    ...
    <div>
      <Fade in={true} timeout={500}>
        ...
        > 
          ...
          <Grid item xs={12}>
            <ContactTostudiesToAddTransferView
              item={item}
              idsToAdd={idsToAdd}
          ...
          <Grid item xs={12}>
            <ContactTostudiesToRemoveTransferView
              item={item}
...
ContactTostudiesTransferLists.propTypes = {
