...
import ContactTostudiesToRemoveTransferViewToolbar from './components/ContactTostudiesToRemoveTransferViewToolbar';
import ContactTostudiesToRemoveTransferViewCursorPagination from './components/ContactTostudiesToRemoveTransferViewCursorPagination';
...
export default function ContactTostudiesToRemoveTransferView(props) {
  ...
  */
  ...
  const getData = useCallback(() => {
    ...
    */
    ...
    let cancelableApiReq = makeCancelable(api.contact.getContactTostudiesConnection(
      graphqlServerUrl, 
      item.contactDbId,
      label,
      sublabel,
    ...
    cancelableApiReq
      ...
      .then(response => {
        ...
        if (
          ...
          //save response data
          let newCount = response.data.data.readOneContact.countFilteredContactTostudies;
          let its = response.data.data.readOneContact.contactTostudiesConnection.edges.map(o => o.node);
          let pi = response.data.data.readOneContact.contactTostudiesConnection.pageInfo;
  ...
  useEffect(() => {
     ...
     * Actions:
     * if A:
     * - remove the internalId of the 'study_to_contact' from idsToRemove[].
     * - reload both transfer tables.
     * - return
     * 
     * else if B:
        ...
        <Grid item xs={12} sm={5} >
          {(item!==undefined) && (
            <Card className={classes.card}>
              ...
              {/* Toolbar */}
              <ContactTostudiesToRemoveTransferViewToolbar
              ...
              {/* Pagination */}
              <ContactTostudiesToRemoveTransferViewCursorPagination
                count={count}
...
ContactTostudiesToRemoveTransferView.propTypes = {
