...
export default function ContactUploadFileDialog(props) {
  ...
  const handleSubmit = (event) => {
    if(file.current !== undefined && file.current !== null) {
      ...
      let query = 'mutation{ bulkAddContactCsv{ contactDbId} }'
  ...
  return (
    ...
    >
      <DialogTitle>
      { t('modelPanels.uploading') + ' Contacts' }
        <div>
...
ContactUploadFileDialog.propTypes = {
