...
import ContactToTrialsCompactViewToolbar from './components/ContactToTrialsCompactViewToolbar';
import ContactToTrialsCompactViewCursorPagination from './components/ContactToTrialsCompactViewCursorPagination';
...
export default function ContactToTrialsCompactView(props) {
  ...
  const getData = useCallback(() => {
    ...
    /*
      API Request: ContactToTrialsFilter
    */
  ...
  useEffect(() => {
     ...
     * 
     * Conditions:
     * A: the current item 'internalId' attribute is in the removedIds of the updated 'trial_to_contact'.
     * B: the current item 'internalId' attribute is in the addedIds of the updated 'trial_to_contact'.
     * 
     * Actions:
     * if A:
     * - reload table.
  ...
  }, [lastModelChanged, lastChangeTimestamp, items, item.contactDbId]);
        ...
        <Grid item xs={12} >
          {(item!==undefined) && (
            <Card className={classes.card}>
              ...
              {/* Toolbar */}
              <ContactToTrialsCompactViewToolbar 
              ...
              {(true) && (
                ...
                <ContactToTrialsCompactViewCursorPagination
                  count={count}
...
ContactToTrialsCompactView.propTypes = {
  item: PropTypes.object.isRequired,
  handleClickOnContactToTrialsRow: PropTypes.func,
};