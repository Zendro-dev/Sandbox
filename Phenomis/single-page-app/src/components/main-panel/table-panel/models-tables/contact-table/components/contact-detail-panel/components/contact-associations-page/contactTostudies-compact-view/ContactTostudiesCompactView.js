...
import ContactTostudiesCompactViewToolbar from './components/ContactTostudiesCompactViewToolbar';
import ContactTostudiesCompactViewCursorPagination from './components/ContactTostudiesCompactViewCursorPagination';
...
export default function ContactTostudiesCompactView(props) {
  ...
  const getData = useCallback(() => {
    ...
    /*
      API Request: ContactTostudiesFilter
    */
    let label = 'studyDbId';
    let sublabel = '';
    let variables = {
  ...
  useEffect(() => {
     ...
     * 
     * Conditions:
     * A: the current item 'internalId' attribute is in the removedIds of the updated 'study_to_contact'.
     * B: the current item 'internalId' attribute is in the addedIds of the updated 'study_to_contact'.
     * 
     * Actions:
     * if A:
     * - reload table.
        ...
        <Grid item xs={12} >
          {(item!==undefined) && (
            <Card className={classes.card}>
              ...
              {/* Toolbar */}
              <ContactTostudiesCompactViewToolbar 
              ...
              {(true) && (
                ...
                <ContactTostudiesCompactViewCursorPagination
                  count={count}
...
ContactTostudiesCompactView.propTypes = {
  item: PropTypes.object.isRequired,
  handleClickOnContactTostudiesRow: PropTypes.func,
};