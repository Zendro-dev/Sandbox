...
export default function ObservationUnitPositionDetailPanel(props) {
  ...
  useEffect(() => {
    ...
    if(lastModelChanged&&
      ...
      lastModelChanged.observationUnitPosition[String(itemState.observationUnitPositionDbId)]) {
          
        //updated item
        if(lastModelChanged.observationUnitPosition[String(itemState.observationUnitPositionDbId)].op === "update"&&
            lastModelChanged.observationUnitPosition[String(itemState.observationUnitPositionDbId)].newItem) {
              //replace item
              setItemState(lastModelChanged.observationUnitPosition[String(itemState.observationUnitPositionDbId)].newItem);
              //show alert
              setUpdated(true);
        } else {
          //deleted item
          if(lastModelChanged.observationUnitPosition[String(itemState.observationUnitPositionDbId)].op === "delete") {
              //show alert
              setDeleted(true);
          }
        }
    }//end: Case 1
  }, [lastModelChanged, lastChangeTimestamp, itemState.observationUnitPositionDbId]);
