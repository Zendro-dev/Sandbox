...
export default function ObservationUnitPositionUploadFileDialog(props) {
  ...
  const handleSubmit = (event) => {
    if(file.current !== undefined && file.current !== null) {
      ...
      let query = 'mutation{ bulkAddObservationUnitPositionCsv{ observationUnitPositionDbId} }'
  ...
  return (
    ...
    >
      <DialogTitle>
      { t('modelPanels.uploading') + ' ObservationUnitPositions' }
        <div>
...
ObservationUnitPositionUploadFileDialog.propTypes = {
