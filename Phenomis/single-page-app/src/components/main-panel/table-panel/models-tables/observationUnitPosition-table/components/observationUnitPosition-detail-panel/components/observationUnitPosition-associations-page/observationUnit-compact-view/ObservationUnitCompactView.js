...
import ObservationUnitCompactViewCursorPagination from './components/ObservationUnitCompactViewCursorPagination';
...
export default function ObservationUnitCompactView(props) {
  ...
  const getData = useCallback(() => {
    ...
    /*
      API Request: ObservationUnitFilter
    */
    ...
    let cancelableApiReq = makeCancelable(api.observationUnitPosition.getObservationUnitConnection(
      graphqlServerUrl, 
    ...
    cancelableApiReq
      ...
      .then(response => {
        ...
        if (
          ...
          let it = response.data.data.readOneObservationUnitPosition.observationUnit;
          ...
          {(item!==undefined) && (
            <Card className={classes.card}>
              ...
              {(false) && (
                ...
                <ObservationUnitCompactViewCursorPagination
                  count={count}
