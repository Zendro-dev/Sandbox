    ...
    cancelableApiReq
      ...
      .then(response => {
        ...
        if(
          ...
          //save response data
          var newCount = response.data.data.countObservationUnitPositions;
    ...
    cancelableApiReq
      ...
      .then(response => {
        ...
        if(
          response.data &&
          response.data.data &&
          response.data.data.csvTableTemplateObservationUnitPosition        ) {
          //notify graphql errors
          if(response.data.errors) {
            actionText.current = t('modelPanels.gotIt', "Got it");
            enqueueSnackbar( t('modelPanels.errors.e3', "The GraphQL query returned a response with errors. Please contact your administrator."), {
                              ...
                              >
                                ...
                                */}
                                ...
                                <TableCell
                                  ...
                                  padding="default"
                                >
                                  {String((item.observationUnitPositionDbId!==null)?item.observationUnitPositionDbId:'')}
                                </TableCell>
