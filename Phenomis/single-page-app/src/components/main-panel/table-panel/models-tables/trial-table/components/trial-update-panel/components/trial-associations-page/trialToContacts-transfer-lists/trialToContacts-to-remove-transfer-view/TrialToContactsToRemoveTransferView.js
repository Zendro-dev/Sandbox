...
import TrialToContactsToRemoveTransferViewToolbar from './components/TrialToContactsToRemoveTransferViewToolbar';
import TrialToContactsToRemoveTransferViewCursorPagination from './components/TrialToContactsToRemoveTransferViewCursorPagination';
...
export default function TrialToContactsToRemoveTransferView(props) {
  ...
  */
  ...
  const getData = useCallback(() => {
    ...
    */
    ...
    let cancelableApiReq = makeCancelable(api.trial.getTrialToContactsConnection(
      graphqlServerUrl, 
      item.trialDbId,
      label,
      sublabel,
    ...
    cancelableApiReq
      ...
      .then(response => {
        ...
        if (
          ...
          //save response data
          let newCount = response.data.data.readOneTrial.countFilteredTrialToContacts;
          let its = response.data.data.readOneTrial.trialToContactsConnection.edges.map(o => o.node);
          let pi = response.data.data.readOneTrial.trialToContactsConnection.pageInfo;
        ...
        <Grid item xs={12} sm={5} >
          {(item!==undefined) && (
            <Card className={classes.card}>
              ...
              {/* Toolbar */}
              <TrialToContactsToRemoveTransferViewToolbar
              ...
              {/* Pagination */}
              <TrialToContactsToRemoveTransferViewCursorPagination
                count={count}
...
TrialToContactsToRemoveTransferView.propTypes = {
