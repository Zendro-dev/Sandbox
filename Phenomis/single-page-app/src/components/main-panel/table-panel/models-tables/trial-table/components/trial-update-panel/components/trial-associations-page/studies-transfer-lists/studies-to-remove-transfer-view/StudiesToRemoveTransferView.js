  ...
  */
  ...
  const getData = useCallback(() => {
    ...
    */
    ...
    let cancelableApiReq = makeCancelable(api.trial.getStudiesConnection(
      graphqlServerUrl, 
      item.trialDbId,
      label,
      sublabel,
    ...
    cancelableApiReq
      ...
      .then(response => {
        ...
        if (
          ...
          //save response data
          let newCount = response.data.data.readOneTrial.countFilteredStudies;
          let its = response.data.data.readOneTrial.studiesConnection.edges.map(o => o.node);
          let pi = response.data.data.readOneTrial.studiesConnection.pageInfo;
