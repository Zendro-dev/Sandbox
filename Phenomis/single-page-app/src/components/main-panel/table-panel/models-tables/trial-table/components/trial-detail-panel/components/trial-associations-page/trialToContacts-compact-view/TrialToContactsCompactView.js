...
import TrialToContactsCompactViewToolbar from './components/TrialToContactsCompactViewToolbar';
import TrialToContactsCompactViewCursorPagination from './components/TrialToContactsCompactViewCursorPagination';
...
export default function TrialToContactsCompactView(props) {
  ...
  const getData = useCallback(() => {
    ...
    /*
      API Request: TrialToContactsFilter
    */
    let label = 'trialDbId';
    let sublabel = '';
    let variables = {
        ...
        <Grid item xs={12} >
          {(item!==undefined) && (
            <Card className={classes.card}>
              ...
              {/* Toolbar */}
              <TrialToContactsCompactViewToolbar 
              ...
              {(true) && (
                ...
                <TrialToContactsCompactViewCursorPagination
                  count={count}
...
TrialToContactsCompactView.propTypes = {
  item: PropTypes.object.isRequired,
  handleClickOnTrialToContactsRow: PropTypes.func,
};