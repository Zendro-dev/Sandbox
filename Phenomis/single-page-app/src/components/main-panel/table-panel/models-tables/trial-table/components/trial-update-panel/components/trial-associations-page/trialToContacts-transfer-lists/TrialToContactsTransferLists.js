...
import TrialToContactsToAddTransferView from './trialToContacts-to-add-transfer-view/TrialToContactsToAddTransferView'
import TrialToContactsToRemoveTransferView from './trialToContacts-to-remove-transfer-view/TrialToContactsToRemoveTransferView'
...
export default function TrialToContactsTransferLists(props) {
    ...
    <div>
      <Fade in={true} timeout={500}>
        ...
        > 
          ...
          <Grid item xs={12}>
            <TrialToContactsToAddTransferView
              item={item}
              idsToAdd={idsToAdd}
          ...
          <Grid item xs={12}>
            <TrialToContactsToRemoveTransferView
              item={item}
...
TrialToContactsTransferLists.propTypes = {
