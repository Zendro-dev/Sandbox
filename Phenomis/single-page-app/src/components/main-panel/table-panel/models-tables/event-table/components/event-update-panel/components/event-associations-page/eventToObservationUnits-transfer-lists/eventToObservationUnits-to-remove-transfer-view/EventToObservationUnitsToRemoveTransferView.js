...
import EventToObservationUnitsToRemoveTransferViewToolbar from './components/EventToObservationUnitsToRemoveTransferViewToolbar';
import EventToObservationUnitsToRemoveTransferViewCursorPagination from './components/EventToObservationUnitsToRemoveTransferViewCursorPagination';
...
export default function EventToObservationUnitsToRemoveTransferView(props) {
  ...
  */
  ...
  const getData = useCallback(() => {
    ...
    */
    ...
    let cancelableApiReq = makeCancelable(api.event.getEventToObservationUnitsConnection(
      graphqlServerUrl, 
      item.eventType,
      label,
      sublabel,
    ...
    cancelableApiReq
      ...
      .then(response => {
        ...
        if (
          ...
          //save response data
          let newCount = response.data.data.readOneEvent.countFilteredEventToObservationUnits;
          let its = response.data.data.readOneEvent.eventToObservationUnitsConnection.edges.map(o => o.node);
          let pi = response.data.data.readOneEvent.eventToObservationUnitsConnection.pageInfo;
        ...
        <Grid item xs={12} sm={5} >
          {(item!==undefined) && (
            <Card className={classes.card}>
              ...
              {/* Toolbar */}
              <EventToObservationUnitsToRemoveTransferViewToolbar
              ...
              {/* Pagination */}
              <EventToObservationUnitsToRemoveTransferViewCursorPagination
                count={count}
...
EventToObservationUnitsToRemoveTransferView.propTypes = {
