...
export default function EventToObservationUnitsToRemoveTransferViewToolbar(props) {
          ...
          <Grid container justify='space-between' alignItems='center' wrap='wrap' spacing={2}>
            ...
            <Grid item xs={12} className={classes.headers}>
              <Grid container justify='flex-start' alignItems='center' wrap='nowrap'>
                ...
                {/* Label */}
                <Grid item xs={8}>
                  <Typography className={classes.label} variant="caption" display="block" noWrap={true}><b>&nbsp;&nbsp;&nbsp;eventDbId</b></Typography>
                </Grid>
...
EventToObservationUnitsToRemoveTransferViewToolbar.propTypes = {
