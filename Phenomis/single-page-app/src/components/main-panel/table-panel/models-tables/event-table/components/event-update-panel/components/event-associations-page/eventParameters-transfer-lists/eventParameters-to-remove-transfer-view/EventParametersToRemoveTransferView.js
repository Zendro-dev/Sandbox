  ...
  */
  ...
  const getData = useCallback(() => {
    ...
    */
    ...
    let cancelableApiReq = makeCancelable(api.event.getEventParametersConnection(
      graphqlServerUrl, 
      item.eventType,
      label,
      sublabel,
    ...
    cancelableApiReq
      ...
      .then(response => {
        ...
        if (
          ...
          //save response data
          let newCount = response.data.data.readOneEvent.countFilteredEventParameters;
          let its = response.data.data.readOneEvent.eventParametersConnection.edges.map(o => o.node);
          let pi = response.data.data.readOneEvent.eventParametersConnection.pageInfo;
