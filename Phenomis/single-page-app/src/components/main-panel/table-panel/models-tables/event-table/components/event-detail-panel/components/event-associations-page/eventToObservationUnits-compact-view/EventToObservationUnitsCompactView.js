...
import EventToObservationUnitsCompactViewToolbar from './components/EventToObservationUnitsCompactViewToolbar';
import EventToObservationUnitsCompactViewCursorPagination from './components/EventToObservationUnitsCompactViewCursorPagination';
...
export default function EventToObservationUnitsCompactView(props) {
  ...
  const getData = useCallback(() => {
    ...
    /*
      API Request: EventToObservationUnitsFilter
    */
    let label = 'eventDbId';
    let sublabel = '';
    let variables = {
        ...
        <Grid item xs={12} >
          {(item!==undefined) && (
            <Card className={classes.card}>
              ...
              {/* Toolbar */}
              <EventToObservationUnitsCompactViewToolbar 
              ...
              {(true) && (
                ...
                <EventToObservationUnitsCompactViewCursorPagination
                  count={count}
...
EventToObservationUnitsCompactView.propTypes = {
  item: PropTypes.object.isRequired,
  handleClickOnEventToObservationUnitsRow: PropTypes.func,
};