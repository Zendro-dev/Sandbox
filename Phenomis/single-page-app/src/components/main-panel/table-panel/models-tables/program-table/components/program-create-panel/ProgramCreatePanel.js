...
export default function ProgramCreatePanel(props) {
  ...
  function getInitialValues() {
    ...
    initialValues.leadPersonName = null;
  ...
  function getInitialValueOkStates() {
    ...
    */
    ...
    initialValueOkStates.leadPersonDbId = 0;
    initialValueOkStates.leadPersonName = 0;
      ...
      .then(response => {
        ...
        if (
          ...
          if(response.data.errors) {
            ...
            onClose(event, true, response.data.data.addProgram);
          }
          return;
