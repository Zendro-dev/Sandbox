  ...
  */
  ...
  const getData = useCallback(() => {
    ...
    */
    ...
    let cancelableApiReq = makeCancelable(api.program.getTrialsConnection(
      graphqlServerUrl, 
      item.programDbId,
      label,
      sublabel,
    ...
    cancelableApiReq
      ...
      .then(response => {
        ...
        if (
          ...
          //save response data
          let newCount = response.data.data.readOneProgram.countFilteredTrials;
          let its = response.data.data.readOneProgram.trialsConnection.edges.map(o => o.node);
          let pi = response.data.data.readOneProgram.trialsConnection.pageInfo;
