  ...
  */
  ...
  const getData = useCallback(() => {
    ...
    */
    ...
    let cancelableApiReq = makeCancelable(api.breedingMethod.getGermplasmConnection(
      graphqlServerUrl, 
    ...
    cancelableApiReq
      ...
      .then(response => {
        ...
        if (
          ...
          //save response data
          let newCount = response.data.data.readOneBreedingMethod.countFilteredGermplasm;
          let its = response.data.data.readOneBreedingMethod.germplasmConnection.edges.map(o => o.node);
          let pi = response.data.data.readOneBreedingMethod.germplasmConnection.pageInfo;
