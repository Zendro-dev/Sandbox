...
export default function BreedingMethodUploadFileDialog(props) {
  ...
  const handleSubmit = (event) => {
    if(file.current !== undefined && file.current !== null) {
      ...
      let query = 'mutation{ bulkAddBreedingMethodCsv{ breedingMethodDbId} }'
  ...
  return (
    ...
    >
      <DialogTitle>
      { t('modelPanels.uploading') + ' BreedingMethods' }
        <div>
...
BreedingMethodUploadFileDialog.propTypes = {
