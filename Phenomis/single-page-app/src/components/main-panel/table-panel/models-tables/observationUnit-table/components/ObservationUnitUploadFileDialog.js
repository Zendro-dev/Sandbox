...
export default function ObservationUnitUploadFileDialog(props) {
  ...
  const handleSubmit = (event) => {
    if(file.current !== undefined && file.current !== null) {
      ...
      let query = 'mutation{ bulkAddObservationUnitCsv{ observationUnitDbId} }'
  ...
  return (
    ...
    >
      <DialogTitle>
      { t('modelPanels.uploading') + ' ObservationUnits' }
        <div>
...
ObservationUnitUploadFileDialog.propTypes = {
