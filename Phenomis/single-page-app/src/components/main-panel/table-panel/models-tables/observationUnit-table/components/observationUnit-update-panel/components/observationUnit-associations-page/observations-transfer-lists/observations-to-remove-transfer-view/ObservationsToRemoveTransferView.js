  ...
  */
  ...
  const getData = useCallback(() => {
    ...
    */
    ...
    let cancelableApiReq = makeCancelable(api.observationUnit.getObservationsConnection(
      graphqlServerUrl, 
    ...
    cancelableApiReq
      ...
      .then(response => {
        ...
        if (
          ...
          //save response data
          let newCount = response.data.data.readOneObservationUnit.countFilteredObservations;
          let its = response.data.data.readOneObservationUnit.observationsConnection.edges.map(o => o.node);
          let pi = response.data.data.readOneObservationUnit.observationsConnection.pageInfo;
