  ...
  */
  ...
  const getData = useCallback(() => {
    ...
    */
    ...
    let cancelableApiReq = makeCancelable(api.observationUnit.getObservationTreatmentsConnection(
      graphqlServerUrl, 
    ...
    cancelableApiReq
      ...
      .then(response => {
        ...
        if (
          ...
          //save response data
          let newCount = response.data.data.readOneObservationUnit.countFilteredObservationTreatments;
          let its = response.data.data.readOneObservationUnit.observationTreatmentsConnection.edges.map(o => o.node);
          let pi = response.data.data.readOneObservationUnit.observationTreatmentsConnection.pageInfo;
