...
import TrialCompactViewCursorPagination from './components/TrialCompactViewCursorPagination';
...
export default function TrialCompactView(props) {
  ...
  const getData = useCallback(() => {
    ...
    */
    ...
    let cancelableApiReq = makeCancelable(api.observationUnit.getTrialConnection(
      graphqlServerUrl, 
    ...
    cancelableApiReq
      ...
      .then(response => {
        ...
        if (
          ...
          let it = response.data.data.readOneObservationUnit.trial;
          ...
          {(item!==undefined) && (
            <Card className={classes.card}>
              ...
              {(false) && (
                ...
                <TrialCompactViewCursorPagination
                  count={count}
