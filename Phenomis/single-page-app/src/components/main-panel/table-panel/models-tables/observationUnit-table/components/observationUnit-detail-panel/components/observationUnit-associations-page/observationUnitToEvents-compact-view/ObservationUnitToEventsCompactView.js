...
import ObservationUnitToEventsCompactViewToolbar from './components/ObservationUnitToEventsCompactViewToolbar';
import ObservationUnitToEventsCompactViewCursorPagination from './components/ObservationUnitToEventsCompactViewCursorPagination';
...
export default function ObservationUnitToEventsCompactView(props) {
  ...
  const getData = useCallback(() => {
    ...
    /*
      API Request: ObservationUnitToEventsFilter
    */
  ...
  useEffect(() => {
     ...
     * 
     * Conditions:
     * A: the current item 'internalId' attribute is in the removedIds of the updated 'observationUnit_to_event'.
     * B: the current item 'internalId' attribute is in the addedIds of the updated 'observationUnit_to_event'.
     * 
     * Actions:
     * if A:
     * - reload table.
        ...
        <Grid item xs={12} >
          {(item!==undefined) && (
            <Card className={classes.card}>
              ...
              {/* Toolbar */}
              <ObservationUnitToEventsCompactViewToolbar 
              ...
              {(true) && (
                ...
                <ObservationUnitToEventsCompactViewCursorPagination
                  count={count}
...
ObservationUnitToEventsCompactView.propTypes = {
  item: PropTypes.object.isRequired,
  handleClickOnObservationUnitToEventsRow: PropTypes.func,
};