...
export default function ImagesCompactView(props) {
  ...
  useEffect(() => {
     ...
     * 
     * Conditions:
     * A: the current item 'internalId' attribute is in the removedIds of the updated 'image'.
     * B: the current item 'internalId' attribute is in the addedIds of the updated 'image'.
     * 
     * Actions:
     * if A:
     * - reload table.
