...
import ProgramCompactViewCursorPagination from './components/ProgramCompactViewCursorPagination';
...
export default function ProgramCompactView(props) {
  ...
  const getData = useCallback(() => {
    ...
    /*
      API Request: ProgramFilter
    */
    let label = 'programName';
    let sublabel = '';
    let variables = {
      pagination: {
    ...
    let cancelableApiReq = makeCancelable(api.observationUnit.getProgramConnection(
      graphqlServerUrl, 
    ...
    cancelableApiReq
      ...
      .then(response => {
        ...
        if (
          ...
          let it = response.data.data.readOneObservationUnit.program;
          ...
          {(item!==undefined) && (
            <Card className={classes.card}>
              ...
              {(false) && (
                ...
                <ProgramCompactViewCursorPagination
                  count={count}
