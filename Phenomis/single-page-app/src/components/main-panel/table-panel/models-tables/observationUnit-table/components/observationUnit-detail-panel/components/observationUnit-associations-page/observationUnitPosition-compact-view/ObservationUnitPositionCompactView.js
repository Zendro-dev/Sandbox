...
import ObservationUnitPositionCompactViewCursorPagination from './components/ObservationUnitPositionCompactViewCursorPagination';
...
export default function ObservationUnitPositionCompactView(props) {
  ...
  const getData = useCallback(() => {
    ...
    /*
      API Request: ObservationUnitPositionFilter
    */
    let label = 'observationUnitPositionName';
    let sublabel = '';
    let variables = {
      pagination: {
    ...
    let cancelableApiReq = makeCancelable(api.observationUnit.getObservationUnitPositionConnection(
      graphqlServerUrl, 
    ...
    cancelableApiReq
      ...
      .then(response => {
        ...
        if (
          ...
          let it = response.data.data.readOneObservationUnit.observationUnitPosition;
          ...
          {(item!==undefined) && (
            <Card className={classes.card}>
              ...
              {(false) && (
                ...
                <ObservationUnitPositionCompactViewCursorPagination
                  count={count}
