  ...
  */
  ...
  const getData = useCallback(() => {
    ...
    */
    ...
    let cancelableApiReq = makeCancelable(api.observationUnit.getImagesConnection(
      graphqlServerUrl, 
    ...
    cancelableApiReq
      ...
      .then(response => {
        ...
        if (
          ...
          //save response data
          let newCount = response.data.data.readOneObservationUnit.countFilteredImages;
          let its = response.data.data.readOneObservationUnit.imagesConnection.edges.map(o => o.node);
          let pi = response.data.data.readOneObservationUnit.imagesConnection.pageInfo;
