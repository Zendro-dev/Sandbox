...
import ObservationUnitToEventsToRemoveTransferViewToolbar from './components/ObservationUnitToEventsToRemoveTransferViewToolbar';
import ObservationUnitToEventsToRemoveTransferViewCursorPagination from './components/ObservationUnitToEventsToRemoveTransferViewCursorPagination';
...
export default function ObservationUnitToEventsToRemoveTransferView(props) {
  ...
  */
  ...
  const getData = useCallback(() => {
    ...
    */
    ...
    let cancelableApiReq = makeCancelable(api.observationUnit.getObservationUnitToEventsConnection(
      graphqlServerUrl, 
    ...
    cancelableApiReq
      ...
      .then(response => {
        ...
        if (
          ...
          //save response data
          let newCount = response.data.data.readOneObservationUnit.countFilteredObservationUnitToEvents;
          let its = response.data.data.readOneObservationUnit.observationUnitToEventsConnection.edges.map(o => o.node);
          let pi = response.data.data.readOneObservationUnit.observationUnitToEventsConnection.pageInfo;
  ...
  useEffect(() => {
     ...
     * Actions:
     * if A:
     * - remove the internalId of the 'observationUnit_to_event' from idsToRemove[].
     * - reload both transfer tables.
     * - return
     * 
     * else if B:
        ...
        <Grid item xs={12} sm={5} >
          {(item!==undefined) && (
            <Card className={classes.card}>
              ...
              {/* Toolbar */}
              <ObservationUnitToEventsToRemoveTransferViewToolbar
              ...
              {/* Pagination */}
              <ObservationUnitToEventsToRemoveTransferViewCursorPagination
                count={count}
...
ObservationUnitToEventsToRemoveTransferView.propTypes = {
