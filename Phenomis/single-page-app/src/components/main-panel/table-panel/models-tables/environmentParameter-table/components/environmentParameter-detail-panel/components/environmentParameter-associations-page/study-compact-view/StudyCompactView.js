...
import StudyCompactViewCursorPagination from './components/StudyCompactViewCursorPagination';
...
export default function StudyCompactView(props) {
  ...
  const getData = useCallback(() => {
    ...
    */
    ...
    let cancelableApiReq = makeCancelable(api.environmentParameter.getStudyConnection(
      graphqlServerUrl, 
    ...
    cancelableApiReq
      ...
      .then(response => {
        ...
        if (
          ...
          let it = response.data.data.readOneEnvironmentParameter.study;
          ...
          {(item!==undefined) && (
            <Card className={classes.card}>
              ...
              {(false) && (
                ...
                <StudyCompactViewCursorPagination
                  count={count}
