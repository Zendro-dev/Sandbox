...
export default function EnvironmentParameterUploadFileDialog(props) {
  ...
  const handleSubmit = (event) => {
    if(file.current !== undefined && file.current !== null) {
      ...
      let query = 'mutation{ bulkAddEnvironmentParameterCsv{ environmentParameterDbId} }'
  ...
  return (
    ...
    >
      <DialogTitle>
      { t('modelPanels.uploading') + ' EnvironmentParameters' }
        <div>
...
EnvironmentParameterUploadFileDialog.propTypes = {
