...
export default function EventParameterUploadFileDialog(props) {
  ...
  const handleSubmit = (event) => {
    if(file.current !== undefined && file.current !== null) {
      ...
      let query = 'mutation{ bulkAddEventParameterCsv{ eventParameterDbId} }'
  ...
  return (
    ...
    >
      <DialogTitle>
      { t('modelPanels.uploading') + ' EventParameters' }
        <div>
...
EventParameterUploadFileDialog.propTypes = {
