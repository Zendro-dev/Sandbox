...
import EventCompactViewCursorPagination from './components/EventCompactViewCursorPagination';
...
export default function EventCompactView(props) {
  ...
  const getData = useCallback(() => {
    ...
    */
    ...
    let cancelableApiReq = makeCancelable(api.eventParameter.getEventConnection(
      graphqlServerUrl, 
    ...
    cancelableApiReq
      ...
      .then(response => {
        ...
        if (
          ...
          let it = response.data.data.readOneEventParameter.event;
          ...
          {(item!==undefined) && (
            <Card className={classes.card}>
              ...
              {(false) && (
                ...
                <EventCompactViewCursorPagination
                  count={count}
