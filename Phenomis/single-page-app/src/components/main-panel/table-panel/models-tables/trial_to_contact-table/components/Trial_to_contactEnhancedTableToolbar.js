...
export default function TrialToContactEnhancedTableToolbar(props) {
                        ...
                        <Grid item xs={12}>
                          <Grid container justify="center">
                            {/* Add */}
                            {
                              ...
                              &&(permissions.trial_to_contact.includes('create') || permissions.trial_to_contact.includes('*')))
                              &&(
                                <Grid item>
                                  <Tooltip title={t('modelPanels.addNew') + " trial_to_contact"}>
                                    <IconButton
                                      color="primary"
                                  ...
                                  >
                                    ...
                                    <Grid item xs={12}>
                                      <Grid container justify='flex-start'>
                                        ...
                                        <input type="hidden" name="model" value='trial_to_contact' />
                                          <ButtonBase
...
TrialToContactEnhancedTableToolbar.propTypes = {
