...
export default function TrialToContactUploadFileDialog(props) {
  ...
  const handleSubmit = (event) => {
    if(file.current !== undefined && file.current !== null) {
      ...
      let query = 'mutation{ bulkAddTrial_to_contactCsv{ id} }'
  ...
  return (
    ...
    >
      <DialogTitle>
      { t('modelPanels.uploading') + ' Trial_to_contacts' }
        <div>
...
TrialToContactUploadFileDialog.propTypes = {
