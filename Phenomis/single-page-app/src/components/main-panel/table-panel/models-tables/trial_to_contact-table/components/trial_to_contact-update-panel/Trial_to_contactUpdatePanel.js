...
export default function TrialToContactUpdatePanel(props) {
  ...
  function doSave(event) {
    ...
    */
    let cancelableApiReq = makeCancelable(api.trial_to_contact.updateItem(graphqlServerUrl, variables));
      ...
      .then(response => {
        ...
        if (
          ...
          if(response.data.errors) {
            ...
            onClose(event, true, response.data.data.updateTrial_to_contact);
          }
          return;
      ...
      <AppBar>
        <Toolbar>
          ...
          <Typography variant="h6" className={classes.title}>
            { t('modelPanels.editing') +  ": Trial_to_contact | id: " + item.id}
          </Typography>
...
TrialToContactUpdatePanel.propTypes = {
