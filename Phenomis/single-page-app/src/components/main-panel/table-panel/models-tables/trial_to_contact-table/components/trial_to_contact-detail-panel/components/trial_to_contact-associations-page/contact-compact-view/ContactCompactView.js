...
import ContactCompactViewToolbar from './components/ContactCompactViewToolbar';
import ContactCompactViewCursorPagination from './components/ContactCompactViewCursorPagination';
...
export default function ContactCompactView(props) {
  ...
  const getData = useCallback(() => {
    ...
    */
    ...
    let cancelableApiReq = makeCancelable(api.trial_to_contact.getContactConnection(
      graphqlServerUrl, 
      item.id,
      label,
      sublabel,
    ...
    cancelableApiReq
      ...
      .then(response => {
        ...
        if (
          ...
          let it = response.data.data.readOneTrial_to_contact.contact;
          ...
          {(item!==undefined) && (
            <Card className={classes.card}>
              ...
              {(false) && (
                ...
                <ContactCompactViewCursorPagination
                  count={count}
...
ContactCompactView.propTypes = {
  item: PropTypes.object.isRequired,
  handleClickOnContactRow: PropTypes.func,
};