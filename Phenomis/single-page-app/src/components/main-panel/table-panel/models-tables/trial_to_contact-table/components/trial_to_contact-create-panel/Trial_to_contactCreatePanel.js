...
import TrialToContactAttributesPage from './components/trial_to_contact-attributes-page/Trial_to_contactAttributesPage'
import TrialToContactAssociationsPage from './components/trial_to_contact-associations-page/Trial_to_contactAssociationsPage'
import TrialToContactTabsA from './components/Trial_to_contactTabsA'
import TrialToContactConfirmationDialog from './components/Trial_to_contactConfirmationDialog'
...
export default function TrialToContactCreatePanel(props) {
  ...
  function doSave(event) {
    ...
    */
    let cancelableApiReq = makeCancelable(api.trial_to_contact.createItem(graphqlServerUrl, variables));
      ...
      .then(response => {
        ...
        if (
          ...
          if(response.data.errors) {
            ...
            onClose(event, true, response.data.data.addTrial_to_contact);
          }
          return;
    ...
    >
      ...
      <AppBar>
        <Toolbar>
          ...
          <Typography variant="h6" className={classes.title}>
            {t('modelPanels.new') + ' Trial_to_contact'}
          </Typography>
          <Tooltip title={ t('modelPanels.save') + " trial_to_contact" }>
            <Fab 
              color="secondary" 
      ...
      <div className={classes.root}>
        <Grid container justify='center' alignItems='flex-start' alignContent='flex-start'>
          ...
          <Grid item xs={12}>
            {/* Associations Page [1] */}
            <TrialToContactAssociationsPage
              hidden={tabsValue !== 1}
        ...
        {/* Confirmation Dialog */}
        <TrialToContactConfirmationDialog
...
TrialToContactCreatePanel.propTypes = {
