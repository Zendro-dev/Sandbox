...
export default function StudyToContactUploadFileDialog(props) {
  ...
  const handleSubmit = (event) => {
    if(file.current !== undefined && file.current !== null) {
      ...
      let query = 'mutation{ bulkAddStudy_to_contactCsv{ id} }'
  ...
  return (
    ...
    >
      <DialogTitle>
      { t('modelPanels.uploading') + ' Study_to_contacts' }
        <div>
...
StudyToContactUploadFileDialog.propTypes = {
