...
export default function ContactToAddTransferViewToolbar(props) {
          ...
          <Grid container justify='space-between' alignItems='center' wrap='wrap' spacing={2}>
            ...
            <Grid item xs={12} className={classes.headers}>
              <Grid container justify='flex-start' alignItems='center' wrap='nowrap'>
                ...
                {/* id*/}
                <Grid item>
                  <Typography className={classes.id} variant="caption" display="block" noWrap={true}><b>contactDbId</b></Typography>
                </Grid>
...
ContactToAddTransferViewToolbar.propTypes = {
