...
export default function StudyToContactEnhancedTableToolbar(props) {
                        ...
                        <Grid item xs={12}>
                          <Grid container justify="center">
                            {/* Add */}
                            {
                              ...
                              &&(permissions.study_to_contact.includes('create') || permissions.study_to_contact.includes('*')))
                              &&(
                                <Grid item>
                                  <Tooltip title={t('modelPanels.addNew') + " study_to_contact"}>
                                    <IconButton
                                      color="primary"
                                  ...
                                  >
                                    ...
                                    <Grid item xs={12}>
                                      <Grid container justify='flex-start'>
                                        ...
                                        <input type="hidden" name="model" value='study_to_contact' />
                                          <ButtonBase
...
StudyToContactEnhancedTableToolbar.propTypes = {
