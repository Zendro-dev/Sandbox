  ...
  */
  ...
  const getData = useCallback(() => {
    ...
    */
    ...
    let cancelableApiReq = makeCancelable(api.image.getObservationsConnection(
      graphqlServerUrl, 
      item.imageDbId,
      label,
      sublabel,
    ...
    cancelableApiReq
      ...
      .then(response => {
        ...
        if (
          ...
          //save response data
          let newCount = response.data.data.readOneImage.countFilteredObservations;
          let its = response.data.data.readOneImage.observationsConnection.edges.map(o => o.node);
          let pi = response.data.data.readOneImage.observationsConnection.pageInfo;
