  ...
  */
  ...
  const getData = useCallback(() => {
    ...
    */
    ...
    let cancelableApiReq = makeCancelable(api.scale.getObservationVariablesConnection(
      graphqlServerUrl, 
      item.scaleDbId,
      label,
      sublabel,
    ...
    cancelableApiReq
      ...
      .then(response => {
        ...
        if (
          ...
          //save response data
          let newCount = response.data.data.readOneScale.countFilteredObservationVariables;
          let its = response.data.data.readOneScale.observationVariablesConnection.edges.map(o => o.node);
          let pi = response.data.data.readOneScale.observationVariablesConnection.pageInfo;
