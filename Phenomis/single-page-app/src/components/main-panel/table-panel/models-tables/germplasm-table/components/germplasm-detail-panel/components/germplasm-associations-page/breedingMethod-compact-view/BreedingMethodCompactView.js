...
import BreedingMethodCompactViewCursorPagination from './components/BreedingMethodCompactViewCursorPagination';
...
export default function BreedingMethodCompactView(props) {
  ...
  const getData = useCallback(() => {
    ...
    /*
      API Request: BreedingMethodFilter
    */
    let label = 'breedingMethodName';
    let sublabel = '';
    let variables = {
      pagination: {
    ...
    let cancelableApiReq = makeCancelable(api.germplasm.getBreedingMethodConnection(
      graphqlServerUrl, 
      item.germplasmDbId,
      label,
      sublabel,
    ...
    cancelableApiReq
      ...
      .then(response => {
        ...
        if (
          ...
          let it = response.data.data.readOneGermplasm.breedingMethod;
          ...
          {(item!==undefined) && (
            <Card className={classes.card}>
              ...
              {(false) && (
                ...
                <BreedingMethodCompactViewCursorPagination
                  count={count}
