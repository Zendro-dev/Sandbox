...
export default function GermplasmUploadFileDialog(props) {
  ...
  const handleSubmit = (event) => {
    if(file.current !== undefined && file.current !== null) {
      ...
      let query = 'mutation{ bulkAddGermplasmCsv{ germplasmDbId} }'
  ...
  return (
    ...
    >
      <DialogTitle>
      { t('modelPanels.uploading') + ' Germplasms' }
        <div>
...
GermplasmUploadFileDialog.propTypes = {
