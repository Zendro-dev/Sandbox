  ...
  */
  ...
  const getData = useCallback(() => {
    ...
    */
    ...
    let cancelableApiReq = makeCancelable(api.germplasm.getObservationsConnection(
      graphqlServerUrl, 
      item.germplasmDbId,
      label,
      sublabel,
    ...
    cancelableApiReq
      ...
      .then(response => {
        ...
        if (
          ...
          //save response data
          let newCount = response.data.data.readOneGermplasm.countFilteredObservations;
          let its = response.data.data.readOneGermplasm.observationsConnection.edges.map(o => o.node);
          let pi = response.data.data.readOneGermplasm.observationsConnection.pageInfo;
