  ...
  */
  ...
  const getData = useCallback(() => {
    ...
    */
    ...
    let cancelableApiReq = makeCancelable(api.location.getStudiesConnection(
      graphqlServerUrl, 
      item.locationDbId,
      label,
      sublabel,
    ...
    cancelableApiReq
      ...
      .then(response => {
        ...
        if (
          ...
          //save response data
          let newCount = response.data.data.readOneLocation.countFilteredStudies;
          let its = response.data.data.readOneLocation.studiesConnection.edges.map(o => o.node);
          let pi = response.data.data.readOneLocation.studiesConnection.pageInfo;
