...
import ImageCompactViewCursorPagination from './components/ImageCompactViewCursorPagination';
...
export default function ImageCompactView(props) {
  ...
  const getData = useCallback(() => {
    ...
    */
    ...
    let cancelableApiReq = makeCancelable(api.observation.getImageConnection(
      graphqlServerUrl, 
    ...
    cancelableApiReq
      ...
      .then(response => {
        ...
        if (
          ...
          let it = response.data.data.readOneObservation.image;
          ...
          {(item!==undefined) && (
            <Card className={classes.card}>
              ...
              {(false) && (
                ...
                <ImageCompactViewCursorPagination
                  count={count}
