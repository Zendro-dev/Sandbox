...
import ObservationVariableCompactViewCursorPagination from './components/ObservationVariableCompactViewCursorPagination';
...
export default function ObservationVariableCompactView(props) {
  ...
  const getData = useCallback(() => {
    ...
    /*
      API Request: ObservationVariableFilter
    */
    ...
    let cancelableApiReq = makeCancelable(api.observation.getObservationVariableConnection(
      graphqlServerUrl, 
    ...
    cancelableApiReq
      ...
      .then(response => {
        ...
        if (
          ...
          let it = response.data.data.readOneObservation.observationVariable;
          ...
          {(item!==undefined) && (
            <Card className={classes.card}>
              ...
              {(false) && (
                ...
                <ObservationVariableCompactViewCursorPagination
                  count={count}
