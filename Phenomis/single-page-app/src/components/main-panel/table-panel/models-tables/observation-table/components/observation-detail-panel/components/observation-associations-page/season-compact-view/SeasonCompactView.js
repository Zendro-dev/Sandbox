...
import SeasonCompactViewCursorPagination from './components/SeasonCompactViewCursorPagination';
...
export default function SeasonCompactView(props) {
  ...
  const getData = useCallback(() => {
    ...
    */
    ...
    let cancelableApiReq = makeCancelable(api.observation.getSeasonConnection(
      graphqlServerUrl, 
    ...
    cancelableApiReq
      ...
      .then(response => {
        ...
        if (
          ...
          let it = response.data.data.readOneObservation.season;
          ...
          {(item!==undefined) && (
            <Card className={classes.card}>
              ...
              {(false) && (
                ...
                <SeasonCompactViewCursorPagination
                  count={count}
