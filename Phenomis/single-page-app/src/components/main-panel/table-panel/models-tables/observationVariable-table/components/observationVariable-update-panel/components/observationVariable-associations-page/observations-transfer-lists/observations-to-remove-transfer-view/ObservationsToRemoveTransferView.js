  ...
  */
  ...
  const getData = useCallback(() => {
    ...
    */
    ...
    let cancelableApiReq = makeCancelable(api.observationVariable.getObservationsConnection(
      graphqlServerUrl, 
    ...
    cancelableApiReq
      ...
      .then(response => {
        ...
        if (
          ...
          //save response data
          let newCount = response.data.data.readOneObservationVariable.countFilteredObservations;
          let its = response.data.data.readOneObservationVariable.observationsConnection.edges.map(o => o.node);
          let pi = response.data.data.readOneObservationVariable.observationsConnection.pageInfo;
