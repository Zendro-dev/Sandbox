...
export default function ObservationVariableUploadFileDialog(props) {
  ...
  const handleSubmit = (event) => {
    if(file.current !== undefined && file.current !== null) {
      ...
      let query = 'mutation{ bulkAddObservationVariableCsv{ observationVariableDbId} }'
  ...
  return (
    ...
    >
      <DialogTitle>
      { t('modelPanels.uploading') + ' ObservationVariables' }
        <div>
...
ObservationVariableUploadFileDialog.propTypes = {
