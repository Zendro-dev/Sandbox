...
import TraitCompactViewToolbar from './components/TraitCompactViewToolbar';
import TraitCompactViewCursorPagination from './components/TraitCompactViewCursorPagination';
...
export default function TraitCompactView(props) {
  ...
  const getData = useCallback(() => {
    ...
    */
    ...
    let cancelableApiReq = makeCancelable(api.observationVariable.getTraitConnection(
      graphqlServerUrl, 
    ...
    cancelableApiReq
      ...
      .then(response => {
        ...
        if (
          ...
          let it = response.data.data.readOneObservationVariable.trait;
          ...
          {(item!==undefined) && (
            <Card className={classes.card}>
              ...
              {(false) && (
                ...
                <TraitCompactViewCursorPagination
                  count={count}
...
TraitCompactView.propTypes = {
  item: PropTypes.object.isRequired,
  handleClickOnTraitRow: PropTypes.func,
};