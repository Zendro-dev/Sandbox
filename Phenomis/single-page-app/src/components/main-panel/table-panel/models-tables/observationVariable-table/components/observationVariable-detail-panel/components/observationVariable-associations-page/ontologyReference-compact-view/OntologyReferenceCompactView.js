...
import OntologyReferenceCompactViewCursorPagination from './components/OntologyReferenceCompactViewCursorPagination';
...
export default function OntologyReferenceCompactView(props) {
  ...
  const getData = useCallback(() => {
    ...
    /*
      API Request: OntologyReferenceFilter
    */
    let label = 'ontologyName';
    let sublabel = '';
    let variables = {
      pagination: {
    ...
    let cancelableApiReq = makeCancelable(api.observationVariable.getOntologyReferenceConnection(
      graphqlServerUrl, 
    ...
    cancelableApiReq
      ...
      .then(response => {
        ...
        if (
          ...
          let it = response.data.data.readOneObservationVariable.ontologyReference;
          ...
          {(item!==undefined) && (
            <Card className={classes.card}>
              ...
              {(false) && (
                ...
                <OntologyReferenceCompactViewCursorPagination
                  count={count}
