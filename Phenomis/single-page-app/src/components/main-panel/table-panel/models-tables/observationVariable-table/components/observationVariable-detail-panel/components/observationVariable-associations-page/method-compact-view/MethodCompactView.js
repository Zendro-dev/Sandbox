...
import MethodCompactViewCursorPagination from './components/MethodCompactViewCursorPagination';
...
export default function MethodCompactView(props) {
  ...
  const getData = useCallback(() => {
    ...
    */
    ...
    let cancelableApiReq = makeCancelable(api.observationVariable.getMethodConnection(
      graphqlServerUrl, 
    ...
    cancelableApiReq
      ...
      .then(response => {
        ...
        if (
          ...
          let it = response.data.data.readOneObservationVariable.method;
          ...
          {(item!==undefined) && (
            <Card className={classes.card}>
              ...
              {(false) && (
                ...
                <MethodCompactViewCursorPagination
                  count={count}
