...
import ScaleCompactViewCursorPagination from './components/ScaleCompactViewCursorPagination';
...
export default function ScaleCompactView(props) {
  ...
  const getData = useCallback(() => {
    ...
    */
    ...
    let cancelableApiReq = makeCancelable(api.observationVariable.getScaleConnection(
      graphqlServerUrl, 
    ...
    cancelableApiReq
      ...
      .then(response => {
        ...
        if (
          ...
          let it = response.data.data.readOneObservationVariable.scale;
          ...
          {(item!==undefined) && (
            <Card className={classes.card}>
              ...
              {(false) && (
                ...
                <ScaleCompactViewCursorPagination
                  count={count}
