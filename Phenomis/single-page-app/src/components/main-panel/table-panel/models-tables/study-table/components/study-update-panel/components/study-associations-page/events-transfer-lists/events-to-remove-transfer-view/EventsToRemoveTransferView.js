  ...
  */
  ...
  const getData = useCallback(() => {
    ...
    */
    ...
    let cancelableApiReq = makeCancelable(api.study.getEventsConnection(
      graphqlServerUrl, 
      item.studyDbId,
      label,
      sublabel,
    ...
    cancelableApiReq
      ...
      .then(response => {
        ...
        if (
          ...
          //save response data
          let newCount = response.data.data.readOneStudy.countFilteredEvents;
          let its = response.data.data.readOneStudy.eventsConnection.edges.map(o => o.node);
          let pi = response.data.data.readOneStudy.eventsConnection.pageInfo;
