...
import StudyToContactsCompactViewToolbar from './components/StudyToContactsCompactViewToolbar';
import StudyToContactsCompactViewCursorPagination from './components/StudyToContactsCompactViewCursorPagination';
...
export default function StudyToContactsCompactView(props) {
  ...
  const getData = useCallback(() => {
    ...
    /*
      API Request: StudyToContactsFilter
    */
    let label = 'studyDbId';
    let sublabel = '';
    let variables = {
        ...
        <Grid item xs={12} >
          {(item!==undefined) && (
            <Card className={classes.card}>
              ...
              {/* Toolbar */}
              <StudyToContactsCompactViewToolbar 
              ...
              {(true) && (
                ...
                <StudyToContactsCompactViewCursorPagination
                  count={count}
...
StudyToContactsCompactView.propTypes = {
  item: PropTypes.object.isRequired,
  handleClickOnStudyToContactsRow: PropTypes.func,
};