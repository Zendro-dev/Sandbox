  ...
  */
  ...
  const getData = useCallback(() => {
    ...
    */
    ...
    let cancelableApiReq = makeCancelable(api.study.getObservationsConnection(
      graphqlServerUrl, 
      item.studyDbId,
      label,
      sublabel,
    ...
    cancelableApiReq
      ...
      .then(response => {
        ...
        if (
          ...
          //save response data
          let newCount = response.data.data.readOneStudy.countFilteredObservations;
          let its = response.data.data.readOneStudy.observationsConnection.edges.map(o => o.node);
          let pi = response.data.data.readOneStudy.observationsConnection.pageInfo;
