  ...
  */
  ...
  const getData = useCallback(() => {
    ...
    */
    ...
    let sublabel = 'environmentParametersDbId';
    let variables = {
      pagination: {
    ...
    let cancelableApiReq = makeCancelable(api.study.getEnvironmentParametersConnection(
      graphqlServerUrl, 
      item.studyDbId,
      label,
      sublabel,
    ...
    cancelableApiReq
      ...
      .then(response => {
        ...
        if (
          ...
          //save response data
          let newCount = response.data.data.readOneStudy.countFilteredEnvironmentParameters;
          let its = response.data.data.readOneStudy.environmentParametersConnection.edges.map(o => o.node);
          let pi = response.data.data.readOneStudy.environmentParametersConnection.pageInfo;
