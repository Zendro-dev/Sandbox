...
import StudyToContactsToAddTransferView from './studyToContacts-to-add-transfer-view/StudyToContactsToAddTransferView'
import StudyToContactsToRemoveTransferView from './studyToContacts-to-remove-transfer-view/StudyToContactsToRemoveTransferView'
...
export default function StudyToContactsTransferLists(props) {
    ...
    <div>
      <Fade in={true} timeout={500}>
        ...
        > 
          ...
          <Grid item xs={12}>
            <StudyToContactsToAddTransferView
              item={item}
              idsToAdd={idsToAdd}
          ...
          <Grid item xs={12}>
            <StudyToContactsToRemoveTransferView
              item={item}
...
StudyToContactsTransferLists.propTypes = {
