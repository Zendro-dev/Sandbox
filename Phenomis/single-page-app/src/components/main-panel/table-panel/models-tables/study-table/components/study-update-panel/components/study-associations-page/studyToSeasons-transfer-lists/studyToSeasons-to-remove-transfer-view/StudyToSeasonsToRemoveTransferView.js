...
import StudyToSeasonsToRemoveTransferViewToolbar from './components/StudyToSeasonsToRemoveTransferViewToolbar';
import StudyToSeasonsToRemoveTransferViewCursorPagination from './components/StudyToSeasonsToRemoveTransferViewCursorPagination';
...
export default function StudyToSeasonsToRemoveTransferView(props) {
  ...
  */
  ...
  const getData = useCallback(() => {
    ...
    */
    ...
    let cancelableApiReq = makeCancelable(api.study.getStudyToSeasonsConnection(
      graphqlServerUrl, 
      item.studyDbId,
      label,
      sublabel,
    ...
    cancelableApiReq
      ...
      .then(response => {
        ...
        if (
          ...
          //save response data
          let newCount = response.data.data.readOneStudy.countFilteredStudyToSeasons;
          let its = response.data.data.readOneStudy.studyToSeasonsConnection.edges.map(o => o.node);
          let pi = response.data.data.readOneStudy.studyToSeasonsConnection.pageInfo;
        ...
        <Grid item xs={12} sm={5} >
          {(item!==undefined) && (
            <Card className={classes.card}>
              ...
              {/* Toolbar */}
              <StudyToSeasonsToRemoveTransferViewToolbar
              ...
              {/* Pagination */}
              <StudyToSeasonsToRemoveTransferViewCursorPagination
                count={count}
...
StudyToSeasonsToRemoveTransferView.propTypes = {
