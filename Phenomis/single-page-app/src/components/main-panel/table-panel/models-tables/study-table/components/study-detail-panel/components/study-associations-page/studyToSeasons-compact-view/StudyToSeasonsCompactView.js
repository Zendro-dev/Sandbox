...
import StudyToSeasonsCompactViewToolbar from './components/StudyToSeasonsCompactViewToolbar';
import StudyToSeasonsCompactViewCursorPagination from './components/StudyToSeasonsCompactViewCursorPagination';
...
export default function StudyToSeasonsCompactView(props) {
  ...
  const getData = useCallback(() => {
    ...
    /*
      API Request: StudyToSeasonsFilter
    */
    let label = 'studyDbId';
    let sublabel = '';
    let variables = {
        ...
        <Grid item xs={12} >
          {(item!==undefined) && (
            <Card className={classes.card}>
              ...
              {/* Toolbar */}
              <StudyToSeasonsCompactViewToolbar 
              ...
              {(true) && (
                ...
                <StudyToSeasonsCompactViewCursorPagination
                  count={count}
...
StudyToSeasonsCompactView.propTypes = {
  item: PropTypes.object.isRequired,
  handleClickOnStudyToSeasonsRow: PropTypes.func,
};