...
import StudyToContactsToRemoveTransferViewToolbar from './components/StudyToContactsToRemoveTransferViewToolbar';
import StudyToContactsToRemoveTransferViewCursorPagination from './components/StudyToContactsToRemoveTransferViewCursorPagination';
...
export default function StudyToContactsToRemoveTransferView(props) {
  ...
  */
  ...
  const getData = useCallback(() => {
    ...
    */
    ...
    let cancelableApiReq = makeCancelable(api.study.getStudyToContactsConnection(
      graphqlServerUrl, 
      item.studyDbId,
      label,
      sublabel,
    ...
    cancelableApiReq
      ...
      .then(response => {
        ...
        if (
          ...
          //save response data
          let newCount = response.data.data.readOneStudy.countFilteredStudyToContacts;
          let its = response.data.data.readOneStudy.studyToContactsConnection.edges.map(o => o.node);
          let pi = response.data.data.readOneStudy.studyToContactsConnection.pageInfo;
        ...
        <Grid item xs={12} sm={5} >
          {(item!==undefined) && (
            <Card className={classes.card}>
              ...
              {/* Toolbar */}
              <StudyToContactsToRemoveTransferViewToolbar
              ...
              {/* Pagination */}
              <StudyToContactsToRemoveTransferViewCursorPagination
                count={count}
...
StudyToContactsToRemoveTransferView.propTypes = {
