...
export default function StudyUploadFileDialog(props) {
  ...
  const handleSubmit = (event) => {
    if(file.current !== undefined && file.current !== null) {
      ...
      let query = 'mutation{ bulkAddStudyCsv{ studyDbId} }'
  ...
  return (
    ...
    >
      <DialogTitle>
      { t('modelPanels.uploading') + ' Studies' }
        <div>
...
StudyUploadFileDialog.propTypes = {
