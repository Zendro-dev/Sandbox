...
import SeasonToStudiesCompactViewToolbar from './components/SeasonToStudiesCompactViewToolbar';
import SeasonToStudiesCompactViewCursorPagination from './components/SeasonToStudiesCompactViewCursorPagination';
...
export default function SeasonToStudiesCompactView(props) {
  ...
  const getData = useCallback(() => {
    ...
    /*
      API Request: SeasonToStudiesFilter
    */
  ...
  useEffect(() => {
     ...
     * 
     * Conditions:
     * A: the current item 'internalId' attribute is in the removedIds of the updated 'study_to_season'.
     * B: the current item 'internalId' attribute is in the addedIds of the updated 'study_to_season'.
     * 
     * Actions:
     * if A:
     * - reload table.
        ...
        <Grid item xs={12} >
          {(item!==undefined) && (
            <Card className={classes.card}>
              ...
              {/* Toolbar */}
              <SeasonToStudiesCompactViewToolbar 
              ...
              {(true) && (
                ...
                <SeasonToStudiesCompactViewCursorPagination
                  count={count}
...
SeasonToStudiesCompactView.propTypes = {
  item: PropTypes.object.isRequired,
  handleClickOnSeasonToStudiesRow: PropTypes.func,
};