...
export default function SeasonUploadFileDialog(props) {
  ...
  const handleSubmit = (event) => {
    if(file.current !== undefined && file.current !== null) {
      ...
      let query = 'mutation{ bulkAddSeasonCsv{ seasonDbId} }'
  ...
  return (
    ...
    >
      <DialogTitle>
      { t('modelPanels.uploading') + ' Seasons' }
        <div>
...
SeasonUploadFileDialog.propTypes = {
