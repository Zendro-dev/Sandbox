  ...
  */
  ...
  const getData = useCallback(() => {
    ...
    */
    ...
    let cancelableApiReq = makeCancelable(api.season.getObservationsConnection(
      graphqlServerUrl, 
      item.seasonDbId,
      label,
      sublabel,
    ...
    cancelableApiReq
      ...
      .then(response => {
        ...
        if (
          ...
          //save response data
          let newCount = response.data.data.readOneSeason.countFilteredObservations;
          let its = response.data.data.readOneSeason.observationsConnection.edges.map(o => o.node);
          let pi = response.data.data.readOneSeason.observationsConnection.pageInfo;
