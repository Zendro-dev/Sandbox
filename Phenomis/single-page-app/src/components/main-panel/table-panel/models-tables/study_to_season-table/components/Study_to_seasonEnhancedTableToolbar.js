...
export default function StudyToSeasonEnhancedTableToolbar(props) {
                        ...
                        <Grid item xs={12}>
                          <Grid container justify="center">
                            {/* Add */}
                            {
                              ...
                              &&(permissions.study_to_season.includes('create') || permissions.study_to_season.includes('*')))
                              &&(
                                <Grid item>
                                  <Tooltip title={t('modelPanels.addNew') + " study_to_season"}>
                                    <IconButton
                                      color="primary"
                                  ...
                                  >
                                    ...
                                    <Grid item xs={12}>
                                      <Grid container justify='flex-start'>
                                        ...
                                        <input type="hidden" name="model" value='study_to_season' />
                                          <ButtonBase
...
StudyToSeasonEnhancedTableToolbar.propTypes = {
