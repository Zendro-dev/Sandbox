...
export default function StudyToSeasonUploadFileDialog(props) {
  ...
  const handleSubmit = (event) => {
    if(file.current !== undefined && file.current !== null) {
      ...
      let query = 'mutation{ bulkAddStudy_to_seasonCsv{ id} }'
  ...
  return (
    ...
    >
      <DialogTitle>
      { t('modelPanels.uploading') + ' Study_to_seasons' }
        <div>
...
StudyToSeasonUploadFileDialog.propTypes = {
