...
export default function StudyToSeasonCreatePanel(props) {
  ...
  function doSave(event) {
    ...
    */
    let cancelableApiReq = makeCancelable(api.study_to_season.createItem(graphqlServerUrl, variables));
      ...
      .then(response => {
        ...
        if (
          ...
          if(response.data.errors) {
            ...
            onClose(event, true, response.data.data.addStudy_to_season);
          }
          return;
      ...
      <AppBar>
        <Toolbar>
          ...
          <Typography variant="h6" className={classes.title}>
            {t('modelPanels.new') + ' Study_to_season'}
          </Typography>
...
StudyToSeasonCreatePanel.propTypes = {
