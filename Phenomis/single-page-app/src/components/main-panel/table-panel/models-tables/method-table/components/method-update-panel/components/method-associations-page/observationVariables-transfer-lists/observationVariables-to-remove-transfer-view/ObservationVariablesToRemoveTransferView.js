  ...
  */
  ...
  const getData = useCallback(() => {
    ...
    */
    ...
    let cancelableApiReq = makeCancelable(api.method.getObservationVariablesConnection(
      graphqlServerUrl, 
      item.methodDbId,
      label,
      sublabel,
    ...
    cancelableApiReq
      ...
      .then(response => {
        ...
        if (
          ...
          //save response data
          let newCount = response.data.data.readOneMethod.countFilteredObservationVariables;
          let its = response.data.data.readOneMethod.observationVariablesConnection.edges.map(o => o.node);
          let pi = response.data.data.readOneMethod.observationVariablesConnection.pageInfo;
