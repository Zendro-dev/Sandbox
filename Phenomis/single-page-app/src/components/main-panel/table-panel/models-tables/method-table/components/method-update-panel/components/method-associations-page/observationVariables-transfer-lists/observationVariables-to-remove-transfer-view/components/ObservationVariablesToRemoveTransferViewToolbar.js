...
export default function ObservationVariablesToRemoveTransferViewToolbar(props) {
          ...
          <Grid container justify='space-between' alignItems='center' wrap='wrap' spacing={2}>
            ...
            <Grid item xs={12} className={classes.headers}>
              <Grid container justify='flex-start' alignItems='center' wrap='nowrap'>
                ...
                {/* methodDbId*/}
                <Grid item>
                  <Typography className={classes.id} variant="caption" display="block" noWrap={true}><b>observationVariableDbId</b></Typography>
                </Grid>
                
                {/* Label */}
                <Grid item xs={8}>
                  <Typography className={classes.label} variant="caption" display="block" noWrap={true}><b>&nbsp;&nbsp;&nbsp;observationVariableName</b></Typography>
                </Grid>
...
ObservationVariablesToRemoveTransferViewToolbar.propTypes = {
