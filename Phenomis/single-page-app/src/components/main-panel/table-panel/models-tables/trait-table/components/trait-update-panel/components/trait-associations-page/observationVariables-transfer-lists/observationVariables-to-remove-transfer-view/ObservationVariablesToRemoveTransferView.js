  ...
  */
  ...
  const getData = useCallback(() => {
    ...
    */
    ...
    let cancelableApiReq = makeCancelable(api.trait.getObservationVariablesConnection(
      graphqlServerUrl, 
      item.traitDbId,
      label,
      sublabel,
    ...
    cancelableApiReq
      ...
      .then(response => {
        ...
        if (
          ...
          //save response data
          let newCount = response.data.data.readOneTrait.countFilteredObservationVariables;
          let its = response.data.data.readOneTrait.observationVariablesConnection.edges.map(o => o.node);
          let pi = response.data.data.readOneTrait.observationVariablesConnection.pageInfo;
