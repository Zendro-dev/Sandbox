...
export default function TraitUploadFileDialog(props) {
  ...
  const handleSubmit = (event) => {
    if(file.current !== undefined && file.current !== null) {
      ...
      let query = 'mutation{ bulkAddTraitCsv{ traitDbId} }'
  ...
  return (
    ...
    >
      <DialogTitle>
      { t('modelPanels.uploading') + ' Traits' }
        <div>
...
TraitUploadFileDialog.propTypes = {
