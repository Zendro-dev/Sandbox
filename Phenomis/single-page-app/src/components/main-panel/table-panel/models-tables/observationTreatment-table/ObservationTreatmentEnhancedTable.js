    ...
    cancelableApiReq
      ...
      .then(response => {
        ...
        if(
          ...
          //save response data
          var newCount = response.data.data.countObservationTreatments;
    ...
    cancelableApiReq
      ...
      .then(response => {
        ...
        if(
          response.data &&
          response.data.data &&
          response.data.data.csvTableTemplateObservationTreatment        ) {
          //notify graphql errors
          if(response.data.errors) {
            actionText.current = t('modelPanels.gotIt', "Got it");
            enqueueSnackbar( t('modelPanels.errors.e3', "The GraphQL query returned a response with errors. Please contact your administrator."), {
                              ...
                              >
                                ...
                                */}
                                ...
                                <TableCell
                                  ...
                                  padding="default"
                                >
                                  {String((item.observationTreatmentDbId!==null)?item.observationTreatmentDbId:'')}
                                </TableCell>
