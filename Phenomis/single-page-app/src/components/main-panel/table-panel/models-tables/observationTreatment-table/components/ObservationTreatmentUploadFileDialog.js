...
export default function ObservationTreatmentUploadFileDialog(props) {
  ...
  const handleSubmit = (event) => {
    if(file.current !== undefined && file.current !== null) {
      ...
      let query = 'mutation{ bulkAddObservationTreatmentCsv{ observationTreatmentDbId} }'
  ...
  return (
    ...
    >
      <DialogTitle>
      { t('modelPanels.uploading') + ' ObservationTreatments' }
        <div>
...
ObservationTreatmentUploadFileDialog.propTypes = {
