  ...
  */
  ...
  const getData = useCallback(() => {
    ...
    */
    ...
    let cancelableApiReq = makeCancelable(api.ontologyReference.getScalesConnection(
      graphqlServerUrl, 
      item.ontologyDbId,
      label,
      sublabel,
    ...
    cancelableApiReq
      ...
      .then(response => {
        ...
        if (
          ...
          //save response data
          let newCount = response.data.data.readOneOntologyReference.countFilteredScales;
          let its = response.data.data.readOneOntologyReference.scalesConnection.edges.map(o => o.node);
          let pi = response.data.data.readOneOntologyReference.scalesConnection.pageInfo;
