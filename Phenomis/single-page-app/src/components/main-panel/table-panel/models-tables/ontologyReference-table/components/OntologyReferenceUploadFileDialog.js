...
export default function OntologyReferenceUploadFileDialog(props) {
  ...
  const handleSubmit = (event) => {
    if(file.current !== undefined && file.current !== null) {
      ...
      let query = 'mutation{ bulkAddOntologyReferenceCsv{ ontologyDbId} }'
  ...
  return (
    ...
    >
      <DialogTitle>
      { t('modelPanels.uploading') + ' OntologyReferences' }
        <div>
...
OntologyReferenceUploadFileDialog.propTypes = {
