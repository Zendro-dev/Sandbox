...
export default function ObservationVariablesToRemoveTransferView(props) {
  ...
  */
  ...
  const getData = useCallback(() => {
    ...
    */
    let label = 'ObservationVariableName';
    let sublabel = '';
    let variables = {
      pagination: {
    ...
    let cancelableApiReq = makeCancelable(api.ontologyReference.getObservationVariablesConnection(
      graphqlServerUrl, 
      item.ontologyDbId,
      label,
      sublabel,
    ...
    cancelableApiReq
      ...
      .then(response => {
        ...
        if (
          ...
          //save response data
          let newCount = response.data.data.readOneOntologyReference.countFilteredObservationVariables;
          let its = response.data.data.readOneOntologyReference.observationVariablesConnection.edges.map(o => o.node);
          let pi = response.data.data.readOneOntologyReference.observationVariablesConnection.pageInfo;
