  ...
  */
  ...
  const getData = useCallback(() => {
    ...
    */
    ...
    let cancelableApiReq = makeCancelable(api.ontologyReference.getMethodsConnection(
      graphqlServerUrl, 
      item.ontologyDbId,
      label,
      sublabel,
    ...
    cancelableApiReq
      ...
      .then(response => {
        ...
        if (
          ...
          //save response data
          let newCount = response.data.data.readOneOntologyReference.countFilteredMethods;
          let its = response.data.data.readOneOntologyReference.methodsConnection.edges.map(o => o.node);
          let pi = response.data.data.readOneOntologyReference.methodsConnection.pageInfo;
