  ...
  */
  ...
  const getData = useCallback(() => {
    ...
    */
    ...
    let cancelableApiReq = makeCancelable(api.ontologyReference.getTraitsConnection(
      graphqlServerUrl, 
      item.ontologyDbId,
      label,
      sublabel,
    ...
    cancelableApiReq
      ...
      .then(response => {
        ...
        if (
          ...
          //save response data
          let newCount = response.data.data.readOneOntologyReference.countFilteredTraits;
          let its = response.data.data.readOneOntologyReference.traitsConnection.edges.map(o => o.node);
          let pi = response.data.data.readOneOntologyReference.traitsConnection.pageInfo;
