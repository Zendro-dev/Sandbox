...
import ObservationUnitToEventAssociationsMenuTabs from './ObservationUnit_to_eventAssociationsMenuTabs'
...
export default function ObservationUnitToEventAssociationsPage(props) {
    ...
    <Fade in={!deleted} timeout={500}>
      ...
      > 
        ...
        <Grid item xs={12} sm={10} md={9} lg={8} xl={7} className={classes.menu}>
          <ObservationUnitToEventAssociationsMenuTabs
...
ObservationUnitToEventAssociationsPage.propTypes = {
