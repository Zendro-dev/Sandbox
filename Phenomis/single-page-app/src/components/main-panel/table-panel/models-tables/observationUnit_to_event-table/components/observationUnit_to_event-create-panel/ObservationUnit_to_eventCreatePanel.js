...
export default function ObservationUnitToEventCreatePanel(props) {
  ...
  function doSave(event) {
    ...
    */
    let cancelableApiReq = makeCancelable(api.observationUnit_to_event.createItem(graphqlServerUrl, variables));
      ...
      .then(response => {
        ...
        if (
          ...
          if(response.data.errors) {
            ...
            onClose(event, true, response.data.data.addObservationUnit_to_event);
          }
          return;
      ...
      <AppBar>
        <Toolbar>
          ...
          <Typography variant="h6" className={classes.title}>
            {t('modelPanels.new') + ' ObservationUnit_to_event'}
          </Typography>
...
ObservationUnitToEventCreatePanel.propTypes = {
