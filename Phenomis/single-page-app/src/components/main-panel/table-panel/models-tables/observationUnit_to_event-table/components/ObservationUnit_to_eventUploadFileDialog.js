...
export default function ObservationUnitToEventUploadFileDialog(props) {
  ...
  const handleSubmit = (event) => {
    if(file.current !== undefined && file.current !== null) {
      ...
      let query = 'mutation{ bulkAddObservationUnit_to_eventCsv{ id} }'
  ...
  return (
    ...
    >
      <DialogTitle>
      { t('modelPanels.uploading') + ' ObservationUnit_to_events' }
        <div>
...
ObservationUnitToEventUploadFileDialog.propTypes = {
