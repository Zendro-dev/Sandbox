...
export default function ObservationUnitToEventEnhancedTableToolbar(props) {
                        ...
                        <Grid item xs={12}>
                          <Grid container justify="center">
                            {/* Add */}
                            {
                              ...
                              &&(permissions.observationUnit_to_event.includes('create') || permissions.observationUnit_to_event.includes('*')))
                              &&(
                                <Grid item>
                                  <Tooltip title={t('modelPanels.addNew') + " observationUnit_to_event"}>
                                    <IconButton
                                      color="primary"
                                  ...
                                  >
                                    ...
                                    <Grid item xs={12}>
                                      <Grid container justify='flex-start'>
                                        ...
                                        <input type="hidden" name="model" value='observationUnit_to_event' />
                                          <ButtonBase
...
ObservationUnitToEventEnhancedTableToolbar.propTypes = {
