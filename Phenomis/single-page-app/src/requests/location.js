...
export default {
   ...
   * 
   * Get observationUnits connection (cursor based) records associated to the given location record
  ...
  getObservationUnitsConnection(url, itemId, label, sublabel, searchText, variables, ops) {
    ...
    var query = (s) ?
      `query readOneLocation($pagination: paginationCursorInput) {
        readOneLocation(locationDbId: "${itemId}") { 
   ...
   * 
   * Get the observationUnit-ids associated (by cursor based connection) to the given location record 
   * through association 'ObservationUnits', from GraphQL Server.
   * 
   * @param {String} url GraphQL Server url
   * @param {Number} itemId Model item internalId.
   ...
   * 
   * Get studies connection (cursor based) records associated to the given location record
   ...
   * 
   * Get the study-ids associated (by cursor based connection) to the given location record 
   * through association 'Studies', from GraphQL Server.
   * 
   * @param {String} url GraphQL Server url
   * @param {Number} itemId Model item internalId.
