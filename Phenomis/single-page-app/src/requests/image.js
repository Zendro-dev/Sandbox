...
export default {
  ...
  getItemsConnection(url, searchText, orderBy, orderDirection, variables, ops) {
    ...
    if (s !== null) {
      ...
      if (o != null) {
        ...
        query =
          `query imagesConnection($pagination: paginationCursorInput)
            { imagesConnection( ${s}, ${o}, pagination: $pagination ) {
              ${qbody}
            }}`
      }
      else {
      ...
      if (o != null) {
        ...
        query =
          `query imagesConnection($pagination: paginationCursorInput)
          { imagesConnection( ${o}, pagination: $pagination ) {
            ${qbody}
          }}`
      }
      else {
   ...
   * 
   * Get observations connection (cursor based) records associated to the given image record
  ...
  getObservationsConnection(url, itemId, label, sublabel, searchText, variables, ops) {
    ...
    var query = (s) ?
      `query readOneImage($pagination: paginationCursorInput) {
   ...
   * 
   * Get the observation-ids associated (by cursor based connection) to the given image record 
   * through association 'Observations', from GraphQL Server.
   * 
   * @param {String} url GraphQL Server url
   * @param {Number} itemId Model item internalId.
   ...
   * 
   * Get observationUnits connection (cursor based) records associated to the given image record
   ...
   * 
   * Get the observationUnit-ids associated (by cursor based connection) to the given image record 
   * through association 'ObservationUnit', from GraphQL Server.
   * 
   * @param {String} url GraphQL Server url
   * @param {Number} itemId Model item internalId.
