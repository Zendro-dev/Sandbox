...
export default {
  ...
  getCountItems(url, searchText, ops) {
    ...
    //if has search
    if (s !== null) {
      query = `{ countObservations(${s}) }`;
    }
    else {
      query = `{ countObservations }`;
    }
  ...
  getItemsConnection(url, searchText, orderBy, orderDirection, variables, ops) {
    ...
    var qbody = `
          ...
          edges {
            node {
              ...
              observationVariable{ observationVariableDbId },
              season{ seasonDbId },
              study{ studyDbId },
            }
          }`
    ...
    if (s !== null) {
      ...
      if (o != null) {
        ...
        query =
          `query observationsConnection($pagination: paginationCursorInput)
            { observationsConnection( ${s}, ${o}, pagination: $pagination ) {
              ${qbody}
            }}`
      }
      else {
      ...
      if (o != null) {
        ...
        query =
          `query observationsConnection($pagination: paginationCursorInput)
          { observationsConnection( ${o}, pagination: $pagination ) {
            ${qbody}
          }}`
      }
      else {
   ...
   * 
   * Get germplasms connection (cursor based) records associated to the given observation record
   ...
   * 
   * Get the germplasm-ids associated (by cursor based connection) to the given observation record 
   * through association 'Germplasm', from GraphQL Server.
   * 
   * @param {String} url GraphQL Server url
   * @param {Number} itemId Model item internalId.
   ...
   * getImageConnection
   * 
   * Get images connection (cursor based) records associated to the given observation record
   ...
   * @param {String} ops Object with adittional query options.
   */
  getImageConnection(url, itemId, label, sublabel, searchText, variables, ops) {
    var query = 
      `{ readOneObservation(observationDbId: "${itemId}") { 
        image{ 
          copyright,
   ...
   * 
   *  
   * getAssociatedImageConnection
   * 
   * Get the image-ids associated (by cursor based connection) to the given observation record 
   * through association 'Image', from GraphQL Server.
   * 
   * @param {String} url GraphQL Server url
   * @param {Number} itemId Model item internalId.
   */
  getAssociatedImageConnection(url, itemId) {
    var query = 
    `{ readOneObservation( observationDbId: "${itemId}" ){ 
      image{ imageDbId } } }`;
    /**
   ...
   * 
   * Get observationUnits connection (cursor based) records associated to the given observation record
   ...
   * 
   * Get the observationUnit-ids associated (by cursor based connection) to the given observation record 
   * through association 'ObservationUnit', from GraphQL Server.
   * 
   * @param {String} url GraphQL Server url
   * @param {Number} itemId Model item internalId.
  ...
  /**
   * getObservationVariableConnection
   * 
   * Get observationVariables connection (cursor based) records associated to the given observation record
   ...
   * @param {String} ops Object with adittional query options.
   */
  getObservationVariableConnection(url, itemId, label, sublabel, searchText, variables, ops) {
    var query = 
      `{ readOneObservation(observationDbId: "${itemId}") { 
        observationVariable{ 
          commonCropName,
   ...
   * 
   *  
   * getAssociatedObservationVariableConnection
   * 
   * Get the observationVariable-ids associated (by cursor based connection) to the given observation record 
   * through association 'ObservationVariable', from GraphQL Server.
   * 
   * @param {String} url GraphQL Server url
   * @param {Number} itemId Model item internalId.
   */
  getAssociatedObservationVariableConnection(url, itemId) {
    var query = 
    `{ readOneObservation( observationDbId: "${itemId}" ){ 
      observationVariable{ observationVariableDbId } } }`;
    /**
   ...
   * getSeasonConnection
   * 
   * Get seasons connection (cursor based) records associated to the given observation record
   ...
   * 
   * Get the season-ids associated (by cursor based connection) to the given observation record 
   * through association 'Season', from GraphQL Server.
   * 
   * @param {String} url GraphQL Server url
   * @param {Number} itemId Model item internalId.
   ...
   * getStudyConnection
   * 
   * Get studies connection (cursor based) records associated to the given observation record
   ...
   * 
   * Get the study-ids associated (by cursor based connection) to the given observation record 
   * through association 'Study', from GraphQL Server.
   * 
   * @param {String} url GraphQL Server url
   * @param {Number} itemId Model item internalId.
