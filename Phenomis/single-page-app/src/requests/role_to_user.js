...
export default {
  ...
  getCountItems(url, searchText, ops) {
    //search
    var s = getSearchArgument('role_to_user', searchText, ops);
    
    var query = '';

    //if has search
    if (s !== null) {
      query = `{ countRole_to_users(${s}) }`;
    }
    else {
      query = `{ countRole_to_users }`;
    }
  ...
  getItemsConnection(url, searchText, orderBy, orderDirection, variables, ops) {
    ...
    if (s !== null) {
      ...
      if (o != null) {
        ...
        query =
          `query role_to_usersConnection($pagination: paginationCursorInput)
            { role_to_usersConnection( ${s}, ${o}, pagination: $pagination ) {
              ${qbody}
            }}`
      }
      else {
        ...
        query =
          `query role_to_usersConnection($pagination: paginationCursorInput)
            { role_to_usersConnection( ${s}, pagination: $pagination ) {
              ${qbody}
            }}`
      }
    }
      ...
      if (o != null) {
        ...
        query =
          `query role_to_usersConnection($pagination: paginationCursorInput)
          { role_to_usersConnection( ${o}, pagination: $pagination ) {
            ${qbody}
          }}`
      }
      else {
