...
export default {
  ...
  getItemsConnection(url, searchText, orderBy, orderDirection, variables, ops) {
    ...
    if (s !== null) {
      ...
      if (o != null) {
        ...
        query =
          `query methodsConnection($pagination: paginationCursorInput)
            { methodsConnection( ${s}, ${o}, pagination: $pagination ) {
              ${qbody}
            }}`
      }
      else {
      ...
      if (o != null) {
        ...
        query =
          `query methodsConnection($pagination: paginationCursorInput)
          { methodsConnection( ${o}, pagination: $pagination ) {
            ${qbody}
          }}`
      }
      else {
   ...
   * 
   * Get observationVariables connection (cursor based) records associated to the given method record
  ...
  getObservationVariablesConnection(url, itemId, label, sublabel, searchText, variables, ops) {
    ...
    var query = (s) ?
      `query readOneMethod($pagination: paginationCursorInput) {
   ...
   * 
   * Get the observationVariable-ids associated (by cursor based connection) to the given method record 
   * through association 'ObservationVariables', from GraphQL Server.
   * 
   * @param {String} url GraphQL Server url
   * @param {Number} itemId Model item internalId.
   ...
   * 
   * Get ontologyReferences connection (cursor based) records associated to the given method record
   ...
   * 
   * Get the ontologyReference-ids associated (by cursor based connection) to the given method record 
   * through association 'OntologyReference', from GraphQL Server.
   * 
   * @param {String} url GraphQL Server url
   * @param {Number} itemId Model item internalId.
