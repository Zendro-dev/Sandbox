...
module.exports = class taxon extends Sequelize.Model {
    ...
    static associate(models) {
        taxon.hasOne(models.taxon, {
            as: 'parent',
            foreignKey: 'taxon_id'
        });
        taxon.hasMany(models.microbiome_asv, {
            as: 'microbiome_asvs',
            foreignKey: 'taxon_id'
        });
        taxon.hasMany(models.cultivar, {
            as: 'cultivars',
            foreignKey: 'taxon_id'
        });
    }
    ...
    static async readById(id) {
        let item = await taxon.findByPk(id);
        if (item === null) {
    ...
    static bulkAddCsv(context) {
        ...
        return `Bulk import of taxon records started. You will be send an email to ${helpersAcl.getTokenFromContext(context).email} informing you about success or errors`;
    }
    ...
    static async add_taxon_id(id, taxon_id) {
        let updated = await taxon.update({
            taxon_id: taxon_id
        }, {
            where: {
                id: id
    ...
    /**
     * bulkAssociateTaxonWithTaxon_id - bulkAssociaton of given ids
     *
     * @param  {array} bulkAssociationInput Array of associations to add
     * @param  {BenignErrorReporter} benignErrorReporter Error Reporter used for reporting Errors from remote zendro services
     * @return {string} returns message on success
     */
    static async bulkAssociateTaxonWithTaxon_id(bulkAssociationInput) {
    ...
    /**
     * bulkDisAssociateTaxonWithTaxon_id - bulkDisAssociaton of given ids
     *
     * @param  {array} bulkAssociationInput Array of associations to remove
     * @param  {BenignErrorReporter} benignErrorReporter Error Reporter used for reporting Errors from remote zendro services
     * @return {string} returns message on success
     */
    static async bulkDisAssociateTaxonWithTaxon_id(bulkAssociationInput) {
        let mappedForeignKeys = helper.mapForeignKeysToPrimaryKeyArray(bulkAssociationInput, "id", "taxon_id");
        var promises = [];
        mappedForeignKeys.forEach(({
            taxon_id,
