...
module.exports = class cultivar extends Sequelize.Model {
    ...
    static associate(models) {
        ...
        cultivar.hasMany(models.individual, {
            as: 'individuals',
    ...
    static async readById(id) {
        let item = await cultivar.findByPk(id);
        if (item === null) {
    ...
    static bulkAddCsv(context) {
        ...
        return `Bulk import of cultivar records started. You will be send an email to ${helpersAcl.getTokenFromContext(context).email} informing you about success or errors`;
    }
    ...
    static async add_taxon_id(id, taxon_id) {
        let updated = await cultivar.update({
            taxon_id: taxon_id
        }, {
            where: {
                id: id
    ...
    /**
     * bulkAssociateCultivarWithTaxon_id - bulkAssociaton of given ids
     *
     * @param  {array} bulkAssociationInput Array of associations to add
     * @param  {BenignErrorReporter} benignErrorReporter Error Reporter used for reporting Errors from remote zendro services
     * @return {string} returns message on success
     */
    static async bulkAssociateCultivarWithTaxon_id(bulkAssociationInput) {
    ...
    /**
     * bulkDisAssociateCultivarWithTaxon_id - bulkDisAssociaton of given ids
     *
     * @param  {array} bulkAssociationInput Array of associations to remove
     * @param  {BenignErrorReporter} benignErrorReporter Error Reporter used for reporting Errors from remote zendro services
     * @return {string} returns message on success
     */
    static async bulkDisAssociateCultivarWithTaxon_id(bulkAssociationInput) {
        let mappedForeignKeys = helper.mapForeignKeysToPrimaryKeyArray(bulkAssociationInput, "id", "taxon_id");
        var promises = [];
        mappedForeignKeys.forEach(({
            taxon_id,
     ...
     */
    static idAttribute() {
        return cultivar.definition.id.name;
    }
    ...
    static idAttributeType() {
        return cultivar.definition.id.type;
    }

    /**
     * getIdValue - Get the value of the idAttribute ("id", or "internalId") for an instance of cultivar.
     *
     * @return {type} id value
     */
    getIdValue() {
        return this[cultivar.idAttribute()]
    }
    ...
    stripAssociations() {
        let attributes = Object.keys(cultivar.definition.attributes);
        attributes.push('id');
