...
module.exports = {
    ...
    country_to_rivers: async function({
        ...
        if (await checkAuthorization(context, 'country_to_river', 'read') === true) {
            helper.checkCountAndReduceRecordsLimit(pagination.limit, context, "country_to_rivers");
    ...
    country_to_riversConnection: async function({
        ...
        if (await checkAuthorization(context, 'country_to_river', 'read') === true) {
            ...
            helper.checkCountAndReduceRecordsLimit(limit, context, "country_to_riversConnection");
            let benignErrorReporter = new errorHelper.BenignErrorReporter(context);
    ...
    readOneCountry_to_river: async function({
        ...
        if (await checkAuthorization(context, 'country_to_river', 'read') === true) {
            helper.checkCountAndReduceRecordsLimit(1, context, "readOneCountry_to_river");
            let benignErrorReporter = new errorHelper.BenignErrorReporter(context);
