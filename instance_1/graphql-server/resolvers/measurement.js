...
module.exports = {
    ...
    measurements: async function({
        ...
        if (await checkAuthorization(context, 'Measurement', 'read') === true) {
            helper.checkCountAndReduceRecordsLimit(pagination.limit, context, "measurements");
    ...
    measurementsConnection: async function({
        ...
        if (await checkAuthorization(context, 'Measurement', 'read') === true) {
            ...
            helper.checkCountAndReduceRecordsLimit(limit, context, "measurementsConnection");
            let benignErrorReporter = new errorHelper.BenignErrorReporter(context);
    ...
    readOneMeasurement: async function({
        ...
        if (await checkAuthorization(context, 'Measurement', 'read') === true) {
            helper.checkCountAndReduceRecordsLimit(1, context, "readOneMeasurement");
            let benignErrorReporter = new errorHelper.BenignErrorReporter(context);
