...
module.exports = class sq_book {
     ...
     * @param {Array}   author_ids Foreign Key (stored in "Me") of the Association to be updated.
     * @param {BenignErrorReporter} benignErrorReporter Error Reporter used for reporting Errors from remote zendro services
     */
    static async add_author_ids(id, author_ids, benignErrorReporter, handle_inverse = true) {
        let responsibleAdapter = this.adapterForIri(id);
        return await adapters[responsibleAdapter].add_author_ids(id, author_ids, benignErrorReporter, handle_inverse);
    }
    ...
    static async remove_author_ids(id, author_ids, benignErrorReporter, handle_inverse = true) {
        let responsibleAdapter = this.adapterForIri(id);
        return await adapters[responsibleAdapter].remove_author_ids(id, author_ids, benignErrorReporter, handle_inverse);
    }
