...
module.exports = class sq_author {
    ...
    static idAttribute() {
        let internalId = sq_author.definition.id.name;
        return internalId;
    }
    ...
    static async addOne(input, benignErrorReporter) {
        ...
        //use default BenignErrorReporter if no BenignErrorReporter defined
        benignErrorReporter = errorHelper.getDefaultBenignErrorReporterIfUndef(benignErrorReporter);
        return adapters[responsibleAdapter].addOne(input, benignErrorReporter).then(result => new sq_author(result));
    }
    ...
    static async updateOne(input, benignErrorReporter) {
        ...
        //use default BenignErrorReporter if no BenignErrorReporter defined
        benignErrorReporter = errorHelper.getDefaultBenignErrorReporterIfUndef(benignErrorReporter);
        return adapters[responsibleAdapter].updateOne(input, benignErrorReporter).then(result => new sq_author(result));
