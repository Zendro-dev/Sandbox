    ...
    static async readAll(search, order, pagination, benignErrorReporter) {
      ...
      int_post_books(search:$search pagination:$pagination order:$order){id          title
        ...
        try {
            ...
            // NO ERROR as such has been detected by the server (Express)
            // check if data was send
            if (response && response.data && response.data.data && response.data.data.int_post_books !== null) {
    ...
    static async readAllCursor(search, order, pagination, benignErrorReporter) {
      ...
      int_post_booksConnection(search:$search pagination:$pagination order:$order){ edges{cursor node{  id  title
        ...
        try {
            ...
            // NO ERROR as such has been detected by the server (Express)
            // check if data was send
            if (response && response.data && response.data.data && response.data.data.int_post_booksConnection !== null) {
                ...
                let nodes_model = valid_nodes.map(e => new int_post_book(e));
