...
module.exports = class author_local extends Sequelize.Model {
    ...
    static async readById(id) {
        let item = await author_local.findByPk(id);
        if (item === null) {
            throw new Error(`Record with ID = "${id}" does not exist`);
        }
        item = author_local.postReadCast(item)
        return item;
    }
    ...
    static async addOne(input) {
        input = author_local.preWriteCast(input)
        try {
            ...
            author_local.postReadCast(result.dataValues)
            author_local.postReadCast(result._previousDataValues)
            return result;
        } catch (error) {
            throw error;
        }
    ...
    static bulkAddCsv(context) {
        ...
        return `Bulk import of author_local records started. You will be send an email to ${helpersAcl.getTokenFromContext(context).email} informing you about success or errors`;
    }

    static csvTableTemplate() {
        return helper.csvTableTemplate(sq_author);
    }
    ...
    static idAttribute() {
        return author_local.definition.id.name;
    }
    ...
    static idAttributeType() {
        return author_local.definition.id.type;
    }
    ...
    getIdValue() {
        return this[author_local.idAttribute()]
    }
    ...
    stripAssociations() {
        let attributes = Object.keys(author_local.definition.attributes);
