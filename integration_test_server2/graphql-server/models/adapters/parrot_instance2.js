...
module.exports = class parrot_instance2 extends Sequelize.Model {
    ...
    static async readById(id) {
        let item = await parrot_instance2.findByPk(id);
        if (item === null) {
    ...
    static bulkAddCsv(context) {
        ...
        return `Bulk import of parrot_instance2 records started. You will be send an email to ${helpersAcl.getTokenFromContext(context).email} informing you about success or errors`;
    }
    ...
    static idAttribute() {
        return parrot_instance2.definition.id.name;
    }
    ...
    static idAttributeType() {
        return parrot_instance2.definition.id.type;
    }
    ...
    getIdValue() {
        return this[parrot_instance2.idAttribute()]
    }
    ...
    stripAssociations() {
        let attributes = Object.keys(parrot_instance2.definition.attributes);
