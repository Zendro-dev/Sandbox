...
module.exports = class person_instance2 extends Sequelize.Model {
    ...
    static async readById(id) {
        let item = await person_instance2.findByPk(id);
        if (item === null) {
            ...
            if (pagination) {
                ...
                if (isForwardPagination) {
                    if (pagination.after) {
                        ...
                        options['where'] = {
                            ...options['where'],
                            ...helper.parseOrderCursor(options['order'], decoded_cursor, "person_id", pagination.includeCursor)
                        };
                    }
                } else { //backward
                    if (pagination.before) {
                        ...
                        options['where'] = {
                            ...options['where'],
                            ...helper.parseOrderCursorBefore(options['order'], decoded_cursor, "person_id", pagination.includeCursor)
                        };
                    }
                }
            }
    ...
    static bulkAddCsv(context) {
        ...
        return `Bulk import of person_instance2 records started. You will be send an email to ${helpersAcl.getTokenFromContext(context).email} informing you about success or errors`;
    }
    ...
    static idAttribute() {
        return person_instance2.definition.id.name;
    }
    ...
    static idAttributeType() {
        return person_instance2.definition.id.type;
    }
    ...
    getIdValue() {
        return this[person_instance2.idAttribute()]
    }
    ...
    stripAssociations() {
        let attributes = Object.keys(person_instance2.definition.attributes);
