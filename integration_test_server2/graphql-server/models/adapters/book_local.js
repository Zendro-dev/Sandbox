...
module.exports = class book_local extends Sequelize.Model {
    ...
    static countRecords(search) {
        ...
        if (search !== undefined && search !== null) {
            ...
            let arg_sequelize = arg.toSequelize(book_local.definition.attributes);
    ...
    static async readAllCursor(search, order, pagination) {
        ...
        let options = helper.buildCursorBasedSequelizeOptions(search, order, pagination, this.idAttribute(), book_local.definition.attributes);
        ...
        if (pagination && (pagination.after || pagination.before)) {
            let oppOptions = helper.buildOppositeSearchSequelize(search, order, {
                ...pagination,
                includeCursor: false
            }, this.idAttribute(), book_local.definition.attributes);
