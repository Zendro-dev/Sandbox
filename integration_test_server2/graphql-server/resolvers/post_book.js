...
module.exports = {
    ...
    post_books: async function({
        ...
        if (await checkAuthorization(context, 'post_book', 'read') === true) {
            helper.checkCountAndReduceRecordsLimit(pagination.limit, context, "post_books");
    ...
    post_booksConnection: async function({
        ...
        if (await checkAuthorization(context, 'post_book', 'read') === true) {
            ...
            helper.checkCountAndReduceRecordsLimit(limit, context, "post_booksConnection");
            let benignErrorReporter = new errorHelper.BenignErrorReporter(context);
    ...
    readOnePost_book: async function({
        ...
        if (await checkAuthorization(context, 'post_book', 'read') === true) {
            helper.checkCountAndReduceRecordsLimit(1, context, "readOnePost_book");
            let benignErrorReporter = new errorHelper.BenignErrorReporter(context);
