...
const definition = {
    ...
    adapterName: 'ontologyReference_PHIS',
    regex: 'phis',
    attributes: {
...
module.exports = class ontologyReference_PHIS extends Sequelize.Model {
    ...
    static async readById(id) {
        let item = await ontologyReference_PHIS.findByPk(id);
        if (item === null) {
    ...
    static idAttribute() {
        return ontologyReference_PHIS.definition.id.name;
    }
    ...
    static idAttributeType() {
        return ontologyReference_PHIS.definition.id.type;
    }
    ...
    getIdValue() {
        return this[ontologyReference_PHIS.idAttribute()]
    }
    ...
    stripAssociations() {
        let attributes = Object.keys(ontologyReference_PHIS.definition.attributes);
