...
const definition = {
    ...
    adapterName: 'observationUnitPosition_PHIS',
    regex: 'phis',
    attributes: {
        blockNumber: 'String',
        entryNumber: 'String',
...
module.exports = class observationUnitPosition_PHIS extends Sequelize.Model {
    ...
    static async readById(id) {
        let item = await observationUnitPosition_PHIS.findByPk(id);
        if (item === null) {
    ...
    static idAttribute() {
        return observationUnitPosition_PHIS.definition.id.name;
    }
    ...
    static idAttributeType() {
        return observationUnitPosition_PHIS.definition.id.type;
    }
    ...
    getIdValue() {
        return this[observationUnitPosition_PHIS.idAttribute()]
    }
    ...
    stripAssociations() {
        let attributes = Object.keys(observationUnitPosition_PHIS.definition.attributes);
