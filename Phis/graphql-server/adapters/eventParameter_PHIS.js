...
const definition = {
    ...
    adapterName: 'eventParameter_PHIS',
    regex: 'phis',
    attributes: {
        key: 'String',
        rdfValue: 'String',
...
module.exports = class eventParameter_PHIS extends Sequelize.Model {
    ...
    static async readById(id) {
        let item = await eventParameter_PHIS.findByPk(id);
        if (item === null) {
    ...
    static idAttribute() {
        return eventParameter_PHIS.definition.id.name;
    }
    ...
    static idAttributeType() {
        return eventParameter_PHIS.definition.id.type;
    }
    ...
    getIdValue() {
        return this[eventParameter_PHIS.idAttribute()]
    }
    ...
    stripAssociations() {
        let attributes = Object.keys(eventParameter_PHIS.definition.attributes);
