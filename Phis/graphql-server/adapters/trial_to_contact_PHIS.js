...
const definition = {
    ...
    adapterName: 'trial_to_contact_PHIS',
    regex: 'phis',
    attributes: {
        trialDbId: 'String',
        contactDbId: 'String'
...
module.exports = class trial_to_contact_PHIS extends Sequelize.Model {
    ...
    static async readById(id) {
        let item = await trial_to_contact_PHIS.findByPk(id);
        if (item === null) {
    ...
    static idAttribute() {
        return trial_to_contact_PHIS.definition.id.name;
    }
    ...
    static idAttributeType() {
        return trial_to_contact_PHIS.definition.id.type;
    }
    ...
    getIdValue() {
        return this[trial_to_contact_PHIS.idAttribute()]
    }
    ...
    stripAssociations() {
        let attributes = Object.keys(trial_to_contact_PHIS.definition.attributes);
        attributes.push('id');
