...
const definition = {
    ...
    adapterName: 'observationUnit_to_event_PHIS',
    regex: 'phis',
    attributes: {
...
module.exports = class observationUnit_to_event_PHIS extends Sequelize.Model {
    ...
    static get adapterName() {
        return 'observationUnit_to_event_PHIS';
    }
    ...
    static async readById(id) {
        let item = await observationUnit_to_event_PHIS.findByPk(id);
        if (item === null) {
    ...
    static idAttribute() {
        return observationUnit_to_event_PHIS.definition.id.name;
    }
    ...
    static idAttributeType() {
        return observationUnit_to_event_PHIS.definition.id.type;
    }
    ...
    getIdValue() {
        return this[observationUnit_to_event_PHIS.idAttribute()]
    }
    ...
    stripAssociations() {
        let attributes = Object.keys(observationUnit_to_event_PHIS.definition.attributes);
        attributes.push('id');
