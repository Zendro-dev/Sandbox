...
module.exports = class program_PHIS extends Sequelize.Model {
    ...
    static async readById(id) {
        let item = await program_PHIS.findByPk(id);
        if (item === null) {
    ...
    static idAttribute() {
        return program_PHIS.definition.id.name;
    }
    ...
    static idAttributeType() {
        return program_PHIS.definition.id.type;
    }
    ...
    getIdValue() {
        return this[program_PHIS.idAttribute()]
    }
    ...
    stripAssociations() {
        let attributes = Object.keys(program_PHIS.definition.attributes);
