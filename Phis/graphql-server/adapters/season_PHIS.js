...
module.exports = class season_PHIS extends Sequelize.Model {
    ...
    static async readById(id) {
        let item = await season_PHIS.findByPk(id);
        if (item === null) {
    ...
    static idAttribute() {
        return season_PHIS.definition.id.name;
    }
    ...
    static idAttributeType() {
        return season_PHIS.definition.id.type;
    }
    ...
    getIdValue() {
        return this[season_PHIS.idAttribute()]
    }
    ...
    stripAssociations() {
        let attributes = Object.keys(season_PHIS.definition.attributes);
