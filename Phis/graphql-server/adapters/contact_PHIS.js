...
module.exports = class contact_PHIS extends Sequelize.Model {
    ...
    static async readById(id) {
        let item = await contact_PHIS.findByPk(id);
        if (item === null) {
    ...
    static idAttribute() {
        return contact_PHIS.definition.id.name;
    }
    ...
    static idAttributeType() {
        return contact_PHIS.definition.id.type;
    }
    ...
    getIdValue() {
        return this[contact_PHIS.idAttribute()]
    }
    ...
    stripAssociations() {
        let attributes = Object.keys(contact_PHIS.definition.attributes);
