...
const definition = {
    ...
    adapterName: 'observationUnit_PHIS',
    regex: 'phis',
    attributes: {
...
module.exports = class observationUnit_PHIS extends Sequelize.Model {
    ...
    static async readById(id) {
        let item = await observationUnit_PHIS.findByPk(id);
        if (item === null) {
    ...
    static idAttribute() {
        return observationUnit_PHIS.definition.id.name;
    }
    ...
    static idAttributeType() {
        return observationUnit_PHIS.definition.id.type;
    }
    ...
    getIdValue() {
        return this[observationUnit_PHIS.idAttribute()]
    }
    ...
    stripAssociations() {
        let attributes = Object.keys(observationUnit_PHIS.definition.attributes);
