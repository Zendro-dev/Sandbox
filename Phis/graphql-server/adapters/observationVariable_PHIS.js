...
const definition = {
    ...
    adapterName: 'observationVariable_PHIS',
    regex: 'phis',
    attributes: {
...
module.exports = class observationVariable_PHIS extends Sequelize.Model {
    ...
    static async readById(id) {
        let item = await observationVariable_PHIS.findByPk(id);
        if (item === null) {
    ...
    static idAttribute() {
        return observationVariable_PHIS.definition.id.name;
    }
    ...
    static idAttributeType() {
        return observationVariable_PHIS.definition.id.type;
    }
    ...
    getIdValue() {
        return this[observationVariable_PHIS.idAttribute()]
    }
    ...
    stripAssociations() {
        let attributes = Object.keys(observationVariable_PHIS.definition.attributes);
