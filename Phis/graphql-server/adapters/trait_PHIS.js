...
module.exports = class trait_PHIS extends Sequelize.Model {
    ...
    static idAttribute() {
        return trait_PHIS.definition.id.name;
    }
    ...
    static idAttributeType() {
        return trait_PHIS.definition.id.type;
    }
    ...
    getIdValue() {
        return this[trait_PHIS.idAttribute()]
    }
    ...
    stripAssociations() {
        let attributes = Object.keys(trait_PHIS.definition.attributes);
