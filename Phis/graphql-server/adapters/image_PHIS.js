...
module.exports = class image_PHIS extends Sequelize.Model {
    ...
    static async readById(id) {
        let item = await image_PHIS.findByPk(id);
        if (item === null) {
    ...
    static idAttribute() {
        return image_PHIS.definition.id.name;
    }
    ...
    static idAttributeType() {
        return image_PHIS.definition.id.type;
    }
    ...
    getIdValue() {
        return this[image_PHIS.idAttribute()]
    }
    ...
    stripAssociations() {
        let attributes = Object.keys(image_PHIS.definition.attributes);
