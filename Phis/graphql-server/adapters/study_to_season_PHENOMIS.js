...
module.exports = class study_to_season_PHENOMIS {

    static get adapterName() {
        return 'study_to_season_PHENOMIS';
    }
    ...
    static readById(iri) {
        let query = `
          query
            readOneStudy_to_season
            {
              readOneStudy_to_season(id:"${iri}")
              {
                id 
                studyDbId 
                seasonDbId 
        ...
        return axios.post(remoteCenzontleURL, {
            ...
            if (res && res.data && res.data.data) {
                return res.data.data.readOneStudy_to_season;
            } else {
    ...
    static countRecords(search) {
        let query = `
      query countStudy_to_seasons($search: searchStudy_to_seasonInput){
        countStudy_to_seasons(search: $search)
      }`
        ...
        return axios.post(remoteCenzontleURL, {
            ...
            //check
            if (res && res.data && res.data.data) {
                return res.data.data.countStudy_to_seasons;
            } else {
                throw new Error(`Invalid response from remote cenz-server: ${remoteCenzontleURL}`);
            }
        }).catch(error => {
    ...
    static readAllCursor(search, order, pagination) {
        ...
        let query = `query study_to_seasonsConnection($search: searchStudy_to_seasonInput $pagination: paginationCursorInput $order: [orderStudy_to_seasonInput]){
      study_to_seasonsConnection(search:$search pagination:$pagination order:$order){ edges{cursor node{  id  studyDbId
         seasonDbId
        ...
        return axios.post(remoteCenzontleURL, {
            ...
            //check
            if (res && res.data && res.data.data) {
                return res.data.data.study_to_seasonsConnection;
            } else {
                throw new Error(`Invalid response from remote cenz-server: ${remoteCenzontleURL}`);
            }
        }).catch(error => {
    ...
    static addOne(input) {
        ...
        return axios.post(remoteCenzontleURL, {
            ...
            //check
            if (res && res.data && res.data.data) {
                return res.data.data.addStudy_to_season;
            } else {
                throw new Error(`Invalid response from remote cenz-server: ${remoteCenzontleURL}`);
            }
        }).catch(error => {
    ...
    static deleteOne(id) {
        ...
        return axios.post(remoteCenzontleURL, {
            ...
            //check
            if (res && res.data && res.data.data) {
                return res.data.data.deleteStudy_to_season;
            } else {
                throw new Error(`Invalid response from remote cenz-server: ${remoteCenzontleURL}`);
            }
        }).catch(error => {
    ...
    static csvTableTemplate() {
        ...
        return axios.post(remoteCenzontleURL, {
            ...
            //check
            if (res && res.data && res.data.data) {
                return res.data.data.csvTableTemplateStudy_to_season;
            } else {
                throw new Error(`Invalid response from remote cenz-server: ${remoteCenzontleURL}`);
            }
        }).catch(error => {
