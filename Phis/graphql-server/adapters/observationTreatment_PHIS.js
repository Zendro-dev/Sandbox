...
const definition = {
    ...
    adapterName: 'observationTreatment_PHIS',
    regex: 'phis',
    attributes: {
        factor: 'String',
        modality: 'String',
...
module.exports = class observationTreatment_PHIS extends Sequelize.Model {
    ...
    static get adapterName() {
        return 'observationTreatment_PHIS';
    }
    ...
    static async readById(id) {
        let item = await observationTreatment_PHIS.findByPk(id);
        if (item === null) {
    ...
    static idAttribute() {
        return observationTreatment_PHIS.definition.id.name;
    }
    ...
    static idAttributeType() {
        return observationTreatment_PHIS.definition.id.type;
    }
    ...
    getIdValue() {
        return this[observationTreatment_PHIS.idAttribute()]
    }
    ...
    stripAssociations() {
        let attributes = Object.keys(observationTreatment_PHIS.definition.attributes);
