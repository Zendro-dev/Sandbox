...
const definition = {
    ...
    adapterName: 'environmentParameter_PHIS',
    regex: 'phis',
    attributes: {
        description: 'String',
...
module.exports = class environmentParameter_PHIS extends Sequelize.Model {
    ...
    static get adapterName() {
        return 'environmentParameter_PHIS';
    }
    ...
    static async readById(id) {
        let item = await environmentParameter_PHIS.findByPk(id);
        if (item === null) {
    ...
    static idAttribute() {
        return environmentParameter_PHIS.definition.id.name;
    }
    ...
    static idAttributeType() {
        return environmentParameter_PHIS.definition.id.type;
    }
    ...
    getIdValue() {
        return this[environmentParameter_PHIS.idAttribute()]
    }
    ...
    stripAssociations() {
        let attributes = Object.keys(environmentParameter_PHIS.definition.attributes);
