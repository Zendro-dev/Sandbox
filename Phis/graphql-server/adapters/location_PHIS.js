...
module.exports = class location_PHIS extends Sequelize.Model {
    ...
    static async readById(id) {
        let item = await location_PHIS.findByPk(id);
        if (item === null) {
    ...
    static idAttribute() {
        return location_PHIS.definition.id.name;
    }
    ...
    static idAttributeType() {
        return location_PHIS.definition.id.type;
    }
    ...
    getIdValue() {
        return this[location_PHIS.idAttribute()]
    }
    ...
    stripAssociations() {
        let attributes = Object.keys(location_PHIS.definition.attributes);
