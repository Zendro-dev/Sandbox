...
module.exports = class event_PHIS extends Sequelize.Model {
    ...
    static async readById(id) {
        let item = await event_PHIS.findByPk(id);
        if (item === null) {
    ...
    static idAttribute() {
        return event_PHIS.definition.id.name;
    }
    ...
    static idAttributeType() {
        return event_PHIS.definition.id.type;
    }
    ...
    getIdValue() {
        return this[event_PHIS.idAttribute()]
    }
    ...
    stripAssociations() {
        let attributes = Object.keys(event_PHIS.definition.attributes);
