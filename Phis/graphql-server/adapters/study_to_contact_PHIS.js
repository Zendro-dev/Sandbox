...
const definition = {
    ...
    adapterName: 'study_to_contact_PHIS',
    regex: 'phis',
    attributes: {
        studyDbId: 'String',
        contactDbId: 'String'
...
module.exports = class study_to_contact_PHIS extends Sequelize.Model {
    ...
    static async readById(id) {
        let item = await study_to_contact_PHIS.findByPk(id);
        if (item === null) {
    ...
    static idAttribute() {
        return study_to_contact_PHIS.definition.id.name;
    }
    ...
    static idAttributeType() {
        return study_to_contact_PHIS.definition.id.type;
    }
    ...
    getIdValue() {
        return this[study_to_contact_PHIS.idAttribute()]
    }
    ...
    stripAssociations() {
        let attributes = Object.keys(study_to_contact_PHIS.definition.attributes);
        attributes.push('id');
