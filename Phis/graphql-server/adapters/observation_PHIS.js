...
module.exports = class observation_PHIS extends Sequelize.Model {
    ...
    static async readById(id) {
        let item = await observation_PHIS.findByPk(id);
        if (item === null) {
    ...
    static idAttribute() {
        return observation_PHIS.definition.id.name;
    }
    ...
    static idAttributeType() {
        return observation_PHIS.definition.id.type;
    }
    ...
    getIdValue() {
        return this[observation_PHIS.idAttribute()]
    }
    ...
    stripAssociations() {
        let attributes = Object.keys(observation_PHIS.definition.attributes);
