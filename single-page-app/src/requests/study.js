 ...
 */
  ...
  /**
   * getAssays   *
   * Get assays records associated to the given study record
...
`;
    ...
    let query =
      `query readOneStudy($study_id:ID!, $search: searchAssayInput, $pagination: paginationCursorInput!) {
             readOneStudy(study_id:$study_id) {
...
//request
    ...
    if(check === 'ok') {
      ...
      || !response.data.data["readOneStudy"]["assaysConnection"]
      || typeof response.data.data["readOneStudy"]["assaysConnection"] !== 'object'
      || !Array.isArray(response.data.data["readOneStudy"]["assaysConnection"].edges)
      || typeof response.data.data["readOneStudy"]["assaysConnection"].pageInfo !== 'object' 
      || response.data.data["readOneStudy"]["assaysConnection"].pageInfo === null)
      return {data: response.data.data, value: null, message: 'bad_type', graphqlErrors: (graphqlErrors.length>0) ? graphqlErrors : undefined};

      //get value
      items = response.data.data["readOneStudy"]["assaysConnection"];
    } else return {data: response.data.data, value: null, message: check, graphqlErrors: (graphqlErrors.length>0) ? graphqlErrors : undefined};
 ...
 */
   ...
   * getAssaysCount
   * 
   * Get assays records count associated to the given study record
   * through association 'Assays', from GraphQL Server.
   * 
   * 
   * @param {String} url GraphQL Server url
  ...
  async getAssaysCount(url, itemId, searchText, ops) {
    ...
    let variables = {"study_id": itemId};
    //search
    let s = getSearchArgument('assay', searchText, ops, 'object');
    if(s) variables.search = s.search;
    //query
    let query =
      `query readOneStudy($study_id:ID!, $search: searchAssayInput) { 
             readOneStudy(study_id:$study_id) {
    ...
    if(check === 'ok') {
      ...
      if(!response.data.data["readOneStudy"]
      || typeof response.data.data["readOneStudy"] !== 'object'
      || !Number.isInteger(response.data.data["readOneStudy"]["countFilteredAssays"])) 
      return {data: response.data.data, value: null, message: 'bad_type', graphqlErrors: (graphqlErrors.length>0) ? graphqlErrors : undefined};

      //get value
      count = response.data.data["readOneStudy"]["countFilteredAssays"];
    } else return {data: response.data.data, value: null, message: check, graphqlErrors: (graphqlErrors.length>0) ? graphqlErrors : undefined};
 ...
 */
  ...
  async getNotAssociatedAssaysCount(url, itemId, searchText, ops) {
    ...
    let f1 = {field: "study_id", valueType: "String", value: itemId, operator: "ne"};
    let f2 = {field: "study_id", valueType: "String", value: null, operator: "eq"};
...
`;
    ...
    let query =
      `query readOneStudy($study_id:ID!, $search: searchContactInput, $pagination: paginationCursorInput!) {
             readOneStudy(study_id:$study_id) {
 ...
 */
  ...
  async getContactsCount(url, itemId, searchText, ops) {
    ...
    //query
    let query =
      `query readOneStudy($study_id:ID!, $search: searchContactInput) { 
             readOneStudy(study_id:$study_id) {
 ...
 */
  ...
  //make filter to exclude itemId on FK & include null's
  let f1 = {field: "study_ids", valueType: "Array", value: itemId, operator: "notIn"};
  let f2 = {field: "study_ids", valueType: "String", value: null, operator: "eq"};
  let nf = {operator: "or", search: [ f1, f2 ]};
 ...
 */
  ...
  /**
   * getFactors   *
   * Get factors records associated to the given study record
...
`;
    ...
    let query =
      `query readOneStudy($study_id:ID!, $search: searchFactorInput, $pagination: paginationCursorInput!) {
             readOneStudy(study_id:$study_id) {
...
//request
    ...
    if(check === 'ok') {
      ...
      if(!response.data.data["readOneStudy"]
      || typeof response.data.data["readOneStudy"] !== 'object'
      || !response.data.data["readOneStudy"]["factorsConnection"]
      || typeof response.data.data["readOneStudy"]["factorsConnection"] !== 'object'
      || !Array.isArray(response.data.data["readOneStudy"]["factorsConnection"].edges)
      || typeof response.data.data["readOneStudy"]["factorsConnection"].pageInfo !== 'object' 
      || response.data.data["readOneStudy"]["factorsConnection"].pageInfo === null)
      return {data: response.data.data, value: null, message: 'bad_type', graphqlErrors: (graphqlErrors.length>0) ? graphqlErrors : undefined};

      //get value
      items = response.data.data["readOneStudy"]["factorsConnection"];
    } else return {data: response.data.data, value: null, message: check, graphqlErrors: (graphqlErrors.length>0) ? graphqlErrors : undefined};
 ...
 */
   ...
   * getFactorsCount
   * 
   * Get factors records count associated to the given study record
   * through association 'Factors', from GraphQL Server.
   * 
   * 
   * @param {String} url GraphQL Server url
  ...
  async getFactorsCount(url, itemId, searchText, ops) {
    ...
    //query
    let query =
      `query readOneStudy($study_id:ID!, $search: searchFactorInput) { 
             readOneStudy(study_id:$study_id) {
    ...
    if(check === 'ok') {
      ...
      if(!response.data.data["readOneStudy"]
      || typeof response.data.data["readOneStudy"] !== 'object'
      || !Number.isInteger(response.data.data["readOneStudy"]["countFilteredFactors"])) 
      return {data: response.data.data, value: null, message: 'bad_type', graphqlErrors: (graphqlErrors.length>0) ? graphqlErrors : undefined};

      //get value
      count = response.data.data["readOneStudy"]["countFilteredFactors"];
    } else return {data: response.data.data, value: null, message: check, graphqlErrors: (graphqlErrors.length>0) ? graphqlErrors : undefined};
 ...
 */
  ...
  /**
   * getFileAttachments   *
   * Get fileAttachments records associated to the given study record
...
`;
    ...
    let query =
      `query readOneStudy($study_id:ID!, $search: searchFileAttachmentInput, $pagination: paginationCursorInput!) {
             readOneStudy(study_id:$study_id) {
...
//request
    ...
    if(check === 'ok') {
      ...
      if(!response.data.data["readOneStudy"]
      || typeof response.data.data["readOneStudy"] !== 'object'
      || !response.data.data["readOneStudy"]["fileAttachmentsConnection"]
      || typeof response.data.data["readOneStudy"]["fileAttachmentsConnection"] !== 'object'
      || !Array.isArray(response.data.data["readOneStudy"]["fileAttachmentsConnection"].edges)
      || typeof response.data.data["readOneStudy"]["fileAttachmentsConnection"].pageInfo !== 'object' 
      || response.data.data["readOneStudy"]["fileAttachmentsConnection"].pageInfo === null)
      return {data: response.data.data, value: null, message: 'bad_type', graphqlErrors: (graphqlErrors.length>0) ? graphqlErrors : undefined};

      //get value
      items = response.data.data["readOneStudy"]["fileAttachmentsConnection"];
    } else return {data: response.data.data, value: null, message: check, graphqlErrors: (graphqlErrors.length>0) ? graphqlErrors : undefined};
 ...
 */
   ...
   * 
   * Get fileAttachments records count associated to the given study record
   * through association 'FileAttachments', from GraphQL Server.
   * 
   * 
   * @param {String} url GraphQL Server url
  ...
  async getFileAttachmentsCount(url, itemId, searchText, ops) {
    ...
    //query
    let query =
      `query readOneStudy($study_id:ID!, $search: searchFileAttachmentInput) { 
             readOneStudy(study_id:$study_id) {
    ...
    if(check === 'ok') {
      ...
      if(!response.data.data["readOneStudy"]
      || typeof response.data.data["readOneStudy"] !== 'object'
      || !Number.isInteger(response.data.data["readOneStudy"]["countFilteredFileAttachments"])) 
      return {data: response.data.data, value: null, message: 'bad_type', graphqlErrors: (graphqlErrors.length>0) ? graphqlErrors : undefined};

      //get value
      count = response.data.data["readOneStudy"]["countFilteredFileAttachments"];
    } else return {data: response.data.data, value: null, message: check, graphqlErrors: (graphqlErrors.length>0) ? graphqlErrors : undefined};
 ...
 */
  ...
  /**
   * getInvestigation   *
   * Get investigations records associated to the given study record
   * through association 'Investigation', from GraphQL Server.
   *
   *
   * @param {String} url GraphQL Server url
   * @param {Number} itemId Model item internalId.
   ...
   * @param {String} ops Object with adittional query options.
   */
  async getInvestigation(url, itemId, searchText, variables, ops) {
    let graphqlErrors = [];
...
`;
    ...
    //set query
    let query = 
      `query readOneStudy($study_id:ID!) {
             readOneStudy(study_id:$study_id) {
                investigation{
                  ${qattributes}
                }
     ...
     * Debug
     */
    if(globals.REQUEST_LOGGER) logRequest('getInvestigation', query, variables);
    ...
    if(check === 'ok') {
      ...
      if(!response.data.data["readOneStudy"]
      || typeof response.data.data["readOneStudy"] !== 'object'
      || typeof response.data.data["readOneStudy"]["investigation"] !== 'object' //can be null
      ) return {data: response.data.data, value: null, message: 'bad_type', graphqlErrors: (graphqlErrors.length>0) ? graphqlErrors : undefined};
      
      //get value
      associatedItem = response.data.data["readOneStudy"]["investigation"];
    } else return {data: response.data.data, value: null, message: check, graphqlErrors: (graphqlErrors.length>0) ? graphqlErrors : undefined};
 ...
 */
  ...
  /**
   * getNotAssociatedInvestigationCount
   *
   * Get count of not associated Investigation from GraphQL Server.
   *
   * @param {String} url GraphQL Server url.
   * @param {String} itemId Model item internalId.
   * @param {String} searchText Text string currently on search bar.
   * @param {String} ops Object with adittional query options.
   */
  async getNotAssociatedInvestigationCount(url, itemId, searchText, ops) {
    let graphqlErrors = [];
    /**
     * Algorithm:
     ...
     * Debug
     */
    if(globals.REQUEST_LOGGER) logRequest('getNotAssociatedInvestigationCount.query1', query, variables);
    //request
    let response = await requestGraphql({ url, query, variables });
    let associatedItem = null;
    //check
   ...
   /**
    ...
    if(s) {
      if(associatedItem) {
        ...
        let f1 = {field: "investigation_id", valueType: "String", value: associatedItem["investigation_id"], operator: "ne"};
        //add new filter to ands array
     ...
     * Debug
     */
    if(globals.REQUEST_LOGGER) logRequest('getNotAssociatedInvestigationCount.query2', query, variables);
    //request
    response = await requestGraphql({ url, query, variables });
    let count = null;
    //check
    check = checkResponse(response, graphqlErrors, "countInvestigations");
    if(check === 'ok') {
      //check type
...
/**
 * getNotAssociatedInvestigation
 *
 * Get not associated Investigation items from GraphQL Server.
 *
 * @param {String} url GraphQL Server url.
 * @param {String} itemId Model item internalId.
 * @param {String} searchText Text string currently on search bar.
 ...
 * @param {Int}    batchSize Max number of records to fetch in batch from GraphQL Server.
 */
async getNotAssociatedInvestigation(url, itemId, searchText, variables, ops, batchSize) {
   //internal checks
   if(!variables||typeof variables !== 'object') throw new Error("internal_error: expected object 'variables' argument");
   if(!variables.pagination||typeof variables.pagination !== 'object' ) throw new Error("internal_error: pagination object expected in variables");
    if(!variables.pagination.first&&!variables.pagination.last ) throw new Error("internal_error: pagination first or last positive argument expected");
...
`;
     ...
     * Debug
     */
    if(globals.REQUEST_LOGGER) logRequest('getNotAssociatedInvestigation.query1', query);
    //request
    let response = await requestGraphql({ url, query });
    let associatedItem = null;
    //check
    ...
    //make filter to exclude associated item
    let f1 = null;
    if(associatedItem) f1 = {field: "investigation_id", valueType: "String", value: associatedItem["investigation_id"], operator: "ne"};
     ...
     * Debug
     */
    if(globals.REQUEST_LOGGER) logRequest('getNotAssociatedInvestigation.query2', query, variables);

    //request
    response = await requestGraphql({ url, query, variables });
    let items = null;
    //check
    check = checkResponse(response, graphqlErrors, "investigationsConnection");
    if(check === 'ok') {
      //check type
 ...
 */
  ...
  /**
   * getMaterials   *
   * Get materials records associated to the given study record
...
`;
    ...
    let query =
      `query readOneStudy($study_id:ID!, $search: searchMaterialInput, $pagination: paginationCursorInput!) {
             readOneStudy(study_id:$study_id) {
...
//request
    ...
    if(check === 'ok') {
      ...
      if(!response.data.data["readOneStudy"]
      || typeof response.data.data["readOneStudy"] !== 'object'
      || !response.data.data["readOneStudy"]["materialsConnection"]
      || typeof response.data.data["readOneStudy"]["materialsConnection"] !== 'object'
      || !Array.isArray(response.data.data["readOneStudy"]["materialsConnection"].edges)
      || typeof response.data.data["readOneStudy"]["materialsConnection"].pageInfo !== 'object' 
      || response.data.data["readOneStudy"]["materialsConnection"].pageInfo === null)
      return {data: response.data.data, value: null, message: 'bad_type', graphqlErrors: (graphqlErrors.length>0) ? graphqlErrors : undefined};

      //get value
      items = response.data.data["readOneStudy"]["materialsConnection"];
    } else return {data: response.data.data, value: null, message: check, graphqlErrors: (graphqlErrors.length>0) ? graphqlErrors : undefined};
 ...
 */
   ...
   * getMaterialsCount
   * 
   * Get materials records count associated to the given study record
   * through association 'Materials', from GraphQL Server.
   * 
   * 
   * @param {String} url GraphQL Server url
  ...
  async getMaterialsCount(url, itemId, searchText, ops) {
    ...
    //query
    let query =
      `query readOneStudy($study_id:ID!, $search: searchMaterialInput) { 
             readOneStudy(study_id:$study_id) {
    ...
    if(check === 'ok') {
      ...
      if(!response.data.data["readOneStudy"]
      || typeof response.data.data["readOneStudy"] !== 'object'
      || !Number.isInteger(response.data.data["readOneStudy"]["countFilteredMaterials"])) 
      return {data: response.data.data, value: null, message: 'bad_type', graphqlErrors: (graphqlErrors.length>0) ? graphqlErrors : undefined};

      //get value
      count = response.data.data["readOneStudy"]["countFilteredMaterials"];
    } else return {data: response.data.data, value: null, message: check, graphqlErrors: (graphqlErrors.length>0) ? graphqlErrors : undefined};
 ...
 */
   ...
   * Get ontologyAnnotations records associated to the given study record
...
`;
    ...
    let query =
      `query readOneStudy($study_id:ID!, $search: searchOntologyAnnotationInput, $pagination: paginationCursorInput!) {
             readOneStudy(study_id:$study_id) {
...
//request
    ...
    if(check === 'ok') {
      ...
      if(!response.data.data["readOneStudy"]
      || typeof response.data.data["readOneStudy"] !== 'object'
      || !response.data.data["readOneStudy"]["ontologyAnnotationsConnection"]
      || typeof response.data.data["readOneStudy"]["ontologyAnnotationsConnection"] !== 'object'
      || !Array.isArray(response.data.data["readOneStudy"]["ontologyAnnotationsConnection"].edges)
      || typeof response.data.data["readOneStudy"]["ontologyAnnotationsConnection"].pageInfo !== 'object' 
      || response.data.data["readOneStudy"]["ontologyAnnotationsConnection"].pageInfo === null)
      return {data: response.data.data, value: null, message: 'bad_type', graphqlErrors: (graphqlErrors.length>0) ? graphqlErrors : undefined};

      //get value
      items = response.data.data["readOneStudy"]["ontologyAnnotationsConnection"];
    } else return {data: response.data.data, value: null, message: check, graphqlErrors: (graphqlErrors.length>0) ? graphqlErrors : undefined};
 ...
 */
   ...
   * 
   * Get ontologyAnnotations records count associated to the given study record
   * through association 'OntologyAnnotations', from GraphQL Server.
   * 
   * 
   * @param {String} url GraphQL Server url
  ...
  async getOntologyAnnotationsCount(url, itemId, searchText, ops) {
    ...
    //query
    let query =
      `query readOneStudy($study_id:ID!, $search: searchOntologyAnnotationInput) { 
             readOneStudy(study_id:$study_id) {
    ...
    if(check === 'ok') {
      ...
      if(!response.data.data["readOneStudy"]
      || typeof response.data.data["readOneStudy"] !== 'object'
      || !Number.isInteger(response.data.data["readOneStudy"]["countFilteredOntologyAnnotations"])) 
      return {data: response.data.data, value: null, message: 'bad_type', graphqlErrors: (graphqlErrors.length>0) ? graphqlErrors : undefined};

      //get value
      count = response.data.data["readOneStudy"]["countFilteredOntologyAnnotations"];
    } else return {data: response.data.data, value: null, message: check, graphqlErrors: (graphqlErrors.length>0) ? graphqlErrors : undefined};
 ...
 */
  ...
  /**
   * getProtocols   *
   * Get protocols records associated to the given study record
...
`;
    ...
    let query =
      `query readOneStudy($study_id:ID!, $search: searchProtocolInput, $pagination: paginationCursorInput!) {
             readOneStudy(study_id:$study_id) {
...
//request
    ...
    if(check === 'ok') {
      ...
      if(!response.data.data["readOneStudy"]
      || typeof response.data.data["readOneStudy"] !== 'object'
      || !response.data.data["readOneStudy"]["protocolsConnection"]
      || typeof response.data.data["readOneStudy"]["protocolsConnection"] !== 'object'
      || !Array.isArray(response.data.data["readOneStudy"]["protocolsConnection"].edges)
      || typeof response.data.data["readOneStudy"]["protocolsConnection"].pageInfo !== 'object' 
      || response.data.data["readOneStudy"]["protocolsConnection"].pageInfo === null)
      return {data: response.data.data, value: null, message: 'bad_type', graphqlErrors: (graphqlErrors.length>0) ? graphqlErrors : undefined};

      //get value
      items = response.data.data["readOneStudy"]["protocolsConnection"];
    } else return {data: response.data.data, value: null, message: check, graphqlErrors: (graphqlErrors.length>0) ? graphqlErrors : undefined};
 ...
 */
   ...
   * getProtocolsCount
   * 
   * Get protocols records count associated to the given study record
   * through association 'Protocols', from GraphQL Server.
   * 
   * 
   * @param {String} url GraphQL Server url
  ...
  async getProtocolsCount(url, itemId, searchText, ops) {
    ...
    //query
    let query =
      `query readOneStudy($study_id:ID!, $search: searchProtocolInput) { 
             readOneStudy(study_id:$study_id) {
    ...
    if(check === 'ok') {
      ...
      if(!response.data.data["readOneStudy"]
      || typeof response.data.data["readOneStudy"] !== 'object'
      || !Number.isInteger(response.data.data["readOneStudy"]["countFilteredProtocols"])) 
      return {data: response.data.data, value: null, message: 'bad_type', graphqlErrors: (graphqlErrors.length>0) ? graphqlErrors : undefined};

      //get value
      count = response.data.data["readOneStudy"]["countFilteredProtocols"];
    } else return {data: response.data.data, value: null, message: check, graphqlErrors: (graphqlErrors.length>0) ? graphqlErrors : undefined};
