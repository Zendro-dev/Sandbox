...
export default {
  ...
  getCountItems(url, searchText, ops) {
    //search
    var s = getSearchArgument('fileAttachment', searchText, ops);
    
    var query = '';

    //if has search
    if (s !== null) {
      query = `{ countFileAttachments(${s}) }`;
    }
    else {
      query = `{ countFileAttachments }`;
    }
  ...
  getItemsConnection(url, searchText, orderBy, orderDirection, variables, ops) {
    ...
    if (s !== null) {
      ...
      if (o != null) {
        ...
        query =
          `query fileAttachmentsConnection($pagination: paginationCursorInput)
            { fileAttachmentsConnection( ${s}, ${o}, pagination: $pagination ) {
              ${qbody}
            }}`
      }
      else {
        ...
        query =
          `query fileAttachmentsConnection($pagination: paginationCursorInput)
            { fileAttachmentsConnection( ${s}, pagination: $pagination ) {
              ${qbody}
            }}`
      }
    }
      ...
      if (o != null) {
        ...
        query =
          `query fileAttachmentsConnection($pagination: paginationCursorInput)
          { fileAttachmentsConnection( ${o}, pagination: $pagination ) {
            ${qbody}
          }}`
      }
      else {
      ...
      `mutation
        addFileAttachment(
          ...
          $description:String,
            ...
            fileType:$fileType,
            fileUrl:$fileUrl,
            smallTnUrl:$smallTnUrl,
            mediumTnUrl:$mediumTnUrl,
            licence:$licence,
