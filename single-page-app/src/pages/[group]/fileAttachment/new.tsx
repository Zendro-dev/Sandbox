...
import uploadFileAttachment from '@/overrides/uploadFileAttachment';
...
const Record: PageWithLayout<RecordUrlQuery> = () => {
  ...
  const handleOnSubmit: ActionHandler = (formData, formStats) => {
    ...
    const submit = async (): Promise<void> => {
      try {
        const request = uploadFileAttachment;
        ...
        router.push(`/models/fileAttachment/edit?id=${newId}`);
      } catch (error) {
  ...
  return (
    <ModelBouncer object="fileAttachment" action="create">
      <NavTabs
