...
import { query, transform } from '@/overrides/readFileAttachments';
import AttachmentTableHeader from '@/overrides/attachments/table-header';

import mime from 'mime-types';
import { FileIcon, defaultStyles, DefaultExtensionType } from 'react-file-icon';

const FileAttachment: PageWithLayout = () => {
  const modelString = 'fileAttachment';
...
FileAttachment.layout = ModelLayout;
