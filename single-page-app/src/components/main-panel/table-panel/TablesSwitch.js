...
const BreedingMethodTable = lazy(() => import('./models-tables/breedingMethod-table/BreedingMethodEnhancedTable'));
const ContactTable = lazy(() => import('./models-tables/contact-table/ContactEnhancedTable'));
const EnvironmentParameterTable = lazy(() => import('./models-tables/environmentParameter-table/EnvironmentParameterEnhancedTable'));
const EventTable = lazy(() => import('./models-tables/event-table/EventEnhancedTable'));
const EventParameterTable = lazy(() => import('./models-tables/eventParameter-table/EventParameterEnhancedTable'));
const GermplasmTable = lazy(() => import('./models-tables/germplasm-table/GermplasmEnhancedTable'));
const ImageTable = lazy(() => import('./models-tables/image-table/ImageEnhancedTable'));
const LocationTable = lazy(() => import('./models-tables/location-table/LocationEnhancedTable'));
const MethodTable = lazy(() => import('./models-tables/method-table/MethodEnhancedTable'));
const ObservationTable = lazy(() => import('./models-tables/observation-table/ObservationEnhancedTable'));
const ObservationTreatmentTable = lazy(() => import('./models-tables/observationTreatment-table/ObservationTreatmentEnhancedTable'));
const ObservationUnitTable = lazy(() => import('./models-tables/observationUnit-table/ObservationUnitEnhancedTable'));
const ObservationUnitPositionTable = lazy(() => import('./models-tables/observationUnitPosition-table/ObservationUnitPositionEnhancedTable'));
const ObservationVariableTable = lazy(() => import('./models-tables/observationVariable-table/ObservationVariableEnhancedTable'));
const OntologyReferenceTable = lazy(() => import('./models-tables/ontologyReference-table/OntologyReferenceEnhancedTable'));
const ProgramTable = lazy(() => import('./models-tables/program-table/ProgramEnhancedTable'));
const ScaleTable = lazy(() => import('./models-tables/scale-table/ScaleEnhancedTable'));
const SeasonTable = lazy(() => import('./models-tables/season-table/SeasonEnhancedTable'));
const StudyTable = lazy(() => import('./models-tables/study-table/StudyEnhancedTable'));
const TraitTable = lazy(() => import('./models-tables/trait-table/TraitEnhancedTable'));
const TrialTable = lazy(() => import('./models-tables/trial-table/TrialEnhancedTable'));
