...
export default function StudiesCompactView(props) {
      ...
      (response) => {
        ...
        if(response.message === 'ok') {
          ...
          if(response.graphqlErrors) {
            ...
            newError.path=['detail', `trialDbId:${item.trialDbId}`, 'studies'];
  ...
  }, [graphqlServerUrl, showMessageB, t, item.trialDbId, search]);
  ...
  }, [lastModelChanged, lastChangeTimestamp, items, item.trialDbId, count, getCount, configurePagination]);
