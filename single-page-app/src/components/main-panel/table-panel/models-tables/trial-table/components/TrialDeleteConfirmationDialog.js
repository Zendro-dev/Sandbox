...
//lazy loading
const TrialDetailPanel = lazy(() => import(/* webpackChunkName: "Delete-DetailTrial" */ './trial-detail-panel/TrialDetailPanel'));
...
export default function TrialDeleteConfirmationDialog(props) {
  ...
  return (
    ...
    >
      ...
      {(!deleted) && (
        <DialogActions>
          <Button 
          id='TrialDeleteConfirmationDialog-button-reject'
          ...
          <Button 
          id='TrialDeleteConfirmationDialog-button-accept'
...
TrialDeleteConfirmationDialog.propTypes = {
