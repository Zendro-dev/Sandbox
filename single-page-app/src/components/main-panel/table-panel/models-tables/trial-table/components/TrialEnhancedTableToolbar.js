...
export default function TrialEnhancedTableToolbar(props) {
                    ...
                    <Grid container justify="flex-end" alignItems='center' wrap='wrap'>
                      ...
                      <Grid item>
                        <Tooltip title={ t('modelPanels.reloadList', "Reload list") }>
                          <IconButton
                            id='TrialEnhancedTableToolbar-iconButton-reloadTable'
                            color='inherit'
                            onClick={(event) => {
                              onReloadClick();
                            }}
                      ...
                      <Grid item>
                        ...
                        {/* Search field */}
                        <TextField
                          id='TrialEnhancedTableToolbar-textField-search'
                            ...
                            startAdornment: (
                              <InputAdornment position="start">
                                <Tooltip title={ t('modelPanels.search') }>
                                  <IconButton
                                    id='TrialEnhancedTableToolbar-iconButton-search'
                                    color='inherit'
                                    onClick={() => {
                              ...
                              <InputAdornment position="end">
                                <Tooltip title={ t('modelPanels.clearSearch') }>
                                  <span>
                                    ...
                                    {(search) && (
                                      <IconButton
                                        id='TrialEnhancedTableToolbar-iconButton-clearSearch'
                                        onClick={() => {
                                          onSearchEnter('');
                                          setDisplayedSearch('');
                                        }}
                          ...
                          <Grid item xs={12}>
                            <Grid container justify="center">
                              {/* Add */}
                              {
                                ...
                                &&(permissions.trial.includes('create') || permissions.trial.includes('*')))
                                &&(
                                  <Grid item>
                                    <Tooltip title={t('modelPanels.addNew') + " trial"}>
                                      <IconButton
                                        id='TrialEnhancedTableToolbar-button-add'
                                        color="primary"
                                ...
                                &&(
                                  <Grid item>
                                    <Tooltip title={ t('modelPanels.importCSV') }>
                                      <IconButton
                                        id='TrialEnhancedTableToolbar-button-import'
                                        color="primary"
                                  ...
                                  <div>
                                    ...
                                    <Grid item>
                                      <Tooltip title={ t('modelPanels.downloadsOptions', 'Download options') }>
                                        <IconButton
                                          id='TrialEnhancedTableToolbar-button-downloadOptions'
                                          color="primary"
                                    ...
                                    >
                                      ...
                                      <Grid item xs={12}>
                                        <Grid container justify='flex-start'>
                                          ...
                                          <input type="hidden" name="model" value='trial' />
                                            <ButtonBase
                                              id='TrialEnhancedTableToolbar-button-exportData'
                                      ...
                                      <Grid item xs={12}>
                                        <Grid container justify='flex-start'>
                                          <ButtonBase
                                            id='TrialEnhancedTableToolbar-button-exportTemplate'
                                            className={classes.textButton}
                                            color="default"
                                            onClick={()=>{
                                              if(!isDownloading.current) {
                                      ...
                                      <Grid item xs={12}>
                                        <Grid container justify='flex-end'>
                                          <Button
                                            id='TrialEnhancedTableToolbar-button-closeDownloadOptions'
...
TrialEnhancedTableToolbar.propTypes = {
