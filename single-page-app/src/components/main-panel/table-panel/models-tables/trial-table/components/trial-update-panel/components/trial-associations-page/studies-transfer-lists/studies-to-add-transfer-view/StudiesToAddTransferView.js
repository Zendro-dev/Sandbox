...
export default function StudiesToAddTransferView(props) {
  ...
  */
  ...
  const getCount = useCallback(async () => {
    ...
    /*
      API Request: api.trial.getNotAssociatedStudiesCount
    */
    let cancelableApiReq = makeCancelable(api.trial.getNotAssociatedStudiesCount(graphqlServerUrl, item.trialDbId, search, ops));
    ...
    await cancelableApiReq
      ...
      (response) => {
        ...
        if(response.message === 'ok') {
          ...
          if(response.graphqlErrors) {
            ...
            newError.locations=[{model: 'trial', association: 'studies', table:'A', method: 'getCount()', request: 'api.trial.getNotAssociatedStudiesCount'}];
            newError.path=['update', `trialDbId:${item.trialDbId}`, 'add', 'studies'];
      ...
      //error
      .catch((err) => { //error: on api.trial.getNotAssociatedStudiesCount
        if(err.isCanceled) {
          return;
        } else {
          //show error
  ...
  const getData = useCallback(async () => {
    ...
    /*
      API Request: api.trial.getNotAssociatedStudies
    */
    let cancelableApiReq = makeCancelable(api.trial.getNotAssociatedStudies(
      graphqlServerUrl,
      item.trialDbId,
      search,
      variables,
    ...
    await cancelableApiReq
      ...
      (response) => {
        ...
        if(response.message === 'ok') {
          ...
          if(response.graphqlErrors) {
            ...
            newError.message = t('modelPanels.errors.data.e3', 'fetched with errors.');
            newError.locations=[{model: 'trial', association: 'studies', table:'A', method: 'getData()', request: 'api.trial.getNotAssociatedStudies'}];
            newError.path=['update', `trialDbId:${item.trialDbId}`, 'add', 'studies'];
            newError.extensions = {graphQL:{data:response.data, errors:response.graphqlErrors}};
      ...
      //error
      .catch((err) => { //error: on api.trial.getNotAssociatedStudies
        if(err.isCanceled) {
          return;
        } else {
          let newError = {};
  ...
  }, [graphqlServerUrl, showMessage, clearRequestGetData, getCount, t, item.trialDbId, dataTrigger, search, configurePagination, onEmptyPage]);
      ...
      (response) => {
        ...
        if(response.message === 'ok') {
          ...
          if(response.graphqlErrors) {
            ...
            newError.message = t('modelPanels.errors.data.e3', 'fetched with errors.');
            newError.locations=[{model: 'trial', association: 'studies', table:'B', method: 'getCountB()', request: 'api.study.getCountItems'}];
            newError.path=['update', `trialDbId:${item.trialDbId}`, 'add', 'studies'];          
            newError.extensions = {graphQL:{data:response.data, errors:response.graphqlErrors}};
  ...
  }, [graphqlServerUrl, showMessageD, t, item.trialDbId, searchB]);
      ...
      (response) => {
        ...
        if(response.message === 'ok') {
          ...
          if(response.graphqlErrors) {
            ...
            newError.message = t('modelPanels.errors.data.e3', 'fetched with errors.');
            newError.locations=[{model: 'trial', association: 'studies', table:'B', method: 'getDataB()', request: 'api.study.getItems'}];
            newError.path=['update', `trialDbId:${item.trialDbId}`, 'add', 'studies'];
            newError.extensions = {graphQL:{data:response.data, errors:response.graphqlErrors}};
  ...
  }, [graphqlServerUrl, showMessageB, clearRequestGetDataB, t, item.trialDbId, dataTriggerB, searchB, getCountB, configurePaginationB, onEmptyPageB]);
  ...
  useEffect(() => {
    ...
    if(lastModelChanged.trial&&
        ...
        lastModelChanged.trial[String(item.trialDbId)].changedAssociations.study_trialDbId&&
        (lastModelChanged.trial[String(item.trialDbId)].changedAssociations.study_trialDbId.added ||
         lastModelChanged.trial[String(item.trialDbId)].changedAssociations.study_trialDbId.removed)) {
          
          //remove any associated internalId from idsToAdd[] & update counts
          let idsAdded = lastModelChanged.trial[String(item.trialDbId)].changedAssociations.study_trialDbId.idsAdded;
          if(idsAdded) {
          ...
          let idsRemoved = lastModelChanged.trial[String(item.trialDbId)].changedAssociations.study_trialDbId.idsRemoved;
          if(idsRemoved) {
            //increment A
  ...
  }, [lastModelChanged, lastChangeTimestamp, items, itemsB, item.trialDbId, handleUntransfer, getCount, count, getCountB, countB, configurePagination, configurePaginationB]);
