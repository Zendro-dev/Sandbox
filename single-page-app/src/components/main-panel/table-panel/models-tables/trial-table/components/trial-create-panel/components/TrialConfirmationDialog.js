...
export default function TrialConfirmationDialog(props) {
  ...
  return (
    <div>
      <Dialog id='TrialConfirmationDialog-create'
        open={open}
      ...
      >
        ...
        <DialogActions>
          ...
          {(acceptText !== '' && acceptText !== null && acceptText !== undefined) &&
            <Button
              id='TrialConfirmationDialog-create-button-accept'
              color="primary"
              variant='contained'
          ...
          {(rejectText !== '' && acceptText !== null && acceptText !== undefined) &&
            ...
            <Button
              id='TrialConfirmationDialog-create-button-reject'
              color="primary" 
...
TrialConfirmationDialog.propTypes = {
