...
export default function EventParameterConfirmationDialog(props) {
  ...
  return (
    <div>
      <Dialog id='EventParameterConfirmationDialog-create'
        open={open}
      ...
      >
        ...
        <DialogActions>
          ...
          {(acceptText !== '' && acceptText !== null && acceptText !== undefined) &&
            <Button
              id='EventParameterConfirmationDialog-create-button-accept'
              color="primary"
              variant='contained'
          ...
          {(rejectText !== '' && acceptText !== null && acceptText !== undefined) &&
            ...
            <Button
              id='EventParameterConfirmationDialog-create-button-reject'
              color="primary" 
...
EventParameterConfirmationDialog.propTypes = {
