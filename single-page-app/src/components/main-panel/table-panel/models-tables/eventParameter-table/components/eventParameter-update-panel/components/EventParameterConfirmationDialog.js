...
export default function EventParameterConfirmationDialog(props) {
  ...
  return (
    <div>
      <Dialog id='EventParameterConfirmationDialog-update'
        open={open}
      ...
      >
        ...
        <DialogActions>
          ...
          {(acceptText !== '' && acceptText !== null && acceptText !== undefined) &&
            <Button
              id='EventParameterConfirmationDialog-update-button-accept'
              color="primary"
              variant='contained'
          ...
          {(rejectText !== '' && acceptText !== null && acceptText !== undefined) &&
            ...
            <Button
              id='EventParameterConfirmationDialog-update-button-reject'
              color="primary" 
