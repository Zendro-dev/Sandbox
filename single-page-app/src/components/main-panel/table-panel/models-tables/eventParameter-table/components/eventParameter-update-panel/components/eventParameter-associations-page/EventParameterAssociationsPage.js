...
//lazy loading
const EventTransferLists = lazy(() => import(/* webpackChunkName: "Update-TransferLists-Event" */ './event-transfer-lists/EventTransferLists'));
...
EventParameterAssociationsPage.propTypes = {
  ...
  eventIdsToRemove: PropTypes.array.isRequired,
