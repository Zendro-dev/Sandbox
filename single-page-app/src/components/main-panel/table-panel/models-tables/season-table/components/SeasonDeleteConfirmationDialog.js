...
//lazy loading
const SeasonDetailPanel = lazy(() => import(/* webpackChunkName: "Delete-DetailSeason" */ './season-detail-panel/SeasonDetailPanel'));
...
export default function SeasonDeleteConfirmationDialog(props) {
  ...
  return (
    ...
    >
      ...
      {(!deleted) && (
        <DialogActions>
          <Button 
          id='SeasonDeleteConfirmationDialog-button-reject'
          ...
          <Button 
          id='SeasonDeleteConfirmationDialog-button-accept'
...
SeasonDeleteConfirmationDialog.propTypes = {
