...
export default function ObservationsCompactView(props) {
      ...
      (response) => {
        ...
        if(response.message === 'ok') {
          ...
          if(response.graphqlErrors) {
            ...
            newError.path=['detail', `seasonDbId:${item.seasonDbId}`, 'observations'];
  ...
  }, [graphqlServerUrl, showMessageB, t, item.seasonDbId, search]);
  ...
  }, [lastModelChanged, lastChangeTimestamp, items, item.seasonDbId, count, getCount, configurePagination]);
