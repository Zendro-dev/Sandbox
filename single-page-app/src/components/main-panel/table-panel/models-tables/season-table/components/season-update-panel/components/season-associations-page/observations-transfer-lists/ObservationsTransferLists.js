...
const ObservationsToRemoveTransferView = lazy(() => import(/* webpackChunkName: "Create-TransferLists-ToRemove-Observations" */ './observations-to-remove-transfer-view/ObservationsToRemoveTransferView'));
