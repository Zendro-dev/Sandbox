...
//lazy loading
const SeasonAttributesPage = lazy(() => import(/* webpackChunkName: "Create-AttributesSeason" */ './components/season-attributes-page/SeasonAttributesPage'));
const SeasonAssociationsPage = lazy(() => import(/* webpackChunkName: "Create-AssociationsSeason" */ './components/season-associations-page/SeasonAssociationsPage'));
const SeasonConfirmationDialog = lazy(() => import(/* webpackChunkName: "Create-ConfirmationSeason" */ './components/SeasonConfirmationDialog'));
...
export default function SeasonCreatePanel(props) {
  ...
  async function doSave(event) {
    ...
    */
    ...
    /*
      API Request: api.season.createItem
    */
    ...
    await cancelableApiReq
      ...
      (response) => {
        ...
        if(response.message === 'ok') {
          ...
          if(response.graphqlErrors) {
            ...
            newError.locations=[{model: 'season', method: 'doSave()', request: 'api.season.createItem'}];
            newError.path=['Seasons', 'add'];
      ...
      //error
      .catch((err) => { //error: on api.season.createItem
        if(err.isCanceled) {
          return
        } else {
          //set ajv errors
  ...
  return (
    ...
    <Dialog id='SeasonCreatePanel-dialog'  
      ...
      <AppBar>
        <Toolbar>
          <Tooltip title={ t('modelPanels.cancel') }>
            <IconButton
              id='SeasonCreatePanel-button-cancel'
              edge="start" 
              color="inherit"
              onClick={(event) => {
                if(!isCanceling.current){
          ...
          <Tooltip title={ t('modelPanels.save') + " season" }>
            <Fab
              id='SeasonCreatePanel-fabButton-save' 
              color="secondary" 
