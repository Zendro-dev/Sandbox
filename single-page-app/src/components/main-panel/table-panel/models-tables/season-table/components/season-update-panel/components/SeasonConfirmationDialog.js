...
export default function SeasonConfirmationDialog(props) {
  ...
  return (
    <div>
      <Dialog id='SeasonConfirmationDialog-update'
        open={open}
      ...
      >
        ...
        <DialogActions>
          ...
          {(acceptText !== '' && acceptText !== null && acceptText !== undefined) &&
            <Button
              id='SeasonConfirmationDialog-update-button-accept'
              color="primary"
              variant='contained'
          ...
          {(rejectText !== '' && acceptText !== null && acceptText !== undefined) &&
            ...
            <Button
              id='SeasonConfirmationDialog-update-button-reject'
              color="primary" 
...
SeasonConfirmationDialog.propTypes = {
