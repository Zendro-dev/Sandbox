...
export default function SeasonEnhancedTableToolbar(props) {
                    ...
                    <Grid container justify="flex-end" alignItems='center' wrap='wrap'>
                      ...
                      <Grid item>
                        <Tooltip title={ t('modelPanels.reloadList', "Reload list") }>
                          <IconButton
                            id='SeasonEnhancedTableToolbar-iconButton-reloadTable'
                            color='inherit'
                            onClick={(event) => {
                              onReloadClick();
                            }}
                      ...
                      <Grid item>
                        ...
                        {/* Search field */}
                        <TextField
                          id='SeasonEnhancedTableToolbar-textField-search'
                            ...
                            startAdornment: (
                              <InputAdornment position="start">
                                <Tooltip title={ t('modelPanels.search') }>
                                  <IconButton
                                    id='SeasonEnhancedTableToolbar-iconButton-search'
                                    color='inherit'
                                    onClick={() => {
                              ...
                              <InputAdornment position="end">
                                <Tooltip title={ t('modelPanels.clearSearch') }>
                                  <span>
                                    ...
                                    {(search) && (
                                      <IconButton
                                        id='SeasonEnhancedTableToolbar-iconButton-clearSearch'
                                        onClick={() => {
                                          onSearchEnter('');
                                          setDisplayedSearch('');
                                        }}
                          ...
                          <Grid item xs={12}>
                            <Grid container justify="center">
                              {/* Add */}
                              {
                                ...
                                &&(permissions.season.includes('create') || permissions.season.includes('*')))
                                &&(
                                  <Grid item>
                                    <Tooltip title={t('modelPanels.addNew') + " season"}>
                                      <IconButton
                                        id='SeasonEnhancedTableToolbar-button-add'
                                        color="primary"
                                ...
                                &&(
                                  <Grid item>
                                    <Tooltip title={ t('modelPanels.importCSV') }>
                                      <IconButton
                                        id='SeasonEnhancedTableToolbar-button-import'
                                        color="primary"
                                  ...
                                  <div>
                                    ...
                                    <Grid item>
                                      <Tooltip title={ t('modelPanels.downloadsOptions', 'Download options') }>
                                        <IconButton
                                          id='SeasonEnhancedTableToolbar-button-downloadOptions'
                                          color="primary"
                                    ...
                                    >
                                      ...
                                      <Grid item xs={12}>
                                        <Grid container justify='flex-start'>
                                          ...
                                          <input type="hidden" name="model" value='season' />
                                            <ButtonBase
                                              id='SeasonEnhancedTableToolbar-button-exportData'
                                      ...
                                      <Grid item xs={12}>
                                        <Grid container justify='flex-start'>
                                          <ButtonBase
                                            id='SeasonEnhancedTableToolbar-button-exportTemplate'
                                            className={classes.textButton}
                                            color="default"
                                            onClick={()=>{
                                              if(!isDownloading.current) {
                                      ...
                                      <Grid item xs={12}>
                                        <Grid container justify='flex-end'>
                                          <Button
                                            id='SeasonEnhancedTableToolbar-button-closeDownloadOptions'
...
SeasonEnhancedTableToolbar.propTypes = {
