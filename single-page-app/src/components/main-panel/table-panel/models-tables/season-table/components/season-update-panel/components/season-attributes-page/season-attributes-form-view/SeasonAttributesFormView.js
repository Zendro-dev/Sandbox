...
export default function SeasonAttributesFormView(props) {
  ...
  return (
    <div id='SeasonAttributesFormView-div-root' className={classes.root}>
            ...
            */}
            ...
            <CardContent key='seasonDbId' className={classes.cardContent}>
              <Grid container alignItems='center' alignContent='center' wrap='nowrap' spacing={1}>
                <Grid item>
                  <Typography variant="h6" display="inline">seasonDbId:</Typography>
                  <Typography variant="h6" display="inline" color="textSecondary">&nbsp;{item.seasonDbId}</Typography>
                </Grid>
                {/*Key icon*/}
                <Grid item>
            ...
            <CardContent key='season' className={classes.cardContent} >
              <StringField
                ...
                valueAjv={valueAjvStates.season}
