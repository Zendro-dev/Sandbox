...
export default function AuthorsCompactView(props) {
  ...
  }, [graphqlServerUrl, showMessage, clearRequestGetData, t, dataTrigger, item.book_id, search]);
  ...
  useEffect(() => {
     ...
     * 
     * Conditions:
     * A: the current item 'internalId' attribute is in the removedIds of the updated 'author'.
     * B: the current item 'internalId' attribute is in the addedIds of the updated 'author'.
     * 
     * Actions:
     * if A:
     * - reload table.
  ...
  }, [lastModelChanged, lastChangeTimestamp, items, item.book_id]);
                          ...
                          >
                            <ListItemAvatar>
                              <Tooltip title={ 'author' }>
                                <Avatar>{"author".slice(0,1)}</Avatar>
                              </Tooltip>
                            </ListItemAvatar>
