  ...
  */
  ...
  const getCount = useCallback(async () => {
    ...
    */
    ...
    let cancelableApiReq = makeCancelable(api.author.getCountItems(graphqlServerUrl, search, ops));
  ...
  const handleAddItem = (event, item) => {
    if(lidsToAdd.current.indexOf(item.author_id) === -1) {
                                ...
                                <Grid container alignItems='center' alignContent='center' wrap='nowrap' spacing={1}>
                                  <Grid item>
                                    <Tooltip title={ 'author_id' }>
                                      <Typography variant="body1" display="block" noWrap={true}>{it.author_id}</Typography>
                                    </Tooltip>
                                  </Grid>
                                  {/*Key icon*/}
                                  <Grid item>
