...
//lazy loading
const BookAttributesPage = lazy(() => retry(() => import(/* webpackChunkName: "Create-AttributesBook" */ './components/book-attributes-page/BookAttributesPage')));
const BookAssociationsPage = lazy(() => retry(() => import(/* webpackChunkName: "Create-AssociationsBook" */ './components/book-associations-page/BookAssociationsPage')));
const BookConfirmationDialog = lazy(() => retry(() => import(/* webpackChunkName: "Create-ConfirmationBook" */ './components/BookConfirmationDialog')));
const AuthorDetailPanel = lazy(() => retry(() => import(/* webpackChunkName: "Create-DetailAuthor" */ '../../../author-table/components/author-detail-panel/AuthorDetailPanel')));
...
export default function BookCreatePanel(props) {
  ...
  function getInitialValues() {
    ...
    initialValues.book_id = null;
    initialValues.name = null;
    initialValues.fk_books_authors = null;
  ...
  function getInitialValueOkStates() {
    ...
    */
    ...
    initialValueOkStates.book_id = 0;
  ...
  async function doSave(event) {
    ...
    */
    ...
    /*
      API Request: api.book.createItem
    */
    ...
    let cancelableApiReq = makeCancelable(api.book.createItem(graphqlServerUrl, variables));
    ...
    await cancelableApiReq
      ...
      (response) => {
        ...
        if(response.message === 'ok') {
          ...
          if(response.graphqlErrors) {
            ...
            newError.locations=[{model: 'book', method: 'doSave()', request: 'api.book.createItem'}];
            newError.path=['Books', 'add'];
      ...
      //error
      .catch((err) => { //error: on api.book.createItem
        if(err.isCanceled) {
          return
        } else {
          //set ajv errors
  ...
  return (
    ...
    <Dialog id='BookCreatePanel-dialog'  
      ...
      <AppBar>
        <Toolbar>
          <Tooltip title={ t('modelPanels.cancel') }>
            <IconButton
              id='BookCreatePanel-button-cancel'
              edge="start" 
              color="inherit"
              onClick={(event) => {
                if(!isCanceling.current){
          ...
          <Typography variant="h6" className={classes.title}>
            {t('modelPanels.new') + ' Book'}
          </Typography>
          <Tooltip title={ t('modelPanels.save') + " book" }>
            <Fab
              id='BookCreatePanel-fabButton-save' 
              color="secondary" 
