...
export default function BookConfirmationDialog(props) {
  ...
  return (
    <div>
      <Dialog id='BookConfirmationDialog-create'
        open={open}
      ...
      >
        ...
        <DialogActions>
          ...
          {(acceptText !== '' && acceptText !== null && acceptText !== undefined) &&
            <Button
              id='BookConfirmationDialog-create-button-accept'
              color="primary"
              variant='contained'
          ...
          {(rejectText !== '' && acceptText !== null && acceptText !== undefined) &&
            ...
            <Button
              id='BookConfirmationDialog-create-button-reject'
              color="primary" 
...
BookConfirmationDialog.propTypes = {
