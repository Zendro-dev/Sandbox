...
//lazy loading
const BookDetailPanel = lazy(() => retry(() => import(/* webpackChunkName: "Delete-DetailBook" */ './book-detail-panel/BookDetailPanel')));
...
export default function BookDeleteConfirmationDialog(props) {
  ...
  return (
    ...
    >
      ...
      {(!deleted) && (
        <DialogActions>
          <Button 
          id='BookDeleteConfirmationDialog-button-reject'
          ...
          <Button 
          id='BookDeleteConfirmationDialog-button-accept'
...
BookDeleteConfirmationDialog.propTypes = {
