...
export default function ObservationUnitCompactView(props) {
  ...
  const getData = useCallback(async () => {
    ...
    */
    ...
    /*
      API Request: api.image.getObservationUnit
    */
    let cancelableApiReq = makeCancelable(api.image.getObservationUnit(
      graphqlServerUrl, 
      item.imageDbId,
      search,
      variables,
      ...
      (response) => {
        ...
        if(response.message === 'ok') {
          ...
          if(response.graphqlErrors) {
            ...
            newError.locations=[{association: 'observationUnit', method: 'getData()', request: 'api.image.getObservationUnit'}];
            newError.path=['detail', `imageDbId:${item.imageDbId}`, 'observationUnit'];
  ...
  }, [graphqlServerUrl, showMessage, clearRequestGetData, t, dataTrigger, item.imageDbId, search]);
