...
export default function ObservationsCompactView(props) {
      ...
      (response) => {
        ...
        if(response.message === 'ok') {
          ...
          if(response.graphqlErrors) {
            ...
            newError.path=['detail', `imageDbId:${item.imageDbId}`, 'observations'];
  ...
  }, [graphqlServerUrl, showMessageB, t, item.imageDbId, search]);
  ...
  }, [lastModelChanged, lastChangeTimestamp, items, item.imageDbId, count, getCount, configurePagination]);
