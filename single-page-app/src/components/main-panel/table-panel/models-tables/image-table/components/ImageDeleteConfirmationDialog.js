...
//lazy loading
const ImageDetailPanel = lazy(() => import(/* webpackChunkName: "Delete-DetailImage" */ './image-detail-panel/ImageDetailPanel'));
...
export default function ImageDeleteConfirmationDialog(props) {
  ...
  return (
    ...
    >
      ...
      {(!deleted) && (
        <DialogActions>
          <Button 
          id='ImageDeleteConfirmationDialog-button-reject'
          ...
          <Button 
          id='ImageDeleteConfirmationDialog-button-accept'
...
ImageDeleteConfirmationDialog.propTypes = {
