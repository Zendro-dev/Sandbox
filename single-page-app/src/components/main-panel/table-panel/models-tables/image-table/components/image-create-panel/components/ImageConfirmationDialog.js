...
export default function ImageConfirmationDialog(props) {
  ...
  return (
    <div>
      <Dialog id='ImageConfirmationDialog-create'
        open={open}
      ...
      >
        ...
        <DialogActions>
          ...
          {(acceptText !== '' && acceptText !== null && acceptText !== undefined) &&
            <Button
              id='ImageConfirmationDialog-create-button-accept'
              color="primary"
              variant='contained'
          ...
          {(rejectText !== '' && acceptText !== null && acceptText !== undefined) &&
            ...
            <Button
              id='ImageConfirmationDialog-create-button-reject'
              color="primary" 
...
ImageConfirmationDialog.propTypes = {
