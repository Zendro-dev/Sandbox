...
//lazy loading
const ObservationVariableDetailPanel = lazy(() => import(/* webpackChunkName: "Delete-DetailObservationVariable" */ './observationVariable-detail-panel/ObservationVariableDetailPanel'));
...
export default function ObservationVariableDeleteConfirmationDialog(props) {
  ...
  return (
    ...
    >
      ...
      {(!deleted) && (
        <DialogActions>
          <Button 
          id='ObservationVariableDeleteConfirmationDialog-button-reject'
          ...
          <Button 
          id='ObservationVariableDeleteConfirmationDialog-button-accept'
...
ObservationVariableDeleteConfirmationDialog.propTypes = {
