...
export default function ObservationVariableConfirmationDialog(props) {
  ...
  return (
    <div>
      <Dialog id='ObservationVariableConfirmationDialog-create'
        open={open}
      ...
      >
        ...
        <DialogActions>
          ...
          {(acceptText !== '' && acceptText !== null && acceptText !== undefined) &&
            <Button
              id='ObservationVariableConfirmationDialog-create-button-accept'
              color="primary"
              variant='contained'
          ...
          {(rejectText !== '' && acceptText !== null && acceptText !== undefined) &&
            ...
            <Button
              id='ObservationVariableConfirmationDialog-create-button-reject'
              color="primary" 
...
ObservationVariableConfirmationDialog.propTypes = {
