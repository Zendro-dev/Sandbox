      ...
      (response) => {
        ...
        if(response.message === 'ok') {
          ...
          if(response.graphqlErrors) {
            ...
            newError.locations=[{model: 'observationVariable', association: 'method', table:'A', method: 'getCount()', request: 'api.method.getCountItems'}];
            newError.path=['add', 'method'];
      ...
      (response) => {
        ...
        if(response.message === 'ok') {
          ...
          if(response.graphqlErrors) {
            ...
            newError.message = t('modelPanels.errors.data.e3', 'fetched with errors.');
            newError.locations=[{model: 'observationVariable', association: 'method', table:'A', method: 'getData()', request: 'api.method.getItems'}];
            newError.path=['add', 'method'];
            newError.extensions = {graphQL:{data:response.data, errors:response.graphqlErrors}};
