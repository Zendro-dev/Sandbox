...
export default function TraitCompactView(props) {
  ...
  const getData = useCallback(async () => {
    ...
    */
    ...
    let cancelableApiReq = makeCancelable(api.observationVariable.getTrait(
      graphqlServerUrl, 
      ...
      (response) => {
        ...
        if(response.message === 'ok') {
          ...
          if(response.graphqlErrors) {
            ...
            newError.locations=[{association: 'trait', method: 'getData()', request: 'api.observationVariable.getTrait'}];
            newError.path=['detail', `observationVariableDbId:${item.observationVariableDbId}`, 'trait'];
            ...
            <Card className={classes.card}>
              ...
              {(!isOnApiRequest && (!areItemsReady)) && (
                ...
                <Fade
                  ...
                  unmountOnExit
                >
                  <div id='TraitCompactView-div-noDataA'>
                    <Grid container>
                      <Grid item xs={12}>
              ...
              {(!isOnApiRequest && areItemsReady) && (
                ...
                >
                  <Box className={classes.listBox} ref={lref}>
                    <List id='TraitCompactView-list-listA'
                    dense component="div" role="list" >
                      {items.map(it => {
                        ...
                        return (
                          <ListItem 
                            id={'TraitCompactView-listA-listItem-'+it.traitDbId}
                            key={key} 
                            role="listitem" 
                            button 
                                  ...
                                  <Grid container alignItems='center' alignContent='center' wrap='nowrap' spacing={1}>
                                    <Grid item>
                                      <Tooltip title={ 'traitDbId' }>
                                        <Typography
                                        id={'TraitCompactView-listA-listItem-id-'+it.traitDbId}
                                ...
                                <React.Fragment>
                                  ...
                                  {(label) && (
                                    <Tooltip title={ 'traitName' }>
                                      <Typography
                                      id={'TraitCompactView-listA-listItem-label-'+it.traitDbId}
                                  ...
                                  {(sublabel) && (
                                    <Tooltip title={ '' }>
                                      <Typography
                                      id={'TraitCompactView-listA-listItem-sublabel-'+it.traitDbId}
