...
export default function ObservationVariableConfirmationDialog(props) {
  ...
  return (
    <div>
      <Dialog id='ObservationVariableConfirmationDialog-update'
        open={open}
      ...
      >
        ...
        <DialogActions>
          ...
          {(acceptText !== '' && acceptText !== null && acceptText !== undefined) &&
            <Button
              id='ObservationVariableConfirmationDialog-update-button-accept'
              color="primary"
              variant='contained'
          ...
          {(rejectText !== '' && acceptText !== null && acceptText !== undefined) &&
            ...
            <Button
              id='ObservationVariableConfirmationDialog-update-button-reject'
              color="primary" 
