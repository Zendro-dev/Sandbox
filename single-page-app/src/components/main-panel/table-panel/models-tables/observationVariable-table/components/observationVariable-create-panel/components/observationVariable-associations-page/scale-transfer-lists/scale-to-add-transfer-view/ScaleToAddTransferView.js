      ...
      (response) => {
        ...
        if(response.message === 'ok') {
          ...
          if(response.graphqlErrors) {
            ...
            newError.locations=[{model: 'observationVariable', association: 'scale', table:'A', method: 'getCount()', request: 'api.scale.getCountItems'}];
            newError.path=['add', 'scale'];
      ...
      (response) => {
        ...
        if(response.message === 'ok') {
          ...
          if(response.graphqlErrors) {
            ...
            newError.message = t('modelPanels.errors.data.e3', 'fetched with errors.');
            newError.locations=[{model: 'observationVariable', association: 'scale', table:'A', method: 'getData()', request: 'api.scale.getItems'}];
            newError.path=['add', 'scale'];
            newError.extensions = {graphQL:{data:response.data, errors:response.graphqlErrors}};
