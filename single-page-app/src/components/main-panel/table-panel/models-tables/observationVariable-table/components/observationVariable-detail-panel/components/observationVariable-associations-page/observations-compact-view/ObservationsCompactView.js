...
import ObservationsCompactViewToolbar from './components/ObservationsCompactViewToolbar';
import ObservationsCompactViewCursorPagination from './components/ObservationsCompactViewCursorPagination';
...
export default function ObservationsCompactView(props) {
      ...
      (response) => {
        ...
        if(response.message === 'ok') {
          ...
          if(response.graphqlErrors) {
            ...
            newError.path=['detail', `observationVariableDbId:${item.observationVariableDbId}`, 'observations'];
  ...
  }, [graphqlServerUrl, showMessageB, t, item.observationVariableDbId, search]);
  ...
  useEffect(() => {
     ...
     * 
     * Conditions:
     * A: the current item 'internalId' attribute is in the removedIds of the updated 'observation'.
     * B: the current item 'internalId' attribute is in the addedIds of the updated 'observation'.
     * 
     * Actions:
     * if A:
     * - reload table.
  ...
  }, [lastModelChanged, lastChangeTimestamp, items, item.observationVariableDbId, count, getCount, configurePagination]);
        ...
        <Grid item xs={12} >
          {(item!==undefined) && (
            <Card className={classes.card}>
              ...
              {/* Toolbar */}
              <ObservationsCompactViewToolbar 
                title={'Observations'}
                search={search}
              ...
              {(!isOnApiRequest && (!areItemsReady)) && (
                ...
                <Fade
                  ...
                  unmountOnExit
                >
                  <div id='ObservationsCompactView-div-noDataA'>
                    <Grid container>
                      <Grid item xs={12}>
              ...
              {(!isOnApiRequest && areItemsReady) && (
                ...
                >
                  <Box className={classes.listBox} ref={lref}>
                    <List id='ObservationsCompactView-list-listA'
                    dense component="div" role="list" >
                      {items.map(it => {
                        ...
                        return (
                          <ListItem 
                            id={'ObservationsCompactView-listA-listItem-'+it.observationDbId}
                            key={key} 
                            role="listitem" 
                            button 
                                  ...
                                  <Grid container alignItems='center' alignContent='center' wrap='nowrap' spacing={1}>
                                    <Grid item>
                                      <Tooltip title={ 'observationDbId' }>
                                        <Typography
                                        id={'ObservationsCompactView-listA-listItem-id-'+it.observationDbId}
                                ...
                                <React.Fragment>
                                  ...
                                  {(label) && (
                                    <Tooltip title={ 'observationVariableName' }>
                                      <Typography
                                      id={'ObservationsCompactView-listA-listItem-label-'+it.observationDbId}
                                  ...
                                  {(sublabel) && (
                                    <Tooltip title={ 'value' }>
                                      <Typography
                                      id={'ObservationsCompactView-listA-listItem-sublabel-'+it.observationDbId}
              ...
              {/* Pagination */}
              <ObservationsCompactViewCursorPagination
                count={count}
...
ObservationsCompactView.propTypes = {
  item: PropTypes.object.isRequired,
  handleClickOnObservationsRow: PropTypes.func,
};