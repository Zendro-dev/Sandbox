...
//lazy loading
const TraitToAddTransferView = lazy(() => import(/* webpackChunkName: "Create-TransferLists-ToAdd-Trait" */ './trait-to-add-transfer-view/TraitToAddTransferView'));
...
export default function TraitTransferLists(props) {
  ...
  return (
    <div id='TraitTransferLists-div-root' className={classes.root}>
