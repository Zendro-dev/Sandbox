...
//lazy loading
const ObservationVariableAttributesPage = lazy(() => import(/* webpackChunkName: "Create-AttributesObservationVariable" */ './components/observationVariable-attributes-page/ObservationVariableAttributesPage'));
const ObservationVariableAssociationsPage = lazy(() => import(/* webpackChunkName: "Create-AssociationsObservationVariable" */ './components/observationVariable-associations-page/ObservationVariableAssociationsPage'));
const ObservationVariableConfirmationDialog = lazy(() => import(/* webpackChunkName: "Create-ConfirmationObservationVariable" */ './components/ObservationVariableConfirmationDialog'));
...
export default function ObservationVariableCreatePanel(props) {
  ...
  async function doSave(event) {
    ...
    */
    ...
    /*
      API Request: api.observationVariable.createItem
    */
    ...
    await cancelableApiReq
      ...
      (response) => {
        ...
        if(response.message === 'ok') {
          ...
          if(response.graphqlErrors) {
            ...
            newError.locations=[{model: 'observationVariable', method: 'doSave()', request: 'api.observationVariable.createItem'}];
            newError.path=['ObservationVariables', 'add'];
      ...
      //error
      .catch((err) => { //error: on api.observationVariable.createItem
        if(err.isCanceled) {
          return
        } else {
          //set ajv errors
  ...
  return (
    ...
    <Dialog id='ObservationVariableCreatePanel-dialog'  
      ...
      <AppBar>
        <Toolbar>
          <Tooltip title={ t('modelPanels.cancel') }>
            <IconButton
              id='ObservationVariableCreatePanel-button-cancel'
              edge="start" 
              color="inherit"
              onClick={(event) => {
                if(!isCanceling.current){
          ...
          <Tooltip title={ t('modelPanels.save') + " observationVariable" }>
            <Fab
              id='ObservationVariableCreatePanel-fabButton-save' 
              color="secondary" 
