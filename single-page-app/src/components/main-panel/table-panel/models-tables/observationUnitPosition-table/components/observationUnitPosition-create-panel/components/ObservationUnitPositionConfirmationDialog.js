...
export default function ObservationUnitPositionConfirmationDialog(props) {
  ...
  return (
    <div>
      <Dialog id='ObservationUnitPositionConfirmationDialog-create'
        open={open}
      ...
      >
        ...
        <DialogActions>
          ...
          {(acceptText !== '' && acceptText !== null && acceptText !== undefined) &&
            <Button
              id='ObservationUnitPositionConfirmationDialog-create-button-accept'
              color="primary"
              variant='contained'
          ...
          {(rejectText !== '' && acceptText !== null && acceptText !== undefined) &&
            ...
            <Button
              id='ObservationUnitPositionConfirmationDialog-create-button-reject'
              color="primary" 
...
ObservationUnitPositionConfirmationDialog.propTypes = {
