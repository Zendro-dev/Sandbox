...
export default function ObservationUnitPositionConfirmationDialog(props) {
  ...
  return (
    <div>
      <Dialog id='ObservationUnitPositionConfirmationDialog-update'
        open={open}
      ...
      >
        ...
        <DialogActions>
          ...
          {(acceptText !== '' && acceptText !== null && acceptText !== undefined) &&
            <Button
              id='ObservationUnitPositionConfirmationDialog-update-button-accept'
              color="primary"
              variant='contained'
          ...
          {(rejectText !== '' && acceptText !== null && acceptText !== undefined) &&
            ...
            <Button
              id='ObservationUnitPositionConfirmationDialog-update-button-reject'
              color="primary" 
