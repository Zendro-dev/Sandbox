...
//lazy loading
const ObservationUnitPositionAttributesPage = lazy(() => import(/* webpackChunkName: "Detail-Attributes-ObservationUnitPosition" */ './components/observationUnitPosition-attributes-page/ObservationUnitPositionAttributesPage'));
const ObservationUnitPositionAssociationsPage = lazy(() => import(/* webpackChunkName: "Detail-Associations-ObservationUnitPosition" */ './components/observationUnitPosition-associations-page/ObservationUnitPositionAssociationsPage'));
const ObservationUnitPositionUpdatePanel = lazy(() => import(/* webpackChunkName: "Detail-Update-ObservationUnitPosition" */ '../observationUnitPosition-update-panel/ObservationUnitPositionUpdatePanel'));
const ObservationUnitPositionDeleteConfirmationDialog = lazy(() => import(/* webpackChunkName: "Detail-Delete-ObservationUnitPosition" */ '../ObservationUnitPositionDeleteConfirmationDialog'));
...
export default function ObservationUnitPositionDetailPanel(props) {
      ...
      lastModelChanged['observationUnitPosition'][String(item['observationUnitPositionDbId'])]) {
        ...
        if(lastModelChanged['observationUnitPosition'][String(item['observationUnitPositionDbId'])].op === "update"&&
            lastModelChanged['observationUnitPosition'][String(item['observationUnitPositionDbId'])].newItem) {
              //replace item
              setItemState(lastModelChanged['observationUnitPosition'][String(item['observationUnitPositionDbId'])].newItem);
              //show alert
              setUpdated(true);
        } else {
          //deleted item
  ...
  const handleUpdateDialogClose = (event, status, item, newItem, changedAssociations) => {
    if(status) {
      dispatch(modelChange('observationUnitPosition', 'update', item, newItem, changedAssociations))
    }
  ...
  const onSuccessDelete = (event, item) => {
    dispatch(modelChange('observationUnitPosition', 'delete', item, null))
          ...
          <AppBar className={classes.appBar}>
            <Toolbar>
              <Tooltip title={ t('modelPanels.close') }>
                <IconButton
                  id='ObservationUnitPositionDetailPanel-button-close'
                  edge="start"
                  color="inherit"
                  onClick={(event) => {
                    if(!isCanceling.current){
              ...
              <Typography variant="h6" className={classes.title}>
                { t('modelPanels.detailOf') +  ": ObservationUnitPosition | observationUnitPositionDbId: " + itemState['observationUnitPositionDbId'] }
              </Typography>
              {/*
                Actions:
                - Edit
              ...
              */}
              {
                ...
                &&(!deleted)&&(
                    ...
                    <Tooltip title={ t('modelPanels.edit') }>
                      <IconButton
                        id='ObservationUnitPositionDetailPanel-button-edit'
                        color='inherit'
                        onClick={(event) => {
              ...
              }
              {
                ...
                &&(!deleted)&&(
                    ...
                    <Tooltip title={ t('modelPanels.delete') }>
                      <IconButton
                        id='ObservationUnitPositionDetailPanel-button-delete'
                        color='inherit'
                        onClick={(event) => {
                          event.stopPropagation();
...
ObservationUnitPositionDetailPanel.propTypes = {
