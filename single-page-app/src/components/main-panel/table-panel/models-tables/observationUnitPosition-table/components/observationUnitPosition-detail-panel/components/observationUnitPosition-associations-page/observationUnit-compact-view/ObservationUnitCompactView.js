...
export default function ObservationUnitCompactView(props) {
  ...
  const getData = useCallback(async () => {
    ...
    */
    ...
    let cancelableApiReq = makeCancelable(api.observationUnitPosition.getObservationUnit(
      graphqlServerUrl, 
      ...
      (response) => {
        ...
        if(response.message === 'ok') {
          ...
          if(response.graphqlErrors) {
            ...
            newError.locations=[{association: 'observationUnit', method: 'getData()', request: 'api.observationUnitPosition.getObservationUnit'}];
            newError.path=['detail', `observationUnitPositionDbId:${item.observationUnitPositionDbId}`, 'observationUnit'];
  ...
  }, [graphqlServerUrl, showMessage, clearRequestGetData, t, dataTrigger, item.observationUnitPositionDbId, search]);
  ...
  }, [lastModelChanged, lastChangeTimestamp, items, item.observationUnitPositionDbId]);
