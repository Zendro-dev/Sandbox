...
export default function PersonAttributesFormView(props) {
  ...
  return (
    <div id='PersonAttributesFormView-div-root' className={classes.root}>
            ...
            <CardHeader
              ...
              title={
                <Typography variant="h6">
                    { t('modelPanels.model') + ': Person' }
                </Typography>
              }
              subheader={getItemsOk()+' / 1 ' + t('modelPanels.completed')}
            >
            </CardHeader>
          </Card>
...
PersonAttributesFormView.propTypes = {
