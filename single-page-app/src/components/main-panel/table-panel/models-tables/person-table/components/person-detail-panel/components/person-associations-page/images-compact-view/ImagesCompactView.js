...
import ImagesCompactViewToolbar from './components/ImagesCompactViewToolbar';
import ImagesCompactViewCursorPagination from './components/ImagesCompactViewCursorPagination';
...
export default function ImagesCompactView(props) {
      ...
      (response) => {
        ...
        if(response.message === 'ok') {
          ...
          if(response.graphqlErrors) {
            ...
            newError.path=['detail', `id:${item.id}`, 'images'];
  ...
  useEffect(() => {
     ...
     * 
     * Conditions:
     * A: the current item 'internalId' attribute is in the removedIds of the updated 'ImageAttachment'.
     * B: the current item 'internalId' attribute is in the addedIds of the updated 'ImageAttachment'.
     * 
     * Actions:
     * if A:
     * - reload table.
            ...
            <Card className={classes.card}>
              ...
              {(!isOnApiRequest && (!areItemsReady)) && (
                ...
                <Fade
                  ...
                  unmountOnExit
                >
                  <div id='ImagesCompactView-div-noDataA'>
                    <Grid container>
                      <Grid item xs={12}>
              ...
              {(!isOnApiRequest && areItemsReady) && (
                ...
                >
                  <Box className={classes.listBox} ref={lref}>
                    <List id='ImagesCompactView-list-listA'
                    dense component="div" role="list" >
                      {items.map(it => {
                        ...
                        return (
                          <ListItem 
                            id={'ImagesCompactView-listA-listItem-'+it.id}
                            key={key} 
                            role="listitem" 
                            button 
                                ...
                                <React.Fragment>
                                  ...
                                  <Grid container alignItems='center' alignContent='center' wrap='nowrap' spacing={1}>
                                    <Grid item>
                                      <Tooltip title={ 'id' }>
                                        <Typography
                                        id={'ImagesCompactView-listA-listItem-id-'+it.id}
                              ...
                              secondary={
                                <React.Fragment>
                                  ...
                                  {(label) && (
                                    <Tooltip title={ '' }>
                                      <Typography
                                      id={'ImagesCompactView-listA-listItem-label-'+it.id}
                                  ...
                                  {(sublabel) && (
                                    <Tooltip title={ '' }>
                                      <Typography
                                      id={'ImagesCompactView-listA-listItem-sublabel-'+it.id}
              ...
              {/* Pagination */}
              <ImagesCompactViewCursorPagination
                count={count}
...
ImagesCompactView.propTypes = {
  item: PropTypes.object.isRequired,
  handleClickOnImagesRow: PropTypes.func,
};