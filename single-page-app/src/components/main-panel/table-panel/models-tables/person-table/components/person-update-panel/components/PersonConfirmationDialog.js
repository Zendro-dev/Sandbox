...
export default function PersonConfirmationDialog(props) {
  ...
  return (
    <div>
      <Dialog id='PersonConfirmationDialog-update'
        open={open}
      ...
      >
        ...
        <DialogActions>
          ...
          {(acceptText !== '' && acceptText !== null && acceptText !== undefined) &&
            <Button
              id='PersonConfirmationDialog-update-button-accept'
              color="primary"
              variant='contained'
          ...
          {(rejectText !== '' && acceptText !== null && acceptText !== undefined) &&
            ...
            <Button
              id='PersonConfirmationDialog-update-button-reject'
              color="primary" 
...
PersonConfirmationDialog.propTypes = {
