      ...
      (response) => {
        ...
        if(response.message === 'ok') {
          ...
          if(response.graphqlErrors) {
            ...
            newError.locations=[{model: 'observationUnit', association: 'observationTreatments', table:'A', method: 'getCount()', request: 'api.observationTreatment.getCountItems'}];
            newError.path=['add', 'observationTreatments'];
      ...
      (response) => {
        ...
        if(response.message === 'ok') {
          ...
          if(response.graphqlErrors) {
            ...
            newError.message = t('modelPanels.errors.data.e3', 'fetched with errors.');
            newError.locations=[{model: 'observationUnit', association: 'observationTreatments', table:'A', method: 'getData()', request: 'api.observationTreatment.getItems'}];
            newError.path=['add', 'observationTreatments'];
            newError.extensions = {graphQL:{data:response.data, errors:response.graphqlErrors}};
