      ...
      (response) => {
        ...
        if(response.message === 'ok') {
          ...
          if(response.graphqlErrors) {
            ...
            newError.locations=[{model: 'observationUnit', association: 'events', table:'A', method: 'getCount()', request: 'api.event.getCountItems'}];
            newError.path=['add', 'events'];
      ...
      (response) => {
        ...
        if(response.message === 'ok') {
          ...
          if(response.graphqlErrors) {
            ...
            newError.message = t('modelPanels.errors.data.e3', 'fetched with errors.');
            newError.locations=[{model: 'observationUnit', association: 'events', table:'A', method: 'getData()', request: 'api.event.getItems'}];
            newError.path=['add', 'events'];
            newError.extensions = {graphQL:{data:response.data, errors:response.graphqlErrors}};
