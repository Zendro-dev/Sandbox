      ...
      (response) => {
        ...
        if(response.message === 'ok') {
          ...
          if(response.graphqlErrors) {
            ...
            newError.locations=[{model: 'observationUnit', association: 'observationUnitPosition', table:'A', method: 'getCount()', request: 'api.observationUnitPosition.getCountItems'}];
            newError.path=['add', 'observationUnitPosition'];
      ...
      (response) => {
        ...
        if(response.message === 'ok') {
          ...
          if(response.graphqlErrors) {
            ...
            newError.message = t('modelPanels.errors.data.e3', 'fetched with errors.');
            newError.locations=[{model: 'observationUnit', association: 'observationUnitPosition', table:'A', method: 'getData()', request: 'api.observationUnitPosition.getItems'}];
            newError.path=['add', 'observationUnitPosition'];
            newError.extensions = {graphQL:{data:response.data, errors:response.graphqlErrors}};
                  ...
                  dense component="div" role="list" >
                    {items.map(it => {
                      ...
                      return (
                        ...
                        >
                          <ListItemAvatar>
                            <Tooltip title={ 'observationUnitPosition' }>
                              <Avatar>{"observationUnitPosition".slice(0,1)}</Avatar>
                            </Tooltip>
                          </ListItemAvatar>
                                ...
                                <Grid container alignItems='center' alignContent='center' wrap='nowrap' spacing={1}>
                                  <Grid item>
                                    <Tooltip title={ 'observationUnitPositionDbId' }>
                                      <Typography variant="body1" display="block" noWrap={true}>{it.observationUnitPositionDbId}</Typography>
                                    </Tooltip>
                                  </Grid>
                                  {/*Key icon*/}
                                  <Grid item>
