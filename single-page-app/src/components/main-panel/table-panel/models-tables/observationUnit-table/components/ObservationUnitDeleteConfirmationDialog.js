...
//lazy loading
const ObservationUnitDetailPanel = lazy(() => import(/* webpackChunkName: "Delete-DetailObservationUnit" */ './observationUnit-detail-panel/ObservationUnitDetailPanel'));
...
export default function ObservationUnitDeleteConfirmationDialog(props) {
  ...
  return (
    ...
    >
      ...
      {(!deleted) && (
        <DialogActions>
          <Button 
          id='ObservationUnitDeleteConfirmationDialog-button-reject'
          ...
          <Button 
          id='ObservationUnitDeleteConfirmationDialog-button-accept'
...
ObservationUnitDeleteConfirmationDialog.propTypes = {
