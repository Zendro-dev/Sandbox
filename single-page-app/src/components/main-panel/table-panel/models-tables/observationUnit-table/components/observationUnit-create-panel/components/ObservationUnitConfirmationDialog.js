...
export default function ObservationUnitConfirmationDialog(props) {
  ...
  return (
    <div>
      <Dialog id='ObservationUnitConfirmationDialog-create'
        open={open}
      ...
      >
        ...
        <DialogActions>
          ...
          {(acceptText !== '' && acceptText !== null && acceptText !== undefined) &&
            <Button
              id='ObservationUnitConfirmationDialog-create-button-accept'
              color="primary"
              variant='contained'
          ...
          {(rejectText !== '' && acceptText !== null && acceptText !== undefined) &&
            ...
            <Button
              id='ObservationUnitConfirmationDialog-create-button-reject'
              color="primary" 
