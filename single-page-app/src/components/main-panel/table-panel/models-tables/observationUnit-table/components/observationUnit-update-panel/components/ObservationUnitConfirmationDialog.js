...
export default function ObservationUnitConfirmationDialog(props) {
  ...
  return (
    <div>
      <Dialog id='ObservationUnitConfirmationDialog-update'
        open={open}
      ...
      >
        ...
        <DialogActions>
          ...
          {(acceptText !== '' && acceptText !== null && acceptText !== undefined) &&
            <Button
              id='ObservationUnitConfirmationDialog-update-button-accept'
              color="primary"
              variant='contained'
          ...
          {(rejectText !== '' && acceptText !== null && acceptText !== undefined) &&
            ...
            <Button
              id='ObservationUnitConfirmationDialog-update-button-reject'
              color="primary" 
...
ObservationUnitConfirmationDialog.propTypes = {
