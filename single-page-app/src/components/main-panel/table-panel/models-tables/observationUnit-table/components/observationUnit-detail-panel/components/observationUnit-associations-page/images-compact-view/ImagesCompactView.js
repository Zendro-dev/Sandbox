      ...
      (response) => {
        ...
        if(response.message === 'ok') {
          ...
          if(response.graphqlErrors) {
            ...
            newError.path=['detail', `observationUnitDbId:${item.observationUnitDbId}`, 'images'];
                  ...
                  <Box className={classes.listBox} ref={lref}>
                    ...
                    dense component="div" role="list" >
                      {items.map(it => {
                        ...
                        return (
                          <ListItem 
                            id={'ImagesCompactView-listA-listItem-'+it.imageDbId}
                            key={key} 
                            role="listitem" 
                            button 
                                  ...
                                  <Grid container alignItems='center' alignContent='center' wrap='nowrap' spacing={1}>
                                    <Grid item>
                                      <Tooltip title={ 'imageDbId' }>
                                        <Typography
                                        id={'ImagesCompactView-listA-listItem-id-'+it.imageDbId}
                                ...
                                <React.Fragment>
                                  ...
                                  {(label) && (
                                    <Tooltip title={ 'imageName' }>
                                      <Typography
                                      id={'ImagesCompactView-listA-listItem-label-'+it.imageDbId}
                                  ...
                                  {(sublabel) && (
                                    <Tooltip title={ '' }>
                                      <Typography
                                      id={'ImagesCompactView-listA-listItem-sublabel-'+it.imageDbId}
