...
import ObservationTreatmentsCompactViewToolbar from './components/ObservationTreatmentsCompactViewToolbar';
import ObservationTreatmentsCompactViewCursorPagination from './components/ObservationTreatmentsCompactViewCursorPagination';
...
export default function ObservationTreatmentsCompactView(props) {
      ...
      (response) => {
        ...
        if(response.message === 'ok') {
          ...
          if(response.graphqlErrors) {
            ...
            newError.path=['detail', `observationUnitDbId:${item.observationUnitDbId}`, 'observationTreatments'];
  ...
  }, [graphqlServerUrl, showMessageB, t, item.observationUnitDbId, search]);
  ...
  useEffect(() => {
     ...
     * 
     * Conditions:
     * A: the current item 'internalId' attribute is in the removedIds of the updated 'observationTreatment'.
     * B: the current item 'internalId' attribute is in the addedIds of the updated 'observationTreatment'.
     * 
     * Actions:
     * if A:
     * - reload table.
  ...
  }, [lastModelChanged, lastChangeTimestamp, items, item.observationUnitDbId, count, getCount, configurePagination]);
        ...
        <Grid item xs={12} >
          {(item!==undefined) && (
            <Card className={classes.card}>
              ...
              {/* Toolbar */}
              <ObservationTreatmentsCompactViewToolbar 
              ...
              {(!isOnApiRequest && (!areItemsReady)) && (
                ...
                <Fade
                  ...
                  unmountOnExit
                >
                  <div id='ObservationTreatmentsCompactView-div-noDataA'>
                    <Grid container>
                      <Grid item xs={12}>
              ...
              {(!isOnApiRequest && areItemsReady) && (
                ...
                >
                  <Box className={classes.listBox} ref={lref}>
                    <List id='ObservationTreatmentsCompactView-list-listA'
                    dense component="div" role="list" >
                      {items.map(it => {
                        ...
                        return (
                          <ListItem 
                            id={'ObservationTreatmentsCompactView-listA-listItem-'+it.observationTreatmentDbId}
                            key={key} 
                            role="listitem" 
                            button 
                                  ...
                                  <Grid container alignItems='center' alignContent='center' wrap='nowrap' spacing={1}>
                                    <Grid item>
                                      <Tooltip title={ 'observationTreatmentDbId' }>
                                        <Typography
                                        id={'ObservationTreatmentsCompactView-listA-listItem-id-'+it.observationTreatmentDbId}
                                ...
                                <React.Fragment>
                                  ...
                                  {(label) && (
                                    <Tooltip title={ 'factor' }>
                                      <Typography
                                      id={'ObservationTreatmentsCompactView-listA-listItem-label-'+it.observationTreatmentDbId}
                                  ...
                                  {(sublabel) && (
                                    <Tooltip title={ '' }>
                                      <Typography
                                      id={'ObservationTreatmentsCompactView-listA-listItem-sublabel-'+it.observationTreatmentDbId}
              ...
              {/* Pagination */}
              <ObservationTreatmentsCompactViewCursorPagination
                count={count}
...
ObservationTreatmentsCompactView.propTypes = {
  item: PropTypes.object.isRequired,
  handleClickOnObservationTreatmentsRow: PropTypes.func,
};