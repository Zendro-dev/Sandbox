...
//lazy loading
const ScaleAttributesPage = lazy(() => import(/* webpackChunkName: "Detail-Attributes-Scale" */ './components/scale-attributes-page/ScaleAttributesPage'));
const ScaleAssociationsPage = lazy(() => import(/* webpackChunkName: "Detail-Associations-Scale" */ './components/scale-associations-page/ScaleAssociationsPage'));
const ScaleUpdatePanel = lazy(() => import(/* webpackChunkName: "Detail-Update-Scale" */ '../scale-update-panel/ScaleUpdatePanel'));
const ScaleDeleteConfirmationDialog = lazy(() => import(/* webpackChunkName: "Detail-Delete-Scale" */ '../ScaleDeleteConfirmationDialog'));
...
export default function ScaleDetailPanel(props) {
      ...
      lastModelChanged['scale'][String(item['scaleDbId'])]) {
        ...
        if(lastModelChanged['scale'][String(item['scaleDbId'])].op === "update"&&
            lastModelChanged['scale'][String(item['scaleDbId'])].newItem) {
              //replace item
              setItemState(lastModelChanged['scale'][String(item['scaleDbId'])].newItem);
              //show alert
              setUpdated(true);
        } else {
          //deleted item
  ...
  const handleUpdateDialogClose = (event, status, item, newItem, changedAssociations) => {
    if(status) {
      dispatch(modelChange('scale', 'update', item, newItem, changedAssociations))
    }
  ...
  const onSuccessDelete = (event, item) => {
    dispatch(modelChange('scale', 'delete', item, null))
          ...
          <AppBar className={classes.appBar}>
            <Toolbar>
              <Tooltip title={ t('modelPanels.close') }>
                <IconButton
                  id='ScaleDetailPanel-button-close'
                  edge="start"
                  color="inherit"
                  onClick={(event) => {
                    if(!isCanceling.current){
              ...
              <Typography variant="h6" className={classes.title}>
                { t('modelPanels.detailOf') +  ": Scale | scaleDbId: " + itemState['scaleDbId'] }
              </Typography>
              {/*
                Actions:
                - Edit
              ...
              */}
              {
                ...
                &&(!deleted)&&(
                    ...
                    <Tooltip title={ t('modelPanels.edit') }>
                      <IconButton
                        id='ScaleDetailPanel-button-edit'
                        color='inherit'
                        onClick={(event) => {
              ...
              }
              {
                ...
                &&(!deleted)&&(
                    ...
                    <Tooltip title={ t('modelPanels.delete') }>
                      <IconButton
                        id='ScaleDetailPanel-button-delete'
                        color='inherit'
                        onClick={(event) => {
                          event.stopPropagation();
