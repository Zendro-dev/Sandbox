...
export default function ObservationVariablesCompactView(props) {
      ...
      (response) => {
        ...
        if(response.message === 'ok') {
          ...
          if(response.graphqlErrors) {
            ...
            newError.path=['detail', `scaleDbId:${item.scaleDbId}`, 'observationVariables'];
  ...
  }, [graphqlServerUrl, showMessageB, t, item.scaleDbId, search]);
  ...
  }, [lastModelChanged, lastChangeTimestamp, items, item.scaleDbId, count, getCount, configurePagination]);
