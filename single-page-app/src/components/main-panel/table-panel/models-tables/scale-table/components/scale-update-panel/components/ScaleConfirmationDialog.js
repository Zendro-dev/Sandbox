...
export default function ScaleConfirmationDialog(props) {
  ...
  return (
    <div>
      <Dialog id='ScaleConfirmationDialog-update'
        open={open}
      ...
      >
        ...
        <DialogActions>
          ...
          {(acceptText !== '' && acceptText !== null && acceptText !== undefined) &&
            <Button
              id='ScaleConfirmationDialog-update-button-accept'
              color="primary"
              variant='contained'
          ...
          {(rejectText !== '' && acceptText !== null && acceptText !== undefined) &&
            ...
            <Button
              id='ScaleConfirmationDialog-update-button-reject'
              color="primary" 
...
ScaleConfirmationDialog.propTypes = {
