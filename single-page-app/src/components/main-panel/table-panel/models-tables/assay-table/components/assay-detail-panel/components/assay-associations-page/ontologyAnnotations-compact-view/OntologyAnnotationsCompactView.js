...
export default function OntologyAnnotationsCompactView(props) {
      ...
      (response) => {
        ...
        if(response.message === 'ok') {
          ...
          if(response.graphqlErrors) {
            ...
            newError.path=['detail', `assay_id:${item.assay_id}`, 'ontologyAnnotations'];
  ...
  }, [graphqlServerUrl, showMessageB, t, item.assay_id, search]);
  ...
  }, [lastModelChanged, lastChangeTimestamp, items, item.assay_id, count, getCount, configurePagination]);
