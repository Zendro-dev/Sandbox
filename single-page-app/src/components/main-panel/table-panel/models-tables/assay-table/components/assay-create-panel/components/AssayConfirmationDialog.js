...
export default function AssayConfirmationDialog(props) {
  ...
  return (
    <div>
      <Dialog id='AssayConfirmationDialog-create'
        open={open}
      ...
      >
        ...
        <DialogActions>
          ...
          {(acceptText !== '' && acceptText !== null && acceptText !== undefined) &&
            <Button
              id='AssayConfirmationDialog-create-button-accept'
              color="primary"
              variant='contained'
          ...
          {(rejectText !== '' && acceptText !== null && acceptText !== undefined) &&
            ...
            <Button
              id='AssayConfirmationDialog-create-button-reject'
              color="primary" 
...
AssayConfirmationDialog.propTypes = {
