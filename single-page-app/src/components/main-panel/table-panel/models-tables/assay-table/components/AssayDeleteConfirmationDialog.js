...
import AssayDetailPanel from './assay-detail-panel/AssayDetailPanel'
...
export default function AssayDeleteConfirmationDialog(props) {
  ...
  return (
    ...
    >
      ...
      {(!deleted) && (
        <DialogActions>
          <Button 
          id='AssayDeleteConfirmationDialog-button-reject'
          ...
          <Button 
          id='AssayDeleteConfirmationDialog-button-accept'
...
AssayDeleteConfirmationDialog.propTypes = {
