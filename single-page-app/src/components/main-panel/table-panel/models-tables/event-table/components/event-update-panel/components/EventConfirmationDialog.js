...
export default function EventConfirmationDialog(props) {
  ...
  return (
    <div>
      <Dialog id='EventConfirmationDialog-update'
        open={open}
      ...
      >
        ...
        <DialogActions>
          ...
          {(acceptText !== '' && acceptText !== null && acceptText !== undefined) &&
            <Button
              id='EventConfirmationDialog-update-button-accept'
              color="primary"
              variant='contained'
          ...
          {(rejectText !== '' && acceptText !== null && acceptText !== undefined) &&
            ...
            <Button
              id='EventConfirmationDialog-update-button-reject'
              color="primary" 
...
EventConfirmationDialog.propTypes = {
