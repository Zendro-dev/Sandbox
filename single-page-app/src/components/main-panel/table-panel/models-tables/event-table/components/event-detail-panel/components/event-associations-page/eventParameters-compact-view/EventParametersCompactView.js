...
import EventParametersCompactViewToolbar from './components/EventParametersCompactViewToolbar';
import EventParametersCompactViewCursorPagination from './components/EventParametersCompactViewCursorPagination';
...
export default function EventParametersCompactView(props) {
      ...
      (response) => {
        ...
        if(response.message === 'ok') {
          ...
          if(response.graphqlErrors) {
            ...
            newError.path=['detail', `eventType:${item.eventType}`, 'eventParameters'];
  ...
  }, [graphqlServerUrl, showMessageB, t, item.eventType, search]);
  ...
  useEffect(() => {
     ...
     * 
     * Conditions:
     * A: the current item 'internalId' attribute is in the removedIds of the updated 'eventParameter'.
     * B: the current item 'internalId' attribute is in the addedIds of the updated 'eventParameter'.
     * 
     * Actions:
     * if A:
     * - reload table.
  ...
  }, [lastModelChanged, lastChangeTimestamp, items, item.eventType, count, getCount, configurePagination]);
        ...
        <Grid item xs={12} >
          {(item!==undefined) && (
            <Card className={classes.card}>
              ...
              {/* Toolbar */}
              <EventParametersCompactViewToolbar 
              ...
              {(!isOnApiRequest && (!areItemsReady)) && (
                ...
                <Fade
                  ...
                  unmountOnExit
                >
                  <div id='EventParametersCompactView-div-noDataA'>
                    <Grid container>
                      <Grid item xs={12}>
              ...
              {(!isOnApiRequest && areItemsReady) && (
                ...
                >
                  <Box className={classes.listBox} ref={lref}>
                    <List id='EventParametersCompactView-list-listA'
                    dense component="div" role="list" >
                      {items.map(it => {
                        ...
                        return (
                          <ListItem 
                            id={'EventParametersCompactView-listA-listItem-'+it.eventParameterDbId}
                            key={key} 
                            role="listitem" 
                            button 
                                  ...
                                  <Grid container alignItems='center' alignContent='center' wrap='nowrap' spacing={1}>
                                    <Grid item>
                                      <Tooltip title={ 'eventParameterDbId' }>
                                        <Typography
                                        id={'EventParametersCompactView-listA-listItem-id-'+it.eventParameterDbId}
                              ...
                              secondary={
                                <React.Fragment>
                                  ...
                                  {(label) && (
                                    <Tooltip title={ 'key' }>
                                      <Typography
                                      id={'EventParametersCompactView-listA-listItem-label-'+it.eventParameterDbId}
                                  ...
                                  {(sublabel) && (
                                    <Tooltip title={ '' }>
                                      <Typography
                                      id={'EventParametersCompactView-listA-listItem-sublabel-'+it.eventParameterDbId}
              ...
              {/* Pagination */}
              <EventParametersCompactViewCursorPagination
                count={count}
...
EventParametersCompactView.propTypes = {
  item: PropTypes.object.isRequired,
  handleClickOnEventParametersRow: PropTypes.func,
};