      ...
      (response) => {
        ...
        if(response.message === 'ok') {
          ...
          if(response.graphqlErrors) {
            ...
            newError.locations=[{model: 'event', association: 'eventParameters', table:'A', method: 'getCount()', request: 'api.eventParameter.getCountItems'}];
            newError.path=['add', 'eventParameters'];
      ...
      (response) => {
        ...
        if(response.message === 'ok') {
          ...
          if(response.graphqlErrors) {
            ...
            newError.message = t('modelPanels.errors.data.e3', 'fetched with errors.');
            newError.locations=[{model: 'event', association: 'eventParameters', table:'A', method: 'getData()', request: 'api.eventParameter.getItems'}];
            newError.path=['add', 'eventParameters'];
            newError.extensions = {graphQL:{data:response.data, errors:response.graphqlErrors}};
