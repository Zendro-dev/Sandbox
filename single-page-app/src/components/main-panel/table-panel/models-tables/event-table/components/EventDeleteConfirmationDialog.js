...
//lazy loading
const EventDetailPanel = lazy(() => import(/* webpackChunkName: "Delete-DetailEvent" */ './event-detail-panel/EventDetailPanel'));
...
export default function EventDeleteConfirmationDialog(props) {
  ...
  return (
    ...
    >
      ...
      {(!deleted) && (
        <DialogActions>
          <Button 
          id='EventDeleteConfirmationDialog-button-reject'
          ...
          <Button 
          id='EventDeleteConfirmationDialog-button-accept'
...
EventDeleteConfirmationDialog.propTypes = {
