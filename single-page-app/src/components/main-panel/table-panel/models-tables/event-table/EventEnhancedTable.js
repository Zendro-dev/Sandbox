...
import EventCreatePanel from './components/event-create-panel/EventCreatePanel'
import EventUpdatePanel from './components/event-update-panel/EventUpdatePanel'
import EventDetailPanel from './components/event-detail-panel/EventDetailPanel'
...
//Plotly
import EventPlotly from '../../../../plots/EventPlotly';
            ...
            <Grid item xs={12}>
              <Paper className={classes.paper}>
                ...
                <EventEnhancedTableToolbar
                  ...
                  search={search}
                  showToggleButtons={Boolean(EventPlotly)}
