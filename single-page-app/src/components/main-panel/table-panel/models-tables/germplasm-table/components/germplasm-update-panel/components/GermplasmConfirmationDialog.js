...
export default function GermplasmConfirmationDialog(props) {
  ...
  return (
    <div>
      <Dialog id='GermplasmConfirmationDialog-update'
        open={open}
      ...
      >
        ...
        <DialogActions>
          ...
          {(acceptText !== '' && acceptText !== null && acceptText !== undefined) &&
            <Button
              id='GermplasmConfirmationDialog-update-button-accept'
              color="primary"
              variant='contained'
          ...
          {(rejectText !== '' && acceptText !== null && acceptText !== undefined) &&
            ...
            <Button
              id='GermplasmConfirmationDialog-update-button-reject'
              color="primary" 
...
GermplasmConfirmationDialog.propTypes = {
