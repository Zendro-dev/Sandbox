...
//lazy loading
const GermplasmAttributesPage = lazy(() => import(/* webpackChunkName: "Update-Attributes-Germplasm" */ './components/germplasm-attributes-page/GermplasmAttributesPage'));
const GermplasmAssociationsPage = lazy(() => import(/* webpackChunkName: "Update-Associations-Germplasm" */ './components/germplasm-associations-page/GermplasmAssociationsPage'));
const GermplasmConfirmationDialog = lazy(() => import(/* webpackChunkName: "Update-Confirmation-Germplasm" */ './components/GermplasmConfirmationDialog'));
const BreedingMethodDetailPanel = lazy(() => import(/* webpackChunkName: "Update-Detail-BreedingMethod" */ '../../../breedingMethod-table/components/breedingMethod-detail-panel/BreedingMethodDetailPanel'));
