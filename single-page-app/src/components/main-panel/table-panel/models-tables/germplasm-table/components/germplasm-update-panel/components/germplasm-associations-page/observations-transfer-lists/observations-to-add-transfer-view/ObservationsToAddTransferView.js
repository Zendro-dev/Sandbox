...
export default function ObservationsToAddTransferView(props) {
  ...
  */
  ...
  const getCount = useCallback(async () => {
    ...
    /*
      API Request: api.germplasm.getNotAssociatedObservationsCount
    */
    let api = await loadApi("germplasm");
    let cancelableApiReq = makeCancelable(api.germplasm.getNotAssociatedObservationsCount(graphqlServerUrl, item.germplasmDbId, search, ops));
    ...
    await cancelableApiReq
      ...
      (response) => {
        ...
        if(response.message === 'ok') {
          ...
          if(response.graphqlErrors) {
            ...
            newError.locations=[{model: 'germplasm', association: 'observations', table:'A', method: 'getCount()', request: 'api.germplasm.getNotAssociatedObservationsCount'}];
            newError.path=['update', `germplasmDbId:${item.germplasmDbId}`, 'add', 'observations'];
      ...
      //error
      .catch((err) => { //error: on api.germplasm.getNotAssociatedObservationsCount
        if(err.isCanceled) {
          return;
        } else {
          //show error
  ...
  const getData = useCallback(async () => {
    ...
    /*
      API Request: api.germplasm.getNotAssociatedObservations
    */
    let api = await loadApi("germplasm");
    let cancelableApiReq = makeCancelable(api.germplasm.getNotAssociatedObservations(
      graphqlServerUrl,
      item.germplasmDbId,
      search,
      variables,
    ...
    await cancelableApiReq
      ...
      (response) => {
        ...
        if(response.message === 'ok') {
          ...
          if(response.graphqlErrors) {
            ...
            newError.message = t('modelPanels.errors.data.e3', 'fetched with errors.');
            newError.locations=[{model: 'germplasm', association: 'observations', table:'A', method: 'getData()', request: 'api.germplasm.getNotAssociatedObservations'}];
            newError.path=['update', `germplasmDbId:${item.germplasmDbId}`, 'add', 'observations'];
            newError.extensions = {graphQL:{data:response.data, errors:response.graphqlErrors}};
      ...
      //error
      .catch((err) => { //error: on api.germplasm.getNotAssociatedObservations
        if(err.isCanceled) {
          return;
        } else {
          let newError = {};
  ...
  }, [graphqlServerUrl, showMessage, clearRequestGetData, getCount, t, item.germplasmDbId, dataTrigger, search, configurePagination, onEmptyPage]);
      ...
      (response) => {
        ...
        if(response.message === 'ok') {
          ...
          if(response.graphqlErrors) {
            ...
            newError.message = t('modelPanels.errors.data.e3', 'fetched with errors.');
            newError.locations=[{model: 'germplasm', association: 'observations', table:'B', method: 'getCountB()', request: 'api.observation.getCountItems'}];
            newError.path=['update', `germplasmDbId:${item.germplasmDbId}`, 'add', 'observations'];          
            newError.extensions = {graphQL:{data:response.data, errors:response.graphqlErrors}};
  ...
  }, [graphqlServerUrl, showMessageD, t, item.germplasmDbId, searchB]);
      ...
      (response) => {
        ...
        if(response.message === 'ok') {
          ...
          if(response.graphqlErrors) {
            ...
            newError.message = t('modelPanels.errors.data.e3', 'fetched with errors.');
            newError.locations=[{model: 'germplasm', association: 'observations', table:'B', method: 'getDataB()', request: 'api.observation.getItems'}];
            newError.path=['update', `germplasmDbId:${item.germplasmDbId}`, 'add', 'observations'];
            newError.extensions = {graphQL:{data:response.data, errors:response.graphqlErrors}};
  ...
  }, [graphqlServerUrl, showMessageB, clearRequestGetDataB, t, item.germplasmDbId, dataTriggerB, searchB, getCountB, configurePaginationB, onEmptyPageB]);
  ...
  useEffect(() => {
    ...
    if(lastModelChanged.germplasm&&
        ...
        lastModelChanged.germplasm[String(item.germplasmDbId)].changedAssociations.observation_germplasmDbId&&
        (lastModelChanged.germplasm[String(item.germplasmDbId)].changedAssociations.observation_germplasmDbId.added ||
         lastModelChanged.germplasm[String(item.germplasmDbId)].changedAssociations.observation_germplasmDbId.removed)) {
          
          //remove any associated internalId from idsToAdd[] & update counts
          let idsAdded = lastModelChanged.germplasm[String(item.germplasmDbId)].changedAssociations.observation_germplasmDbId.idsAdded;
          if(idsAdded) {
          ...
          let idsRemoved = lastModelChanged.germplasm[String(item.germplasmDbId)].changedAssociations.observation_germplasmDbId.idsRemoved;
          if(idsRemoved) {
            //increment A
  ...
  }, [lastModelChanged, lastChangeTimestamp, items, itemsB, item.germplasmDbId, handleUntransfer, getCount, count, getCountB, countB, configurePagination, configurePaginationB]);
