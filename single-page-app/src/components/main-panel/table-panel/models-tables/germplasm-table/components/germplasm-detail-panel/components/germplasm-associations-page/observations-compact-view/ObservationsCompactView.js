...
export default function ObservationsCompactView(props) {
      ...
      (response) => {
        ...
        if(response.message === 'ok') {
          ...
          if(response.graphqlErrors) {
            ...
            newError.path=['detail', `germplasmDbId:${item.germplasmDbId}`, 'observations'];
  ...
  }, [graphqlServerUrl, showMessageB, t, item.germplasmDbId, search]);
  ...
  }, [lastModelChanged, lastChangeTimestamp, items, item.germplasmDbId, count, getCount, configurePagination]);
