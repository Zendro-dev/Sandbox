...
//lazy loading
const GermplasmAttributesPage = lazy(() => import(/* webpackChunkName: "Create-AttributesGermplasm" */ './components/germplasm-attributes-page/GermplasmAttributesPage'));
const GermplasmAssociationsPage = lazy(() => import(/* webpackChunkName: "Create-AssociationsGermplasm" */ './components/germplasm-associations-page/GermplasmAssociationsPage'));
const GermplasmConfirmationDialog = lazy(() => import(/* webpackChunkName: "Create-ConfirmationGermplasm" */ './components/GermplasmConfirmationDialog'));
const BreedingMethodDetailPanel = lazy(() => import(/* webpackChunkName: "Create-DetailBreedingMethod" */ '../../../breedingMethod-table/components/breedingMethod-detail-panel/BreedingMethodDetailPanel'));
...
export default function GermplasmCreatePanel(props) {
  ...
  async function doSave(event) {
    ...
    */
    ...
    /*
      API Request: api.germplasm.createItem
    */
    ...
    await cancelableApiReq
      ...
      (response) => {
        ...
        if(response.message === 'ok') {
          ...
          if(response.graphqlErrors) {
            ...
            newError.locations=[{model: 'germplasm', method: 'doSave()', request: 'api.germplasm.createItem'}];
            newError.path=['Germplasms', 'add'];
      ...
      //error
      .catch((err) => { //error: on api.germplasm.createItem
        if(err.isCanceled) {
          return
        } else {
          //set ajv errors
  ...
  return (
    ...
    <Dialog id='GermplasmCreatePanel-dialog'  
      ...
      <AppBar>
        <Toolbar>
          <Tooltip title={ t('modelPanels.cancel') }>
            <IconButton
              id='GermplasmCreatePanel-button-cancel'
              edge="start" 
              color="inherit"
              onClick={(event) => {
                if(!isCanceling.current){
          ...
          <Tooltip title={ t('modelPanels.save') + " germplasm" }>
            <Fab
              id='GermplasmCreatePanel-fabButton-save' 
              color="secondary" 
