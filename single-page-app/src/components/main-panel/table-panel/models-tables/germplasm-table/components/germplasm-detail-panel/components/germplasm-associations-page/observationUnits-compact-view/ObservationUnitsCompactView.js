...
import ObservationUnitsCompactViewToolbar from './components/ObservationUnitsCompactViewToolbar';
import ObservationUnitsCompactViewCursorPagination from './components/ObservationUnitsCompactViewCursorPagination';
...
export default function ObservationUnitsCompactView(props) {
      ...
      (response) => {
        ...
        if(response.message === 'ok') {
          ...
          if(response.graphqlErrors) {
            ...
            newError.path=['detail', `germplasmDbId:${item.germplasmDbId}`, 'observationUnits'];
        ...
        <Grid item xs={12} >
          {(item!==undefined) && (
            <Card className={classes.card}>
              ...
              {/* Toolbar */}
              <ObservationUnitsCompactViewToolbar 
              ...
              {(!isOnApiRequest && (!areItemsReady)) && (
                ...
                <Fade
                  ...
                  unmountOnExit
                >
                  <div id='ObservationUnitsCompactView-div-noDataA'>
                    <Grid container>
                      <Grid item xs={12}>
              ...
              {(!isOnApiRequest && areItemsReady) && (
                ...
                >
                  <Box className={classes.listBox} ref={lref}>
                    <List id='ObservationUnitsCompactView-list-listA'
                    dense component="div" role="list" >
                      {items.map(it => {
                        ...
                        return (
                          <ListItem 
                            id={'ObservationUnitsCompactView-listA-listItem-'+it.observationUnitDbId}
                            key={key} 
                            role="listitem" 
                            button 
                                  ...
                                  <Grid container alignItems='center' alignContent='center' wrap='nowrap' spacing={1}>
                                    <Grid item>
                                      <Tooltip title={ 'observationUnitDbId' }>
                                        <Typography
                                        id={'ObservationUnitsCompactView-listA-listItem-id-'+it.observationUnitDbId}
                                ...
                                <React.Fragment>
                                  ...
                                  {(label) && (
                                    <Tooltip title={ 'observationUnitName' }>
                                      <Typography
                                      id={'ObservationUnitsCompactView-listA-listItem-label-'+it.observationUnitDbId}
                                  ...
                                  {(sublabel) && (
                                    <Tooltip title={ '' }>
                                      <Typography
                                      id={'ObservationUnitsCompactView-listA-listItem-sublabel-'+it.observationUnitDbId}
              ...
              {/* Pagination */}
              <ObservationUnitsCompactViewCursorPagination
                count={count}
...
ObservationUnitsCompactView.propTypes = {
  item: PropTypes.object.isRequired,
  handleClickOnObservationUnitsRow: PropTypes.func,
};