...
//lazy loading
const GermplasmDetailPanel = lazy(() => import(/* webpackChunkName: "Delete-DetailGermplasm" */ './germplasm-detail-panel/GermplasmDetailPanel'));
...
export default function GermplasmDeleteConfirmationDialog(props) {
  ...
  return (
    ...
    >
      ...
      {(!deleted) && (
        <DialogActions>
          <Button 
          id='GermplasmDeleteConfirmationDialog-button-reject'
          ...
          <Button 
          id='GermplasmDeleteConfirmationDialog-button-accept'
...
GermplasmDeleteConfirmationDialog.propTypes = {
