...
import BooksCompactViewCursorPagination from './components/BooksCompactViewCursorPagination';
...
export default function BooksCompactView(props) {
      ...
      (response) => {
        ...
        if(response.message === 'ok') {
          ...
          if(response.graphqlErrors) {
            ...
            newError.path=['detail', `author_id:${item.author_id}`, 'books'];
  ...
  }, [graphqlServerUrl, showMessageB, t, item.author_id, search]);
  ...
  useEffect(() => {
     ...
     * 
     * Conditions:
     * A: the current item 'internalId' attribute is in the removedIds of the updated 'book'.
     * B: the current item 'internalId' attribute is in the addedIds of the updated 'book'.
     * 
     * Actions:
     * if A:
     * - reload table.
  ...
  }, [lastModelChanged, lastChangeTimestamp, items, item.author_id, count, getCount, configurePagination]);
        ...
        <Grid item xs={12} >
          {(item!==undefined) && (
            <Card className={classes.card}>
                  ...
                  <Box className={classes.listBox} ref={lref}>
                    ...
                    dense component="div" role="list" >
                      {items.map(it => {
                        ...
                        return (
                          <ListItem 
                            id={'BooksCompactView-listA-listItem-'+it.book_id}
                            key={key} 
                            role="listitem" 
                            button 
                                  ...
                                  <Grid container alignItems='center' alignContent='center' wrap='nowrap' spacing={1}>
                                    <Grid item>
                                      <Tooltip title={ 'book_id' }>
                                        <Typography
                                        id={'BooksCompactView-listA-listItem-id-'+it.book_id}
                              ...
                              secondary={
                                <React.Fragment>
                                  ...
                                  {(label) && (
                                    <Tooltip title={ 'name' }>
                                      <Typography
                                      id={'BooksCompactView-listA-listItem-label-'+it.book_id}
                                  ...
                                  {(sublabel) && (
                                    <Tooltip title={ '' }>
                                      <Typography
                                      id={'BooksCompactView-listA-listItem-sublabel-'+it.book_id}
              ...
              {/* Pagination */}
              <BooksCompactViewCursorPagination
                count={count}
