...
export default function AuthorConfirmationDialog(props) {
  ...
  return (
    <div>
      <Dialog id='AuthorConfirmationDialog-create'
        open={open}
      ...
      >
        ...
        <DialogActions>
          ...
          {(acceptText !== '' && acceptText !== null && acceptText !== undefined) &&
            <Button
              id='AuthorConfirmationDialog-create-button-accept'
              color="primary"
              variant='contained'
          ...
          {(rejectText !== '' && acceptText !== null && acceptText !== undefined) &&
            ...
            <Button
              id='AuthorConfirmationDialog-create-button-reject'
              color="primary" 
...
AuthorConfirmationDialog.propTypes = {
