...
//lazy loading
const AuthorDetailPanel = lazy(() => retry(() => import(/* webpackChunkName: "Delete-DetailAuthor" */ './author-detail-panel/AuthorDetailPanel')));
...
export default function AuthorDeleteConfirmationDialog(props) {
  ...
  }, [lastModelChanged, lastChangeTimestamp, item.author_id]);
  ...
  return (
    ...
    >
      ...
      {(!deleted) && (
        <DialogActions>
          <Button 
          id='AuthorDeleteConfirmationDialog-button-reject'
          ...
          <Button 
          id='AuthorDeleteConfirmationDialog-button-accept'
...
AuthorDeleteConfirmationDialog.propTypes = {
