...
import ProgramsCompactViewToolbar from './components/ProgramsCompactViewToolbar';
import ProgramsCompactViewCursorPagination from './components/ProgramsCompactViewCursorPagination';
...
export default function ProgramsCompactView(props) {
      ...
      (response) => {
        ...
        if(response.message === 'ok') {
          ...
          if(response.graphqlErrors) {
            ...
            newError.path=['detail', `contactDbId:${item.contactDbId}`, 'programs'];
  ...
  }, [graphqlServerUrl, showMessageB, t, item.contactDbId, search]);
  ...
  useEffect(() => {
     ...
     * 
     * Conditions:
     * A: the current item 'internalId' attribute is in the removedIds of the updated 'program'.
     * B: the current item 'internalId' attribute is in the addedIds of the updated 'program'.
     * 
     * Actions:
     * if A:
     * - reload table.
  ...
  }, [lastModelChanged, lastChangeTimestamp, items, item.contactDbId, count, getCount, configurePagination]);
            ...
            <Card className={classes.card}>
              ...
              {(!isOnApiRequest && (!areItemsReady)) && (
                ...
                <Fade
                  ...
                  unmountOnExit
                >
                  <div id='ProgramsCompactView-div-noDataA'>
                    <Grid container>
                      <Grid item xs={12}>
              ...
              {(!isOnApiRequest && areItemsReady) && (
                ...
                >
                  <Box className={classes.listBox} ref={lref}>
                    <List id='ProgramsCompactView-list-listA'
                    dense component="div" role="list" >
                      {items.map(it => {
                        ...
                        return (
                          <ListItem 
                            id={'ProgramsCompactView-listA-listItem-'+it.programDbId}
                            key={key} 
                            role="listitem" 
                            button 
                                  ...
                                  <Grid container alignItems='center' alignContent='center' wrap='nowrap' spacing={1}>
                                    <Grid item>
                                      <Tooltip title={ 'programDbId' }>
                                        <Typography
                                        id={'ProgramsCompactView-listA-listItem-id-'+it.programDbId}
                                ...
                                <React.Fragment>
                                  ...
                                  {(label) && (
                                    <Tooltip title={ 'programName' }>
                                      <Typography
                                      id={'ProgramsCompactView-listA-listItem-label-'+it.programDbId}
                                  ...
                                  {(sublabel) && (
                                    <Tooltip title={ '' }>
                                      <Typography
                                      id={'ProgramsCompactView-listA-listItem-sublabel-'+it.programDbId}
              ...
              {/* Pagination */}
              <ProgramsCompactViewCursorPagination
                count={count}
...
ProgramsCompactView.propTypes = {
  item: PropTypes.object.isRequired,
  handleClickOnProgramsRow: PropTypes.func,
};