...
export default function ContactCreatePanel(props) {
  ...
  function getInitialValues() {
    ...
    initialValues.affiliation = null;
  ...
  function getInitialValueOkStates() {
    ...
    */
    ...
    initialValueOkStates.contact_id = 0;
    initialValueOkStates.name = 0;
    initialValueOkStates.email = 0;
    initialValueOkStates.phone = 0;
    initialValueOkStates.address = 0;
    initialValueOkStates.affiliation = 0;
