      ...
      (response) => {
        ...
        if(response.message === 'ok') {
          ...
          if(response.graphqlErrors) {
            ...
            newError.locations=[{model: 'contact', association: 'programs', table:'A', method: 'getCount()', request: 'api.program.getCountItems'}];
            newError.path=['add', 'programs'];
      ...
      (response) => {
        ...
        if(response.message === 'ok') {
          ...
          if(response.graphqlErrors) {
            ...
            newError.message = t('modelPanels.errors.data.e3', 'fetched with errors.');
            newError.locations=[{model: 'contact', association: 'programs', table:'A', method: 'getData()', request: 'api.program.getItems'}];
            newError.path=['add', 'programs'];
            newError.extensions = {graphQL:{data:response.data, errors:response.graphqlErrors}};
