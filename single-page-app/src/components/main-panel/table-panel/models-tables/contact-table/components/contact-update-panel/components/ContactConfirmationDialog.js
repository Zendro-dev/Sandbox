...
export default function ContactConfirmationDialog(props) {
  ...
  return (
    <div>
      <Dialog id='ContactConfirmationDialog-update'
        open={open}
      ...
      >
        ...
        <DialogActions>
          ...
          {(acceptText !== '' && acceptText !== null && acceptText !== undefined) &&
            <Button
              id='ContactConfirmationDialog-update-button-accept'
              color="primary"
              variant='contained'
          ...
          {(rejectText !== '' && acceptText !== null && acceptText !== undefined) &&
            ...
            <Button
              id='ContactConfirmationDialog-update-button-reject'
              color="primary" 
...
ContactConfirmationDialog.propTypes = {
