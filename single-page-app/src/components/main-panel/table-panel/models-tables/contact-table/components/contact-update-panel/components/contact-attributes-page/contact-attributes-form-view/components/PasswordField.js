...
export default function PasswordField(props) {
  ...
  useEffect(() => {
    ...
    if(lastModelChanged&&
      ...
      lastModelChanged['contact'][String(itemId['contact_id'])]) {

        //updated password
        if(lastModelChanged['contact'][String(itemId['contact_id'])].op === "updatePassword"&&
            lastModelChanged['contact'][String(itemId['contact_id'])].newItem) {
              //update password value
              setValue(lastModelChanged['contact'][String(itemId['contact_id'])].newItem[itemKey]);
        }
    }//end: Case 1
