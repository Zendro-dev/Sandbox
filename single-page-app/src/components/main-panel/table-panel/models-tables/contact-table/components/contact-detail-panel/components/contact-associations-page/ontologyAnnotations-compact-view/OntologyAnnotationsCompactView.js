...
export default function OntologyAnnotationsCompactView(props) {
      ...
      (response) => {
        ...
        if(response.message === 'ok') {
          ...
          if(response.graphqlErrors) {
            ...
            newError.path=['detail', `contact_id:${item.contact_id}`, 'ontologyAnnotations'];
  ...
  }, [graphqlServerUrl, showMessageB, t, item.contact_id, search]);
  ...
  }, [lastModelChanged, lastChangeTimestamp, items, item.contact_id, count, getCount, configurePagination]);
