...
//lazy loading
const ProgramsToAddTransferView = lazy(() => import(/* webpackChunkName: "Create-TransferLists-ToAdd-Programs" */ './programs-to-add-transfer-view/ProgramsToAddTransferView'));
const ProgramsToRemoveTransferView = lazy(() => import(/* webpackChunkName: "Create-TransferLists-ToRemove-Programs" */ './programs-to-remove-transfer-view/ProgramsToRemoveTransferView'));
