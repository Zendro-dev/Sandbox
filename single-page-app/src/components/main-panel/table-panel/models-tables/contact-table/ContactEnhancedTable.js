...
//lazy loading
const ContactCreatePanel = lazy(() => import(/* webpackChunkName: "Create-Contact" */ './components/contact-create-panel/ContactCreatePanel'));
const ContactUpdatePanel = lazy(() => import(/* webpackChunkName: "Update-Contact" */ './components/contact-update-panel/ContactUpdatePanel'));
const ContactDetailPanel = lazy(() => import(/* webpackChunkName: "Detail-Contact" */ './components/contact-detail-panel/ContactDetailPanel'));
const ContactDeleteConfirmationDialog = lazy(() => import(/* webpackChunkName: "Delete-Contact" */ './components/ContactDeleteConfirmationDialog'));
//Plotly
const ContactPlotly = lazy(() => import(/* webpackChunkName: "Plotly-Contact" */ '../../../../plots/ContactPlotly'));
...
export default function ContactEnhancedTable(props) {
  ...
  const [orderBy, setOrderBy] = useState('contactDbId');
                          ...
                          <TableBody id='ContactEnhancedTable-tableBody'>
                            {
                              items.map((item, index) => {
                                return ([
                                  ...
                                  */
                                  <TableRow
                                    id={'ContactEnhancedTable-row-'+item.contactDbId}
                                    hover
                                    onClick={event => handleClickOnRow(event, item)}
                                    role="checkbox"
                                    tabIndex={-1}
                                    key={item.contactDbId}
                                  >
                                    ...
                                    <TableCell padding="checkbox">
                                      <Tooltip title={ t('modelPanels.viewDetails') }>
                                        <IconButton
                                          id={'ContactEnhancedTable-row-iconButton-detail-'+item.contactDbId}
                                          color="default"
                                          onClick={event => {
                                    ...
                                    */}
                                      ...
                                      &&(
                                        <TableCell padding='checkbox' align='center'>
                                          <Tooltip title={ t('modelPanels.edit') }>
                                            <IconButton
                                              id={'ContactEnhancedTable-row-iconButton-edit-'+item.contactDbId}
                                              color="default"
                                              onClick={(event) => {
                                                event.stopPropagation();
                                      ...
                                      &&(
                                        <TableCell padding='checkbox' align='center'>
                                          <Tooltip title={ t('modelPanels.delete') }>
                                            <IconButton
                                              id={'ContactEnhancedTable-row-iconButton-delete-'+item.contactDbId}
                                              color="default"
                                              onClick={(event) => {
                                                event.stopPropagation();
                                    ...
                                    <TableCell
                                      ...
                                      padding="checkbox"
                                    >
                                      <Tooltip title={ 'contactDbId: ' + item.contactDbId}>
                                        <Typography variant='body2' color='textSecondary' display='block' noWrap={true}>{item.contactDbId}</Typography>
                                      </Tooltip>
                                    </TableCell>
                                    ...
                                    <TableCell
                                      ...
                                      padding="default"
                                    >
                                      {String((item.orcid!==null)?item.orcid:'')}
                                    </TableCell>
                                    ...
                                    <TableCell
                                      ...
                                      padding="default"
                                    >
                                      {String((item.trialDbIds!==null)?item.trialDbIds:'')}
                                    </TableCell>
