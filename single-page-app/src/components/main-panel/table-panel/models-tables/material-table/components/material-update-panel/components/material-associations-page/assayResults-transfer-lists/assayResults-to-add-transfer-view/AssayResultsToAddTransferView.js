...
export default function AssayResultsToAddTransferView(props) {
  ...
  */
  ...
  const getCount = useCallback(async () => {
    ...
    /*
      API Request: api.material.getNotAssociatedAssayResultsCount
    */
    let cancelableApiReq = makeCancelable(api.material.getNotAssociatedAssayResultsCount(graphqlServerUrl, item.material_id, search, ops));
    ...
    await cancelableApiReq
      ...
      (response) => {
        ...
        if(response.message === 'ok') {
          ...
          if(response.graphqlErrors) {
            ...
            newError.locations=[{model: 'material', association: 'assayResults', table:'A', method: 'getCount()', request: 'api.material.getNotAssociatedAssayResultsCount'}];
            newError.path=['update', `material_id:${item.material_id}`, 'add', 'assayResults'];
      ...
      //error
      .catch((err) => { //error: on api.material.getNotAssociatedAssayResultsCount
        if(err.isCanceled) {
          return;
        } else {
          //show error
  ...
  const getData = useCallback(async () => {
    ...
    /*
      API Request: api.material.getNotAssociatedAssayResults
    */
    let cancelableApiReq = makeCancelable(api.material.getNotAssociatedAssayResults(
      graphqlServerUrl,
      item.material_id,
      search,
      variables,
    ...
    await cancelableApiReq
      ...
      (response) => {
        ...
        if(response.message === 'ok') {
          ...
          if(response.graphqlErrors) {
            ...
            newError.message = t('modelPanels.errors.data.e3', 'fetched with errors.');
            newError.locations=[{model: 'material', association: 'assayResults', table:'A', method: 'getData()', request: 'api.material.getNotAssociatedAssayResults'}];
            newError.path=['update', `material_id:${item.material_id}`, 'add', 'assayResults'];
            newError.extensions = {graphQL:{data:response.data, errors:response.graphqlErrors}};
      ...
      //error
      .catch((err) => { //error: on api.material.getNotAssociatedAssayResults
        if(err.isCanceled) {
          return;
        } else {
          let newError = {};
      ...
      (response) => {
        ...
        if(response.message === 'ok') {
          ...
          if(response.graphqlErrors) {
            ...
            newError.message = t('modelPanels.errors.data.e3', 'fetched with errors.');
            newError.locations=[{model: 'material', association: 'assayResults', table:'B', method: 'getCountB()', request: 'api.assayResult.getCountItems'}];
            newError.path=['update', `material_id:${item.material_id}`, 'add', 'assayResults'];          
            newError.extensions = {graphQL:{data:response.data, errors:response.graphqlErrors}};
      ...
      (response) => {
        ...
        if(response.message === 'ok') {
          ...
          if(response.graphqlErrors) {
            ...
            newError.message = t('modelPanels.errors.data.e3', 'fetched with errors.');
            newError.locations=[{model: 'material', association: 'assayResults', table:'B', method: 'getDataB()', request: 'api.assayResult.getItems'}];
            newError.path=['update', `material_id:${item.material_id}`, 'add', 'assayResults'];
            newError.extensions = {graphQL:{data:response.data, errors:response.graphqlErrors}};
  ...
  useEffect(() => {
    ...
    if(lastModelChanged.material&&
        ...
        lastModelChanged.material[String(item.material_id)].changedAssociations.assayResult_material_id&&
        (lastModelChanged.material[String(item.material_id)].changedAssociations.assayResult_material_id.added ||
         lastModelChanged.material[String(item.material_id)].changedAssociations.assayResult_material_id.removed)) {
          
          //remove any associated internalId from idsToAdd[] & update counts
          let idsAdded = lastModelChanged.material[String(item.material_id)].changedAssociations.assayResult_material_id.idsAdded;
          if(idsAdded) {
          ...
          let idsRemoved = lastModelChanged.material[String(item.material_id)].changedAssociations.assayResult_material_id.idsRemoved;
          if(idsRemoved) {
            //increment A
