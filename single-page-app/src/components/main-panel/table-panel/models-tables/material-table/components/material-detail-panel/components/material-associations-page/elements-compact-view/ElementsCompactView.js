...
import ElementsCompactViewToolbar from './components/ElementsCompactViewToolbar';
import ElementsCompactViewCursorPagination from './components/ElementsCompactViewCursorPagination';
...
export default function ElementsCompactView(props) {
      ...
      (response) => {
        ...
        if(response.message === 'ok') {
          ...
          if(response.graphqlErrors) {
            ...
            newError.path=['detail', `material_id:${item.material_id}`, 'elements'];
            ...
            <Card className={classes.card}>
              ...
              {(!isOnApiRequest && (!areItemsReady)) && (
                ...
                <Fade
                  ...
                  unmountOnExit
                >
                  <div id='ElementsCompactView-div-noDataA'>
                    <Grid container>
                      <Grid item xs={12}>
              ...
              {(!isOnApiRequest && areItemsReady) && (
                ...
                >
                  <Box className={classes.listBox} ref={lref}>
                    <List id='ElementsCompactView-list-listA'
                    dense component="div" role="list" >
                      {items.map(it => {
                        ...
                        return (
                          <ListItem 
                            id={'ElementsCompactView-listA-listItem-'+it.material_id}
                            key={key} 
                            role="listitem" 
                            button 
                                  ...
                                  <Grid container alignItems='center' alignContent='center' wrap='nowrap' spacing={1}>
                                    <Grid item>
                                      <Tooltip title={ 'material_id' }>
                                        <Typography
                                        id={'ElementsCompactView-listA-listItem-id-'+it.material_id}
                              ...
                              secondary={
                                <React.Fragment>
                                  ...
                                  {(label) && (
                                    <Tooltip title={ 'name' }>
                                      <Typography
                                      id={'ElementsCompactView-listA-listItem-label-'+it.material_id}
                                  ...
                                  {(sublabel) && (
                                    <Tooltip title={ '' }>
                                      <Typography
                                      id={'ElementsCompactView-listA-listItem-sublabel-'+it.material_id}
              ...
              {/* Pagination */}
              <ElementsCompactViewCursorPagination
                count={count}
...
ElementsCompactView.propTypes = {
  item: PropTypes.object.isRequired,
  handleClickOnElementsRow: PropTypes.func,
};