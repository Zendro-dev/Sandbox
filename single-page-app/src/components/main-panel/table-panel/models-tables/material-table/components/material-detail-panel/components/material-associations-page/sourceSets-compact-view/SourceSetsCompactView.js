...
import SourceSetsCompactViewToolbar from './components/SourceSetsCompactViewToolbar';
import SourceSetsCompactViewCursorPagination from './components/SourceSetsCompactViewCursorPagination';
...
export default function SourceSetsCompactView(props) {
      ...
      (response) => {
        ...
        if(response.message === 'ok') {
          ...
          if(response.graphqlErrors) {
            ...
            newError.path=['detail', `material_id:${item.material_id}`, 'sourceSets'];
            ...
            <Card className={classes.card}>
              ...
              {(!isOnApiRequest && (!areItemsReady)) && (
                ...
                <Fade
                  ...
                  unmountOnExit
                >
                  <div id='SourceSetsCompactView-div-noDataA'>
                    <Grid container>
                      <Grid item xs={12}>
              ...
              {(!isOnApiRequest && areItemsReady) && (
                ...
                >
                  <Box className={classes.listBox} ref={lref}>
                    <List id='SourceSetsCompactView-list-listA'
                    dense component="div" role="list" >
                      {items.map(it => {
                        ...
                        return (
                          <ListItem 
                            id={'SourceSetsCompactView-listA-listItem-'+it.material_id}
                            key={key} 
                            role="listitem" 
                            button 
                                  ...
                                  <Grid container alignItems='center' alignContent='center' wrap='nowrap' spacing={1}>
                                    <Grid item>
                                      <Tooltip title={ 'material_id' }>
                                        <Typography
                                        id={'SourceSetsCompactView-listA-listItem-id-'+it.material_id}
                              ...
                              secondary={
                                <React.Fragment>
                                  ...
                                  {(label) && (
                                    <Tooltip title={ 'name' }>
                                      <Typography
                                      id={'SourceSetsCompactView-listA-listItem-label-'+it.material_id}
                                  ...
                                  {(sublabel) && (
                                    <Tooltip title={ '' }>
                                      <Typography
                                      id={'SourceSetsCompactView-listA-listItem-sublabel-'+it.material_id}
              ...
              {/* Pagination */}
              <SourceSetsCompactViewCursorPagination
                count={count}
...
SourceSetsCompactView.propTypes = {
  item: PropTypes.object.isRequired,
  handleClickOnSourceSetsRow: PropTypes.func,
};