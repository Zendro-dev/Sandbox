...
export default function MaterialConfirmationDialog(props) {
  ...
  return (
    <div>
      <Dialog id='MaterialConfirmationDialog-update'
        open={open}
      ...
      >
        ...
        <DialogActions>
          ...
          {(acceptText !== '' && acceptText !== null && acceptText !== undefined) &&
            <Button
              id='MaterialConfirmationDialog-update-button-accept'
              color="primary"
              variant='contained'
          ...
          {(rejectText !== '' && acceptText !== null && acceptText !== undefined) &&
            ...
            <Button
              id='MaterialConfirmationDialog-update-button-reject'
              color="primary" 
...
MaterialConfirmationDialog.propTypes = {
