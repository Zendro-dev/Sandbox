...
export default function OntologyAnnotationCompactView(props) {
      ...
      (response) => {
        ...
        if(response.message === 'ok') {
          ...
          if(response.graphqlErrors) {
            ...
            newError.path=['detail', `material_id:${item.material_id}`, 'ontologyAnnotation'];
  ...
  }, [graphqlServerUrl, showMessageB, t, item.material_id, search]);
  ...
  }, [lastModelChanged, lastChangeTimestamp, items, item.material_id, count, getCount, configurePagination]);
