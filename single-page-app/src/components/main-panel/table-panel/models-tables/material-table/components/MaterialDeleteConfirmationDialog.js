...
import MaterialDetailPanel from './material-detail-panel/MaterialDetailPanel'
...
export default function MaterialDeleteConfirmationDialog(props) {
  ...
  return (
    ...
    >
      ...
      {(!deleted) && (
        <DialogActions>
          <Button 
          id='MaterialDeleteConfirmationDialog-button-reject'
          ...
          <Button 
          id='MaterialDeleteConfirmationDialog-button-accept'
...
MaterialDeleteConfirmationDialog.propTypes = {
