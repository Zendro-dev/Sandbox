      ...
      (response) => {
        ...
        if(response.message === 'ok') {
          ...
          if(response.graphqlErrors) {
            ...
            newError.locations=[{model: 'program', association: 'trials', table:'A', method: 'getCount()', request: 'api.trial.getCountItems'}];
            newError.path=['add', 'trials'];
      ...
      (response) => {
        ...
        if(response.message === 'ok') {
          ...
          if(response.graphqlErrors) {
            ...
            newError.message = t('modelPanels.errors.data.e3', 'fetched with errors.');
            newError.locations=[{model: 'program', association: 'trials', table:'A', method: 'getData()', request: 'api.trial.getItems'}];
            newError.path=['add', 'trials'];
            newError.extensions = {graphQL:{data:response.data, errors:response.graphqlErrors}};
