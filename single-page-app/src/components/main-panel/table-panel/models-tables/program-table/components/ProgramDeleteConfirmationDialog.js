...
//lazy loading
const ProgramDetailPanel = lazy(() => import(/* webpackChunkName: "Delete-DetailProgram" */ './program-detail-panel/ProgramDetailPanel'));
...
export default function ProgramDeleteConfirmationDialog(props) {
  ...
  return (
    ...
    >
      ...
      {(!deleted) && (
        <DialogActions>
          <Button 
          id='ProgramDeleteConfirmationDialog-button-reject'
          ...
          <Button 
          id='ProgramDeleteConfirmationDialog-button-accept'
...
ProgramDeleteConfirmationDialog.propTypes = {
