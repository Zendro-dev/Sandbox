...
export default function ProgramConfirmationDialog(props) {
  ...
  return (
    <div>
      <Dialog id='ProgramConfirmationDialog-create'
        open={open}
      ...
      >
        ...
        <DialogActions>
          ...
          {(acceptText !== '' && acceptText !== null && acceptText !== undefined) &&
            <Button
              id='ProgramConfirmationDialog-create-button-accept'
              color="primary"
              variant='contained'
          ...
          {(rejectText !== '' && acceptText !== null && acceptText !== undefined) &&
            ...
            <Button
              id='ProgramConfirmationDialog-create-button-reject'
              color="primary" 
...
ProgramConfirmationDialog.propTypes = {
