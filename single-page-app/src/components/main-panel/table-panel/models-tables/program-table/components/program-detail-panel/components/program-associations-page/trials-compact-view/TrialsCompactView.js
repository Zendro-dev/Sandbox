...
import TrialsCompactViewToolbar from './components/TrialsCompactViewToolbar';
import TrialsCompactViewCursorPagination from './components/TrialsCompactViewCursorPagination';
...
export default function TrialsCompactView(props) {
      ...
      (response) => {
        ...
        if(response.message === 'ok') {
          ...
          if(response.graphqlErrors) {
            ...
            newError.path=['detail', `programDbId:${item.programDbId}`, 'trials'];
  ...
  }, [graphqlServerUrl, showMessageB, t, item.programDbId, search]);
  ...
  useEffect(() => {
     ...
     * 
     * Conditions:
     * A: the current item 'internalId' attribute is in the removedIds of the updated 'trial'.
     * B: the current item 'internalId' attribute is in the addedIds of the updated 'trial'.
     * 
     * Actions:
     * if A:
     * - reload table.
  ...
  }, [lastModelChanged, lastChangeTimestamp, items, item.programDbId, count, getCount, configurePagination]);
            ...
            <Card className={classes.card}>
              ...
              {(!isOnApiRequest && (!areItemsReady)) && (
                ...
                <Fade
                  ...
                  unmountOnExit
                >
                  <div id='TrialsCompactView-div-noDataA'>
                    <Grid container>
                      <Grid item xs={12}>
              ...
              {(!isOnApiRequest && areItemsReady) && (
                ...
                >
                  <Box className={classes.listBox} ref={lref}>
                    <List id='TrialsCompactView-list-listA'
                    dense component="div" role="list" >
                      {items.map(it => {
                        ...
                        return (
                          <ListItem 
                            id={'TrialsCompactView-listA-listItem-'+it.trialDbId}
                            key={key} 
                            role="listitem" 
                            button 
                                  ...
                                  <Grid container alignItems='center' alignContent='center' wrap='nowrap' spacing={1}>
                                    <Grid item>
                                      <Tooltip title={ 'trialDbId' }>
                                        <Typography
                                        id={'TrialsCompactView-listA-listItem-id-'+it.trialDbId}
                                ...
                                <React.Fragment>
                                  ...
                                  {(label) && (
                                    <Tooltip title={ 'trialName' }>
                                      <Typography
                                      id={'TrialsCompactView-listA-listItem-label-'+it.trialDbId}
                                  ...
                                  {(sublabel) && (
                                    <Tooltip title={ '' }>
                                      <Typography
                                      id={'TrialsCompactView-listA-listItem-sublabel-'+it.trialDbId}
              ...
              {/* Pagination */}
              <TrialsCompactViewCursorPagination
                count={count}
...
TrialsCompactView.propTypes = {
  item: PropTypes.object.isRequired,
  handleClickOnTrialsRow: PropTypes.func,
};