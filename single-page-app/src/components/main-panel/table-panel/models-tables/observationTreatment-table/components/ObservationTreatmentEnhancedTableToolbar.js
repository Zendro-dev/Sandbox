...
export default function ObservationTreatmentEnhancedTableToolbar(props) {
                    ...
                    <Grid container justify="flex-end" alignItems='center' wrap='wrap'>
                      ...
                      <Grid item>
                        <Tooltip title={ t('modelPanels.reloadList', "Reload list") }>
                          <IconButton
                            id='ObservationTreatmentEnhancedTableToolbar-iconButton-reloadTable'
                            color='inherit'
                            onClick={(event) => {
                              onReloadClick();
                            }}
                      ...
                      <Grid item>
                        ...
                        {/* Search field */}
                        <TextField
                          id='ObservationTreatmentEnhancedTableToolbar-textField-search'
                            ...
                            startAdornment: (
                              <InputAdornment position="start">
                                <Tooltip title={ t('modelPanels.search') }>
                                  <IconButton
                                    id='ObservationTreatmentEnhancedTableToolbar-iconButton-search'
                                    color='inherit'
                                    onClick={() => {
                              ...
                              <InputAdornment position="end">
                                <Tooltip title={ t('modelPanels.clearSearch') }>
                                  <span>
                                    ...
                                    {(search) && (
                                      <IconButton
                                        id='ObservationTreatmentEnhancedTableToolbar-iconButton-clearSearch'
                                        onClick={() => {
                                          onSearchEnter('');
                                          setDisplayedSearch('');
                                        }}
                          ...
                          <Grid item xs={12}>
                            <Grid container justify="center">
                              {/* Add */}
                              {
                                ...
                                &&(permissions.observationTreatment.includes('create') || permissions.observationTreatment.includes('*')))
                                &&(
                                  <Grid item>
                                    <Tooltip title={t('modelPanels.addNew') + " observationTreatment"}>
                                      <IconButton
                                        id='ObservationTreatmentEnhancedTableToolbar-button-add'
                                        color="primary"
                                ...
                                &&(
                                  <Grid item>
                                    <Tooltip title={ t('modelPanels.importCSV') }>
                                      <IconButton
                                        id='ObservationTreatmentEnhancedTableToolbar-button-import'
                                        color="primary"
                                  ...
                                  <div>
                                    ...
                                    <Grid item>
                                      <Tooltip title={ t('modelPanels.downloadsOptions', 'Download options') }>
                                        <IconButton
                                          id='ObservationTreatmentEnhancedTableToolbar-button-downloadOptions'
                                          color="primary"
                                    ...
                                    >
                                      ...
                                      <Grid item xs={12}>
                                        <Grid container justify='flex-start'>
                                          ...
                                          <input type="hidden" name="model" value='observationTreatment' />
                                            <ButtonBase
                                              id='ObservationTreatmentEnhancedTableToolbar-button-exportData'
                                      ...
                                      <Grid item xs={12}>
                                        <Grid container justify='flex-start'>
                                          <ButtonBase
                                            id='ObservationTreatmentEnhancedTableToolbar-button-exportTemplate'
                                            className={classes.textButton}
                                            color="default"
                                            onClick={()=>{
                                              if(!isDownloading.current) {
                                      ...
                                      <Grid item xs={12}>
                                        <Grid container justify='flex-end'>
                                          <Button
                                            id='ObservationTreatmentEnhancedTableToolbar-button-closeDownloadOptions'
...
ObservationTreatmentEnhancedTableToolbar.propTypes = {
