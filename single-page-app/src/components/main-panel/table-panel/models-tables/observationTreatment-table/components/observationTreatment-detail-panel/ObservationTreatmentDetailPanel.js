...
//lazy loading
const ObservationTreatmentAttributesPage = lazy(() => import(/* webpackChunkName: "Detail-Attributes-ObservationTreatment" */ './components/observationTreatment-attributes-page/ObservationTreatmentAttributesPage'));
const ObservationTreatmentAssociationsPage = lazy(() => import(/* webpackChunkName: "Detail-Associations-ObservationTreatment" */ './components/observationTreatment-associations-page/ObservationTreatmentAssociationsPage'));
const ObservationTreatmentUpdatePanel = lazy(() => import(/* webpackChunkName: "Detail-Update-ObservationTreatment" */ '../observationTreatment-update-panel/ObservationTreatmentUpdatePanel'));
const ObservationTreatmentDeleteConfirmationDialog = lazy(() => import(/* webpackChunkName: "Detail-Delete-ObservationTreatment" */ '../ObservationTreatmentDeleteConfirmationDialog'));
...
export default function ObservationTreatmentDetailPanel(props) {
      ...
      lastModelChanged['observationTreatment'][String(item['observationTreatmentDbId'])]) {
        ...
        if(lastModelChanged['observationTreatment'][String(item['observationTreatmentDbId'])].op === "update"&&
            lastModelChanged['observationTreatment'][String(item['observationTreatmentDbId'])].newItem) {
              //replace item
              setItemState(lastModelChanged['observationTreatment'][String(item['observationTreatmentDbId'])].newItem);
              //show alert
              setUpdated(true);
        } else {
          //deleted item
  ...
  const handleUpdateDialogClose = (event, status, item, newItem, changedAssociations) => {
    if(status) {
      dispatch(modelChange('observationTreatment', 'update', item, newItem, changedAssociations))
    }
  ...
  const onSuccessDelete = (event, item) => {
    dispatch(modelChange('observationTreatment', 'delete', item, null))
          ...
          <AppBar className={classes.appBar}>
            <Toolbar>
              <Tooltip title={ t('modelPanels.close') }>
                <IconButton
                  id='ObservationTreatmentDetailPanel-button-close'
                  edge="start"
                  color="inherit"
                  onClick={(event) => {
                    if(!isCanceling.current){
              ...
              <Typography variant="h6" className={classes.title}>
                { t('modelPanels.detailOf') +  ": ObservationTreatment | observationTreatmentDbId: " + itemState['observationTreatmentDbId'] }
              </Typography>
              {/*
                Actions:
                - Edit
              ...
              */}
              {
                ...
                &&(!deleted)&&(
                    ...
                    <Tooltip title={ t('modelPanels.edit') }>
                      <IconButton
                        id='ObservationTreatmentDetailPanel-button-edit'
                        color='inherit'
                        onClick={(event) => {
              ...
              }
              {
                ...
                &&(!deleted)&&(
                    ...
                    <Tooltip title={ t('modelPanels.delete') }>
                      <IconButton
                        id='ObservationTreatmentDetailPanel-button-delete'
                        color='inherit'
                        onClick={(event) => {
                          event.stopPropagation();
...
ObservationTreatmentDetailPanel.propTypes = {
