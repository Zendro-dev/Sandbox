...
//lazy loading
const ObservationTreatmentDetailPanel = lazy(() => import(/* webpackChunkName: "Delete-DetailObservationTreatment" */ './observationTreatment-detail-panel/ObservationTreatmentDetailPanel'));
...
export default function ObservationTreatmentDeleteConfirmationDialog(props) {
  ...
  return (
    ...
    >
      ...
      {(!deleted) && (
        <DialogActions>
          <Button 
          id='ObservationTreatmentDeleteConfirmationDialog-button-reject'
          ...
          <Button 
          id='ObservationTreatmentDeleteConfirmationDialog-button-accept'
...
ObservationTreatmentDeleteConfirmationDialog.propTypes = {
