...
export default function ObservationUnitCompactView(props) {
  ...
  const getData = useCallback(async () => {
    ...
    */
    ...
    let cancelableApiReq = makeCancelable(api.observationTreatment.getObservationUnit(
      graphqlServerUrl, 
      ...
      (response) => {
        ...
        if(response.message === 'ok') {
          ...
          if(response.graphqlErrors) {
            ...
            newError.locations=[{association: 'observationUnit', method: 'getData()', request: 'api.observationTreatment.getObservationUnit'}];
            newError.path=['detail', `observationTreatmentDbId:${item.observationTreatmentDbId}`, 'observationUnit'];
  ...
  }, [graphqlServerUrl, showMessage, clearRequestGetData, t, dataTrigger, item.observationTreatmentDbId, search]);
  ...
  }, [lastModelChanged, lastChangeTimestamp, items, item.observationTreatmentDbId]);
