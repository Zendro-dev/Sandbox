...
export default function ObservationTreatmentConfirmationDialog(props) {
  ...
  return (
    <div>
      <Dialog id='ObservationTreatmentConfirmationDialog-update'
        open={open}
      ...
      >
        ...
        <DialogActions>
          ...
          {(acceptText !== '' && acceptText !== null && acceptText !== undefined) &&
            <Button
              id='ObservationTreatmentConfirmationDialog-update-button-accept'
              color="primary"
              variant='contained'
          ...
          {(rejectText !== '' && acceptText !== null && acceptText !== undefined) &&
            ...
            <Button
              id='ObservationTreatmentConfirmationDialog-update-button-reject'
              color="primary" 
...
ObservationTreatmentConfirmationDialog.propTypes = {
