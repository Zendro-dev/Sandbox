...
//lazy loading
const ObservationTreatmentAttributesPage = lazy(() => import(/* webpackChunkName: "Create-AttributesObservationTreatment" */ './components/observationTreatment-attributes-page/ObservationTreatmentAttributesPage'));
const ObservationTreatmentAssociationsPage = lazy(() => import(/* webpackChunkName: "Create-AssociationsObservationTreatment" */ './components/observationTreatment-associations-page/ObservationTreatmentAssociationsPage'));
const ObservationTreatmentConfirmationDialog = lazy(() => import(/* webpackChunkName: "Create-ConfirmationObservationTreatment" */ './components/ObservationTreatmentConfirmationDialog'));
...
export default function ObservationTreatmentCreatePanel(props) {
  ...
  function getInitialValues() {
    ...
    initialValues.modality = null;
    initialValues.observationUnitDbId = null;
    initialValues.observationTreatmentDbId = null;
  ...
  function getInitialValueOkStates() {
    ...
    */
    ...
    initialValueOkStates.factor = 0;
    initialValueOkStates.modality = 0;
    initialValueOkStates.observationUnitDbId = -2; //FK
    initialValueOkStates.observationTreatmentDbId = 0;
  ...
  async function doSave(event) {
    ...
    */
    ...
    /*
      API Request: api.observationTreatment.createItem
    */
    let api = await loadApi("observationTreatment");
    let cancelableApiReq = makeCancelable(api.observationTreatment.createItem(graphqlServerUrl, variables));
    ...
    await cancelableApiReq
      ...
      (response) => {
        ...
        if(response.message === 'ok') {
          ...
          if(response.graphqlErrors) {
            ...
            newError.locations=[{model: 'observationTreatment', method: 'doSave()', request: 'api.observationTreatment.createItem'}];
            newError.path=['ObservationTreatments', 'add'];
      ...
      //error
      .catch((err) => { //error: on api.observationTreatment.createItem
        if(err.isCanceled) {
          return
        } else {
          //set ajv errors
  ...
  return (
    ...
    <Dialog id='ObservationTreatmentCreatePanel-dialog'  
      ...
      <AppBar>
        <Toolbar>
          <Tooltip title={ t('modelPanels.cancel') }>
            <IconButton
              id='ObservationTreatmentCreatePanel-button-cancel'
              edge="start" 
              color="inherit"
              onClick={(event) => {
                if(!isCanceling.current){
          ...
          <Typography variant="h6" className={classes.title}>
            {t('modelPanels.new') + ' ObservationTreatment'}
          </Typography>
          <Tooltip title={ t('modelPanels.save') + " observationTreatment" }>
            <Fab
              id='ObservationTreatmentCreatePanel-fabButton-save' 
              color="secondary" 
...
ObservationTreatmentCreatePanel.propTypes = {
