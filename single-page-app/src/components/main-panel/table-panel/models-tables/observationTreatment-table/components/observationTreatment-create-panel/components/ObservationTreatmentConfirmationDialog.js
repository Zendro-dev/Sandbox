...
export default function ObservationTreatmentConfirmationDialog(props) {
  ...
  return (
    <div>
      <Dialog id='ObservationTreatmentConfirmationDialog-create'
        open={open}
      ...
      >
        ...
        <DialogActions>
          ...
          {(acceptText !== '' && acceptText !== null && acceptText !== undefined) &&
            <Button
              id='ObservationTreatmentConfirmationDialog-create-button-accept'
              color="primary"
              variant='contained'
          ...
          {(rejectText !== '' && acceptText !== null && acceptText !== undefined) &&
            ...
            <Button
              id='ObservationTreatmentConfirmationDialog-create-button-reject'
              color="primary" 
