...
export default function SPARefactorUploadFileDialog(props) {
  ...
  const handleSubmit = (event) => {
    if(file.current !== undefined && file.current !== null) {
      ...
      let query = 'mutation{ bulkAddSPARefactorCsv }'
  ...
  return (
    ...
    >
      <DialogTitle>
      { t('modelPanels.uploading') + ' SPARefactors' }
        <div>
...
SPARefactorUploadFileDialog.propTypes = {
