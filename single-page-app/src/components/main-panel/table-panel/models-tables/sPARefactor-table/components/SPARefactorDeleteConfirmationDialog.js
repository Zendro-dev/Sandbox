...
//lazy loading
const SPARefactorDetailPanel = lazy(() => retry(() => import(/* webpackChunkName: "Delete-DetailSPARefactor" */ './sPARefactor-detail-panel/SPARefactorDetailPanel')));
...
export default function SPARefactorDeleteConfirmationDialog(props) {
  ...
  return (
    ...
    >
      ...
      {(!deleted) && (
        <DialogActions>
          <Button 
          id='SPARefactorDeleteConfirmationDialog-button-reject'
          ...
          <Button 
          id='SPARefactorDeleteConfirmationDialog-button-accept'
...
SPARefactorDeleteConfirmationDialog.propTypes = {
