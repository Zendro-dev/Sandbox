...
export default function SPARefactorConfirmationDialog(props) {
  ...
  return (
    <div>
      <Dialog id='SPARefactorConfirmationDialog-create'
        open={open}
      ...
      >
        ...
        <DialogActions>
          ...
          {(acceptText !== '' && acceptText !== null && acceptText !== undefined) &&
            <Button
              id='SPARefactorConfirmationDialog-create-button-accept'
              color="primary"
              variant='contained'
          ...
          {(rejectText !== '' && acceptText !== null && acceptText !== undefined) &&
            ...
            <Button
              id='SPARefactorConfirmationDialog-create-button-reject'
              color="primary" 
