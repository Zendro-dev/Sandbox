...
//lazy loading
const SPARefactorAttributesPage = lazy(() => retry(() => import(/* webpackChunkName: "Detail-Attributes-SPARefactor" */ './components/sPARefactor-attributes-page/SPARefactorAttributesPage')));
const SPARefactorAssociationsPage = lazy(() => retry(() => import(/* webpackChunkName: "Detail-Associations-SPARefactor" */ './components/sPARefactor-associations-page/SPARefactorAssociationsPage')));
const SPARefactorUpdatePanel = lazy(() => retry(() => import(/* webpackChunkName: "Detail-Update-SPARefactor" */ '../sPARefactor-update-panel/SPARefactorUpdatePanel')));
const SPARefactorDeleteConfirmationDialog = lazy(() => retry(() => import(/* webpackChunkName: "Detail-Delete-SPARefactor" */ '../SPARefactorDeleteConfirmationDialog')));
...
export default function SPARefactorDetailPanel(props) {
  ...
  const handleUpdateDialogClose = (event, status, item, newItem, changedAssociations) => {
    if(status) {
      dispatch(modelChange('SPARefactor', 'update', item, newItem, changedAssociations))
    }
  ...
  const onSuccessDelete = (event, item) => {
    dispatch(modelChange('SPARefactor', 'delete', item, null))
          ...
          <AppBar className={classes.appBar}>
            <Toolbar>
              <Tooltip title={ t('modelPanels.close') }>
                <IconButton
                  id='SPARefactorDetailPanel-button-close'
                  edge="start"
                  color="inherit"
                  onClick={(event) => {
                    if(!isCanceling.current){
              ...
              */}
              {
                ...
                &&(!deleted)&&(
                    ...
                    <Tooltip title={ t('modelPanels.edit') }>
                      <IconButton
                        id='SPARefactorDetailPanel-button-edit'
                        color='inherit'
                        onClick={(event) => {
              ...
              }
              {
                ...
                &&(!deleted)&&(
                    ...
                    <Tooltip title={ t('modelPanels.delete') }>
                      <IconButton
                        id='SPARefactorDetailPanel-button-delete'
                        color='inherit'
                        onClick={(event) => {
                          event.stopPropagation();
...
SPARefactorDetailPanel.propTypes = {
