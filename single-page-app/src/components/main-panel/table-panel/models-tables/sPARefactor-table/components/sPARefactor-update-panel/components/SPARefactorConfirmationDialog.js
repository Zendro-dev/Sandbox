...
export default function SPARefactorConfirmationDialog(props) {
  ...
  return (
    <div>
      <Dialog id='SPARefactorConfirmationDialog-update'
        open={open}
      ...
      >
        ...
        <DialogActions>
          ...
          {(acceptText !== '' && acceptText !== null && acceptText !== undefined) &&
            <Button
              id='SPARefactorConfirmationDialog-update-button-accept'
              color="primary"
              variant='contained'
          ...
          {(rejectText !== '' && acceptText !== null && acceptText !== undefined) &&
            ...
            <Button
              id='SPARefactorConfirmationDialog-update-button-reject'
              color="primary" 
...
SPARefactorConfirmationDialog.propTypes = {
