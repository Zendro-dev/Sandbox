...
export default function EnvironmentParameterConfirmationDialog(props) {
  ...
  return (
    <div>
      <Dialog id='EnvironmentParameterConfirmationDialog-create'
        open={open}
      ...
      >
        ...
        <DialogActions>
          ...
          {(acceptText !== '' && acceptText !== null && acceptText !== undefined) &&
            <Button
              id='EnvironmentParameterConfirmationDialog-create-button-accept'
              color="primary"
              variant='contained'
          ...
          {(rejectText !== '' && acceptText !== null && acceptText !== undefined) &&
            ...
            <Button
              id='EnvironmentParameterConfirmationDialog-create-button-reject'
              color="primary" 
