...
export default function EnvironmentParameterConfirmationDialog(props) {
  ...
  return (
    <div>
      <Dialog id='EnvironmentParameterConfirmationDialog-update'
        open={open}
      ...
      >
        ...
        <DialogActions>
          ...
          {(acceptText !== '' && acceptText !== null && acceptText !== undefined) &&
            <Button
              id='EnvironmentParameterConfirmationDialog-update-button-accept'
              color="primary"
              variant='contained'
          ...
          {(rejectText !== '' && acceptText !== null && acceptText !== undefined) &&
            ...
            <Button
              id='EnvironmentParameterConfirmationDialog-update-button-reject'
              color="primary" 
...
EnvironmentParameterConfirmationDialog.propTypes = {
