...
//lazy loading
const EnvironmentParameterAttributesPage = lazy(() => import(/* webpackChunkName: "Detail-Attributes-EnvironmentParameter" */ './components/environmentParameter-attributes-page/EnvironmentParameterAttributesPage'));
const EnvironmentParameterAssociationsPage = lazy(() => import(/* webpackChunkName: "Detail-Associations-EnvironmentParameter" */ './components/environmentParameter-associations-page/EnvironmentParameterAssociationsPage'));
const EnvironmentParameterUpdatePanel = lazy(() => import(/* webpackChunkName: "Detail-Update-EnvironmentParameter" */ '../environmentParameter-update-panel/EnvironmentParameterUpdatePanel'));
const EnvironmentParameterDeleteConfirmationDialog = lazy(() => import(/* webpackChunkName: "Detail-Delete-EnvironmentParameter" */ '../EnvironmentParameterDeleteConfirmationDialog'));
...
export default function EnvironmentParameterDetailPanel(props) {
      ...
      lastModelChanged['environmentParameter'][String(item['environmentParameterDbId'])]) {
        ...
        if(lastModelChanged['environmentParameter'][String(item['environmentParameterDbId'])].op === "update"&&
            lastModelChanged['environmentParameter'][String(item['environmentParameterDbId'])].newItem) {
              //replace item
              setItemState(lastModelChanged['environmentParameter'][String(item['environmentParameterDbId'])].newItem);
              //show alert
              setUpdated(true);
        } else {
          //deleted item
  ...
  const handleUpdateDialogClose = (event, status, item, newItem, changedAssociations) => {
    if(status) {
      dispatch(modelChange('environmentParameter', 'update', item, newItem, changedAssociations))
    }
  ...
  const onSuccessDelete = (event, item) => {
    dispatch(modelChange('environmentParameter', 'delete', item, null))
          ...
          <AppBar className={classes.appBar}>
            <Toolbar>
              <Tooltip title={ t('modelPanels.close') }>
                <IconButton
                  id='EnvironmentParameterDetailPanel-button-close'
                  edge="start"
                  color="inherit"
                  onClick={(event) => {
                    if(!isCanceling.current){
              ...
              <Typography variant="h6" className={classes.title}>
                { t('modelPanels.detailOf') +  ": EnvironmentParameter | environmentParameterDbId: " + itemState['environmentParameterDbId'] }
              </Typography>
              {/*
                Actions:
                - Edit
              ...
              */}
              {
                ...
                &&(!deleted)&&(
                    ...
                    <Tooltip title={ t('modelPanels.edit') }>
                      <IconButton
                        id='EnvironmentParameterDetailPanel-button-edit'
                        color='inherit'
                        onClick={(event) => {
              ...
              }
              {
                ...
                &&(!deleted)&&(
                    ...
                    <Tooltip title={ t('modelPanels.delete') }>
                      <IconButton
                        id='EnvironmentParameterDetailPanel-button-delete'
                        color='inherit'
                        onClick={(event) => {
                          event.stopPropagation();
...
EnvironmentParameterDetailPanel.propTypes = {
