...
export default function CountriesCompactView(props) {
      ...
      (response) => {
        ...
        if(response.message === 'ok') {
          ...
          if(response.graphqlErrors) {
            ...
            newError.path=['detail', `river_id:${item.river_id}`, 'countries'];
  ...
  }, [graphqlServerUrl, showMessageB, t, item.river_id, search]);
  ...
  }, [lastModelChanged, lastChangeTimestamp, items, item.river_id, count, getCount, configurePagination]);
