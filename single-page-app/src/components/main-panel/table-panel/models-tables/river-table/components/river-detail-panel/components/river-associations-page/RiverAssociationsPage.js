...
import RiverAssociationsMenuTabs from './RiverAssociationsMenuTabs';
...
export default function RiverAssociationsPage(props) {
  ...
  return (
    <Fade in={!deleted} timeout={500}>
      <Grid
        id='RiverAssociationsPage-div-root'
...
RiverAssociationsPage.propTypes = {
