...
export default function RiverConfirmationDialog(props) {
  ...
  return (
    <div>
      <Dialog id='RiverConfirmationDialog-create'
        open={open}
      ...
      >
        ...
        <DialogActions>
          ...
          {(acceptText !== '' && acceptText !== null && acceptText !== undefined) &&
            <Button
              id='RiverConfirmationDialog-create-button-accept'
              color="primary"
              variant='contained'
          ...
          {(rejectText !== '' && acceptText !== null && acceptText !== undefined) &&
            ...
            <Button
              id='RiverConfirmationDialog-create-button-reject'
              color="primary" 
...
RiverConfirmationDialog.propTypes = {
