...
export default function OntologyAnnotationsToAddTransferView(props) {
  ...
  */
  ...
  const getCount = useCallback(async () => {
    ...
    /*
      API Request: api.assayResult.getNotAssociatedOntologyAnnotationsCount
    */
    let cancelableApiReq = makeCancelable(api.assayResult.getNotAssociatedOntologyAnnotationsCount(graphqlServerUrl, item.assayResult_id, search, ops));
    ...
    await cancelableApiReq
      ...
      (response) => {
        ...
        if(response.message === 'ok') {
          ...
          if(response.graphqlErrors) {
            ...
            newError.locations=[{model: 'assayResult', association: 'ontologyAnnotations', table:'A', method: 'getCount()', request: 'api.assayResult.getNotAssociatedOntologyAnnotationsCount'}];
            newError.path=['update', `assayResult_id:${item.assayResult_id}`, 'add', 'ontologyAnnotations'];
      ...
      //error
      .catch((err) => { //error: on api.assayResult.getNotAssociatedOntologyAnnotationsCount
        if(err.isCanceled) {
          return;
        } else {
          //show error
  ...
  const getData = useCallback(async () => {
    ...
    /*
      API Request: api.assayResult.getNotAssociatedOntologyAnnotations
    */
    let cancelableApiReq = makeCancelable(api.assayResult.getNotAssociatedOntologyAnnotations(
      graphqlServerUrl,
      item.assayResult_id,
      search,
      variables,
    ...
    await cancelableApiReq
      ...
      (response) => {
        ...
        if(response.message === 'ok') {
          ...
          if(response.graphqlErrors) {
            ...
            newError.message = t('modelPanels.errors.data.e3', 'fetched with errors.');
            newError.locations=[{model: 'assayResult', association: 'ontologyAnnotations', table:'A', method: 'getData()', request: 'api.assayResult.getNotAssociatedOntologyAnnotations'}];
            newError.path=['update', `assayResult_id:${item.assayResult_id}`, 'add', 'ontologyAnnotations'];
            newError.extensions = {graphQL:{data:response.data, errors:response.graphqlErrors}};
      ...
      //error
      .catch((err) => { //error: on api.assayResult.getNotAssociatedOntologyAnnotations
        if(err.isCanceled) {
          return;
        } else {
          let newError = {};
  ...
  }, [graphqlServerUrl, showMessage, clearRequestGetData, getCount, t, item.assayResult_id, dataTrigger, search, configurePagination, onEmptyPage]);
      ...
      (response) => {
        ...
        if(response.message === 'ok') {
          ...
          if(response.graphqlErrors) {
            ...
            newError.message = t('modelPanels.errors.data.e3', 'fetched with errors.');
            newError.locations=[{model: 'assayResult', association: 'ontologyAnnotations', table:'B', method: 'getCountB()', request: 'api.ontologyAnnotation.getCountItems'}];
            newError.path=['update', `assayResult_id:${item.assayResult_id}`, 'add', 'ontologyAnnotations'];          
            newError.extensions = {graphQL:{data:response.data, errors:response.graphqlErrors}};
  ...
  }, [graphqlServerUrl, showMessageD, t, item.assayResult_id, searchB]);
      ...
      (response) => {
        ...
        if(response.message === 'ok') {
          ...
          if(response.graphqlErrors) {
            ...
            newError.message = t('modelPanels.errors.data.e3', 'fetched with errors.');
            newError.locations=[{model: 'assayResult', association: 'ontologyAnnotations', table:'B', method: 'getDataB()', request: 'api.ontologyAnnotation.getItems'}];
            newError.path=['update', `assayResult_id:${item.assayResult_id}`, 'add', 'ontologyAnnotations'];
            newError.extensions = {graphQL:{data:response.data, errors:response.graphqlErrors}};
  ...
  }, [graphqlServerUrl, showMessageB, clearRequestGetDataB, t, item.assayResult_id, dataTriggerB, searchB, getCountB, configurePaginationB, onEmptyPageB]);
  ...
  useEffect(() => {
    ...
    if(lastModelChanged.assayResult&&
        ...
        lastModelChanged.assayResult[String(item.assayResult_id)].changedAssociations.assayResult_ontologyAnnotation_ids&&
        (lastModelChanged.assayResult[String(item.assayResult_id)].changedAssociations.assayResult_ontologyAnnotation_ids.added ||
         lastModelChanged.assayResult[String(item.assayResult_id)].changedAssociations.assayResult_ontologyAnnotation_ids.removed)) {
          
          //remove any associated internalId from idsToAdd[] & update counts
          let idsAdded = lastModelChanged.assayResult[String(item.assayResult_id)].changedAssociations.assayResult_ontologyAnnotation_ids.idsAdded;
          if(idsAdded) {
          ...
          let idsRemoved = lastModelChanged.assayResult[String(item.assayResult_id)].changedAssociations.assayResult_ontologyAnnotation_ids.idsRemoved;
          if(idsRemoved) {
            //increment A
     ...
     * but this action happened on the peer relation, identified by 'assayResult_ontologyAnnotation_ids'.
     * 
     * Conditions:
    ...
    if(lastModelChanged.ontologyAnnotation) {
      ...
      oens.forEach( (entry) => {
        if(entry[1].changedAssociations&&
          entry[1].changedAssociations.assayResult_ontologyAnnotation_ids) {

            //case A: this item was removed from peer relation.
            if(entry[1].changedAssociations.assayResult_ontologyAnnotation_ids.removed) {
              let idsRemoved = entry[1].changedAssociations.assayResult_ontologyAnnotation_ids.idsRemoved;
              if(idsRemoved) {
            ...
            if(entry[1].changedAssociations.assayResult_ontologyAnnotation_ids.added) {
              let idsAdded = entry[1].changedAssociations.assayResult_ontologyAnnotation_ids.idsAdded;
              if(idsAdded) {
  ...
  }, [lastModelChanged, lastChangeTimestamp, items, itemsB, item.assayResult_id, handleUntransfer, getCount, count, getCountB, countB, configurePagination, configurePaginationB]);
