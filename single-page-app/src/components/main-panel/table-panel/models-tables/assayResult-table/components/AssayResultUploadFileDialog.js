...
export default function AssayResultUploadFileDialog(props) {
  ...
  const handleSubmit = (event) => {
    if(file.current !== undefined && file.current !== null) {
      ...
      let query = 'mutation{ bulkAddAssayResultCsv }'
  ...
  return (
    ...
    >
      <DialogTitle>
      { t('modelPanels.uploading') + ' AssayResults' }
        <div>
...
AssayResultUploadFileDialog.propTypes = {
