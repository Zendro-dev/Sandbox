      ...
      (response) => {
        ...
        if(response.message === 'ok') {
          ...
          if(response.graphqlErrors) {
            ...
            newError.locations=[{model: 'assayResult', association: 'observedMaterial', table:'A', method: 'getCount()', request: 'api.material.getCountItems'}];
            newError.path=['add', 'observedMaterial'];
      ...
      (response) => {
        ...
        if(response.message === 'ok') {
          ...
          if(response.graphqlErrors) {
            ...
            newError.message = t('modelPanels.errors.data.e3', 'fetched with errors.');
            newError.locations=[{model: 'assayResult', association: 'observedMaterial', table:'A', method: 'getData()', request: 'api.material.getItems'}];
            newError.path=['add', 'observedMaterial'];
            newError.extensions = {graphQL:{data:response.data, errors:response.graphqlErrors}};
