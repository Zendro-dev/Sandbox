...
import AssayResultDetailPanel from './assayResult-detail-panel/AssayResultDetailPanel'
...
export default function AssayResultDeleteConfirmationDialog(props) {
  ...
  return (
    ...
    >
      ...
      {(!deleted) && (
        <DialogActions>
          <Button 
          id='AssayResultDeleteConfirmationDialog-button-reject'
          ...
          <Button 
          id='AssayResultDeleteConfirmationDialog-button-accept'
...
AssayResultDeleteConfirmationDialog.propTypes = {
