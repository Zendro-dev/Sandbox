...
export default function AssayResultConfirmationDialog(props) {
  ...
  return (
    <div>
      <Dialog id='AssayResultConfirmationDialog-create'
        open={open}
      ...
      >
        ...
        <DialogActions>
          ...
          {(acceptText !== '' && acceptText !== null && acceptText !== undefined) &&
            <Button
              id='AssayResultConfirmationDialog-create-button-accept'
              color="primary"
              variant='contained'
          ...
          {(rejectText !== '' && acceptText !== null && acceptText !== undefined) &&
            ...
            <Button
              id='AssayResultConfirmationDialog-create-button-reject'
              color="primary" 
...
AssayResultConfirmationDialog.propTypes = {
