...
export default function OntologyAnnotationsCompactView(props) {
      ...
      (response) => {
        ...
        if(response.message === 'ok') {
          ...
          if(response.graphqlErrors) {
            ...
            newError.path=['detail', `assayResult_id:${item.assayResult_id}`, 'ontologyAnnotations'];
  ...
  }, [graphqlServerUrl, showMessageB, t, item.assayResult_id, search]);
  ...
  }, [lastModelChanged, lastChangeTimestamp, items, item.assayResult_id, count, getCount, configurePagination]);
