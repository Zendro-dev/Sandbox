...
export default function AssayResultEnhancedTableToolbar(props) {
                    ...
                    <Grid container justify="flex-end" alignItems='center' wrap='wrap'>
                      ...
                      <Grid item>
                        <Tooltip title={ t('modelPanels.reloadList', "Reload list") }>
                          <IconButton
                            id='AssayResultEnhancedTableToolbar-iconButton-reloadTable'
                            color='inherit'
                            onClick={(event) => {
                              onReloadClick();
                            }}
                      ...
                      <Grid item>
                        ...
                        {/* Search field */}
                        <TextField
                          id='AssayResultEnhancedTableToolbar-textField-search'
                            ...
                            startAdornment: (
                              <InputAdornment position="start">
                                <Tooltip title={ t('modelPanels.search') }>
                                  <IconButton
                                    id='AssayResultEnhancedTableToolbar-iconButton-search'
                                    color='inherit'
                                    onClick={() => {
                              ...
                              <InputAdornment position="end">
                                <Tooltip title={ t('modelPanels.clearSearch') }>
                                  <span>
                                    ...
                                    {(search) && (
                                      <IconButton
                                        id='AssayResultEnhancedTableToolbar-iconButton-clearSearch'
                                        onClick={() => {
                                          onSearchEnter('');
                                          setDisplayedSearch('');
                                        }}
                          ...
                          <Grid item xs={12}>
                            <Grid container justify="center">
                              {/* Add */}
                              {
                                ...
                                &&(permissions.assayResult.includes('create') || permissions.assayResult.includes('*')))
                                &&(
                                  <Grid item>
                                    <Tooltip title={t('modelPanels.addNew') + " assayResult"}>
                                      <IconButton
                                        id='AssayResultEnhancedTableToolbar-button-add'
                                        color="primary"
                                ...
                                &&(
                                  <Grid item>
                                    <Tooltip title={ t('modelPanels.importCSV') }>
                                      <IconButton
                                        id='AssayResultEnhancedTableToolbar-button-import'
                                        color="primary"
                                  ...
                                  <div>
                                    ...
                                    <Grid item>
                                      <Tooltip title={ t('modelPanels.downloadsOptions', 'Download options') }>
                                        <IconButton
                                          id='AssayResultEnhancedTableToolbar-button-downloadOptions'
                                          color="primary"
                                    ...
                                    >
                                      ...
                                      <Grid item xs={12}>
                                        <Grid container justify='flex-start'>
                                          ...
                                          <input type="hidden" name="model" value='assayResult' />
                                            <ButtonBase
                                              id='AssayResultEnhancedTableToolbar-button-exportData'
                                      ...
                                      <Grid item xs={12}>
                                        <Grid container justify='flex-start'>
                                          <ButtonBase
                                            id='AssayResultEnhancedTableToolbar-button-exportTemplate'
                                            className={classes.textButton}
                                            color="default"
                                            onClick={()=>{
                                              if(!isDownloading.current) {
                                      ...
                                      <Grid item xs={12}>
                                        <Grid container justify='flex-end'>
                                          <Button
                                            id='AssayResultEnhancedTableToolbar-button-closeDownloadOptions'
...
AssayResultEnhancedTableToolbar.propTypes = {
