          ...
          {(associationSelected === 'observedMaterial') && (
            <Grid item xs={12} sm={11}>
              <ObservedMaterialTransferLists
                ...
                idsToRemove={observedMaterialIdsToRemove}
                handleTransferToAdd={handleTransferToAdd}
                handleUntransferFromAdd={handleUntransferFromAdd}
                handleTransferToRemove={handleTransferToRemove}
                handleUntransferFromRemove={handleUntransferFromRemove}
...
AssayResultAssociationsPage.propTypes = {
  ...
  assayIdsToRemove: PropTypes.array.isRequired,
  ...
  observedMaterialIdsToRemove: PropTypes.array.isRequired,
