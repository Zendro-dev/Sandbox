...
export default function AssayResultConfirmationDialog(props) {
  ...
  return (
    <div>
      <Dialog id='AssayResultConfirmationDialog-update'
        open={open}
      ...
      >
        ...
        <DialogActions>
          ...
          {(acceptText !== '' && acceptText !== null && acceptText !== undefined) &&
            <Button
              id='AssayResultConfirmationDialog-update-button-accept'
              color="primary"
              variant='contained'
          ...
          {(rejectText !== '' && acceptText !== null && acceptText !== undefined) &&
            ...
            <Button
              id='AssayResultConfirmationDialog-update-button-reject'
              color="primary" 
