...
export default function FileAttachmentsToAddTransferView(props) {
  ...
  */
  ...
  const getCount = useCallback(async () => {
    ...
    /*
      API Request: api.assayResult.getNotAssociatedFileAttachmentsCount
    */
    let cancelableApiReq = makeCancelable(api.assayResult.getNotAssociatedFileAttachmentsCount(graphqlServerUrl, item.assayResult_id, search, ops));
    ...
    await cancelableApiReq
      ...
      (response) => {
        ...
        if(response.message === 'ok') {
          ...
          if(response.graphqlErrors) {
            ...
            newError.locations=[{model: 'assayResult', association: 'fileAttachments', table:'A', method: 'getCount()', request: 'api.assayResult.getNotAssociatedFileAttachmentsCount'}];
            newError.path=['update', `assayResult_id:${item.assayResult_id}`, 'add', 'fileAttachments'];
      ...
      //error
      .catch((err) => { //error: on api.assayResult.getNotAssociatedFileAttachmentsCount
        if(err.isCanceled) {
          return;
        } else {
          //show error
  ...
  const getData = useCallback(async () => {
    ...
    /*
      API Request: api.assayResult.getNotAssociatedFileAttachments
    */
    let cancelableApiReq = makeCancelable(api.assayResult.getNotAssociatedFileAttachments(
      graphqlServerUrl,
      item.assayResult_id,
      search,
      variables,
    ...
    await cancelableApiReq
      ...
      (response) => {
        ...
        if(response.message === 'ok') {
          ...
          if(response.graphqlErrors) {
            ...
            newError.message = t('modelPanels.errors.data.e3', 'fetched with errors.');
            newError.locations=[{model: 'assayResult', association: 'fileAttachments', table:'A', method: 'getData()', request: 'api.assayResult.getNotAssociatedFileAttachments'}];
            newError.path=['update', `assayResult_id:${item.assayResult_id}`, 'add', 'fileAttachments'];
            newError.extensions = {graphQL:{data:response.data, errors:response.graphqlErrors}};
      ...
      //error
      .catch((err) => { //error: on api.assayResult.getNotAssociatedFileAttachments
        if(err.isCanceled) {
          return;
        } else {
          let newError = {};
      ...
      (response) => {
        ...
        if(response.message === 'ok') {
          ...
          if(response.graphqlErrors) {
            ...
            newError.message = t('modelPanels.errors.data.e3', 'fetched with errors.');
            newError.locations=[{model: 'assayResult', association: 'fileAttachments', table:'B', method: 'getCountB()', request: 'api.fileAttachment.getCountItems'}];
            newError.path=['update', `assayResult_id:${item.assayResult_id}`, 'add', 'fileAttachments'];          
            newError.extensions = {graphQL:{data:response.data, errors:response.graphqlErrors}};
      ...
      (response) => {
        ...
        if(response.message === 'ok') {
          ...
          if(response.graphqlErrors) {
            ...
            newError.message = t('modelPanels.errors.data.e3', 'fetched with errors.');
            newError.locations=[{model: 'assayResult', association: 'fileAttachments', table:'B', method: 'getDataB()', request: 'api.fileAttachment.getItems'}];
            newError.path=['update', `assayResult_id:${item.assayResult_id}`, 'add', 'fileAttachments'];
            newError.extensions = {graphQL:{data:response.data, errors:response.graphqlErrors}};
  ...
  useEffect(() => {
    ...
    if(lastModelChanged.assayResult&&
        ...
        lastModelChanged.assayResult[String(item.assayResult_id)].changedAssociations.assayResult_fileAttachment_ids&&
        (lastModelChanged.assayResult[String(item.assayResult_id)].changedAssociations.assayResult_fileAttachment_ids.added ||
         lastModelChanged.assayResult[String(item.assayResult_id)].changedAssociations.assayResult_fileAttachment_ids.removed)) {
          
          //remove any associated internalId from idsToAdd[] & update counts
          let idsAdded = lastModelChanged.assayResult[String(item.assayResult_id)].changedAssociations.assayResult_fileAttachment_ids.idsAdded;
          if(idsAdded) {
          ...
          let idsRemoved = lastModelChanged.assayResult[String(item.assayResult_id)].changedAssociations.assayResult_fileAttachment_ids.idsRemoved;
          if(idsRemoved) {
            //increment A
     ...
     * but this action happened on the peer relation, identified by 'assayResult_fileAttachment_ids'.
     * 
     * Conditions:
    ...
    if(lastModelChanged.fileAttachment) {
      ...
      oens.forEach( (entry) => {
        if(entry[1].changedAssociations&&
          entry[1].changedAssociations.assayResult_fileAttachment_ids) {

            //case A: this item was removed from peer relation.
            if(entry[1].changedAssociations.assayResult_fileAttachment_ids.removed) {
              let idsRemoved = entry[1].changedAssociations.assayResult_fileAttachment_ids.idsRemoved;
              if(idsRemoved) {
            ...
            if(entry[1].changedAssociations.assayResult_fileAttachment_ids.added) {
              let idsAdded = entry[1].changedAssociations.assayResult_fileAttachment_ids.idsAdded;
              if(idsAdded) {
