...
export default function InvestigationConfirmationDialog(props) {
  ...
  return (
    <div>
      <Dialog id='InvestigationConfirmationDialog-create'
        open={open}
      ...
      >
        ...
        <DialogActions>
          ...
          {(acceptText !== '' && acceptText !== null && acceptText !== undefined) &&
            <Button
              id='InvestigationConfirmationDialog-create-button-accept'
              color="primary"
              variant='contained'
          ...
          {(rejectText !== '' && acceptText !== null && acceptText !== undefined) &&
            ...
            <Button
              id='InvestigationConfirmationDialog-create-button-reject'
              color="primary" 
