...
export default function StudiesToAddTransferView(props) {
  ...
  */
  ...
  const getCount = useCallback(async () => {
    ...
    /*
      API Request: api.investigation.getNotAssociatedStudiesCount
    */
    let cancelableApiReq = makeCancelable(api.investigation.getNotAssociatedStudiesCount(graphqlServerUrl, item.investigation_id, search, ops));
    ...
    await cancelableApiReq
      ...
      (response) => {
        ...
        if(response.message === 'ok') {
          ...
          if(response.graphqlErrors) {
            ...
            newError.locations=[{model: 'investigation', association: 'studies', table:'A', method: 'getCount()', request: 'api.investigation.getNotAssociatedStudiesCount'}];
            newError.path=['update', `investigation_id:${item.investigation_id}`, 'add', 'studies'];
      ...
      //error
      .catch((err) => { //error: on api.investigation.getNotAssociatedStudiesCount
        if(err.isCanceled) {
          return;
        } else {
          //show error
  ...
  const getData = useCallback(async () => {
    ...
    /*
      API Request: api.investigation.getNotAssociatedStudies
    */
    let cancelableApiReq = makeCancelable(api.investigation.getNotAssociatedStudies(
      graphqlServerUrl,
    ...
    await cancelableApiReq
      ...
      (response) => {
        ...
        if(response.message === 'ok') {
          ...
          if(response.graphqlErrors) {
            ...
            newError.message = t('modelPanels.errors.data.e3', 'fetched with errors.');
            newError.locations=[{model: 'investigation', association: 'studies', table:'A', method: 'getData()', request: 'api.investigation.getNotAssociatedStudies'}];
            newError.path=['update', `investigation_id:${item.investigation_id}`, 'add', 'studies'];
            newError.extensions = {graphQL:{data:response.data, errors:response.graphqlErrors}};
      ...
      //error
      .catch((err) => { //error: on api.investigation.getNotAssociatedStudies
        if(err.isCanceled) {
          return;
        } else {
          let newError = {};
      ...
      (response) => {
        ...
        if(response.message === 'ok') {
          ...
          if(response.graphqlErrors) {
            ...
            newError.message = t('modelPanels.errors.data.e3', 'fetched with errors.');
            newError.locations=[{model: 'investigation', association: 'studies', table:'B', method: 'getCountB()', request: 'api.study.getCountItems'}];
            newError.path=['update', `investigation_id:${item.investigation_id}`, 'add', 'studies'];          
            newError.extensions = {graphQL:{data:response.data, errors:response.graphqlErrors}};
      ...
      (response) => {
        ...
        if(response.message === 'ok') {
          ...
          if(response.graphqlErrors) {
            ...
            newError.message = t('modelPanels.errors.data.e3', 'fetched with errors.');
            newError.locations=[{model: 'investigation', association: 'studies', table:'B', method: 'getDataB()', request: 'api.study.getItems'}];
            newError.path=['update', `investigation_id:${item.investigation_id}`, 'add', 'studies'];
            newError.extensions = {graphQL:{data:response.data, errors:response.graphqlErrors}};
  ...
  useEffect(() => {
    ...
    if(lastModelChanged.investigation&&
        ...
        lastModelChanged.investigation[String(item.investigation_id)].changedAssociations.study_investigation_id&&
        (lastModelChanged.investigation[String(item.investigation_id)].changedAssociations.study_investigation_id.added ||
         lastModelChanged.investigation[String(item.investigation_id)].changedAssociations.study_investigation_id.removed)) {
          
          //remove any associated internalId from idsToAdd[] & update counts
          let idsAdded = lastModelChanged.investigation[String(item.investigation_id)].changedAssociations.study_investigation_id.idsAdded;
          if(idsAdded) {
          ...
          let idsRemoved = lastModelChanged.investigation[String(item.investigation_id)].changedAssociations.study_investigation_id.idsRemoved;
          if(idsRemoved) {
            //increment A
