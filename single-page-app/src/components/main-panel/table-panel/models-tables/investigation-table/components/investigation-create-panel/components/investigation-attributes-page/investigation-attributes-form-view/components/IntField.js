  ...
  return (
    <Grid container justify='flex-start' alignItems='center' spacing={0}>
      <Grid item>
        {(!refresh) && (
          <TextField
            id={'IntField-Investigation-'+name}
            value={value}
            label={label}
            type="number"
                ...
                <InputAdornment position="end">
                  {(valueOk!==undefined&&valueOk===1) 
                    ...
                    <Tooltip title={ t('modelPanels.valueEntered', "Value entered") }>
                      <Typography id={'IntField-Investigation-exists-'+name} variant="caption" color="primary">
                        &#8707;
                      </Typography>
                    </Tooltip>
                    : 
                    <Tooltip title={ t('modelPanels.valueNotEntered', "Value not entered") }>
                      <Typography id={'IntField-Investigation-notExists-'+name} variant="caption" color="textSecondary">
                        &#8708;
                      </Typography>
                    </Tooltip>
                  }
      ...
      {(valueAjv !== undefined && valueAjv.errors.length > 0) && (
        <Grid item id={'IntField-Investigation-ajvError-'+name} xs={12}>
