...
export default function InvestigationConfirmationDialog(props) {
  ...
  return (
    <div>
      <Dialog id='InvestigationConfirmationDialog-update'
        open={open}
      ...
      >
        ...
        <DialogActions>
          ...
          {(acceptText !== '' && acceptText !== null && acceptText !== undefined) &&
            <Button
              id='InvestigationConfirmationDialog-update-button-accept'
              color="primary"
              variant='contained'
          ...
          {(rejectText !== '' && acceptText !== null && acceptText !== undefined) &&
            ...
            <Button
              id='InvestigationConfirmationDialog-update-button-reject'
              color="primary" 
...
InvestigationConfirmationDialog.propTypes = {
