...
import InvestigationDetailPanel from './investigation-detail-panel/InvestigationDetailPanel'
...
export default function InvestigationDeleteConfirmationDialog(props) {
  ...
  return (
    ...
    >
      ...
      {(!deleted) && (
        <DialogActions>
          <Button 
          id='InvestigationDeleteConfirmationDialog-button-reject'
          ...
          <Button 
          id='InvestigationDeleteConfirmationDialog-button-accept'
...
InvestigationDeleteConfirmationDialog.propTypes = {
