...
import FileAttachmentsCompactViewToolbar from './components/FileAttachmentsCompactViewToolbar';
import FileAttachmentsCompactViewCursorPagination from './components/FileAttachmentsCompactViewCursorPagination';
...
export default function FileAttachmentsCompactView(props) {
      ...
      (response) => {
        ...
        if(response.message === 'ok') {
          ...
          if(response.graphqlErrors) {
            ...
            newError.path=['detail', `investigation_id:${item.investigation_id}`, 'fileAttachments'];
  ...
  useEffect(() => {
     ...
     * 
     * Conditions:
     * A: the current item 'internalId' attribute is in the removedIds of the updated 'fileAttachment'.
     * B: the current item 'internalId' attribute is in the addedIds of the updated 'fileAttachment'.
     * 
     * Actions:
     * if A:
     * - reload table.
        ...
        <Grid item xs={12} >
          {(item!==undefined) && (
            <Card className={classes.card}>
              ...
              {/* Toolbar */}
              <FileAttachmentsCompactViewToolbar 
              ...
              {(!isOnApiRequest && (!areItemsReady)) && (
                ...
                <Fade
                  ...
                  unmountOnExit
                >
                  <div id='FileAttachmentsCompactView-div-noDataA'>
                    <Grid container>
                      <Grid item xs={12}>
              ...
              {(!isOnApiRequest && areItemsReady) && (
                ...
                >
                  <Box className={classes.listBox} ref={lref}>
                    <List id='FileAttachmentsCompactView-list-listA'
                    dense component="div" role="list" >
                      {items.map(it => {
                        ...
                        return (
                          <ListItem 
                            id={'FileAttachmentsCompactView-listA-listItem-'+it.fileAttachment_id}
                            key={key} 
                            role="listitem" 
                            button 
                                  ...
                                  <Grid container alignItems='center' alignContent='center' wrap='nowrap' spacing={1}>
                                    <Grid item>
                                      <Tooltip title={ 'fileAttachment_id' }>
                                        <Typography
                                        id={'FileAttachmentsCompactView-listA-listItem-id-'+it.fileAttachment_id}
                                ...
                                <React.Fragment>
                                  ...
                                  {(label) && (
                                    <Tooltip title={ 'fileName' }>
                                      <Typography
                                      id={'FileAttachmentsCompactView-listA-listItem-label-'+it.fileAttachment_id}
                                  ...
                                  {(sublabel) && (
                                    <Tooltip title={ '' }>
                                      <Typography
                                      id={'FileAttachmentsCompactView-listA-listItem-sublabel-'+it.fileAttachment_id}
              ...
              {/* Pagination */}
              <FileAttachmentsCompactViewCursorPagination
                count={count}
...
FileAttachmentsCompactView.propTypes = {
  item: PropTypes.object.isRequired,
  handleClickOnFileAttachmentsRow: PropTypes.func,
};