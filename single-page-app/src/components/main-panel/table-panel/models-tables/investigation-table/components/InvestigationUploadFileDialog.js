...
export default function InvestigationUploadFileDialog(props) {
  ...
  const handleSubmit = (event) => {
    if(file.current !== undefined && file.current !== null) {
      ...
      let query = 'mutation{ bulkAddInvestigationCsv }'
  ...
  return (
    ...
    >
      <DialogTitle>
      { t('modelPanels.uploading') + ' Investigations' }
        <div>
...
InvestigationUploadFileDialog.propTypes = {
