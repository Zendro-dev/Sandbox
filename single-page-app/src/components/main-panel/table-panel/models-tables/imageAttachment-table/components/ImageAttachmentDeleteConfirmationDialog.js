...
import ImageAttachmentDetailPanel from './imageAttachment-detail-panel/ImageAttachmentDetailPanel'
...
export default function ImageAttachmentDeleteConfirmationDialog(props) {
  ...
  return (
    ...
    >
      ...
      {(!deleted) && (
        <DialogActions>
          <Button 
          id='ImageAttachmentDeleteConfirmationDialog-button-reject'
          ...
          <Button 
          id='ImageAttachmentDeleteConfirmationDialog-button-accept'
...
ImageAttachmentDeleteConfirmationDialog.propTypes = {
