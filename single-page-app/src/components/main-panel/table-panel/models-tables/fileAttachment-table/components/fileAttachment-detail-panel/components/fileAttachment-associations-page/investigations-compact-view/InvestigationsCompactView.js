...
export default function InvestigationsCompactView(props) {
      ...
      (response) => {
        ...
        if(response.message === 'ok') {
          ...
          if(response.graphqlErrors) {
            ...
            newError.path=['detail', `fileAttachment_id:${item.fileAttachment_id}`, 'investigations'];
  ...
  }, [graphqlServerUrl, showMessageB, t, item.fileAttachment_id, search]);
  ...
  }, [lastModelChanged, lastChangeTimestamp, items, item.fileAttachment_id, count, getCount, configurePagination]);
