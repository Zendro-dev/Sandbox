      ...
      lastModelChanged['fileAttachment'][String(item['fileAttachment_id'])]) {
        ...
        if(lastModelChanged['fileAttachment'][String(item['fileAttachment_id'])].op === "update"&&
            lastModelChanged['fileAttachment'][String(item['fileAttachment_id'])].newItem) {
              //replace item
              setItemState(lastModelChanged['fileAttachment'][String(item['fileAttachment_id'])].newItem);
              //show alert
              setUpdated(true);
        } else {
          //deleted item
          ...
          <AppBar className={classes.appBar}>
            <Toolbar>
              ...
              <Typography variant="h6" className={classes.title}>
                { t('modelPanels.detailOf') +  ": FileAttachment | fileAttachment_id: " + itemState['fileAttachment_id'] }
              </Typography>
              {/*
                Actions:
                - Edit
