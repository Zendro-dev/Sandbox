...
export default function FileAttachmentUploadFileDialog(props) {
  ...
  const handleSubmit = (event) => {
    if(file.current !== undefined && file.current !== null) {
      ...
      let query = 'mutation{ bulkAddFileAttachmentCsv{ id} }'
  ...
  return (
    ...
    >
      <DialogTitle>
      { t('modelPanels.uploading') + ' FileAttachments' }
        <div>
...
FileAttachmentUploadFileDialog.propTypes = {
