...
export default function PasswordField(props) {
  ...
  useEffect(() => {
    ...
    if(lastModelChanged&&
      ...
      lastModelChanged['fileAttachment'][String(itemId['fileAttachment_id'])]) {

        //updated password
        if(lastModelChanged['fileAttachment'][String(itemId['fileAttachment_id'])].op === "updatePassword"&&
            lastModelChanged['fileAttachment'][String(itemId['fileAttachment_id'])].newItem) {
              //update password value
              setValue(lastModelChanged['fileAttachment'][String(itemId['fileAttachment_id'])].newItem[itemKey]);
        }
    }//end: Case 1
