  ...
  return (
    <div>
      <Grid container justify='flex-start' alignItems='center' spacing={2}>
        <Grid item xs={12}>
          <form noValidate autoComplete="off">
            <TextField
              id={'StringField-FileAttachment-'+name}
              label={label}
              value={value}
                ...
                endAdornment:
                  <InputAdornment position="end">
                    <Tooltip title={ t('modelPanels.showPassword', 'Show password') }>
                      <IconButton
                        id={'StringField-FileAttachment-button-showPassword'+name}
      ...
      {(changePasswordDialogOpen) && (
        <Dialog 
          id={'StringField-FileAttachment-ChangePasswordDialog-'+name} 
          ...
          <DialogContent>
            ...
            <form noValidate autoComplete="off">
              <Grid container justify='center' alignItems='center' spacing={2}>
                <Grid item xs={12}>
                  <TextField
                    id={'StringField-FileAttachment-ChangePasswordDialog-textField-newPassword-'+name}
                ...
                <Grid item xs={12}>
                  <TextField
                    id={'StringField-FileAttachment-ChangePasswordDialog-textField-newPassword2-'+name}
