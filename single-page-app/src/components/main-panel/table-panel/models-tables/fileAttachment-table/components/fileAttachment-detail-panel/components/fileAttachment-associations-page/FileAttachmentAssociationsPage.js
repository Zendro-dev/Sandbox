...
import FileAttachmentAssociationsMenuTabs from './FileAttachmentAssociationsMenuTabs'
...
export default function FileAttachmentAssociationsPage(props) {
  ...
  return (
    <Fade in={!deleted} timeout={500}>
      <Grid
        id='FileAttachmentAssociationsPage-div-root'
      ...
      > 
        ...
        <Grid item xs={12} sm={10} md={9} lg={8} xl={7} className={classes.menu}>
          <FileAttachmentAssociationsMenuTabs
...
FileAttachmentAssociationsPage.propTypes = {
