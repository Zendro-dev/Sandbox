...
export default function FileAttachmentConfirmationDialog(props) {
  ...
  return (
    <div>
      <Dialog id='FileAttachmentConfirmationDialog-create'
        open={open}
      ...
      >
        ...
        <DialogActions>
          ...
          {(acceptText !== '' && acceptText !== null && acceptText !== undefined) &&
            <Button
              id='FileAttachmentConfirmationDialog-create-button-accept'
              color="primary"
              variant='contained'
          ...
          {(rejectText !== '' && acceptText !== null && acceptText !== undefined) &&
            ...
            <Button
              id='FileAttachmentConfirmationDialog-create-button-reject'
              color="primary" 
...
FileAttachmentConfirmationDialog.propTypes = {
