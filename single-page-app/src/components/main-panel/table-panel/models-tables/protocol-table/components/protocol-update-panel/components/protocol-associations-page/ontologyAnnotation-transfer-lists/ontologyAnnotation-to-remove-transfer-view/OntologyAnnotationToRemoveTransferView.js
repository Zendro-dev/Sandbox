...
import OntologyAnnotationToRemoveTransferViewToolbar from './components/OntologyAnnotationToRemoveTransferViewToolbar';
import OntologyAnnotationToRemoveTransferViewCursorPagination from './components/OntologyAnnotationToRemoveTransferViewCursorPagination';
...
export default function OntologyAnnotationToRemoveTransferView(props) {
...
const showMessageB = useCallback((message, withDetail) => {
 ...
 /**
  ...
  const getCount = useCallback(async () => {
    ...
    /*
      API Request: api.protocol.getOntologyAnnotationCount
    */
    let cancelableApiReq = makeCancelable(api.protocol.getOntologyAnnotationCount(
      graphqlServerUrl, 
      item.protocol_id,
      search,
    ));
    ...
    await cancelableApiReq
      ...
      (response) => {
        ...
        if(response.message === 'ok') {
          ...
          if(response.graphqlErrors) {
            ...
            newError.locations=[{association: 'ontologyAnnotation', method: 'getCount()', request: 'api.protocol.getOntologyAnnotationCount'}];
            newError.path=['update', `protocol_id:${item.protocol_id}`, 'remove', 'ontologyAnnotation'];
      ...
      //error
      .catch((err) => { //error: on api.protocol.getOntologyAnnotationCount
        if(err.isCanceled) {
          return;
        } else {
          let newError = {};
  ...
  const getData = useCallback(async () => {
    ...
    /*
      API Request: api.protocol.getOntologyAnnotation
    */
    let variables = {
      pagination: {...paginationRef.current}
    };
    let cancelableApiReq = makeCancelable(api.protocol.getOntologyAnnotation(
      graphqlServerUrl, 
      item.protocol_id,
      search,
      variables,
    ...
    await cancelableApiReq
      ...
      (response) => {
        ...
        if(response.message === 'ok') {
          ...
          if(response.graphqlErrors) {
            ...
            newError.message = t('modelPanels.errors.data.e3', 'fetched with errors.');
            newError.locations=[{association: 'ontologyAnnotation', method: 'getData()', request: 'api.protocol.getOntologyAnnotation'}];
            newError.path=['update', `protocol_id:${item.protocol_id}`, 'remove', 'ontologyAnnotation'];
            newError.extensions = {graphQL:{data:response.data, errors:response.graphqlErrors}};
      ...
      //error
      .catch((err) => { //error: on api.protocol.getOntologyAnnotation
        if(err.isCanceled) {
          return;
        } else {
          let newError = {};
  ...
  }, [graphqlServerUrl, showMessage, clearRequestGetData, t, dataTrigger, item.protocol_id, search, getCount, configurePagination, onEmptyPage]);
        ...
        <Grid item xs={12} sm={5} >
          {(item!==undefined) && (
            <Card className={classes.card}>
              ...
              {/* Toolbar */}
              <OntologyAnnotationToRemoveTransferViewToolbar
              ...
              {(!isOnApiRequest && (!areItemsReady)) && (
                ...
                <Fade
                  ...
                  unmountOnExit
                >
                  <div id='OntologyAnnotationToRemoveTransferView-div-noDataA'>
                    <Grid container>
                      <Grid item xs={12}>
              ...
              {(!isOnApiRequest && areItemsReady) && (
                ...
                >
                  <Box className={classes.listBox} ref={lref}>
                    <List id='OntologyAnnotationToRemoveTransferView-list-listA'
                      ...
                      {items.map(it => {
                        ...
                        return (
                          <ListItem 
                            id={'OntologyAnnotationToRemoveTransferView-listA-listItem-'+it.ontologyAnnotation_id}
                            key={key} 
                            role="listitem" 
                            button 
                          ...
                          >
                            ...
                            <ListItemSecondaryAction>
                              <Tooltip title={!disabled ? t('modelPanels.transferToRemove') : t('modelPanels.alreadyToRemove') }>
                                <span>
                                  <IconButton
                                    id={'OntologyAnnotationToRemoveTransferView-listA-listItem-'+it.ontologyAnnotation_id+'-button-remove'}
                                    color="primary"
              ...
              {/* Pagination */}
              <OntologyAnnotationToRemoveTransferViewCursorPagination
                count={count}
            ...
            <Card className={classes.card}>
              ...
              {(!thereAreItemsToAdd) && (
                ...
                <Fade
                  ...
                  unmountOnExit
                >
                  <div id='OntologyAnnotationToRemoveTransferView-div-noItemsB'>
                    <Grid container>
                      <Grid item xs={12}>
                        <Grid className={classes.noDataBox} container justify="center" alignItems="center">
                          <Grid item>
              ...
              {(thereAreItemsToAdd && !isOnApiRequestB && (!areItemsReadyB)) && (
                ...
                <Fade
                  ...
                  unmountOnExit
                >
                  <div id='OntologyAnnotationToRemoveTransferView-div-noDataB'>
                    <Grid container>
                      <Grid item xs={12}>
                        <Grid className={classes.noDataBox} container justify="center" alignItems="center">
                          <Grid item>
              ...
              {(thereAreItemsToAdd && !isOnApiRequestB && areItemsReadyB) && (
                ...
                >
                  <Box className={classes.listBox} ref={lrefB}>
                    <List id='OntologyAnnotationToRemoveTransferView-list-listB'
                      dense component="div" role="list">
                      {itemsB.map(it => {
                        let key = it.ontologyAnnotation_id;
                        let label = it.ontology;
                        ...
                        return (
                          <ListItem 
                            id={'OntologyAnnotationToRemoveTransferView-listB-listItem-'+it.ontologyAnnotation_id}
                            key={key} 
                            role="listitem"
                            button
                            className={classes.row}
                          ...
                          >
                            ...
                            <ListItemSecondaryAction>
                              <Tooltip title={ t('modelPanels.untransferToRemove') }>
                                <IconButton
                                  id={'OntologyAnnotationToRemoveTransferView-listB-listItem-'+it.ontologyAnnotation_id+'-button-remove'}
                                  color="primary"
                                  onClick={(event) => {
                                    event.stopPropagation();
...
OntologyAnnotationToRemoveTransferView.propTypes = {
