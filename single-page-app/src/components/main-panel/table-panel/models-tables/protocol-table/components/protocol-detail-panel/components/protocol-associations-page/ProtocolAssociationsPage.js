...
import ProtocolAssociationsMenuTabs from './ProtocolAssociationsMenuTabs'
...
export default function ProtocolAssociationsPage(props) {
  ...
  return (
    <Fade in={!deleted} timeout={500}>
      <Grid
        id='ProtocolAssociationsPage-div-root'
...
ProtocolAssociationsPage.propTypes = {
