...
export default function ProtocolConfirmationDialog(props) {
  ...
  return (
    <div>
      <Dialog id='ProtocolConfirmationDialog-create'
        open={open}
      ...
      >
        ...
        <DialogActions>
          ...
          {(acceptText !== '' && acceptText !== null && acceptText !== undefined) &&
            <Button
              id='ProtocolConfirmationDialog-create-button-accept'
              color="primary"
              variant='contained'
          ...
          {(rejectText !== '' && acceptText !== null && acceptText !== undefined) &&
            ...
            <Button
              id='ProtocolConfirmationDialog-create-button-reject'
              color="primary" 
...
ProtocolConfirmationDialog.propTypes = {
