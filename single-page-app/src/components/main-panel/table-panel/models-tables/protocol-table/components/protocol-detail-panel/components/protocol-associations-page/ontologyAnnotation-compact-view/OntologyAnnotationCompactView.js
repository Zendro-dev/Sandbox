...
import OntologyAnnotationCompactViewToolbar from './components/OntologyAnnotationCompactViewToolbar';
import OntologyAnnotationCompactViewCursorPagination from './components/OntologyAnnotationCompactViewCursorPagination';
...
export default function OntologyAnnotationCompactView(props) {
      ...
      (response) => {
        ...
        if(response.message === 'ok') {
          ...
          if(response.graphqlErrors) {
            ...
            newError.path=['detail', `protocol_id:${item.protocol_id}`, 'ontologyAnnotation'];
  ...
  }, [graphqlServerUrl, showMessageB, t, item.protocol_id, search]);
  ...
  }, [lastModelChanged, lastChangeTimestamp, items, item.protocol_id, count, getCount, configurePagination]);
        ...
        <Grid item xs={12} >
          {(item!==undefined) && (
            <Card className={classes.card}>
              ...
              {/* Toolbar */}
              <OntologyAnnotationCompactViewToolbar 
              ...
              {(!isOnApiRequest && (!areItemsReady)) && (
                ...
                <Fade
                  ...
                  unmountOnExit
                >
                  <div id='OntologyAnnotationCompactView-div-noDataA'>
                    <Grid container>
                      <Grid item xs={12}>
              ...
              {(!isOnApiRequest && areItemsReady) && (
                ...
                >
                  <Box className={classes.listBox} ref={lref}>
                    <List id='OntologyAnnotationCompactView-list-listA'
                    dense component="div" role="list" >
                      {items.map(it => {
                        ...
                        return (
                          <ListItem 
                            id={'OntologyAnnotationCompactView-listA-listItem-'+it.ontologyAnnotation_id}
                            key={key} 
                            role="listitem" 
                            button 
                                  ...
                                  <Grid container alignItems='center' alignContent='center' wrap='nowrap' spacing={1}>
                                    <Grid item>
                                      <Tooltip title={ 'ontologyAnnotation_id' }>
                                        <Typography
                                        id={'OntologyAnnotationCompactView-listA-listItem-id-'+it.ontologyAnnotation_id}
                                ...
                                <React.Fragment>
                                  ...
                                  {(label) && (
                                    <Tooltip title={ 'ontology' }>
                                      <Typography
                                      id={'OntologyAnnotationCompactView-listA-listItem-label-'+it.ontologyAnnotation_id}
                                  ...
                                  {(sublabel) && (
                                    <Tooltip title={ '' }>
                                      <Typography
                                      id={'OntologyAnnotationCompactView-listA-listItem-sublabel-'+it.ontologyAnnotation_id}
              ...
              {/* Pagination */}
              <OntologyAnnotationCompactViewCursorPagination
                count={count}
...
OntologyAnnotationCompactView.propTypes = {
  item: PropTypes.object.isRequired,
  handleClickOnOntologyAnnotationRow: PropTypes.func,
};