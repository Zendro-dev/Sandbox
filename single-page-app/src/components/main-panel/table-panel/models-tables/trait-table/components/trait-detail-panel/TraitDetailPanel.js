...
//lazy loading
const TraitAttributesPage = lazy(() => import(/* webpackChunkName: "Detail-Attributes-Trait" */ './components/trait-attributes-page/TraitAttributesPage'));
const TraitAssociationsPage = lazy(() => import(/* webpackChunkName: "Detail-Associations-Trait" */ './components/trait-associations-page/TraitAssociationsPage'));
const TraitUpdatePanel = lazy(() => import(/* webpackChunkName: "Detail-Update-Trait" */ '../trait-update-panel/TraitUpdatePanel'));
const TraitDeleteConfirmationDialog = lazy(() => import(/* webpackChunkName: "Detail-Delete-Trait" */ '../TraitDeleteConfirmationDialog'));
const ObservationVariableDetailPanel = lazy(() => import(/* webpackChunkName: "Detail-Detail-ObservationVariable" */ '../../../observationVariable-table/components/observationVariable-detail-panel/ObservationVariableDetailPanel'));
...
export default function TraitDetailPanel(props) {
      ...
      lastModelChanged['trait'][String(item['traitDbId'])]) {
        ...
        if(lastModelChanged['trait'][String(item['traitDbId'])].op === "update"&&
            lastModelChanged['trait'][String(item['traitDbId'])].newItem) {
              //replace item
              setItemState(lastModelChanged['trait'][String(item['traitDbId'])].newItem);
              //show alert
              setUpdated(true);
        } else {
          //deleted item
  ...
  const handleUpdateDialogClose = (event, status, item, newItem, changedAssociations) => {
    if(status) {
      dispatch(modelChange('trait', 'update', item, newItem, changedAssociations))
    }
  ...
  const onSuccessDelete = (event, item) => {
    dispatch(modelChange('trait', 'delete', item, null))
          ...
          <AppBar className={classes.appBar}>
            <Toolbar>
              <Tooltip title={ t('modelPanels.close') }>
                <IconButton
                  id='TraitDetailPanel-button-close'
                  edge="start"
                  color="inherit"
                  onClick={(event) => {
                    if(!isCanceling.current){
              ...
              <Typography variant="h6" className={classes.title}>
                { t('modelPanels.detailOf') +  ": Trait | traitDbId: " + itemState['traitDbId'] }
              </Typography>
              {/*
                Actions:
                - Edit
              ...
              */}
              {
                ...
                &&(!deleted)&&(
                    ...
                    <Tooltip title={ t('modelPanels.edit') }>
                      <IconButton
                        id='TraitDetailPanel-button-edit'
                        color='inherit'
                        onClick={(event) => {
              ...
              }
              {
                ...
                &&(!deleted)&&(
                    ...
                    <Tooltip title={ t('modelPanels.delete') }>
                      <IconButton
                        id='TraitDetailPanel-button-delete'
                        color='inherit'
                        onClick={(event) => {
                          event.stopPropagation();
