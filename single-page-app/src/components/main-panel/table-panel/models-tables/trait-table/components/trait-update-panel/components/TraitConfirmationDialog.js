...
export default function TraitConfirmationDialog(props) {
  ...
  return (
    <div>
      <Dialog id='TraitConfirmationDialog-update'
        open={open}
      ...
      >
        ...
        <DialogActions>
          ...
          {(acceptText !== '' && acceptText !== null && acceptText !== undefined) &&
            <Button
              id='TraitConfirmationDialog-update-button-accept'
              color="primary"
              variant='contained'
          ...
          {(rejectText !== '' && acceptText !== null && acceptText !== undefined) &&
            ...
            <Button
              id='TraitConfirmationDialog-update-button-reject'
              color="primary" 
...
TraitConfirmationDialog.propTypes = {
