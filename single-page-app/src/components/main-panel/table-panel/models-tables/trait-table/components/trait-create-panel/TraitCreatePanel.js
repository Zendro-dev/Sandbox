...
//lazy loading
const TraitAttributesPage = lazy(() => import(/* webpackChunkName: "Create-AttributesTrait" */ './components/trait-attributes-page/TraitAttributesPage'));
const TraitAssociationsPage = lazy(() => import(/* webpackChunkName: "Create-AssociationsTrait" */ './components/trait-associations-page/TraitAssociationsPage'));
const TraitConfirmationDialog = lazy(() => import(/* webpackChunkName: "Create-ConfirmationTrait" */ './components/TraitConfirmationDialog'));
...
export default function TraitCreatePanel(props) {
  ...
  function getInitialValues() {
    ...
    initialValues.mainAbbreviation = null;
    initialValues.status = null;
    initialValues.traitClass = null;
    initialValues.traitDescription = null;
    initialValues.traitName = null;
  ...
  function getInitialValueOkStates() {
    ...
    */
    ...
    initialValueOkStates.attribute = 0;
    initialValueOkStates.entity = 0;
    initialValueOkStates.mainAbbreviation = 0;
    initialValueOkStates.status = 0;
    initialValueOkStates.traitClass = 0;
    initialValueOkStates.traitDescription = 0;
    initialValueOkStates.traitName = 0;
    initialValueOkStates.xref = 0;
    initialValueOkStates.traitDbId = 0;
  ...
  async function doSave(event) {
    ...
    */
    ...
    /*
      API Request: api.trait.createItem
    */
    let api = await loadApi("trait");
    let cancelableApiReq = makeCancelable(api.trait.createItem(graphqlServerUrl, variables));
    ...
    await cancelableApiReq
      ...
      (response) => {
        ...
        if(response.message === 'ok') {
          ...
          if(response.graphqlErrors) {
            ...
            newError.locations=[{model: 'trait', method: 'doSave()', request: 'api.trait.createItem'}];
            newError.path=['Traits', 'add'];
      ...
      //error
      .catch((err) => { //error: on api.trait.createItem
        if(err.isCanceled) {
          return
        } else {
          //set ajv errors
  ...
  return (
    ...
    <Dialog id='TraitCreatePanel-dialog'  
      ...
      <AppBar>
        <Toolbar>
          <Tooltip title={ t('modelPanels.cancel') }>
            <IconButton
              id='TraitCreatePanel-button-cancel'
              edge="start" 
              color="inherit"
              onClick={(event) => {
                if(!isCanceling.current){
          ...
          <Typography variant="h6" className={classes.title}>
            {t('modelPanels.new') + ' Trait'}
          </Typography>
          <Tooltip title={ t('modelPanels.save') + " trait" }>
            <Fab
              id='TraitCreatePanel-fabButton-save' 
              color="secondary" 
