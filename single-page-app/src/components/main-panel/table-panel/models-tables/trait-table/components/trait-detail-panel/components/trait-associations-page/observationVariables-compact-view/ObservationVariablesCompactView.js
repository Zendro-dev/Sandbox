...
export default function ObservationVariablesCompactView(props) {
      ...
      (response) => {
        ...
        if(response.message === 'ok') {
          ...
          if(response.graphqlErrors) {
            ...
            newError.path=['detail', `traitDbId:${item.traitDbId}`, 'observationVariables'];
  ...
  }, [graphqlServerUrl, showMessageB, t, item.traitDbId, search]);
  ...
  }, [lastModelChanged, lastChangeTimestamp, items, item.traitDbId, count, getCount, configurePagination]);
