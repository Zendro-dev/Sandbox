...
//lazy loading
const ObservationVariablesToAddTransferView = lazy(() => import(/* webpackChunkName: "Create-TransferLists-ToAdd-ObservationVariables" */ './observationVariables-to-add-transfer-view/ObservationVariablesToAddTransferView'));
const ObservationVariablesToRemoveTransferView = lazy(() => import(/* webpackChunkName: "Create-TransferLists-ToRemove-ObservationVariables" */ './observationVariables-to-remove-transfer-view/ObservationVariablesToRemoveTransferView'));
    ...
    <div id='ObservationVariablesTransferLists-div-root' className={classes.root}>
      <Fade in={true} timeout={500}>
        ...
        > 
          ...
          <Grid item xs={12}>
            <Suspense fallback={<div />}>
              <ObservationVariablesToRemoveTransferView
                item={item}
