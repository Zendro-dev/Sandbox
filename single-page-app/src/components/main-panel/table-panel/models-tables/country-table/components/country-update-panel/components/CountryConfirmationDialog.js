...
export default function CountryConfirmationDialog(props) {
  ...
  return (
    <div>
      <Dialog id='CountryConfirmationDialog-update'
        open={open}
      ...
      >
        ...
        <DialogActions>
          ...
          {(acceptText !== '' && acceptText !== null && acceptText !== undefined) &&
            <Button
              id='CountryConfirmationDialog-update-button-accept'
              color="primary"
              variant='contained'
          ...
          {(rejectText !== '' && acceptText !== null && acceptText !== undefined) &&
            ...
            <Button
              id='CountryConfirmationDialog-update-button-reject'
              color="primary" 
...
CountryConfirmationDialog.propTypes = {
