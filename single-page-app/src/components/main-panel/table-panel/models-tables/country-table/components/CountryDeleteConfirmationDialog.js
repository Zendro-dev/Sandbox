...
//lazy loading
const CountryDetailPanel = lazy(() => retry(() => import(/* webpackChunkName: "Delete-DetailCountry" */ './country-detail-panel/CountryDetailPanel')));
...
export default function CountryDeleteConfirmationDialog(props) {
  ...
  return (
    ...
    >
      ...
      {(!deleted) && (
        <DialogActions>
          <Button 
          id='CountryDeleteConfirmationDialog-button-reject'
          ...
          <Button 
          id='CountryDeleteConfirmationDialog-button-accept'
...
CountryDeleteConfirmationDialog.propTypes = {
