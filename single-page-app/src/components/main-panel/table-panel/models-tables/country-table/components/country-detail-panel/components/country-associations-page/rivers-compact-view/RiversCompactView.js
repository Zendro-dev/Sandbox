...
import RiversCompactViewToolbar from './components/RiversCompactViewToolbar';
import RiversCompactViewCursorPagination from './components/RiversCompactViewCursorPagination';
...
export default function RiversCompactView(props) {
      ...
      (response) => {
        ...
        if(response.message === 'ok') {
          ...
          if(response.graphqlErrors) {
            ...
            newError.path=['detail', `country_id:${item.country_id}`, 'rivers'];
  ...
  }, [graphqlServerUrl, showMessageB, t, item.country_id, search]);
  ...
  useEffect(() => {
     ...
     * 
     * Conditions:
     * A: the current item 'internalId' attribute is in the removedIds of the updated 'river'.
     * B: the current item 'internalId' attribute is in the addedIds of the updated 'river'.
     * 
     * Actions:
     * if A:
     * - reload table.
  ...
  }, [lastModelChanged, lastChangeTimestamp, items, item.country_id, count, getCount, configurePagination]);
            ...
            <Card className={classes.card}>
              ...
              {(!isOnApiRequest && (!areItemsReady)) && (
                ...
                <Fade
                  ...
                  unmountOnExit
                >
                  <div id='RiversCompactView-div-noDataA'>
                    <Grid container>
                      <Grid item xs={12}>
              ...
              {(!isOnApiRequest && areItemsReady) && (
                ...
                >
                  <Box className={classes.listBox} ref={lref}>
                    <List id='RiversCompactView-list-listA'
                    dense component="div" role="list" >
                      {items.map(it => {
                        ...
                        return (
                          <ListItem 
                            id={'RiversCompactView-listA-listItem-'+it.river_id}
                            key={key} 
                            role="listitem" 
                            button 
                                  ...
                                  <Grid container alignItems='center' alignContent='center' wrap='nowrap' spacing={1}>
                                    <Grid item>
                                      <Tooltip title={ 'river_id' }>
                                        <Typography
                                        id={'RiversCompactView-listA-listItem-id-'+it.river_id}
                              ...
                              secondary={
                                <React.Fragment>
                                  ...
                                  {(label) && (
                                    <Tooltip title={ '' }>
                                      <Typography
                                      id={'RiversCompactView-listA-listItem-label-'+it.river_id}
                                  ...
                                  {(sublabel) && (
                                    <Tooltip title={ '' }>
                                      <Typography
                                      id={'RiversCompactView-listA-listItem-sublabel-'+it.river_id}
              ...
              {/* Pagination */}
              <RiversCompactViewCursorPagination
                count={count}
...
RiversCompactView.propTypes = {
  item: PropTypes.object.isRequired,
  handleClickOnRiversRow: PropTypes.func,
};