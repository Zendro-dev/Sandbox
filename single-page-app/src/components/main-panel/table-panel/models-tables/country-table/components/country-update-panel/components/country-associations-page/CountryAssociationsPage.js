...
//lazy loading
const UniqueCapitalTransferLists = lazy(() => retry(() => import(/* webpackChunkName: "Update-TransferLists-UniqueCapital" */ './unique_capital-transfer-lists/Unique_capitalTransferLists')));
const ContinentTransferLists = lazy(() => retry(() => import(/* webpackChunkName: "Update-TransferLists-Continent" */ './continent-transfer-lists/ContinentTransferLists')));
const RiversTransferLists = lazy(() => retry(() => import(/* webpackChunkName: "Update-TransferLists-Rivers" */ './rivers-transfer-lists/RiversTransferLists')));
...
export default function CountryAssociationsPage(props) {
  ...
  const {
    ...
    unique_capitalIdsToRemove,
    continentIdsToAdd,
    continentIdsToRemove,
    riversIdsToAdd,
    riversIdsToRemove,
    handleTransferToAdd,
            ...
            <Grid item xs={12} sm={11}>
              <Suspense fallback={<div />}><ErrorBoundary belowToolbar={true} showMessage={true}>
                <UniqueCapitalTransferLists
                  ...
                  idsToRemove={unique_capitalIdsToRemove}
            ...
            <Grid item xs={12} sm={11}>
              <Suspense fallback={<div />}><ErrorBoundary belowToolbar={true} showMessage={true}>
                <ContinentTransferLists
                  ...
                  idsToRemove={continentIdsToRemove}
                  handleTransferToAdd={handleTransferToAdd}
                  handleUntransferFromAdd={handleUntransferFromAdd}
                  handleTransferToRemove={handleTransferToRemove}
                  handleUntransferFromRemove={handleUntransferFromRemove}
...
CountryAssociationsPage.propTypes = {
  ...
  unique_capitalIdsToRemove: PropTypes.array.isRequired,
  continentIdsToAdd: PropTypes.array.isRequired,
  continentIdsToRemove: PropTypes.array.isRequired,
  riversIdsToAdd: PropTypes.array.isRequired,
  riversIdsToRemove: PropTypes.array.isRequired,
