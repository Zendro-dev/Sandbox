...
import OntologyAnnotationDetailPanel from './ontologyAnnotation-detail-panel/OntologyAnnotationDetailPanel'
...
export default function OntologyAnnotationDeleteConfirmationDialog(props) {
  ...
  return (
    ...
    >
      ...
      {(!deleted) && (
        <DialogActions>
          <Button 
          id='OntologyAnnotationDeleteConfirmationDialog-button-reject'
          ...
          <Button 
          id='OntologyAnnotationDeleteConfirmationDialog-button-accept'
...
OntologyAnnotationDeleteConfirmationDialog.propTypes = {
