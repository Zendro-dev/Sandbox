...
import AssayResultsCompactViewToolbar from './components/AssayResultsCompactViewToolbar';
import AssayResultsCompactViewCursorPagination from './components/AssayResultsCompactViewCursorPagination';
...
export default function AssayResultsCompactView(props) {
      ...
      (response) => {
        ...
        if(response.message === 'ok') {
          ...
          if(response.graphqlErrors) {
            ...
            newError.path=['detail', `ontologyAnnotation_id:${item.ontologyAnnotation_id}`, 'assayResults'];
  ...
  useEffect(() => {
     ...
     * 
     * Conditions:
     * A: the current item 'internalId' attribute is in the removedIds of the updated 'assayResult'.
     * B: the current item 'internalId' attribute is in the addedIds of the updated 'assayResult'.
     * 
     * Actions:
     * if A:
     * - reload table.
        ...
        <Grid item xs={12} >
          {(item!==undefined) && (
            <Card className={classes.card}>
              ...
              {/* Toolbar */}
              <AssayResultsCompactViewToolbar 
                title={'AssayResults'}
                search={search}
              ...
              {(!isOnApiRequest && (!areItemsReady)) && (
                ...
                <Fade
                  ...
                  unmountOnExit
                >
                  <div id='AssayResultsCompactView-div-noDataA'>
                    <Grid container>
                      <Grid item xs={12}>
              ...
              {(!isOnApiRequest && areItemsReady) && (
                ...
                >
                  <Box className={classes.listBox} ref={lref}>
                    <List id='AssayResultsCompactView-list-listA'
                    dense component="div" role="list" >
                      {items.map(it => {
                        ...
                        return (
                          <ListItem 
                            id={'AssayResultsCompactView-listA-listItem-'+it.assayResult_id}
                            key={key} 
                            role="listitem" 
                            button 
                                  ...
                                  <Grid container alignItems='center' alignContent='center' wrap='nowrap' spacing={1}>
                                    <Grid item>
                                      <Tooltip title={ 'assayResult_id' }>
                                        <Typography
                                        id={'AssayResultsCompactView-listA-listItem-id-'+it.assayResult_id}
                                ...
                                <React.Fragment>
                                  ...
                                  {(label) && (
                                    <Tooltip title={ 'value_as_str' }>
                                      <Typography
                                      id={'AssayResultsCompactView-listA-listItem-label-'+it.assayResult_id}
                                  ...
                                  {(sublabel) && (
                                    <Tooltip title={ '' }>
                                      <Typography
                                      id={'AssayResultsCompactView-listA-listItem-sublabel-'+it.assayResult_id}
              ...
              {/* Pagination */}
              <AssayResultsCompactViewCursorPagination
                count={count}
...
AssayResultsCompactView.propTypes = {
  item: PropTypes.object.isRequired,
  handleClickOnAssayResultsRow: PropTypes.func,
};