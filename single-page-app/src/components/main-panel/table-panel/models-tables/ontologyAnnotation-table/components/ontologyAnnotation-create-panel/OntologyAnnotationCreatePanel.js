...
export default function OntologyAnnotationCreatePanel(props) {
  ...
  function getInitialValues() {
    ...
    initialValues.ontologyAnnotation_id = null;
    initialValues.ontology = null;
    initialValues.ontologyURL = null;
    initialValues.term = null;
    initialValues.termURL = null;
  ...
  function getInitialValueOkStates() {
    ...
    */
    ...
    initialValueOkStates.ontologyAnnotation_id = 0;
    initialValueOkStates.ontology = 0;
    initialValueOkStates.ontologyURL = 0;
    initialValueOkStates.term = 0;
    initialValueOkStates.termURL = 0;
  ...
  async function doSave(event) {
    ...
    */
    ...
    /*
      API Request: api.ontologyAnnotation.createItem
    */
    let cancelableApiReq = makeCancelable(api.ontologyAnnotation.createItem(graphqlServerUrl, variables));
    ...
    await cancelableApiReq
      ...
      (response) => {
        ...
        if(response.message === 'ok') {
          ...
          if(response.graphqlErrors) {
            ...
            newError.locations=[{model: 'ontologyAnnotation', method: 'doSave()', request: 'api.ontologyAnnotation.createItem'}];
            newError.path=['OntologyAnnotations', 'add'];
      ...
      //error
      .catch((err) => { //error: on api.ontologyAnnotation.createItem
        if(err.isCanceled) {
          return
        } else {
          //set ajv errors
  ...
  return (
    ...
    <Dialog id='OntologyAnnotationCreatePanel-dialog'  
      ...
      <AppBar>
        <Toolbar>
          <Tooltip title={ t('modelPanels.cancel') }>
            <IconButton
              id='OntologyAnnotationCreatePanel-button-cancel'
              edge="start" 
              color="inherit"
              onClick={(event) => {
                if(!isCanceling.current){
          ...
          <Typography variant="h6" className={classes.title}>
            {t('modelPanels.new') + ' OntologyAnnotation'}
          </Typography>
          <Tooltip title={ t('modelPanels.save') + " ontologyAnnotation" }>
            <Fab
              id='OntologyAnnotationCreatePanel-fabButton-save' 
              color="secondary" 
...
OntologyAnnotationCreatePanel.propTypes = {
