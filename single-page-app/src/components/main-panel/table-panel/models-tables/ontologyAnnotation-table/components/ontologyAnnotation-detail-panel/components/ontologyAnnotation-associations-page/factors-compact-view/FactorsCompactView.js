...
import FactorsCompactViewToolbar from './components/FactorsCompactViewToolbar';
import FactorsCompactViewCursorPagination from './components/FactorsCompactViewCursorPagination';
...
export default function FactorsCompactView(props) {
      ...
      (response) => {
        ...
        if(response.message === 'ok') {
          ...
          if(response.graphqlErrors) {
            ...
            newError.path=['detail', `ontologyAnnotation_id:${item.ontologyAnnotation_id}`, 'factors'];
  ...
  useEffect(() => {
     ...
     * 
     * Conditions:
     * A: the current item 'internalId' attribute is in the removedIds of the updated 'factor'.
     * B: the current item 'internalId' attribute is in the addedIds of the updated 'factor'.
     * 
     * Actions:
     * if A:
     * - reload table.
            ...
            <Card className={classes.card}>
              ...
              {(!isOnApiRequest && (!areItemsReady)) && (
                ...
                <Fade
                  ...
                  unmountOnExit
                >
                  <div id='FactorsCompactView-div-noDataA'>
                    <Grid container>
                      <Grid item xs={12}>
              ...
              {(!isOnApiRequest && areItemsReady) && (
                ...
                >
                  <Box className={classes.listBox} ref={lref}>
                    <List id='FactorsCompactView-list-listA'
                    dense component="div" role="list" >
                      {items.map(it => {
                        ...
                        return (
                          <ListItem 
                            id={'FactorsCompactView-listA-listItem-'+it.factor_id}
                            key={key} 
                            role="listitem" 
                            button 
                                  ...
                                  <Grid container alignItems='center' alignContent='center' wrap='nowrap' spacing={1}>
                                    <Grid item>
                                      <Tooltip title={ 'factor_id' }>
                                        <Typography
                                        id={'FactorsCompactView-listA-listItem-id-'+it.factor_id}
                              ...
                              secondary={
                                <React.Fragment>
                                  ...
                                  {(label) && (
                                    <Tooltip title={ 'name' }>
                                      <Typography
                                      id={'FactorsCompactView-listA-listItem-label-'+it.factor_id}
                                  ...
                                  {(sublabel) && (
                                    <Tooltip title={ '' }>
                                      <Typography
                                      id={'FactorsCompactView-listA-listItem-sublabel-'+it.factor_id}
              ...
              {/* Pagination */}
              <FactorsCompactViewCursorPagination
                count={count}
...
FactorsCompactView.propTypes = {
  item: PropTypes.object.isRequired,
  handleClickOnFactorsRow: PropTypes.func,
};