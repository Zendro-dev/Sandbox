...
import ContactsCompactViewToolbar from './components/ContactsCompactViewToolbar';
import ContactsCompactViewCursorPagination from './components/ContactsCompactViewCursorPagination';
...
export default function ContactsCompactView(props) {
      ...
      (response) => {
        ...
        if(response.message === 'ok') {
          ...
          if(response.graphqlErrors) {
            ...
            newError.path=['detail', `ontologyAnnotation_id:${item.ontologyAnnotation_id}`, 'contacts'];
  ...
  useEffect(() => {
     ...
     * 
     * Conditions:
     * A: the current item 'internalId' attribute is in the removedIds of the updated 'contact'.
     * B: the current item 'internalId' attribute is in the addedIds of the updated 'contact'.
     * 
     * Actions:
     * if A:
     * - reload table.
            ...
            <Card className={classes.card}>
              ...
              {(!isOnApiRequest && (!areItemsReady)) && (
                ...
                <Fade
                  ...
                  unmountOnExit
                >
                  <div id='ContactsCompactView-div-noDataA'>
                    <Grid container>
                      <Grid item xs={12}>
              ...
              {(!isOnApiRequest && areItemsReady) && (
                ...
                >
                  <Box className={classes.listBox} ref={lref}>
                    <List id='ContactsCompactView-list-listA'
                    dense component="div" role="list" >
                      {items.map(it => {
                        ...
                        return (
                          <ListItem 
                            id={'ContactsCompactView-listA-listItem-'+it.contact_id}
                            key={key} 
                            role="listitem" 
                            button 
                                  ...
                                  <Grid container alignItems='center' alignContent='center' wrap='nowrap' spacing={1}>
                                    <Grid item>
                                      <Tooltip title={ 'contact_id' }>
                                        <Typography
                                        id={'ContactsCompactView-listA-listItem-id-'+it.contact_id}
                              ...
                              secondary={
                                <React.Fragment>
                                  ...
                                  {(label) && (
                                    <Tooltip title={ 'name' }>
                                      <Typography
                                      id={'ContactsCompactView-listA-listItem-label-'+it.contact_id}
                                  ...
                                  {(sublabel) && (
                                    <Tooltip title={ '' }>
                                      <Typography
                                      id={'ContactsCompactView-listA-listItem-sublabel-'+it.contact_id}
              ...
              {/* Pagination */}
              <ContactsCompactViewCursorPagination
                count={count}
...
ContactsCompactView.propTypes = {
  item: PropTypes.object.isRequired,
  handleClickOnContactsRow: PropTypes.func,
};