...
import InvestigationsCompactViewToolbar from './components/InvestigationsCompactViewToolbar';
import InvestigationsCompactViewCursorPagination from './components/InvestigationsCompactViewCursorPagination';
...
export default function InvestigationsCompactView(props) {
      ...
      (response) => {
        ...
        if(response.message === 'ok') {
          ...
          if(response.graphqlErrors) {
            ...
            newError.path=['detail', `ontologyAnnotation_id:${item.ontologyAnnotation_id}`, 'investigations'];
  ...
  }, [graphqlServerUrl, showMessageB, t, item.ontologyAnnotation_id, search]);
  ...
  useEffect(() => {
     ...
     * 
     * Conditions:
     * A: the current item 'internalId' attribute is in the removedIds of the updated 'investigation'.
     * B: the current item 'internalId' attribute is in the addedIds of the updated 'investigation'.
     * 
     * Actions:
     * if A:
     * - reload table.
  ...
  }, [lastModelChanged, lastChangeTimestamp, items, item.ontologyAnnotation_id, count, getCount, configurePagination]);
        ...
        <Grid item xs={12} >
          {(item!==undefined) && (
            <Card className={classes.card}>
              ...
              {/* Toolbar */}
              <InvestigationsCompactViewToolbar 
              ...
              {(!isOnApiRequest && (!areItemsReady)) && (
                ...
                <Fade
                  ...
                  unmountOnExit
                >
                  <div id='InvestigationsCompactView-div-noDataA'>
                    <Grid container>
                      <Grid item xs={12}>
              ...
              {(!isOnApiRequest && areItemsReady) && (
                ...
                >
                  <Box className={classes.listBox} ref={lref}>
                    <List id='InvestigationsCompactView-list-listA'
                    dense component="div" role="list" >
                      {items.map(it => {
                        ...
                        return (
                          <ListItem 
                            id={'InvestigationsCompactView-listA-listItem-'+it.investigation_id}
                            key={key} 
                            role="listitem" 
                            button 
                                  ...
                                  <Grid container alignItems='center' alignContent='center' wrap='nowrap' spacing={1}>
                                    <Grid item>
                                      <Tooltip title={ 'investigation_id' }>
                                        <Typography
                                        id={'InvestigationsCompactView-listA-listItem-id-'+it.investigation_id}
                              ...
                              secondary={
                                <React.Fragment>
                                  ...
                                  {(label) && (
                                    <Tooltip title={ 'title' }>
                                      <Typography
                                      id={'InvestigationsCompactView-listA-listItem-label-'+it.investigation_id}
                                  ...
                                  {(sublabel) && (
                                    <Tooltip title={ '' }>
                                      <Typography
                                      id={'InvestigationsCompactView-listA-listItem-sublabel-'+it.investigation_id}
              ...
              {/* Pagination */}
              <InvestigationsCompactViewCursorPagination
                count={count}
...
InvestigationsCompactView.propTypes = {
  item: PropTypes.object.isRequired,
  handleClickOnInvestigationsRow: PropTypes.func,
};