...
export default function OntologyAnnotationConfirmationDialog(props) {
  ...
  return (
    <div>
      <Dialog id='OntologyAnnotationConfirmationDialog-update'
        open={open}
      ...
      >
        ...
        <DialogActions>
          ...
          {(acceptText !== '' && acceptText !== null && acceptText !== undefined) &&
            <Button
              id='OntologyAnnotationConfirmationDialog-update-button-accept'
              color="primary"
              variant='contained'
          ...
          {(rejectText !== '' && acceptText !== null && acceptText !== undefined) &&
            ...
            <Button
              id='OntologyAnnotationConfirmationDialog-update-button-reject'
              color="primary" 
