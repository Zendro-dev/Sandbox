...
import AssaysCompactViewToolbar from './components/AssaysCompactViewToolbar';
import AssaysCompactViewCursorPagination from './components/AssaysCompactViewCursorPagination';
...
export default function AssaysCompactView(props) {
      ...
      (response) => {
        ...
        if(response.message === 'ok') {
          ...
          if(response.graphqlErrors) {
            ...
            newError.path=['detail', `ontologyAnnotation_id:${item.ontologyAnnotation_id}`, 'assays'];
  ...
  useEffect(() => {
     ...
     * 
     * Conditions:
     * A: the current item 'internalId' attribute is in the removedIds of the updated 'assay'.
     * B: the current item 'internalId' attribute is in the addedIds of the updated 'assay'.
     * 
     * Actions:
     * if A:
     * - reload table.
            ...
            <Card className={classes.card}>
              ...
              {(!isOnApiRequest && (!areItemsReady)) && (
                ...
                <Fade
                  ...
                  unmountOnExit
                >
                  <div id='AssaysCompactView-div-noDataA'>
                    <Grid container>
                      <Grid item xs={12}>
              ...
              {(!isOnApiRequest && areItemsReady) && (
                ...
                >
                  <Box className={classes.listBox} ref={lref}>
                    <List id='AssaysCompactView-list-listA'
                    dense component="div" role="list" >
                      {items.map(it => {
                        ...
                        return (
                          <ListItem 
                            id={'AssaysCompactView-listA-listItem-'+it.assay_id}
                            key={key} 
                            role="listitem" 
                            button 
                                  ...
                                  <Grid container alignItems='center' alignContent='center' wrap='nowrap' spacing={1}>
                                    <Grid item>
                                      <Tooltip title={ 'assay_id' }>
                                        <Typography
                                        id={'AssaysCompactView-listA-listItem-id-'+it.assay_id}
                                ...
                                <React.Fragment>
                                  ...
                                  {(label) && (
                                    <Tooltip title={ 'measurement' }>
                                      <Typography
                                      id={'AssaysCompactView-listA-listItem-label-'+it.assay_id}
                                  ...
                                  {(sublabel) && (
                                    <Tooltip title={ '' }>
                                      <Typography
                                      id={'AssaysCompactView-listA-listItem-sublabel-'+it.assay_id}
              ...
              {/* Pagination */}
              <AssaysCompactViewCursorPagination
                count={count}
...
AssaysCompactView.propTypes = {
  item: PropTypes.object.isRequired,
  handleClickOnAssaysRow: PropTypes.func,
};