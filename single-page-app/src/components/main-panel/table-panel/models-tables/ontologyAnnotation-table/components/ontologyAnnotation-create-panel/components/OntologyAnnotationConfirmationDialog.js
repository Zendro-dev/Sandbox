...
export default function OntologyAnnotationConfirmationDialog(props) {
  ...
  return (
    <div>
      <Dialog id='OntologyAnnotationConfirmationDialog-create'
        open={open}
      ...
      >
        ...
        <DialogActions>
          ...
          {(acceptText !== '' && acceptText !== null && acceptText !== undefined) &&
            <Button
              id='OntologyAnnotationConfirmationDialog-create-button-accept'
              color="primary"
              variant='contained'
          ...
          {(rejectText !== '' && acceptText !== null && acceptText !== undefined) &&
            ...
            <Button
              id='OntologyAnnotationConfirmationDialog-create-button-reject'
              color="primary" 
...
OntologyAnnotationConfirmationDialog.propTypes = {
