...
import ProtocolsCompactViewToolbar from './components/ProtocolsCompactViewToolbar';
import ProtocolsCompactViewCursorPagination from './components/ProtocolsCompactViewCursorPagination';
...
export default function ProtocolsCompactView(props) {
      ...
      (response) => {
        ...
        if(response.message === 'ok') {
          ...
          if(response.graphqlErrors) {
            ...
            newError.path=['detail', `ontologyAnnotation_id:${item.ontologyAnnotation_id}`, 'protocols'];
  ...
  useEffect(() => {
     ...
     * 
     * Conditions:
     * A: the current item 'internalId' attribute is in the removedIds of the updated 'protocol'.
     * B: the current item 'internalId' attribute is in the addedIds of the updated 'protocol'.
     * 
     * Actions:
     * if A:
     * - reload table.
            ...
            <Card className={classes.card}>
              ...
              {(!isOnApiRequest && (!areItemsReady)) && (
                ...
                <Fade
                  ...
                  unmountOnExit
                >
                  <div id='ProtocolsCompactView-div-noDataA'>
                    <Grid container>
                      <Grid item xs={12}>
              ...
              {(!isOnApiRequest && areItemsReady) && (
                ...
                >
                  <Box className={classes.listBox} ref={lref}>
                    <List id='ProtocolsCompactView-list-listA'
                    dense component="div" role="list" >
                      {items.map(it => {
                        ...
                        return (
                          <ListItem 
                            id={'ProtocolsCompactView-listA-listItem-'+it.protocol_id}
                            key={key} 
                            role="listitem" 
                            button 
                                  ...
                                  <Grid container alignItems='center' alignContent='center' wrap='nowrap' spacing={1}>
                                    <Grid item>
                                      <Tooltip title={ 'protocol_id' }>
                                        <Typography
                                        id={'ProtocolsCompactView-listA-listItem-id-'+it.protocol_id}
                              ...
                              secondary={
                                <React.Fragment>
                                  ...
                                  {(label) && (
                                    <Tooltip title={ 'name' }>
                                      <Typography
                                      id={'ProtocolsCompactView-listA-listItem-label-'+it.protocol_id}
                                  ...
                                  {(sublabel) && (
                                    <Tooltip title={ '' }>
                                      <Typography
                                      id={'ProtocolsCompactView-listA-listItem-sublabel-'+it.protocol_id}
              ...
              {/* Pagination */}
              <ProtocolsCompactViewCursorPagination
                count={count}
...
ProtocolsCompactView.propTypes = {
  item: PropTypes.object.isRequired,
  handleClickOnProtocolsRow: PropTypes.func,
};