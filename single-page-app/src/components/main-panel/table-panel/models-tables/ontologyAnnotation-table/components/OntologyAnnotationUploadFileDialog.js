...
export default function OntologyAnnotationUploadFileDialog(props) {
  ...
  const handleSubmit = (event) => {
    if(file.current !== undefined && file.current !== null) {
      ...
      let query = 'mutation{ bulkAddOntologyAnnotationCsv }'
  ...
  return (
    ...
    >
      <DialogTitle>
      { t('modelPanels.uploading') + ' OntologyAnnotations' }
        <div>
...
OntologyAnnotationUploadFileDialog.propTypes = {
