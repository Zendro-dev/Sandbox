...
import MaterialsCompactViewToolbar from './components/MaterialsCompactViewToolbar';
import MaterialsCompactViewCursorPagination from './components/MaterialsCompactViewCursorPagination';
...
export default function MaterialsCompactView(props) {
      ...
      (response) => {
        ...
        if(response.message === 'ok') {
          ...
          if(response.graphqlErrors) {
            ...
            newError.path=['detail', `ontologyAnnotation_id:${item.ontologyAnnotation_id}`, 'materials'];
  ...
  useEffect(() => {
     ...
     * 
     * Conditions:
     * A: the current item 'internalId' attribute is in the removedIds of the updated 'material'.
     * B: the current item 'internalId' attribute is in the addedIds of the updated 'material'.
     * 
     * Actions:
     * if A:
     * - reload table.
            ...
            <Card className={classes.card}>
              ...
              {(!isOnApiRequest && (!areItemsReady)) && (
                ...
                <Fade
                  ...
                  unmountOnExit
                >
                  <div id='MaterialsCompactView-div-noDataA'>
                    <Grid container>
                      <Grid item xs={12}>
              ...
              {(!isOnApiRequest && areItemsReady) && (
                ...
                >
                  <Box className={classes.listBox} ref={lref}>
                    <List id='MaterialsCompactView-list-listA'
                    dense component="div" role="list" >
                      {items.map(it => {
                        ...
                        return (
                          <ListItem 
                            id={'MaterialsCompactView-listA-listItem-'+it.material_id}
                            key={key} 
                            role="listitem" 
                            button 
                                  ...
                                  <Grid container alignItems='center' alignContent='center' wrap='nowrap' spacing={1}>
                                    <Grid item>
                                      <Tooltip title={ 'material_id' }>
                                        <Typography
                                        id={'MaterialsCompactView-listA-listItem-id-'+it.material_id}
                              ...
                              secondary={
                                <React.Fragment>
                                  ...
                                  {(label) && (
                                    <Tooltip title={ 'name' }>
                                      <Typography
                                      id={'MaterialsCompactView-listA-listItem-label-'+it.material_id}
                                  ...
                                  {(sublabel) && (
                                    <Tooltip title={ '' }>
                                      <Typography
                                      id={'MaterialsCompactView-listA-listItem-sublabel-'+it.material_id}
              ...
              {/* Pagination */}
              <MaterialsCompactViewCursorPagination
                count={count}
...
MaterialsCompactView.propTypes = {
  item: PropTypes.object.isRequired,
  handleClickOnMaterialsRow: PropTypes.func,
};