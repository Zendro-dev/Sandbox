...
import StudiesCompactViewToolbar from './components/StudiesCompactViewToolbar';
import StudiesCompactViewCursorPagination from './components/StudiesCompactViewCursorPagination';
...
export default function StudiesCompactView(props) {
      ...
      (response) => {
        ...
        if(response.message === 'ok') {
          ...
          if(response.graphqlErrors) {
            ...
            newError.path=['detail', `ontologyAnnotation_id:${item.ontologyAnnotation_id}`, 'studies'];
  ...
  useEffect(() => {
     ...
     * 
     * Conditions:
     * A: the current item 'internalId' attribute is in the removedIds of the updated 'study'.
     * B: the current item 'internalId' attribute is in the addedIds of the updated 'study'.
     * 
     * Actions:
     * if A:
     * - reload table.
            ...
            <Card className={classes.card}>
              ...
              {(!isOnApiRequest && (!areItemsReady)) && (
                ...
                <Fade
                  ...
                  unmountOnExit
                >
                  <div id='StudiesCompactView-div-noDataA'>
                    <Grid container>
                      <Grid item xs={12}>
              ...
              {(!isOnApiRequest && areItemsReady) && (
                ...
                >
                  <Box className={classes.listBox} ref={lref}>
                    <List id='StudiesCompactView-list-listA'
                    dense component="div" role="list" >
                      {items.map(it => {
                        ...
                        return (
                          <ListItem 
                            id={'StudiesCompactView-listA-listItem-'+it.study_id}
                            key={key} 
                            role="listitem" 
                            button 
                                  ...
                                  <Grid container alignItems='center' alignContent='center' wrap='nowrap' spacing={1}>
                                    <Grid item>
                                      <Tooltip title={ 'study_id' }>
                                        <Typography
                                        id={'StudiesCompactView-listA-listItem-id-'+it.study_id}
                              ...
                              secondary={
                                <React.Fragment>
                                  ...
                                  {(label) && (
                                    <Tooltip title={ 'name' }>
                                      <Typography
                                      id={'StudiesCompactView-listA-listItem-label-'+it.study_id}
                                  ...
                                  {(sublabel) && (
                                    <Tooltip title={ '' }>
                                      <Typography
                                      id={'StudiesCompactView-listA-listItem-sublabel-'+it.study_id}
              ...
              {/* Pagination */}
              <StudiesCompactViewCursorPagination
                count={count}
...
StudiesCompactView.propTypes = {
  item: PropTypes.object.isRequired,
  handleClickOnStudiesRow: PropTypes.func,
};