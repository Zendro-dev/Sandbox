...
import EventsCompactViewToolbar from './components/EventsCompactViewToolbar';
import EventsCompactViewCursorPagination from './components/EventsCompactViewCursorPagination';
...
export default function EventsCompactView(props) {
      ...
      (response) => {
        ...
        if(response.message === 'ok') {
          ...
          if(response.graphqlErrors) {
            ...
            newError.path=['detail', `studyDbId:${item.studyDbId}`, 'events'];
  ...
  useEffect(() => {
     ...
     * 
     * Conditions:
     * A: the current item 'internalId' attribute is in the removedIds of the updated 'event'.
     * B: the current item 'internalId' attribute is in the addedIds of the updated 'event'.
     * 
     * Actions:
     * if A:
     * - reload table.
            ...
            <Card className={classes.card}>
              ...
              {(!isOnApiRequest && (!areItemsReady)) && (
                ...
                <Fade
                  ...
                  unmountOnExit
                >
                  <div id='EventsCompactView-div-noDataA'>
                    <Grid container>
                      <Grid item xs={12}>
              ...
              {(!isOnApiRequest && areItemsReady) && (
                ...
                >
                  <Box className={classes.listBox} ref={lref}>
                    <List id='EventsCompactView-list-listA'
                    dense component="div" role="list" >
                      {items.map(it => {
                        ...
                        return (
                          <ListItem 
                            id={'EventsCompactView-listA-listItem-'+it.eventType}
                            key={key} 
                            role="listitem" 
                            button 
                                  ...
                                  <Grid container alignItems='center' alignContent='center' wrap='nowrap' spacing={1}>
                                    <Grid item>
                                      <Tooltip title={ 'eventType' }>
                                        <Typography
                                        id={'EventsCompactView-listA-listItem-id-'+it.eventType}
                              ...
                              secondary={
                                <React.Fragment>
                                  ...
                                  {(label) && (
                                    <Tooltip title={ 'eventType' }>
                                      <Typography
                                      id={'EventsCompactView-listA-listItem-label-'+it.eventType}
                                  ...
                                  {(sublabel) && (
                                    <Tooltip title={ '' }>
                                      <Typography
                                      id={'EventsCompactView-listA-listItem-sublabel-'+it.eventType}
              ...
              {/* Pagination */}
              <EventsCompactViewCursorPagination
                count={count}
...
EventsCompactView.propTypes = {
  ...
  handleClickOnEventsRow: PropTypes.func,
};