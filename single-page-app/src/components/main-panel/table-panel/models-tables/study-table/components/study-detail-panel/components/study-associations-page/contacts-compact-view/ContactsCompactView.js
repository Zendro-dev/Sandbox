      ...
      (response) => {
        ...
        if(response.message === 'ok') {
          ...
          if(response.graphqlErrors) {
            ...
            newError.path=['detail', `studyDbId:${item.studyDbId}`, 'contacts'];
                  ...
                  <Box className={classes.listBox} ref={lref}>
                    ...
                    dense component="div" role="list" >
                      {items.map(it => {
                        ...
                        return (
                          <ListItem 
                            id={'ContactsCompactView-listA-listItem-'+it.contactDbId}
                            key={key} 
                            role="listitem" 
                            button 
                                  ...
                                  <Grid container alignItems='center' alignContent='center' wrap='nowrap' spacing={1}>
                                    <Grid item>
                                      <Tooltip title={ 'contactDbId' }>
                                        <Typography
                                        id={'ContactsCompactView-listA-listItem-id-'+it.contactDbId}
                              ...
                              secondary={
                                <React.Fragment>
                                  ...
                                  {(label) && (
                                    <Tooltip title={ 'name' }>
                                      <Typography
                                      id={'ContactsCompactView-listA-listItem-label-'+it.contactDbId}
                                  ...
                                  {(sublabel) && (
                                    <Tooltip title={ '' }>
                                      <Typography
                                      id={'ContactsCompactView-listA-listItem-sublabel-'+it.contactDbId}
