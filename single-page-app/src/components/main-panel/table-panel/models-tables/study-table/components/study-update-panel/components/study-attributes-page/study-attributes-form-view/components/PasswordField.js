...
export default function PasswordField(props) {
  ...
  useEffect(() => {
    ...
    if(lastModelChanged&&
      ...
      lastModelChanged['study'][String(itemId['study_id'])]) {

        //updated password
        if(lastModelChanged['study'][String(itemId['study_id'])].op === "updatePassword"&&
            lastModelChanged['study'][String(itemId['study_id'])].newItem) {
              //update password value
              setValue(lastModelChanged['study'][String(itemId['study_id'])].newItem[itemKey]);
        }
    }//end: Case 1
