      ...
      <Grid container justify='center'>
        ...
        <Card className={classes.cardB} elevation={0}>
          ...
          <Card className={classes.card}>
            ...
            */}
            {/* study_id*/}
            <CardContent key='study_id' className={classes.cardContent}>
              <Grid container alignItems='center' alignContent='center' wrap='nowrap' spacing={1}>
                <Grid item>
                  <Typography variant="h6" display="inline">study_id:</Typography>
                  <Typography variant="h6" display="inline" color="textSecondary">&nbsp;{item.study_id}</Typography>
                </Grid>
                {/*Key icon*/}
                <Grid item>
