...
export default function StudyConfirmationDialog(props) {
  ...
  return (
    <div>
      <Dialog id='StudyConfirmationDialog-create'
        open={open}
      ...
      >
        ...
        <DialogActions>
          ...
          {(acceptText !== '' && acceptText !== null && acceptText !== undefined) &&
            <Button
              id='StudyConfirmationDialog-create-button-accept'
              color="primary"
              variant='contained'
          ...
          {(rejectText !== '' && acceptText !== null && acceptText !== undefined) &&
            ...
            <Button
              id='StudyConfirmationDialog-create-button-reject'
              color="primary" 
...
StudyConfirmationDialog.propTypes = {
