...
//lazy loading
const StudyDetailPanel = lazy(() => import(/* webpackChunkName: "Delete-DetailStudy" */ './study-detail-panel/StudyDetailPanel'));
...
export default function StudyDeleteConfirmationDialog(props) {
  ...
  return (
    ...
    >
      ...
      {(!deleted) && (
        <DialogActions>
          <Button 
          id='StudyDeleteConfirmationDialog-button-reject'
          ...
          <Button 
          id='StudyDeleteConfirmationDialog-button-accept'
...
StudyDeleteConfirmationDialog.propTypes = {
