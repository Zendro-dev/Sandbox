      ...
      (response) => {
        ...
        if(response.message === 'ok') {
          ...
          if(response.graphqlErrors) {
            ...
            newError.locations=[{model: 'study', association: 'investigation', table:'A', method: 'getCount()', request: 'api.investigation.getCountItems'}];
            newError.path=['add', 'investigation'];
      ...
      (response) => {
        ...
        if(response.message === 'ok') {
          ...
          if(response.graphqlErrors) {
            ...
            newError.message = t('modelPanels.errors.data.e3', 'fetched with errors.');
            newError.locations=[{model: 'study', association: 'investigation', table:'A', method: 'getData()', request: 'api.investigation.getItems'}];
            newError.path=['add', 'investigation'];
            newError.extensions = {graphQL:{data:response.data, errors:response.graphqlErrors}};
