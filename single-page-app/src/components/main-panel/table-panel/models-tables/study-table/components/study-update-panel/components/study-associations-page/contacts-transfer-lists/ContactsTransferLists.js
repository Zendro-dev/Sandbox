...
//lazy loading
const ContactsToAddTransferView = lazy(() => import(/* webpackChunkName: "Create-TransferLists-ToAdd-Contacts" */ './contacts-to-add-transfer-view/ContactsToAddTransferView'));
const ContactsToRemoveTransferView = lazy(() => import(/* webpackChunkName: "Create-TransferLists-ToRemove-Contacts" */ './contacts-to-remove-transfer-view/ContactsToRemoveTransferView'));
