...
export default function OntologyAnnotationsCompactView(props) {
      ...
      (response) => {
        ...
        if(response.message === 'ok') {
          ...
          if(response.graphqlErrors) {
            ...
            newError.path=['detail', `study_id:${item.study_id}`, 'ontologyAnnotations'];
  ...
  }, [graphqlServerUrl, showMessageB, t, item.study_id, search]);
  ...
  }, [lastModelChanged, lastChangeTimestamp, items, item.study_id, count, getCount, configurePagination]);
