      ...
      (response) => {
        ...
        if(response.message === 'ok') {
          ...
          if(response.graphqlErrors) {
            ...
            newError.locations=[{model: 'study', association: 'seasons', table:'A', method: 'getCount()', request: 'api.season.getCountItems'}];
            newError.path=['add', 'seasons'];
      ...
      (response) => {
        ...
        if(response.message === 'ok') {
          ...
          if(response.graphqlErrors) {
            ...
            newError.message = t('modelPanels.errors.data.e3', 'fetched with errors.');
            newError.locations=[{model: 'study', association: 'seasons', table:'A', method: 'getData()', request: 'api.season.getItems'}];
            newError.path=['add', 'seasons'];
            newError.extensions = {graphQL:{data:response.data, errors:response.graphqlErrors}};
