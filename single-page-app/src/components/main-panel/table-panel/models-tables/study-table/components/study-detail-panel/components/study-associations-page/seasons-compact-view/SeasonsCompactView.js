...
import SeasonsCompactViewToolbar from './components/SeasonsCompactViewToolbar';
import SeasonsCompactViewCursorPagination from './components/SeasonsCompactViewCursorPagination';
...
export default function SeasonsCompactView(props) {
      ...
      (response) => {
        ...
        if(response.message === 'ok') {
          ...
          if(response.graphqlErrors) {
            ...
            newError.path=['detail', `studyDbId:${item.studyDbId}`, 'seasons'];
  ...
  useEffect(() => {
     ...
     * 
     * Conditions:
     * A: the current item 'internalId' attribute is in the removedIds of the updated 'season'.
     * B: the current item 'internalId' attribute is in the addedIds of the updated 'season'.
     * 
     * Actions:
     * if A:
     * - reload table.
            ...
            <Card className={classes.card}>
              ...
              {(!isOnApiRequest && (!areItemsReady)) && (
                ...
                <Fade
                  ...
                  unmountOnExit
                >
                  <div id='SeasonsCompactView-div-noDataA'>
                    <Grid container>
                      <Grid item xs={12}>
              ...
              {(!isOnApiRequest && areItemsReady) && (
                ...
                >
                  <Box className={classes.listBox} ref={lref}>
                    <List id='SeasonsCompactView-list-listA'
                    dense component="div" role="list" >
                      {items.map(it => {
                        ...
                        return (
                          <ListItem 
                            id={'SeasonsCompactView-listA-listItem-'+it.seasonDbId}
                            key={key} 
                            role="listitem" 
                            button 
                                  ...
                                  <Grid container alignItems='center' alignContent='center' wrap='nowrap' spacing={1}>
                                    <Grid item>
                                      <Tooltip title={ 'seasonDbId' }>
                                        <Typography
                                        id={'SeasonsCompactView-listA-listItem-id-'+it.seasonDbId}
                              ...
                              secondary={
                                <React.Fragment>
                                  ...
                                  {(label) && (
                                    <Tooltip title={ 'season' }>
                                      <Typography
                                      id={'SeasonsCompactView-listA-listItem-label-'+it.seasonDbId}
                                  ...
                                  {(sublabel) && (
                                    <Tooltip title={ '' }>
                                      <Typography
                                      id={'SeasonsCompactView-listA-listItem-sublabel-'+it.seasonDbId}
              ...
              {/* Pagination */}
              <SeasonsCompactViewCursorPagination
                count={count}
...
SeasonsCompactView.propTypes = {
  item: PropTypes.object.isRequired,
  handleClickOnSeasonsRow: PropTypes.func,
};