...
//lazy loading
const StudyAttributesPage = lazy(() => import(/* webpackChunkName: "Detail-Attributes-Study" */ './components/study-attributes-page/StudyAttributesPage'));
const StudyAssociationsPage = lazy(() => import(/* webpackChunkName: "Detail-Associations-Study" */ './components/study-associations-page/StudyAssociationsPage'));
const StudyUpdatePanel = lazy(() => import(/* webpackChunkName: "Detail-Update-Study" */ '../study-update-panel/StudyUpdatePanel'));
const StudyDeleteConfirmationDialog = lazy(() => import(/* webpackChunkName: "Detail-Delete-Study" */ '../StudyDeleteConfirmationDialog'));
...
const EnvironmentParameterDetailPanel = lazy(() => import(/* webpackChunkName: "Detail-Detail-EnvironmentParameter" */ '../../../environmentParameter-table/components/environmentParameter-detail-panel/EnvironmentParameterDetailPanel'));
