...
import StudyCreatePanel from './components/study-create-panel/StudyCreatePanel'
import StudyUpdatePanel from './components/study-update-panel/StudyUpdatePanel'
import StudyDetailPanel from './components/study-detail-panel/StudyDetailPanel'
import StudyDeleteConfirmationDialog from './components/StudyDeleteConfirmationDialog'
...
//Plotly
import StudyPlotly from '../../../../plots/StudyPlotly';
...
export default function StudyEnhancedTable(props) {
  ...
  const [orderBy, setOrderBy] = useState('study_id');
            ...
            <Grid item xs={12}>
              <Paper className={classes.paper}>
                ...
                <StudyEnhancedTableToolbar
                  ...
                  search={search}
                  showToggleButtons={Boolean(StudyPlotly)}
                          ...
                          <TableBody id='StudyEnhancedTable-tableBody'>
                            {
                              items.map((item, index) => {
                                return ([
                                  ...
                                  */
                                  <TableRow
                                    id={'StudyEnhancedTable-row-'+item.study_id}
                                    hover
                                  ...
                                  >
                                    ...
                                    <TableCell padding="checkbox">
                                      <Tooltip title={ t('modelPanels.viewDetails') }>
                                        <IconButton
                                          id={'StudyEnhancedTable-row-iconButton-detail-'+item.study_id}
                                          color="default"
                                          onClick={event => {
                                    ...
                                    */}
                                      ...
                                      &&(
                                        <TableCell padding='checkbox' align='center'>
                                          <Tooltip title={ t('modelPanels.edit') }>
                                            <IconButton
                                              id={'StudyEnhancedTable-row-iconButton-edit-'+item.study_id}
                                              color="default"
                                              onClick={(event) => {
                                                event.stopPropagation();
                                      ...
                                      &&(
                                        <TableCell padding='checkbox' align='center'>
                                          <Tooltip title={ t('modelPanels.delete') }>
                                            <IconButton
                                              id={'StudyEnhancedTable-row-iconButton-delete-'+item.study_id}
                                              color="default"
                                              onClick={(event) => {
                                                event.stopPropagation();
                                    ...
                                    <TableCell
                                      ...
                                      padding="checkbox"
                                    >
                                      <Tooltip title={ 'study_id: ' + item.study_id}>
                                        <Typography variant='body2' color='textSecondary' display='block' noWrap={true}>{item.study_id}</Typography>
                                      </Tooltip>
                                    </TableCell>
                                    ...
                                    <TableCell
                                      ...
                                      padding="default"
                                    >
                                      {String((item.investigation_id!==null)?item.investigation_id:'')}
                                    </TableCell>
