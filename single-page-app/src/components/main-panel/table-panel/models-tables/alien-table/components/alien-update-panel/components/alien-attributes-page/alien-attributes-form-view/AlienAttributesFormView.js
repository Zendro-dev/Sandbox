...
export default function AlienAttributesFormView(props) {
  ...
  return (
    <div id='AlienAttributesFormView-div-root' className={classes.root}>
...
AlienAttributesFormView.propTypes = {
