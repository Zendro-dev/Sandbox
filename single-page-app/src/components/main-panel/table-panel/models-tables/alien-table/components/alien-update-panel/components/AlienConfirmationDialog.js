...
export default function AlienConfirmationDialog(props) {
  ...
  return (
    <div>
      <Dialog id='AlienConfirmationDialog-update'
        open={open}
      ...
      >
        ...
        <DialogActions>
          ...
          {(acceptText !== '' && acceptText !== null && acceptText !== undefined) &&
            <Button
              id='AlienConfirmationDialog-update-button-accept'
              color="primary"
              variant='contained'
          ...
          {(rejectText !== '' && acceptText !== null && acceptText !== undefined) &&
            ...
            <Button
              id='AlienConfirmationDialog-update-button-reject'
              color="primary" 
...
AlienConfirmationDialog.propTypes = {
