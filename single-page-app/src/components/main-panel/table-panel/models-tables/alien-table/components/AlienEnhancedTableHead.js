...
export default function AlienEnhancedTableHead(props) {
    ...
    <TableHead>
      <TableRow>
        ...
        {/* Actions */}
        {
          ...
          &&(permissions.alien.includes('update') || permissions.alien.includes('delete') || permissions.alien.includes('*')))
          &&(
            <TableCell 
              padding="checkbox" 
              align='center' 
              ...
              colSpan={
                0 +
                ((permissions.alien.includes('update') || permissions.alien.includes('*')) ? 1 : 0) 
                +
                ((permissions.alien.includes('delete') || permissions.alien.includes('*')) ? 1 : 0)
              }
            >
...
AlienEnhancedTableHead.propTypes = {
