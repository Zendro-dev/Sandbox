...
import AlienEnhancedTableHead from './components/AlienEnhancedTableHead'
import AlienEnhancedTableToolbar from './components/AlienEnhancedTableToolbar'
import AlienUploadFileDialog from './components/AlienUploadFileDialog'
import AlienCursorPagination from './components/AlienCursorPagination'
...
//lazy loading
const AlienCreatePanel = lazy(() => retry(() => import(/* webpackChunkName: "Create-Alien" */ './components/alien-create-panel/AlienCreatePanel')));
const AlienUpdatePanel = lazy(() => retry(() => import(/* webpackChunkName: "Update-Alien" */ './components/alien-update-panel/AlienUpdatePanel')));
const AlienDetailPanel = lazy(() => retry(() => import(/* webpackChunkName: "Detail-Alien" */ './components/alien-detail-panel/AlienDetailPanel')));
const AlienDeleteConfirmationDialog = lazy(() => retry(() => import(/* webpackChunkName: "Delete-Alien" */ './components/AlienDeleteConfirmationDialog')));
...
export default function AlienEnhancedTable(props) {
  ...
  const [orderBy, setOrderBy] = useState('idField');
  ...
  const getCount = useCallback(async () => {
    ...
    /*
      API Request: api.alien.getCountItems
    */
    let api = await loadApi("alien");
    if(!api) {
      let newError = {};
    ...
    let cancelableApiReq = makeCancelable(api.alien.getCountItems(graphqlServerUrl, search));
    ...
    await cancelableApiReq
      ...
      (response) => {
        ...
        if(response.message === 'ok') {
          ...
          if(response.graphqlErrors) {
            ...
            newError.locations=[{model: 'alien', method: 'getCount()', request: 'api.alien.getCountItems'}];
            newError.path=['Aliens'];
      ...
      //error
      .catch((err) => { //error: on api.alien.getCountItems
        if(err.isCanceled) {
          return
        } else {
          let newError = {};
  ...
  const getData = useCallback(async () => {
    ...
    /*
      API Request: api.alien.getItems
    */
    let api = await loadApi("alien");
    if(!api) {
      let newError = {};
    ...
    let cancelableApiReq = makeCancelable(api.alien.getItems(
      graphqlServerUrl,
      search,
      orderBy,
      order,
    ...
    await cancelableApiReq
      ...
      (response) => {
        ...
        if(response.message === 'ok') {
          ...
          if(response.graphqlErrors) {
            ...
            newError.message = t('modelPanels.errors.data.e3', 'fetched with errors.');
            newError.locations=[{model: 'alien', method: 'getData()', request: 'api.alien.getItems'}];
            newError.path=['Aliens'];
            newError.extensions = {graphQL:{data:response.data, errors:response.graphqlErrors}};
            errors.current.push(newError);
            console.log("Error: ", newError);
      ...
      //error
      .catch((err) => { //error: on api.alien.getItems
        if(err.isCanceled) {
          return;
        } else {
          let newError = {};
  ...
  useEffect(() => {
     ...
     */
    if(isNewChange&&!changes.changesCompleted&&changes.lastModelChanged&&changes.lastModelChanged['alien']
    &&(Object.keys(changes.lastModelChanged['alien']).length===1)
    &&(changes.lastModelChanged['alien'][Object.keys(changes.lastModelChanged['alien'])[0]].op === "delete")
    ) {
      //decrement count
      setCount(count-1);
      //count
  ...
  async function doDelete(event, item) {
    ...
    let variables = {};
    //set idField (internalId)
    variables.idField = item.idField;

    /*
      API Request: api.alien.deleteItem
    */
    let api = await loadApi("alien");
    if(!api) {
      let newError = {};
    ...
    let cancelableApiReq = makeCancelable(api.alien.deleteItem(graphqlServerUrl, variables));
    cancelablePromises.current.push(cancelableApiReq);
    await cancelableApiReq
      .promise
      .then(
      ...
      (response) => {
        ...
        if(response.message === 'ok') {
          ...
          if(response.graphqlErrors) {
            ...
            variant.current='info';
            newError.message = t('modelPanels.errors.data.e3', 'fetched with errors.');
            newError.locations=[{model: 'alien', method: 'doDelete()', request: 'api.alien.deleteItem'}];
            newError.path=['Aliens', `idField:${item.idField}`, 'delete'];
            newError.extensions = {graphQL:{data:response.data, errors:response.graphqlErrors}};
            errors.current.push(newError);
            console.log("Error: ", newError);
      ...
      //error
      .catch((err) => { //error: on api.alien.deleteItem
        if(err.isCanceled) {
          return
        } else {
          let newError = {};
  ...
  async function getCsvTemplate() {
    ...
    /*
      API Request: api.alien.tableTemplate
    */
    let api = await loadApi("alien");
    if(!api) {
      let newError = {};
    ...
    let cancelableApiReq = makeCancelable(api.alien.tableTemplate(graphqlServerUrl));
    cancelablePromises.current.push(cancelableApiReq);
    await cancelableApiReq
      .promise
      .then(
      ...
      (response) => {
        ...
        if(response.message === 'ok') {
          ...
          if(response.graphqlErrors) {
            ...
            variant.current='info';
            newError.message = t('modelPanels.errors.data.e3', 'fetched with errors.');
            newError.locations=[{model: 'alien', method: 'getCsvTemplate()', request: 'api.alien.tableTemplate'}];
            newError.path=['Aliens', 'csvTemplate'];
            newError.extensions = {graphQL:{data:response.data, errors:response.graphqlErrors}};
            errors.current.push(newError);
            console.log("Error: ", newError);
        ...
        link.href = url;
        link.setAttribute("download", "alien-template.csv");
      ...
      //error
      .catch((err) => { //error: on api.alien.tableTemplate
        if(err.isCanceled) {
          return
        } else {
          let newError = {};
                  ...
                  */}
                  <div>
                    ...
                    <div className={classes.tableWrapper} ref={twref}>
                      ...
                      >
                        <Box
                          id='AlienEnhancedTable-box-noData'
                          className={classes.tableBackdrop}
                          bgcolor='rgba(255, 255, 255, 0.0)'
                      ...
                      {/* Table */}
                      <Table id='AlienEnhancedTable-table' stickyHeader size='small' ref={tref}>

                        {/* Table Head */}
                        <AlienEnhancedTableHead
                          permissions={permissions}
                          order={order}
                          orderBy={orderBy}
                        ...
                        <Fade
                          in={(!isOnApiRequest && items.length > 0)}
                        >
                          <TableBody id='AlienEnhancedTable-tableBody'>
                            {
                              items.map((item, index) => {
                                return ([
                                  ...
                                  */
                                  <TableRow
                                    id={'AlienEnhancedTable-row-'+item.idField}
                                    hover
                                  ...
                                  >
                                    ...
                                    <TableCell padding="checkbox">
                                      <Tooltip title={ t('modelPanels.viewDetails') }>
                                        <IconButton
                                          id={'AlienEnhancedTable-row-iconButton-detail-'+item.idField}
                                          color="default"
                                          onClick={event => {
                                    ...
                                    */}
                                    {
                                      /* acl check */
                                      (permissions&&permissions.alien&&Array.isArray(permissions.alien)
                                      &&(permissions.alien.includes('update') || permissions.alien.includes('*')))
                                      &&(
                                        <TableCell padding='checkbox' align='center'>
                                          <Tooltip title={ t('modelPanels.edit') }>
                                            <IconButton
                                              id={'AlienEnhancedTable-row-iconButton-edit-'+item.idField}
                                              color="default"
                                              onClick={(event) => {
                                                event.stopPropagation();
...

                                    {
                                      /* acl check */
                                      (permissions&&permissions.alien&&Array.isArray(permissions.alien)
                                      &&(permissions.alien.includes('delete') || permissions.alien.includes('*')))
                                      &&(
                                        <TableCell padding='checkbox' align='center'>
                                          <Tooltip title={ t('modelPanels.delete') }>
                                            <IconButton
                                              id={'AlienEnhancedTable-row-iconButton-delete-'+item.idField}
                                              color="default"
                                              onClick={(event) => {
                                                event.stopPropagation();
                                    ...
                                    <TableCell
                                      ...
                                      padding="checkbox"
                                    >
                                      <Tooltip title={ 'idField: ' + item.idField}>
                                        <Typography variant='body2' color='textSecondary' display='block' noWrap={true}>{item.idField}</Typography>
                                      </Tooltip>
                                    </TableCell>
                                    ...
                                    <TableCell
                                      ...
                                      padding="default"
                                    >
                                      {String((item.stringField!==null)?item.stringField:'')}
                                    </TableCell>
                                    ...
                                    <TableCell
                                      ...
                                      padding="default"
                                    >
                                      {String((item.intField!==null)?item.intField:'')}
                                    </TableCell>
                                    ...
                                    <TableCell
                                      ...
                                      padding="default"
                                    >
                                      {String((item.floatField!==null)?item.floatField:'')}
                                    </TableCell>
                                    ...
                                    <TableCell
                                      ...
                                      padding="default"
                                    >
                                      {String((item.datetimeField!==null)?moment(item.datetimeField, "YYYY-MM-DDTHH:mm:ss.SSSZ").format("YYYY-MM-DDTHH:mm:ss.SSSZ"):'')}
                                    </TableCell>
                                    ...
                                    <TableCell
                                      ...
                                      padding="default"
                                    >
                                      {String((item.booleanField!==null)?item.booleanField:'')}
                                    </TableCell>
                                    ...
                                    <TableCell
                                      ...
                                      padding="default"
                                    >
                                      {String((item.stringArrayField!==null)?item.stringArrayField:'')}
                                    </TableCell>
                                    ...
                                    <TableCell
                                      ...
                                      padding="default"
                                    >
                                      {String((item.intArrayField!==null)?item.intArrayField:'')}
                                    </TableCell>
                                    ...
                                    <TableCell
                                      ...
                                      padding="default"
                                    >
                                      {String((item.floatArrayField!==null)?item.floatArrayField:'')}
                                    </TableCell>
                                    ...
                                    <TableCell
                                      ...
                                      padding="default"
                                    >
                                      {String((item.datetimeArrayField!==null)?item.datetimeArrayField:'')}
                                    </TableCell>
                                    ...
                                    <TableCell
                                      ...
                                      padding="default"
                                    >
                                      {String((item.booleanArrayField!==null)?item.booleanArrayField:'')}
                                    </TableCell>
