...
import CountriesCompactViewToolbar from './components/CountriesCompactViewToolbar';
import CountriesCompactViewCursorPagination from './components/CountriesCompactViewCursorPagination';
...
export default function CountriesCompactView(props) {
      ...
      (response) => {
        ...
        if(response.message === 'ok') {
          ...
          if(response.graphqlErrors) {
            ...
            newError.path=['detail', `continent_id:${item.continent_id}`, 'countries'];
  ...
  }, [graphqlServerUrl, showMessageB, t, item.continent_id, search]);
  ...
  useEffect(() => {
     ...
     * 
     * Conditions:
     * A: the current item 'internalId' attribute is in the removedIds of the updated 'country'.
     * B: the current item 'internalId' attribute is in the addedIds of the updated 'country'.
     * 
     * Actions:
     * if A:
     * - reload table.
  ...
  }, [lastModelChanged, lastChangeTimestamp, items, item.continent_id, count, getCount, configurePagination]);
            ...
            <Card className={classes.card}>
              ...
              {(!isOnApiRequest && (!areItemsReady)) && (
                ...
                <Fade
                  ...
                  unmountOnExit
                >
                  <div id='CountriesCompactView-div-noDataA'>
                    <Grid container>
                      <Grid item xs={12}>
              ...
              {(!isOnApiRequest && areItemsReady) && (
                ...
                >
                  <Box className={classes.listBox} ref={lref}>
                    <List id='CountriesCompactView-list-listA'
                    dense component="div" role="list" >
                      {items.map(it => {
                        ...
                        return (
                          <ListItem 
                            id={'CountriesCompactView-listA-listItem-'+it.country_id}
                            key={key} 
                            role="listitem" 
                            button 
                                  ...
                                  <Grid container alignItems='center' alignContent='center' wrap='nowrap' spacing={1}>
                                    <Grid item>
                                      <Tooltip title={ 'country_id' }>
                                        <Typography
                                        id={'CountriesCompactView-listA-listItem-id-'+it.country_id}
                              ...
                              secondary={
                                <React.Fragment>
                                  ...
                                  {(label) && (
                                    <Tooltip title={ '' }>
                                      <Typography
                                      id={'CountriesCompactView-listA-listItem-label-'+it.country_id}
                                  ...
                                  {(sublabel) && (
                                    <Tooltip title={ '' }>
                                      <Typography
                                      id={'CountriesCompactView-listA-listItem-sublabel-'+it.country_id}
              ...
              {/* Pagination */}
              <CountriesCompactViewCursorPagination
                count={count}
...
CountriesCompactView.propTypes = {
  item: PropTypes.object.isRequired,
  handleClickOnCountriesRow: PropTypes.func,
};