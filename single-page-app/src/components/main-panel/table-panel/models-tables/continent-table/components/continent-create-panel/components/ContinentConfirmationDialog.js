...
export default function ContinentConfirmationDialog(props) {
  ...
  return (
    <div>
      <Dialog id='ContinentConfirmationDialog-create'
        open={open}
      ...
      >
        ...
        <DialogActions>
          ...
          {(acceptText !== '' && acceptText !== null && acceptText !== undefined) &&
            <Button
              id='ContinentConfirmationDialog-create-button-accept'
              color="primary"
              variant='contained'
          ...
          {(rejectText !== '' && acceptText !== null && acceptText !== undefined) &&
            ...
            <Button
              id='ContinentConfirmationDialog-create-button-reject'
              color="primary" 
...
ContinentConfirmationDialog.propTypes = {
