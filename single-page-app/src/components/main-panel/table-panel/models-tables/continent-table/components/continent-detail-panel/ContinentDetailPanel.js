...
//lazy loading
const ContinentAttributesPage = lazy(() => retry(() => import(/* webpackChunkName: "Detail-Attributes-Continent" */ './components/continent-attributes-page/ContinentAttributesPage')));
const ContinentAssociationsPage = lazy(() => retry(() => import(/* webpackChunkName: "Detail-Associations-Continent" */ './components/continent-associations-page/ContinentAssociationsPage')));
const ContinentUpdatePanel = lazy(() => retry(() => import(/* webpackChunkName: "Detail-Update-Continent" */ '../continent-update-panel/ContinentUpdatePanel')));
const ContinentDeleteConfirmationDialog = lazy(() => retry(() => import(/* webpackChunkName: "Detail-Delete-Continent" */ '../ContinentDeleteConfirmationDialog')));
const CountryDetailPanel = lazy(() => retry(() => import(/* webpackChunkName: "Detail-Detail-Country" */ '../../../country-table/components/country-detail-panel/CountryDetailPanel')));
...
export default function ContinentDetailPanel(props) {
      ...
      lastModelChanged['continent'][String(item['continent_id'])]) {
        ...
        if(lastModelChanged['continent'][String(item['continent_id'])].op === "update"&&
            lastModelChanged['continent'][String(item['continent_id'])].newItem) {
              //replace item
              setItemState(lastModelChanged['continent'][String(item['continent_id'])].newItem);
              //show alert
              setUpdated(true);
        } else {
          //deleted item
  ...
  const handleUpdateDialogClose = (event, status, item, newItem, changedAssociations) => {
    if(status) {
      dispatch(modelChange('continent', 'update', item, newItem, changedAssociations))
    }
  ...
  const onSuccessDelete = (event, item) => {
    dispatch(modelChange('continent', 'delete', item, null))
          ...
          <AppBar className={classes.appBar}>
            <Toolbar>
              <Tooltip title={ t('modelPanels.close') }>
                <IconButton
                  id='ContinentDetailPanel-button-close'
                  edge="start"
                  color="inherit"
                  onClick={(event) => {
                    if(!isCanceling.current){
              ...
              <Typography variant="h6" className={classes.title}>
                { t('modelPanels.detailOf') +  ": Continent | continent_id: " + itemState['continent_id'] }
              </Typography>
              {/*
                Actions:
                - Edit
              ...
              */}
              {
                ...
                &&(!deleted)&&(
                    ...
                    <Tooltip title={ t('modelPanels.edit') }>
                      <IconButton
                        id='ContinentDetailPanel-button-edit'
                        color='inherit'
                        onClick={(event) => {
              ...
              }
              {
                ...
                &&(!deleted)&&(
                    ...
                    <Tooltip title={ t('modelPanels.delete') }>
                      <IconButton
                        id='ContinentDetailPanel-button-delete'
                        color='inherit'
                        onClick={(event) => {
                          event.stopPropagation();
...
ContinentDetailPanel.propTypes = {
