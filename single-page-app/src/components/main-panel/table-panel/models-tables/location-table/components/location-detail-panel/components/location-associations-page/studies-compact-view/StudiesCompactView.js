...
export default function StudiesCompactView(props) {
      ...
      (response) => {
        ...
        if(response.message === 'ok') {
          ...
          if(response.graphqlErrors) {
            ...
            newError.path=['detail', `locationDbId:${item.locationDbId}`, 'studies'];
  ...
  }, [graphqlServerUrl, showMessageB, t, item.locationDbId, search]);
  ...
  }, [lastModelChanged, lastChangeTimestamp, items, item.locationDbId, count, getCount, configurePagination]);
                  ...
                  <Box className={classes.listBox} ref={lref}>
                    ...
                    dense component="div" role="list" >
                      {items.map(it => {
                        ...
                        return (
                          <ListItem 
                            id={'StudiesCompactView-listA-listItem-'+it.studyDbId}
                            key={key} 
                            role="listitem" 
                            button 
                                  ...
                                  <Grid container alignItems='center' alignContent='center' wrap='nowrap' spacing={1}>
                                    <Grid item>
                                      <Tooltip title={ 'studyDbId' }>
                                        <Typography
                                        id={'StudiesCompactView-listA-listItem-id-'+it.studyDbId}
                                ...
                                <React.Fragment>
                                  ...
                                  {(label) && (
                                    <Tooltip title={ 'studyName' }>
                                      <Typography
                                      id={'StudiesCompactView-listA-listItem-label-'+it.studyDbId}
                                  ...
                                  {(sublabel) && (
                                    <Tooltip title={ '' }>
                                      <Typography
                                      id={'StudiesCompactView-listA-listItem-sublabel-'+it.studyDbId}
