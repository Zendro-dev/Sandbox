...
//lazy loading
const LocationDetailPanel = lazy(() => import(/* webpackChunkName: "Delete-DetailLocation" */ './location-detail-panel/LocationDetailPanel'));
  ...
  return (
    ...
    >
      ...
      {(!deleted) && (
        <DialogActions>
          <Button 
          id='LocationDeleteConfirmationDialog-button-reject'
          ...
          <Button 
          id='LocationDeleteConfirmationDialog-button-accept'
