...
//lazy loading
const LocationAttributesPage = lazy(() => import(/* webpackChunkName: "Create-AttributesLocation" */ './components/location-attributes-page/LocationAttributesPage'));
const LocationAssociationsPage = lazy(() => import(/* webpackChunkName: "Create-AssociationsLocation" */ './components/location-associations-page/LocationAssociationsPage'));
const LocationConfirmationDialog = lazy(() => import(/* webpackChunkName: "Create-ConfirmationLocation" */ './components/LocationConfirmationDialog'));
...
export default function LocationCreatePanel(props) {
  ...
  function getInitialValues() {
    ...
    initialValues.coordinateDescription = null;
    initialValues.countryCode = null;
    initialValues.countryName = null;
    initialValues.documentationURL = null;
    initialValues.environmentType = null;
    initialValues.exposure = null;
    initialValues.instituteAddress = null;
    initialValues.instituteName = null;
    initialValues.locationName = null;
    initialValues.locationType = null;
    initialValues.siteStatus = null;
    initialValues.slope = null;
    initialValues.topography = null;
  ...
  function getInitialValueOkStates() {
    ...
    */
    ...
    initialValueOkStates.coordinateDescription = 0;
    initialValueOkStates.countryCode = 0;
    initialValueOkStates.countryName = 0;
    initialValueOkStates.documentationURL = 0;
    initialValueOkStates.environmentType = 0;
    initialValueOkStates.exposure = 0;
    initialValueOkStates.instituteAddress = 0;
    initialValueOkStates.instituteName = 0;
    initialValueOkStates.locationName = 0;
    initialValueOkStates.locationType = 0;
    initialValueOkStates.siteStatus = 0;
    initialValueOkStates.slope = 0;
    initialValueOkStates.topography = 0;
    initialValueOkStates.locationDbId = 0;
  ...
  async function doSave(event) {
    ...
    */
    ...
    /*
      API Request: api.location.createItem
    */
    let api = await loadApi("location");
    let cancelableApiReq = makeCancelable(api.location.createItem(graphqlServerUrl, variables));
    ...
    await cancelableApiReq
      ...
      (response) => {
        ...
        if(response.message === 'ok') {
          ...
          if(response.graphqlErrors) {
            ...
            newError.locations=[{model: 'location', method: 'doSave()', request: 'api.location.createItem'}];
            newError.path=['Locations', 'add'];
      ...
      //error
      .catch((err) => { //error: on api.location.createItem
        if(err.isCanceled) {
          return
        } else {
          //set ajv errors
  ...
  return (
    ...
    <Dialog id='LocationCreatePanel-dialog'  
      ...
      <AppBar>
        <Toolbar>
          <Tooltip title={ t('modelPanels.cancel') }>
            <IconButton
              id='LocationCreatePanel-button-cancel'
              edge="start" 
              color="inherit"
              onClick={(event) => {
                if(!isCanceling.current){
          ...
          <Typography variant="h6" className={classes.title}>
            {t('modelPanels.new') + ' Location'}
          </Typography>
          <Tooltip title={ t('modelPanels.save') + " location" }>
            <Fab
              id='LocationCreatePanel-fabButton-save' 
              color="secondary" 
