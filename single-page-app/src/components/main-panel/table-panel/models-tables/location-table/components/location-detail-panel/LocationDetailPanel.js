...
//lazy loading
const LocationAttributesPage = lazy(() => import(/* webpackChunkName: "Detail-Attributes-Location" */ './components/location-attributes-page/LocationAttributesPage'));
const LocationAssociationsPage = lazy(() => import(/* webpackChunkName: "Detail-Associations-Location" */ './components/location-associations-page/LocationAssociationsPage'));
const LocationUpdatePanel = lazy(() => import(/* webpackChunkName: "Detail-Update-Location" */ '../location-update-panel/LocationUpdatePanel'));
const LocationDeleteConfirmationDialog = lazy(() => import(/* webpackChunkName: "Detail-Delete-Location" */ '../LocationDeleteConfirmationDialog'));
      ...
      lastModelChanged['location'][String(item['locationDbId'])]) {
        ...
        if(lastModelChanged['location'][String(item['locationDbId'])].op === "update"&&
            lastModelChanged['location'][String(item['locationDbId'])].newItem) {
              //replace item
              setItemState(lastModelChanged['location'][String(item['locationDbId'])].newItem);
              //show alert
              setUpdated(true);
        } else {
          //deleted item
          ...
          <AppBar className={classes.appBar}>
            <Toolbar>
              <Tooltip title={ t('modelPanels.close') }>
                <IconButton
                  id='LocationDetailPanel-button-close'
                  edge="start"
                  color="inherit"
                  onClick={(event) => {
                    if(!isCanceling.current){
              ...
              <Typography variant="h6" className={classes.title}>
                { t('modelPanels.detailOf') +  ": Location | locationDbId: " + itemState['locationDbId'] }
              </Typography>
              {/*
                Actions:
                - Edit
              ...
              */}
              {
                ...
                &&(!deleted)&&(
                    ...
                    <Tooltip title={ t('modelPanels.edit') }>
                      <IconButton
                        id='LocationDetailPanel-button-edit'
                        color='inherit'
                        onClick={(event) => {
              ...
              }
              {
                ...
                &&(!deleted)&&(
                    ...
                    <Tooltip title={ t('modelPanels.delete') }>
                      <IconButton
                        id='LocationDetailPanel-button-delete'
                        color='inherit'
                        onClick={(event) => {
                          event.stopPropagation();
