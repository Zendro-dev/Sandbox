...
export default function LocationConfirmationDialog(props) {
  ...
  return (
    <div>
      <Dialog id='LocationConfirmationDialog-update'
        open={open}
      ...
      >
        ...
        <DialogActions>
          ...
          {(acceptText !== '' && acceptText !== null && acceptText !== undefined) &&
            <Button
              id='LocationConfirmationDialog-update-button-accept'
              color="primary"
              variant='contained'
          ...
          {(rejectText !== '' && acceptText !== null && acceptText !== undefined) &&
            ...
            <Button
              id='LocationConfirmationDialog-update-button-reject'
              color="primary" 
