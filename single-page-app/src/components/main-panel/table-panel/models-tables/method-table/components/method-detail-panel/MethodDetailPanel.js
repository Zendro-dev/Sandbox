...
//lazy loading
const MethodAttributesPage = lazy(() => import(/* webpackChunkName: "Detail-Attributes-Method" */ './components/method-attributes-page/MethodAttributesPage'));
const MethodAssociationsPage = lazy(() => import(/* webpackChunkName: "Detail-Associations-Method" */ './components/method-associations-page/MethodAssociationsPage'));
const MethodUpdatePanel = lazy(() => import(/* webpackChunkName: "Detail-Update-Method" */ '../method-update-panel/MethodUpdatePanel'));
const MethodDeleteConfirmationDialog = lazy(() => import(/* webpackChunkName: "Detail-Delete-Method" */ '../MethodDeleteConfirmationDialog'));
...
export default function MethodDetailPanel(props) {
      ...
      lastModelChanged['method'][String(item['methodDbId'])]) {
        ...
        if(lastModelChanged['method'][String(item['methodDbId'])].op === "update"&&
            lastModelChanged['method'][String(item['methodDbId'])].newItem) {
              //replace item
              setItemState(lastModelChanged['method'][String(item['methodDbId'])].newItem);
              //show alert
              setUpdated(true);
        } else {
          //deleted item
  ...
  const handleUpdateDialogClose = (event, status, item, newItem, changedAssociations) => {
    if(status) {
      dispatch(modelChange('method', 'update', item, newItem, changedAssociations))
    }
  ...
  const onSuccessDelete = (event, item) => {
    dispatch(modelChange('method', 'delete', item, null))
          ...
          <AppBar className={classes.appBar}>
            <Toolbar>
              <Tooltip title={ t('modelPanels.close') }>
                <IconButton
                  id='MethodDetailPanel-button-close'
                  edge="start"
                  color="inherit"
                  onClick={(event) => {
                    if(!isCanceling.current){
              ...
              <Typography variant="h6" className={classes.title}>
                { t('modelPanels.detailOf') +  ": Method | methodDbId: " + itemState['methodDbId'] }
              </Typography>
              {/*
                Actions:
                - Edit
              ...
              */}
              {
                ...
                &&(!deleted)&&(
                    ...
                    <Tooltip title={ t('modelPanels.edit') }>
                      <IconButton
                        id='MethodDetailPanel-button-edit'
                        color='inherit'
                        onClick={(event) => {
              ...
              }
              {
                ...
                &&(!deleted)&&(
                    ...
                    <Tooltip title={ t('modelPanels.delete') }>
                      <IconButton
                        id='MethodDetailPanel-button-delete'
                        color='inherit'
                        onClick={(event) => {
                          event.stopPropagation();
