...
export default function MethodConfirmationDialog(props) {
  ...
  return (
    <div>
      <Dialog id='MethodConfirmationDialog-update'
        open={open}
      ...
      >
        ...
        <DialogActions>
          ...
          {(acceptText !== '' && acceptText !== null && acceptText !== undefined) &&
            <Button
              id='MethodConfirmationDialog-update-button-accept'
              color="primary"
              variant='contained'
          ...
          {(rejectText !== '' && acceptText !== null && acceptText !== undefined) &&
            ...
            <Button
              id='MethodConfirmationDialog-update-button-reject'
              color="primary" 
...
MethodConfirmationDialog.propTypes = {
