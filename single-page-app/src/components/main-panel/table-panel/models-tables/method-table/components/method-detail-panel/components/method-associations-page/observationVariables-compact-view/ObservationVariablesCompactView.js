...
export default function ObservationVariablesCompactView(props) {
      ...
      (response) => {
        ...
        if(response.message === 'ok') {
          ...
          if(response.graphqlErrors) {
            ...
            newError.path=['detail', `methodDbId:${item.methodDbId}`, 'observationVariables'];
  ...
  }, [graphqlServerUrl, showMessageB, t, item.methodDbId, search]);
  ...
  }, [lastModelChanged, lastChangeTimestamp, items, item.methodDbId, count, getCount, configurePagination]);
