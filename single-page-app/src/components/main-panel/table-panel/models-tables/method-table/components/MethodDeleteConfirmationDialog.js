...
//lazy loading
const MethodDetailPanel = lazy(() => import(/* webpackChunkName: "Delete-DetailMethod" */ './method-detail-panel/MethodDetailPanel'));
...
export default function MethodDeleteConfirmationDialog(props) {
  ...
  return (
    ...
    >
      ...
      {(!deleted) && (
        <DialogActions>
          <Button 
          id='MethodDeleteConfirmationDialog-button-reject'
          ...
          <Button 
          id='MethodDeleteConfirmationDialog-button-accept'
...
MethodDeleteConfirmationDialog.propTypes = {
