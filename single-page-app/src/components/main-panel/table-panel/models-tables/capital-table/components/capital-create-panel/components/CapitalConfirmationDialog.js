...
export default function CapitalConfirmationDialog(props) {
  ...
  return (
    <div>
      <Dialog id='CapitalConfirmationDialog-create'
        open={open}
      ...
      >
        ...
        <DialogActions>
          ...
          {(acceptText !== '' && acceptText !== null && acceptText !== undefined) &&
            <Button
              id='CapitalConfirmationDialog-create-button-accept'
              color="primary"
              variant='contained'
          ...
          {(rejectText !== '' && acceptText !== null && acceptText !== undefined) &&
            ...
            <Button
              id='CapitalConfirmationDialog-create-button-reject'
              color="primary" 
...
CapitalConfirmationDialog.propTypes = {
