      ...
      (response) => {
        ...
        if(response.message === 'ok') {
          ...
          if(response.graphqlErrors) {
            ...
            newError.locations=[{model: 'capital', association: 'unique_country', table:'A', method: 'getCount()', request: 'api.country.getCountItems'}];
            newError.path=['add', 'unique_country'];
      ...
      (response) => {
        ...
        if(response.message === 'ok') {
          ...
          if(response.graphqlErrors) {
            ...
            newError.message = t('modelPanels.errors.data.e3', 'fetched with errors.');
            newError.locations=[{model: 'capital', association: 'unique_country', table:'A', method: 'getData()', request: 'api.country.getItems'}];
            newError.path=['add', 'unique_country'];
            newError.extensions = {graphQL:{data:response.data, errors:response.graphqlErrors}};
            errors.current.push(newError);
            console.log("Error: ", newError);
