  ...
  return (
    <Grid container justify='flex-start' alignItems='center' spacing={0}>
              ...
              <InputAdornment position="end">
                {(valueOk!==undefined&&valueOk===1) 
                  ...
                  <Tooltip title={ t('modelPanels.valueEntered', "Value entered") }>
                    <Typography id={'StringField-Factor-exists-'+name} variant="caption" color="primary">
                      &#8707;
                    </Typography>
                  </Tooltip>
                  : 
                  <Tooltip title={ t('modelPanels.valueNotEntered', "Value not entered") }>
                    <Typography id={'StringField-Factor-notExists-'+name} variant="caption" color="textSecondary">
                      &#8708;
                    </Typography>
                  </Tooltip>
                }
      ...
      {(valueAjv !== undefined && valueAjv.errors.length > 0) && (
        <Grid item id={'StringField-Factor-ajvError-'+name} xs={12}>
