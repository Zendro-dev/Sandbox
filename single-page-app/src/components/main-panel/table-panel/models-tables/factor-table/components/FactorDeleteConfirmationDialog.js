...
import FactorDetailPanel from './factor-detail-panel/FactorDetailPanel'
...
export default function FactorDeleteConfirmationDialog(props) {
  ...
  return (
    ...
    >
      ...
      {(!deleted) && (
        <DialogActions>
          <Button 
          id='FactorDeleteConfirmationDialog-button-reject'
          ...
          <Button 
          id='FactorDeleteConfirmationDialog-button-accept'
...
FactorDeleteConfirmationDialog.propTypes = {
