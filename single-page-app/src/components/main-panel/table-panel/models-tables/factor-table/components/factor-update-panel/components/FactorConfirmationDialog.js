...
export default function FactorConfirmationDialog(props) {
  ...
  return (
    <div>
      <Dialog id='FactorConfirmationDialog-update'
        open={open}
      ...
      >
        ...
        <DialogActions>
          ...
          {(acceptText !== '' && acceptText !== null && acceptText !== undefined) &&
            <Button
              id='FactorConfirmationDialog-update-button-accept'
              color="primary"
              variant='contained'
          ...
          {(rejectText !== '' && acceptText !== null && acceptText !== undefined) &&
            ...
            <Button
              id='FactorConfirmationDialog-update-button-reject'
              color="primary" 
...
FactorConfirmationDialog.propTypes = {
