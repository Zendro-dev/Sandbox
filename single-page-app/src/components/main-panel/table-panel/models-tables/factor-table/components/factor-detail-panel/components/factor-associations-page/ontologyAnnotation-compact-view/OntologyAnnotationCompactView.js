...
export default function OntologyAnnotationCompactView(props) {
      ...
      (response) => {
        ...
        if(response.message === 'ok') {
          ...
          if(response.graphqlErrors) {
            ...
            newError.path=['detail', `factor_id:${item.factor_id}`, 'ontologyAnnotation'];
  ...
  }, [graphqlServerUrl, showMessageB, t, item.factor_id, search]);
  ...
  }, [lastModelChanged, lastChangeTimestamp, items, item.factor_id, count, getCount, configurePagination]);
