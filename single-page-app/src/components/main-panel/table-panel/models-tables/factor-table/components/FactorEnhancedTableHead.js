...
export default function FactorEnhancedTableHead(props) {
    ...
    <TableHead>
      <TableRow>
        ...
        {/* Actions */}
        {
          ...
          &&(permissions.factor.includes('update') || permissions.factor.includes('delete') || permissions.factor.includes('*')))
          &&(
            <TableCell 
              padding="checkbox" 
              align='center' 
              ...
              colSpan={
                0 +
                ((permissions.factor.includes('update') || permissions.factor.includes('*')) ? 1 : 0) 
                +
                ((permissions.factor.includes('delete') || permissions.factor.includes('*')) ? 1 : 0)
              }
            >
        ...
        */}
        ...
        <TableCell
          ...
          align='left'
          padding="checkbox"
          sortDirection={orderBy === 'factor_id' ? order : false}
        >
          <TableSortLabel
            active={orderBy === 'factor_id'}
            direction={order}
            onClick={(event) => { onRequestSort(event, 'factor_id') }}
          >
...
FactorEnhancedTableHead.propTypes = {
