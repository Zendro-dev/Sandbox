...
import OntologyAnnotationToRemoveTransferView from './ontologyAnnotation-to-remove-transfer-view/OntologyAnnotationToRemoveTransferView'
    ...
    <div id='OntologyAnnotationTransferLists-div-root' className={classes.root}>
      <Fade in={true} timeout={500}>
        ...
        > 
          ...
          <Grid item xs={12}>
            <OntologyAnnotationToRemoveTransferView
              item={item}
