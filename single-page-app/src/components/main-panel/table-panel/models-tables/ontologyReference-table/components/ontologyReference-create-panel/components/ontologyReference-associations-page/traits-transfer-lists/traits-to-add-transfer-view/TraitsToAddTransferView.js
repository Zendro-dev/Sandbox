      ...
      (response) => {
        ...
        if(response.message === 'ok') {
          ...
          if(response.graphqlErrors) {
            ...
            newError.locations=[{model: 'ontologyReference', association: 'traits', table:'A', method: 'getCount()', request: 'api.trait.getCountItems'}];
            newError.path=['add', 'traits'];
      ...
      (response) => {
        ...
        if(response.message === 'ok') {
          ...
          if(response.graphqlErrors) {
            ...
            newError.message = t('modelPanels.errors.data.e3', 'fetched with errors.');
            newError.locations=[{model: 'ontologyReference', association: 'traits', table:'A', method: 'getData()', request: 'api.trait.getItems'}];
            newError.path=['add', 'traits'];
            newError.extensions = {graphQL:{data:response.data, errors:response.graphqlErrors}};
