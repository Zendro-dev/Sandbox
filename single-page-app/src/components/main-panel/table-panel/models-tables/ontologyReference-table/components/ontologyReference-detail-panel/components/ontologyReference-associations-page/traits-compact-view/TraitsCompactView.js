...
import TraitsCompactViewToolbar from './components/TraitsCompactViewToolbar';
import TraitsCompactViewCursorPagination from './components/TraitsCompactViewCursorPagination';
...
export default function TraitsCompactView(props) {
      ...
      (response) => {
        ...
        if(response.message === 'ok') {
          ...
          if(response.graphqlErrors) {
            ...
            newError.path=['detail', `ontologyDbId:${item.ontologyDbId}`, 'traits'];
  ...
  useEffect(() => {
     ...
     * 
     * Conditions:
     * A: the current item 'internalId' attribute is in the removedIds of the updated 'trait'.
     * B: the current item 'internalId' attribute is in the addedIds of the updated 'trait'.
     * 
     * Actions:
     * if A:
     * - reload table.
            ...
            <Card className={classes.card}>
              ...
              {(!isOnApiRequest && (!areItemsReady)) && (
                ...
                <Fade
                  ...
                  unmountOnExit
                >
                  <div id='TraitsCompactView-div-noDataA'>
                    <Grid container>
                      <Grid item xs={12}>
              ...
              {(!isOnApiRequest && areItemsReady) && (
                ...
                >
                  <Box className={classes.listBox} ref={lref}>
                    <List id='TraitsCompactView-list-listA'
                    dense component="div" role="list" >
                      {items.map(it => {
                        ...
                        return (
                          <ListItem 
                            id={'TraitsCompactView-listA-listItem-'+it.traitDbId}
                            key={key} 
                            role="listitem" 
                            button 
                                  ...
                                  <Grid container alignItems='center' alignContent='center' wrap='nowrap' spacing={1}>
                                    <Grid item>
                                      <Tooltip title={ 'traitDbId' }>
                                        <Typography
                                        id={'TraitsCompactView-listA-listItem-id-'+it.traitDbId}
                                ...
                                <React.Fragment>
                                  ...
                                  {(label) && (
                                    <Tooltip title={ 'traitName' }>
                                      <Typography
                                      id={'TraitsCompactView-listA-listItem-label-'+it.traitDbId}
                                  ...
                                  {(sublabel) && (
                                    <Tooltip title={ '' }>
                                      <Typography
                                      id={'TraitsCompactView-listA-listItem-sublabel-'+it.traitDbId}
              ...
              {/* Pagination */}
              <TraitsCompactViewCursorPagination
                count={count}
...
TraitsCompactView.propTypes = {
  item: PropTypes.object.isRequired,
  handleClickOnTraitsRow: PropTypes.func,
};