...
import MethodsCompactViewToolbar from './components/MethodsCompactViewToolbar';
import MethodsCompactViewCursorPagination from './components/MethodsCompactViewCursorPagination';
...
export default function MethodsCompactView(props) {
      ...
      (response) => {
        ...
        if(response.message === 'ok') {
          ...
          if(response.graphqlErrors) {
            ...
            newError.path=['detail', `ontologyDbId:${item.ontologyDbId}`, 'methods'];
  ...
  useEffect(() => {
     ...
     * 
     * Conditions:
     * A: the current item 'internalId' attribute is in the removedIds of the updated 'method'.
     * B: the current item 'internalId' attribute is in the addedIds of the updated 'method'.
     * 
     * Actions:
     * if A:
     * - reload table.
            ...
            <Card className={classes.card}>
              ...
              {(!isOnApiRequest && (!areItemsReady)) && (
                ...
                <Fade
                  ...
                  unmountOnExit
                >
                  <div id='MethodsCompactView-div-noDataA'>
                    <Grid container>
                      <Grid item xs={12}>
              ...
              {(!isOnApiRequest && areItemsReady) && (
                ...
                >
                  <Box className={classes.listBox} ref={lref}>
                    <List id='MethodsCompactView-list-listA'
                    dense component="div" role="list" >
                      {items.map(it => {
                        ...
                        return (
                          <ListItem 
                            id={'MethodsCompactView-listA-listItem-'+it.methodDbId}
                            key={key} 
                            role="listitem" 
                            button 
                                  ...
                                  <Grid container alignItems='center' alignContent='center' wrap='nowrap' spacing={1}>
                                    <Grid item>
                                      <Tooltip title={ 'methodDbId' }>
                                        <Typography
                                        id={'MethodsCompactView-listA-listItem-id-'+it.methodDbId}
                                ...
                                <React.Fragment>
                                  ...
                                  {(label) && (
                                    <Tooltip title={ 'methodName' }>
                                      <Typography
                                      id={'MethodsCompactView-listA-listItem-label-'+it.methodDbId}
                                  ...
                                  {(sublabel) && (
                                    <Tooltip title={ '' }>
                                      <Typography
                                      id={'MethodsCompactView-listA-listItem-sublabel-'+it.methodDbId}
              ...
              {/* Pagination */}
              <MethodsCompactViewCursorPagination
                count={count}
...
MethodsCompactView.propTypes = {
  item: PropTypes.object.isRequired,
  handleClickOnMethodsRow: PropTypes.func,
};