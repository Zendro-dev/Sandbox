...
export default function OntologyReferenceConfirmationDialog(props) {
  ...
  return (
    <div>
      <Dialog id='OntologyReferenceConfirmationDialog-update'
        open={open}
      ...
      >
        ...
        <DialogActions>
          ...
          {(acceptText !== '' && acceptText !== null && acceptText !== undefined) &&
            <Button
              id='OntologyReferenceConfirmationDialog-update-button-accept'
              color="primary"
              variant='contained'
          ...
          {(rejectText !== '' && acceptText !== null && acceptText !== undefined) &&
            ...
            <Button
              id='OntologyReferenceConfirmationDialog-update-button-reject'
              color="primary" 
