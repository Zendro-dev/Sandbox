...
import ObservationVariablesCompactViewToolbar from './components/ObservationVariablesCompactViewToolbar';
import ObservationVariablesCompactViewCursorPagination from './components/ObservationVariablesCompactViewCursorPagination';
...
export default function ObservationVariablesCompactView(props) {
      ...
      (response) => {
        ...
        if(response.message === 'ok') {
          ...
          if(response.graphqlErrors) {
            ...
            newError.path=['detail', `ontologyDbId:${item.ontologyDbId}`, 'observationVariables'];
  ...
  }, [graphqlServerUrl, showMessageB, t, item.ontologyDbId, search]);
  ...
  useEffect(() => {
     ...
     * 
     * Conditions:
     * A: the current item 'internalId' attribute is in the removedIds of the updated 'observationVariable'.
     * B: the current item 'internalId' attribute is in the addedIds of the updated 'observationVariable'.
     * 
     * Actions:
     * if A:
     * - reload table.
  ...
  }, [lastModelChanged, lastChangeTimestamp, items, item.ontologyDbId, count, getCount, configurePagination]);
        ...
        <Grid item xs={12} >
          {(item!==undefined) && (
            <Card className={classes.card}>
              ...
              {/* Toolbar */}
              <ObservationVariablesCompactViewToolbar 
              ...
              {(!isOnApiRequest && (!areItemsReady)) && (
                ...
                <Fade
                  ...
                  unmountOnExit
                >
                  <div id='ObservationVariablesCompactView-div-noDataA'>
                    <Grid container>
                      <Grid item xs={12}>
              ...
              {(!isOnApiRequest && areItemsReady) && (
                ...
                >
                  <Box className={classes.listBox} ref={lref}>
                    <List id='ObservationVariablesCompactView-list-listA'
                    dense component="div" role="list" >
                      {items.map(it => {
                        ...
                        return (
                          <ListItem 
                            id={'ObservationVariablesCompactView-listA-listItem-'+it.observationVariableDbId}
                            key={key} 
                            role="listitem" 
                            button 
                                  ...
                                  <Grid container alignItems='center' alignContent='center' wrap='nowrap' spacing={1}>
                                    <Grid item>
                                      <Tooltip title={ 'observationVariableDbId' }>
                                        <Typography
                                        id={'ObservationVariablesCompactView-listA-listItem-id-'+it.observationVariableDbId}
                                ...
                                <React.Fragment>
                                  ...
                                  {(label) && (
                                    <Tooltip title={ 'ObservationVariableName' }>
                                      <Typography
                                      id={'ObservationVariablesCompactView-listA-listItem-label-'+it.observationVariableDbId}
                                  ...
                                  {(sublabel) && (
                                    <Tooltip title={ '' }>
                                      <Typography
                                      id={'ObservationVariablesCompactView-listA-listItem-sublabel-'+it.observationVariableDbId}
              ...
              {/* Pagination */}
              <ObservationVariablesCompactViewCursorPagination
                count={count}
...
ObservationVariablesCompactView.propTypes = {
  item: PropTypes.object.isRequired,
  handleClickOnObservationVariablesRow: PropTypes.func,
};