...
//lazy loading
const OntologyReferenceAttributesPage = lazy(() => import(/* webpackChunkName: "Detail-Attributes-OntologyReference" */ './components/ontologyReference-attributes-page/OntologyReferenceAttributesPage'));
const OntologyReferenceAssociationsPage = lazy(() => import(/* webpackChunkName: "Detail-Associations-OntologyReference" */ './components/ontologyReference-associations-page/OntologyReferenceAssociationsPage'));
const OntologyReferenceUpdatePanel = lazy(() => import(/* webpackChunkName: "Detail-Update-OntologyReference" */ '../ontologyReference-update-panel/OntologyReferenceUpdatePanel'));
const OntologyReferenceDeleteConfirmationDialog = lazy(() => import(/* webpackChunkName: "Detail-Delete-OntologyReference" */ '../OntologyReferenceDeleteConfirmationDialog'));
...
export default function OntologyReferenceDetailPanel(props) {
      ...
      lastModelChanged['ontologyReference'][String(item['ontologyDbId'])]) {
        ...
        if(lastModelChanged['ontologyReference'][String(item['ontologyDbId'])].op === "update"&&
            lastModelChanged['ontologyReference'][String(item['ontologyDbId'])].newItem) {
              //replace item
              setItemState(lastModelChanged['ontologyReference'][String(item['ontologyDbId'])].newItem);
              //show alert
              setUpdated(true);
        } else {
          //deleted item
  ...
  const handleUpdateDialogClose = (event, status, item, newItem, changedAssociations) => {
    if(status) {
      dispatch(modelChange('ontologyReference', 'update', item, newItem, changedAssociations))
    }
  ...
  const onSuccessDelete = (event, item) => {
    dispatch(modelChange('ontologyReference', 'delete', item, null))
          ...
          <AppBar className={classes.appBar}>
            <Toolbar>
              <Tooltip title={ t('modelPanels.close') }>
                <IconButton
                  id='OntologyReferenceDetailPanel-button-close'
                  edge="start"
                  color="inherit"
                  onClick={(event) => {
                    if(!isCanceling.current){
              ...
              <Typography variant="h6" className={classes.title}>
                { t('modelPanels.detailOf') +  ": OntologyReference | ontologyDbId: " + itemState['ontologyDbId'] }
              </Typography>
              {/*
                Actions:
                - Edit
              ...
              */}
              {
                ...
                &&(!deleted)&&(
                    ...
                    <Tooltip title={ t('modelPanels.edit') }>
                      <IconButton
                        id='OntologyReferenceDetailPanel-button-edit'
                        color='inherit'
                        onClick={(event) => {
              ...
              }
              {
                ...
                &&(!deleted)&&(
                    ...
                    <Tooltip title={ t('modelPanels.delete') }>
                      <IconButton
                        id='OntologyReferenceDetailPanel-button-delete'
                        color='inherit'
                        onClick={(event) => {
                          event.stopPropagation();
...
OntologyReferenceDetailPanel.propTypes = {
