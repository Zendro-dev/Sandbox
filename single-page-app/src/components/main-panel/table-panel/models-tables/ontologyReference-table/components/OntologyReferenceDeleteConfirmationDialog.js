...
//lazy loading
const OntologyReferenceDetailPanel = lazy(() => import(/* webpackChunkName: "Delete-DetailOntologyReference" */ './ontologyReference-detail-panel/OntologyReferenceDetailPanel'));
...
export default function OntologyReferenceDeleteConfirmationDialog(props) {
  ...
  return (
    ...
    >
      ...
      {(!deleted) && (
        <DialogActions>
          <Button 
          id='OntologyReferenceDeleteConfirmationDialog-button-reject'
          ...
          <Button 
          id='OntologyReferenceDeleteConfirmationDialog-button-accept'
...
OntologyReferenceDeleteConfirmationDialog.propTypes = {
