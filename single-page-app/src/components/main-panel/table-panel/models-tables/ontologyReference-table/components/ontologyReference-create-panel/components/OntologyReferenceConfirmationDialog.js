...
export default function OntologyReferenceConfirmationDialog(props) {
  ...
  return (
    <div>
      <Dialog id='OntologyReferenceConfirmationDialog-create'
        open={open}
      ...
      >
        ...
        <DialogActions>
          ...
          {(acceptText !== '' && acceptText !== null && acceptText !== undefined) &&
            <Button
              id='OntologyReferenceConfirmationDialog-create-button-accept'
              color="primary"
              variant='contained'
          ...
          {(rejectText !== '' && acceptText !== null && acceptText !== undefined) &&
            ...
            <Button
              id='OntologyReferenceConfirmationDialog-create-button-reject'
              color="primary" 
...
OntologyReferenceConfirmationDialog.propTypes = {
