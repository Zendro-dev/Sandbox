      ...
      (response) => {
        ...
        if(response.message === 'ok') {
          ...
          if(response.graphqlErrors) {
            ...
            newError.locations=[{model: 'ontologyReference', association: 'methods', table:'A', method: 'getCount()', request: 'api.method.getCountItems'}];
            newError.path=['add', 'methods'];
      ...
      (response) => {
        ...
        if(response.message === 'ok') {
          ...
          if(response.graphqlErrors) {
            ...
            newError.message = t('modelPanels.errors.data.e3', 'fetched with errors.');
            newError.locations=[{model: 'ontologyReference', association: 'methods', table:'A', method: 'getData()', request: 'api.method.getItems'}];
            newError.path=['add', 'methods'];
            newError.extensions = {graphQL:{data:response.data, errors:response.graphqlErrors}};
