...
import ScalesCompactViewToolbar from './components/ScalesCompactViewToolbar';
import ScalesCompactViewCursorPagination from './components/ScalesCompactViewCursorPagination';
...
export default function ScalesCompactView(props) {
      ...
      (response) => {
        ...
        if(response.message === 'ok') {
          ...
          if(response.graphqlErrors) {
            ...
            newError.path=['detail', `ontologyDbId:${item.ontologyDbId}`, 'scales'];
  ...
  useEffect(() => {
     ...
     * 
     * Conditions:
     * A: the current item 'internalId' attribute is in the removedIds of the updated 'scale'.
     * B: the current item 'internalId' attribute is in the addedIds of the updated 'scale'.
     * 
     * Actions:
     * if A:
     * - reload table.
            ...
            <Card className={classes.card}>
              ...
              {(!isOnApiRequest && (!areItemsReady)) && (
                ...
                <Fade
                  ...
                  unmountOnExit
                >
                  <div id='ScalesCompactView-div-noDataA'>
                    <Grid container>
                      <Grid item xs={12}>
              ...
              {(!isOnApiRequest && areItemsReady) && (
                ...
                >
                  <Box className={classes.listBox} ref={lref}>
                    <List id='ScalesCompactView-list-listA'
                    dense component="div" role="list" >
                      {items.map(it => {
                        ...
                        return (
                          <ListItem 
                            id={'ScalesCompactView-listA-listItem-'+it.scaleDbId}
                            key={key} 
                            role="listitem" 
                            button 
                                  ...
                                  <Grid container alignItems='center' alignContent='center' wrap='nowrap' spacing={1}>
                                    <Grid item>
                                      <Tooltip title={ 'scaleDbId' }>
                                        <Typography
                                        id={'ScalesCompactView-listA-listItem-id-'+it.scaleDbId}
                                ...
                                <React.Fragment>
                                  ...
                                  {(label) && (
                                    <Tooltip title={ 'scaleName' }>
                                      <Typography
                                      id={'ScalesCompactView-listA-listItem-label-'+it.scaleDbId}
                                  ...
                                  {(sublabel) && (
                                    <Tooltip title={ '' }>
                                      <Typography
                                      id={'ScalesCompactView-listA-listItem-sublabel-'+it.scaleDbId}
              ...
              {/* Pagination */}
              <ScalesCompactViewCursorPagination
                count={count}
...
ScalesCompactView.propTypes = {
  item: PropTypes.object.isRequired,
  handleClickOnScalesRow: PropTypes.func,
};