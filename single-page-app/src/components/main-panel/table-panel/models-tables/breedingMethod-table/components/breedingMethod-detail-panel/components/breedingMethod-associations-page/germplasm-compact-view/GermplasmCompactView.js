...
import GermplasmCompactViewToolbar from './components/GermplasmCompactViewToolbar';
import GermplasmCompactViewCursorPagination from './components/GermplasmCompactViewCursorPagination';
...
export default function GermplasmCompactView(props) {
      ...
      (response) => {
        ...
        if(response.message === 'ok') {
          ...
          if(response.graphqlErrors) {
            ...
            newError.path=['detail', `breedingMethodDbId:${item.breedingMethodDbId}`, 'germplasm'];
  ...
  }, [graphqlServerUrl, showMessageB, t, item.breedingMethodDbId, search]);
  ...
  useEffect(() => {
     ...
     * 
     * Conditions:
     * A: the current item 'internalId' attribute is in the removedIds of the updated 'germplasm'.
     * B: the current item 'internalId' attribute is in the addedIds of the updated 'germplasm'.
     * 
     * Actions:
     * if A:
     * - reload table.
  ...
  }, [lastModelChanged, lastChangeTimestamp, items, item.breedingMethodDbId, count, getCount, configurePagination]);
            ...
            <Card className={classes.card}>
              ...
              {(!isOnApiRequest && (!areItemsReady)) && (
                ...
                <Fade
                  ...
                  unmountOnExit
                >
                  <div id='GermplasmCompactView-div-noDataA'>
                    <Grid container>
                      <Grid item xs={12}>
              ...
              {(!isOnApiRequest && areItemsReady) && (
                ...
                >
                  <Box className={classes.listBox} ref={lref}>
                    <List id='GermplasmCompactView-list-listA'
                    dense component="div" role="list" >
                      {items.map(it => {
                        ...
                        return (
                          <ListItem 
                            id={'GermplasmCompactView-listA-listItem-'+it.germplasmDbId}
                            key={key} 
                            role="listitem" 
                            button 
                                  ...
                                  <Grid container alignItems='center' alignContent='center' wrap='nowrap' spacing={1}>
                                    <Grid item>
                                      <Tooltip title={ 'germplasmDbId' }>
                                        <Typography
                                        id={'GermplasmCompactView-listA-listItem-id-'+it.germplasmDbId}
                                ...
                                <React.Fragment>
                                  ...
                                  {(label) && (
                                    <Tooltip title={ 'germplasmName' }>
                                      <Typography
                                      id={'GermplasmCompactView-listA-listItem-label-'+it.germplasmDbId}
                                  ...
                                  {(sublabel) && (
                                    <Tooltip title={ '' }>
                                      <Typography
                                      id={'GermplasmCompactView-listA-listItem-sublabel-'+it.germplasmDbId}
              ...
              {/* Pagination */}
              <GermplasmCompactViewCursorPagination
                count={count}
...
GermplasmCompactView.propTypes = {
  item: PropTypes.object.isRequired,
  handleClickOnGermplasmRow: PropTypes.func,
};