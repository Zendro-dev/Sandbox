...
//lazy loading
const GermplasmToAddTransferView = lazy(() => import(/* webpackChunkName: "Create-TransferLists-ToAdd-Germplasm" */ './germplasm-to-add-transfer-view/GermplasmToAddTransferView'));
const GermplasmToRemoveTransferView = lazy(() => import(/* webpackChunkName: "Create-TransferLists-ToRemove-Germplasm" */ './germplasm-to-remove-transfer-view/GermplasmToRemoveTransferView'));
...
export default function GermplasmTransferLists(props) {
  ...
  return (
    <div id='GermplasmTransferLists-div-root' className={classes.root}>
