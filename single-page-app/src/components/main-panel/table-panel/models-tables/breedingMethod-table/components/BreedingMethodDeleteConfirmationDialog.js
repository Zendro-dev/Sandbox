...
//lazy loading
const BreedingMethodDetailPanel = lazy(() => import(/* webpackChunkName: "Delete-DetailBreedingMethod" */ './breedingMethod-detail-panel/BreedingMethodDetailPanel'));
...
export default function BreedingMethodDeleteConfirmationDialog(props) {
  ...
  return (
    ...
    >
      ...
      {(!deleted) && (
        <DialogActions>
          <Button 
          id='BreedingMethodDeleteConfirmationDialog-button-reject'
          ...
          <Button 
          id='BreedingMethodDeleteConfirmationDialog-button-accept'
...
BreedingMethodDeleteConfirmationDialog.propTypes = {
