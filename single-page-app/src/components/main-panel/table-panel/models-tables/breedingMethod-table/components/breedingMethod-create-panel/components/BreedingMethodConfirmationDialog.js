...
export default function BreedingMethodConfirmationDialog(props) {
  ...
  return (
    <div>
      <Dialog id='BreedingMethodConfirmationDialog-create'
        open={open}
      ...
      >
        ...
        <DialogActions>
          ...
          {(acceptText !== '' && acceptText !== null && acceptText !== undefined) &&
            <Button
              id='BreedingMethodConfirmationDialog-create-button-accept'
              color="primary"
              variant='contained'
          ...
          {(rejectText !== '' && acceptText !== null && acceptText !== undefined) &&
            ...
            <Button
              id='BreedingMethodConfirmationDialog-create-button-reject'
              color="primary" 
...
BreedingMethodConfirmationDialog.propTypes = {
