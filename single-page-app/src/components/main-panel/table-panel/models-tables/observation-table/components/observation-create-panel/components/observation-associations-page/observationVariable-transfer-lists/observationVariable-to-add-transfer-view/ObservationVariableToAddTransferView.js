      ...
      (response) => {
        ...
        if(response.message === 'ok') {
          ...
          if(response.graphqlErrors) {
            ...
            newError.locations=[{model: 'observation', association: 'observationVariable', table:'A', method: 'getCount()', request: 'api.observationVariable.getCountItems'}];
            newError.path=['add', 'observationVariable'];
      ...
      (response) => {
        ...
        if(response.message === 'ok') {
          ...
          if(response.graphqlErrors) {
            ...
            newError.message = t('modelPanels.errors.data.e3', 'fetched with errors.');
            newError.locations=[{model: 'observation', association: 'observationVariable', table:'A', method: 'getData()', request: 'api.observationVariable.getItems'}];
            newError.path=['add', 'observationVariable'];
            newError.extensions = {graphQL:{data:response.data, errors:response.graphqlErrors}};
