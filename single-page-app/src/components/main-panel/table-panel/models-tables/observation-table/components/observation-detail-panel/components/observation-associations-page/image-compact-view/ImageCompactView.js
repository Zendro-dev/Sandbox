...
import ImageCompactViewToolbar from './components/ImageCompactViewToolbar';
...
export default function ImageCompactView(props) {
  ...
  const getData = useCallback(async () => {
    ...
    */
    ...
    let cancelableApiReq = makeCancelable(api.observation.getImage(
      graphqlServerUrl, 
      ...
      (response) => {
        ...
        if(response.message === 'ok') {
          ...
          if(response.graphqlErrors) {
            ...
            newError.locations=[{association: 'image', method: 'getData()', request: 'api.observation.getImage'}];
            newError.path=['detail', `observationDbId:${item.observationDbId}`, 'image'];
            ...
            <Card className={classes.card}>
              ...
              {(!isOnApiRequest && (!areItemsReady)) && (
                ...
                <Fade
                  ...
                  unmountOnExit
                >
                  <div id='ImageCompactView-div-noDataA'>
                    <Grid container>
                      <Grid item xs={12}>
              ...
              {(!isOnApiRequest && areItemsReady) && (
                ...
                >
                  <Box className={classes.listBox} ref={lref}>
                    <List id='ImageCompactView-list-listA'
                    dense component="div" role="list" >
                      {items.map(it => {
                        ...
                        return (
                          <ListItem 
                            id={'ImageCompactView-listA-listItem-'+it.imageDbId}
                            key={key} 
                            role="listitem" 
                            button 
                                  ...
                                  <Grid container alignItems='center' alignContent='center' wrap='nowrap' spacing={1}>
                                    <Grid item>
                                      <Tooltip title={ 'imageDbId' }>
                                        <Typography
                                        id={'ImageCompactView-listA-listItem-id-'+it.imageDbId}
                                ...
                                <React.Fragment>
                                  ...
                                  {(label) && (
                                    <Tooltip title={ 'imageName' }>
                                      <Typography
                                      id={'ImageCompactView-listA-listItem-label-'+it.imageDbId}
                                  ...
                                  {(sublabel) && (
                                    <Tooltip title={ '' }>
                                      <Typography
                                      id={'ImageCompactView-listA-listItem-sublabel-'+it.imageDbId}
...
ImageCompactView.propTypes = {
  item: PropTypes.object.isRequired,
  handleClickOnImageRow: PropTypes.func,
};