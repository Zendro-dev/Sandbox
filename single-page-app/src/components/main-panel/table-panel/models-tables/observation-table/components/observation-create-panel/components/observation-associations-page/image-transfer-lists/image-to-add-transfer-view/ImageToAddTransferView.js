      ...
      (response) => {
        ...
        if(response.message === 'ok') {
          ...
          if(response.graphqlErrors) {
            ...
            newError.locations=[{model: 'observation', association: 'image', table:'A', method: 'getCount()', request: 'api.image.getCountItems'}];
            newError.path=['add', 'image'];
      ...
      (response) => {
        ...
        if(response.message === 'ok') {
          ...
          if(response.graphqlErrors) {
            ...
            newError.message = t('modelPanels.errors.data.e3', 'fetched with errors.');
            newError.locations=[{model: 'observation', association: 'image', table:'A', method: 'getData()', request: 'api.image.getItems'}];
            newError.path=['add', 'image'];
            newError.extensions = {graphQL:{data:response.data, errors:response.graphqlErrors}};
