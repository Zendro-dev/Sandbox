...
//lazy loading
const ObservationDetailPanel = lazy(() => import(/* webpackChunkName: "Delete-DetailObservation" */ './observation-detail-panel/ObservationDetailPanel'));
...
export default function ObservationDeleteConfirmationDialog(props) {
  ...
  return (
    ...
    >
      ...
      {(!deleted) && (
        <DialogActions>
          <Button 
          id='ObservationDeleteConfirmationDialog-button-reject'
          ...
          <Button 
          id='ObservationDeleteConfirmationDialog-button-accept'
...
ObservationDeleteConfirmationDialog.propTypes = {
