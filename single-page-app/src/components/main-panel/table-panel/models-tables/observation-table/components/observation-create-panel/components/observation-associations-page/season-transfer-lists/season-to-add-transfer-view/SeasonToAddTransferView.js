      ...
      (response) => {
        ...
        if(response.message === 'ok') {
          ...
          if(response.graphqlErrors) {
            ...
            newError.locations=[{model: 'observation', association: 'season', table:'A', method: 'getCount()', request: 'api.season.getCountItems'}];
            newError.path=['add', 'season'];
      ...
      (response) => {
        ...
        if(response.message === 'ok') {
          ...
          if(response.graphqlErrors) {
            ...
            newError.message = t('modelPanels.errors.data.e3', 'fetched with errors.');
            newError.locations=[{model: 'observation', association: 'season', table:'A', method: 'getData()', request: 'api.season.getItems'}];
            newError.path=['add', 'season'];
            newError.extensions = {graphQL:{data:response.data, errors:response.graphqlErrors}};
