...
//lazy loading
const SeasonToAddTransferView = lazy(() => import(/* webpackChunkName: "Create-TransferLists-ToAdd-Season" */ './season-to-add-transfer-view/SeasonToAddTransferView'));
...
export default function SeasonTransferLists(props) {
  ...
  return (
    <div id='SeasonTransferLists-div-root' className={classes.root}>
