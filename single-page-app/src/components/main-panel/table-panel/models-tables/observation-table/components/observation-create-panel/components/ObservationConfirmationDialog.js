...
export default function ObservationConfirmationDialog(props) {
  ...
  return (
    <div>
      <Dialog id='ObservationConfirmationDialog-create'
        open={open}
      ...
      >
        ...
        <DialogActions>
          ...
          {(acceptText !== '' && acceptText !== null && acceptText !== undefined) &&
            <Button
              id='ObservationConfirmationDialog-create-button-accept'
              color="primary"
              variant='contained'
          ...
          {(rejectText !== '' && acceptText !== null && acceptText !== undefined) &&
            ...
            <Button
              id='ObservationConfirmationDialog-create-button-reject'
              color="primary" 
...
ObservationConfirmationDialog.propTypes = {
