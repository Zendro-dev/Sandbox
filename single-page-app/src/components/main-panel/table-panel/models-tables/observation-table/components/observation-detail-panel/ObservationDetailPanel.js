...
//lazy loading
const ObservationAttributesPage = lazy(() => import(/* webpackChunkName: "Detail-Attributes-Observation" */ './components/observation-attributes-page/ObservationAttributesPage'));
const ObservationAssociationsPage = lazy(() => import(/* webpackChunkName: "Detail-Associations-Observation" */ './components/observation-associations-page/ObservationAssociationsPage'));
const ObservationUpdatePanel = lazy(() => import(/* webpackChunkName: "Detail-Update-Observation" */ '../observation-update-panel/ObservationUpdatePanel'));
const ObservationDeleteConfirmationDialog = lazy(() => import(/* webpackChunkName: "Detail-Delete-Observation" */ '../ObservationDeleteConfirmationDialog'));
...
const ImageDetailPanel = lazy(() => import(/* webpackChunkName: "Detail-Detail-Image" */ '../../../image-table/components/image-detail-panel/ImageDetailPanel'));
...
const SeasonDetailPanel = lazy(() => import(/* webpackChunkName: "Detail-Detail-Season" */ '../../../season-table/components/season-detail-panel/SeasonDetailPanel'));
      ...
      lastModelChanged['observation'][String(item['observationDbId'])]) {
        ...
        if(lastModelChanged['observation'][String(item['observationDbId'])].op === "update"&&
            lastModelChanged['observation'][String(item['observationDbId'])].newItem) {
              //replace item
              setItemState(lastModelChanged['observation'][String(item['observationDbId'])].newItem);
              //show alert
              setUpdated(true);
        } else {
          //deleted item
          ...
          <AppBar className={classes.appBar}>
            <Toolbar>
              <Tooltip title={ t('modelPanels.close') }>
                <IconButton
                  id='ObservationDetailPanel-button-close'
                  edge="start"
                  color="inherit"
                  onClick={(event) => {
                    if(!isCanceling.current){
              ...
              */}
              {
                ...
                &&(!deleted)&&(
                    ...
                    <Tooltip title={ t('modelPanels.edit') }>
                      <IconButton
                        id='ObservationDetailPanel-button-edit'
                        color='inherit'
                        onClick={(event) => {
              ...
              }
              {
                ...
                &&(!deleted)&&(
                    ...
                    <Tooltip title={ t('modelPanels.delete') }>
                      <IconButton
                        id='ObservationDetailPanel-button-delete'
                        color='inherit'
                        onClick={(event) => {
                          event.stopPropagation();
