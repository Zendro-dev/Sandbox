...
export default function ObservationConfirmationDialog(props) {
  ...
  return (
    <div>
      <Dialog id='ObservationConfirmationDialog-update'
        open={open}
      ...
      >
        ...
        <DialogActions>
          ...
          {(acceptText !== '' && acceptText !== null && acceptText !== undefined) &&
            <Button
              id='ObservationConfirmationDialog-update-button-accept'
              color="primary"
              variant='contained'
          ...
          {(rejectText !== '' && acceptText !== null && acceptText !== undefined) &&
            ...
            <Button
              id='ObservationConfirmationDialog-update-button-reject'
              color="primary" 
