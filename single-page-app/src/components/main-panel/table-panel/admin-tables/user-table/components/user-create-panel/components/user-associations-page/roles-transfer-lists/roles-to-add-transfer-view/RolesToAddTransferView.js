      ...
      (response) => {
        ...
        if(response.message === 'ok') {
          ...
          if(response.graphqlErrors) {
            ...
            newError.locations=[{model: 'user', association: 'roles', table:'A', method: 'getCount()', request: 'api.role.getCountItems'}];
      ...
      (response) => {
        ...
        if(response.message === 'ok') {
          ...
          if(response.graphqlErrors) {
            ...
            newError.message = t('modelPanels.errors.data.e3', 'fetched with errors.');
            newError.locations=[{model: 'user', association: 'roles', table:'A', method: 'getData()', request: 'api.role.getItems'}];
            newError.path=['add', 'roles'];
            newError.extensions = {graphQL:{data:response.data, errors:response.graphqlErrors}};
