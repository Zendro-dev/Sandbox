  ...
  return (
    <div>
      ...
      {(changePasswordDialogOpen) && (
        <Dialog 
          id={'StringField-User-ChangePasswordDialog-'+name} 
          ...
          <DialogContent>
            ...
            <form noValidate autoComplete="off">
              <Grid container justify='center' alignItems='center' spacing={2}>
                <Grid item xs={12}>
                  <TextField
                    id={'StringField-User-ChangePasswordDialog-textField-newPassword-'+name}
                ...
                <Grid item xs={12}>
                  <TextField
                    id={'StringField-User-ChangePasswordDialog-textField-newPassword2-'+name}
