...
import UserCreatePanel from './components/user-create-panel/UserCreatePanel'
import UserUpdatePanel from './components/user-update-panel/UserUpdatePanel'
import UserDetailPanel from './components/user-detail-panel/UserDetailPanel'
...
//Plotly
import UserPlotly from '../../../../plots/UserPlotly';
            ...
            <Grid item xs={12}>
              <Paper className={classes.paper}>
                ...
                <UserEnhancedTableToolbar
                  ...
                  search={search}
                  showToggleButtons={Boolean(UserPlotly)}
