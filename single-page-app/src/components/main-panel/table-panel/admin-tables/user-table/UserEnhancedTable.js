...
import UserCursorPagination from './components/UserCursorPagination'
...
//lazy loading
const UserCreatePanel = lazy(() => import(/* webpackChunkName: "Create-User" */ './components/user-create-panel/UserCreatePanel'));
const UserUpdatePanel = lazy(() => import(/* webpackChunkName: "Update-User" */ './components/user-update-panel/UserUpdatePanel'));
const UserDetailPanel = lazy(() => import(/* webpackChunkName: "Detail-User" */ './components/user-detail-panel/UserDetailPanel'));
const UserDeleteConfirmationDialog = lazy(() => import(/* webpackChunkName: "Delete-User" */ './components/UserDeleteConfirmationDialog'));
//Plotly
const UserPlotly = lazy(() => import(/* webpackChunkName: "Plotly-User" */ '../../../../plots/UserPlotly'));
  ...
  async function getCsvTemplate() {
    ...
    */
    ...
    await cancelableApiReq
      ...
      //error
      .catch((err) => { //error: on api.user.tableTemplate
        if(err.isCanceled) {
          return
        } else {
          let newError = {};
                  ...
                  */}
                  <div>
                    ...
                    <div className={classes.tableWrapper} ref={twref}>
                      ...
                      {/* Table */}
                      <Table id='UserEnhancedTable-table' stickyHeader size='small' ref={tref}>
                          ...
                          <TableBody id='UserEnhancedTable-tableBody'>
                            {
                              items.map((item, index) => {
                                return ([
                                  ...
                                  */
                                  <TableRow
                                    id={'UserEnhancedTable-row-'+item.id}
                                    hover
                                  ...
                                  >
                                    ...
                                    <TableCell padding="checkbox">
                                      <Tooltip title={ t('modelPanels.viewDetails') }>
                                        <IconButton
                                          id={'UserEnhancedTable-row-iconButton-detail-'+item.id}
                                          color="default"
                                          onClick={event => {
                                      ...
                                      &&(
                                        <TableCell padding='checkbox' align='center'>
                                          <Tooltip title={ t('modelPanels.edit') }>
                                            <IconButton
                                              id={'UserEnhancedTable-row-iconButton-edit-'+item.id}
                                              color="default"
                                              onClick={(event) => {
                                                event.stopPropagation();
                                      ...
                                      &&(
                                        <TableCell padding='checkbox' align='center'>
                                          <Tooltip title={ t('modelPanels.delete') }>
                                            <IconButton
                                              id={'UserEnhancedTable-row-iconButton-delete-'+item.id}
                                              color="default"
                                              onClick={(event) => {
                                                event.stopPropagation();
