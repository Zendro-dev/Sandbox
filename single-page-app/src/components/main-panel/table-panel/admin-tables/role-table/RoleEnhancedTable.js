...
//lazy loading
const RoleCreatePanel = lazy(() => import(/* webpackChunkName: "Create-Role" */ './components/role-create-panel/RoleCreatePanel'));
const RoleUpdatePanel = lazy(() => import(/* webpackChunkName: "Update-Role" */ './components/role-update-panel/RoleUpdatePanel'));
const RoleDetailPanel = lazy(() => import(/* webpackChunkName: "Detail-Role" */ './components/role-detail-panel/RoleDetailPanel'));
const RoleDeleteConfirmationDialog = lazy(() => import(/* webpackChunkName: "Delete-Role" */ './components/RoleDeleteConfirmationDialog'));
//Plotly
const RolePlotly = lazy(() => import(/* webpackChunkName: "Plotly-Role" */ '../../../../plots/RolePlotly'));
