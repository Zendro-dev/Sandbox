...
module.exports = class book {
    ...
    static get registeredAdapters() {
        return ["book_server1", "book_server2"].reduce((a, c) => {
            a[c] = adapters[c];
            return a;
        }, {});
    }
    ...
    /**
     * add_author_id - field Mutation (model-layer) for to_one associationsArguments to add
     *
    ...
    /**
     * remove_author_id - field Mutation (model-layer) for to_one associationsArguments to remove
     *
     * @param {Id}   book_id   IdAttribute of the root model to be updated
     * @param {Id}   author_id Foreign Key (stored in "Me") of the Association to be updated.
     * @param {BenignErrorReporter} benignErrorReporter Error Reporter used for reporting Errors from remote zendro services
