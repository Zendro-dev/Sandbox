...
module.exports = class dog extends Sequelize.Model {
    ...
    static async readById(id) {
        let item = await dog.findByPk(id);
        if (item === null) {
    ...
    static bulkAddCsv(context) {
        ...
        return `Bulk import of dog records started. You will be send an email to ${helpersAcl.getTokenFromContext(context).email} informing you about success or errors`;
    }
