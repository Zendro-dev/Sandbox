...
import MeasurementsCompactViewToolbar from './components/MeasurementsCompactViewToolbar';
import MeasurementsCompactViewCursorPagination from './components/MeasurementsCompactViewCursorPagination';
...
export default function MeasurementsCompactView(props) {
    ...
    cancelableApiReq
      ...
      (response) => {
        ...
        if(!response.data ||!response.data.data) {
          ...
          newError.path=['detail', `accession_id:${item.accession_id}`, 'measurements'];
  ...
  useEffect(() => {
     ...
     * 
     * Conditions:
     * A: the current item 'internalId' attribute is in the removedIds of the updated 'Measurement'.
     * B: the current item 'internalId' attribute is in the addedIds of the updated 'Measurement'.
     * 
     * Actions:
     * if A:
     * - reload table.
        ...
        <Grid item xs={12} >
          {(item!==undefined) && (
            <Card className={classes.card}>
              ...
              {/* Toolbar */}
              <MeasurementsCompactViewToolbar 
                title={'Measurements'}
                search={search}
                                  ...
                                  <Grid container alignItems='center' alignContent='center' wrap='nowrap' spacing={1}>
                                    <Grid item>
                                      <Tooltip title={ 'measurement_id' }>
                                        <Typography variant="h6" display="block" noWrap={true}>{it.measurement_id}</Typography>
                                      </Tooltip>
                                    </Grid>
                                    {/*Key icon*/}
                                    <Grid item>
              ...
              {(true) && (
                ...
                <MeasurementsCompactViewCursorPagination
                  count={count}
...
MeasurementsCompactView.propTypes = {
  item: PropTypes.object.isRequired,
  handleClickOnMeasurementsRow: PropTypes.func,
};