...
import AccessionsCompactViewToolbar from './components/AccessionsCompactViewToolbar';
import AccessionsCompactViewCursorPagination from './components/AccessionsCompactViewCursorPagination';
...
export default function AccessionsCompactView(props) {
    ...
    cancelableApiReq
      ...
      (response) => {
        ...
        if(!response.data ||!response.data.data) {
          ...
          newError.path=['detail', `locationId:${item.locationId}`, 'accessions'];
  ...
  }, [lastModelChanged, lastChangeTimestamp, items, item.locationId]);
          ...
          {(item!==undefined) && (
            <Card className={classes.card}>
              ...
              {(true) && (
                ...
                <AccessionsCompactViewCursorPagination
                  count={count}
...
AccessionsCompactView.propTypes = {
  item: PropTypes.object.isRequired,
  handleClickOnAccessionsRow: PropTypes.func,
};