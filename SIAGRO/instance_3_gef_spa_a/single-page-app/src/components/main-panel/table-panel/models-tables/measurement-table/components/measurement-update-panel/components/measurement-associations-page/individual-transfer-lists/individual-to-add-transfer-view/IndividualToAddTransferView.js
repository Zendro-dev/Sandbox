  ...
  */
  ...
  const getData = useCallback(() => {
    ...
    if(lidsAssociated.current === undefined) {
      /*
        API Request: associated individual ids
      */
      ...
      cancelableApiReq
        ...
        .then(response => {
          ...
          if (
            ...
            //set internalId
            let idso = response.data.data.readOneMeasurement.individual;
            lidsAssociated.current = (idso&&typeof idso==='object'&&idso.hasOwnProperty('name')) ? [idso.name] : [];
