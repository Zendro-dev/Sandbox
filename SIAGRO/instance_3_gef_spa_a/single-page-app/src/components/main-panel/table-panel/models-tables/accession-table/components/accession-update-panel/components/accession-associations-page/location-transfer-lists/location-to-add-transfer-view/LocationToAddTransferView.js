                    ...
                    <List dense component="div" role="list" >
                      {items.map(it => {
                        ...
                        return (
                          ...
                          >
                            <ListItemAvatar>
                              <Tooltip title={ (associatedItem.locationId===it.locationId) ? 'Location — ' + t('modelPanels.associated', 'Associated') : 'Location '}>
                                <Avatar>
                                  {"location".slice(0,1)}
                                </Avatar>
                              </Tooltip>
                              ...
                              primary={
                                <React.Fragment>
                                  ...
                                  <Grid container alignItems='center' alignContent='center' wrap='nowrap' spacing={1}>
                                    ...
                                    {/*Key icon*/}
                                    <Grid item>
                                      <Tooltip title={ (associatedItem.locationId===it.locationId) ? t('modelPanels.internalId', 'Unique Identifier') + ' — ' + t('modelPanels.associated', 'Associated') : t('modelPanels.internalId', 'Unique Identifier')}>
