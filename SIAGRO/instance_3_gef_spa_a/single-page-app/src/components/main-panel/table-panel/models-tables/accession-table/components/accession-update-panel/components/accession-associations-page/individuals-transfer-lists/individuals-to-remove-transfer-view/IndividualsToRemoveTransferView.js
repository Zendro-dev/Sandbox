    ...
    cancelableApiReq
      ...
      .then(response => {
        ...
        if (
          ...
          //save response data
          let newCount = response.data.data.readOneAccession.countFilteredIndividuals;
          let its = response.data.data.readOneAccession.individualsConnection.edges.map(o => o.node);
          let pi = response.data.data.readOneAccession.individualsConnection.pageInfo;
