    ...
    cancelableApiReq
      ...
      .then(response => {
        ...
        if (
          ...
          //save response data
          let newCount = response.data.data.readOneAccession.countFilteredMeasurements;
          let its = response.data.data.readOneAccession.measurementsConnection.edges.map(o => o.node);
          let pi = response.data.data.readOneAccession.measurementsConnection.pageInfo;
