...
import IndividualsCompactViewToolbar from './components/IndividualsCompactViewToolbar';
import IndividualsCompactViewCursorPagination from './components/IndividualsCompactViewCursorPagination';
...
export default function IndividualsCompactView(props) {
    ...
    cancelableApiReq
      ...
      (response) => {
        ...
        if(!response.data ||!response.data.data) {
          ...
          newError.path=['detail', `accession_id:${item.accession_id}`, 'individuals'];
          ...
          {(item!==undefined) && (
            <Card className={classes.card}>
                              ...
                              primary={
                                <React.Fragment>
                                  ...
                                  <Grid container alignItems='center' alignContent='center' wrap='nowrap' spacing={1}>
                                    <Grid item>
                                      <Tooltip title={ 'name' }>
                                        <Typography variant="h6" display="block" noWrap={true}>{it.name}</Typography>
                                      </Tooltip>
                                    </Grid>
                                    {/*Key icon*/}
                                    <Grid item>
              ...
              {(true) && (
                ...
                <IndividualsCompactViewCursorPagination
                  count={count}
...
IndividualsCompactView.propTypes = {
  item: PropTypes.object.isRequired,
  handleClickOnIndividualsRow: PropTypes.func,
};