  ...
  */
  ...
  const getData = useCallback(() => {
    ...
    if(lidsAssociated.current === undefined) {
      /*
        API Request: associated accession ids
      */
      ...
      cancelableApiReq
        ...
        .then(response => {
          ...
          if (
            ...
            //set internalId
            let idso = response.data.data.readOneIndividual.accession;
            lidsAssociated.current = (idso&&typeof idso==='object'&&idso.hasOwnProperty('accession_id')) ? [idso.accession_id] : [];
            ...
            cancelableApiReqB
              ...
              .then(response => {
                ...
                if (
                  ...
                  //save response data
                  let newCount = response.data.data.countAccessions;
