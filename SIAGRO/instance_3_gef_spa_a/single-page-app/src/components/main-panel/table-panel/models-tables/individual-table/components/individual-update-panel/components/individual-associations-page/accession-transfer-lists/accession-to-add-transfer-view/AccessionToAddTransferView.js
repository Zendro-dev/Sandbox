                    ...
                    <List dense component="div" role="list" >
                      {items.map(it => {
                        ...
                        return (
                          ...
                          >
                            <ListItemAvatar>
                              <Tooltip title={ (associatedItem.accession_id===it.accession_id) ? 'Accession — ' + t('modelPanels.associated', 'Associated') : 'Accession '}>
                                <Avatar>
                                  {"accession".slice(0,1)}
                                </Avatar>
                              </Tooltip>
                              ...
                              primary={
                                <React.Fragment>
                                  ...
                                  <Grid container alignItems='center' alignContent='center' wrap='nowrap' spacing={1}>
                                    ...
                                    {/*Key icon*/}
                                    <Grid item>
                                      <Tooltip title={ (associatedItem.accession_id===it.accession_id) ? t('modelPanels.internalId', 'Unique Identifier') + ' — ' + t('modelPanels.associated', 'Associated') : t('modelPanels.internalId', 'Unique Identifier')}>
