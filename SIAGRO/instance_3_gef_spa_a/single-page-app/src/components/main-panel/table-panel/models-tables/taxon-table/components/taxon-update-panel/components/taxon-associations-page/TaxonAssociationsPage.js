...
import AccessionsTransferLists from './accessions-transfer-lists/AccessionsTransferLists'
    ...
    <div hidden={hidden}>
      <Fade in={!hidden} timeout={500}>
        ...
        > 
          ...
          {/* Accessions Transfer Lists */}
          {(associationSelected === 'accessions') && (
            <Grid item xs={12} sm={10} md={9}>
              <AccessionsTransferLists
                item={item}
                idsToAdd={accessionsIdsToAdd}
                idsToRemove={accessionsIdsToRemove}
...
TaxonAssociationsPage.propTypes = {
  ...
  accessionsIdsToAdd: PropTypes.array.isRequired,
  accessionsIdsToRemove: PropTypes.array.isRequired,
