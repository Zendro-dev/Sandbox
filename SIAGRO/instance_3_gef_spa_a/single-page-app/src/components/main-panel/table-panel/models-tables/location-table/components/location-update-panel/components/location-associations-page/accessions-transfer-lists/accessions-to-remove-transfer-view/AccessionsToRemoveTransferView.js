    ...
    cancelableApiReq
      ...
      .then(response => {
        ...
        if (
          ...
          //save response data
          let newCount = response.data.data.readOneLocation.countFilteredAccessions;
          let its = response.data.data.readOneLocation.accessionsConnection.edges.map(o => o.node);
          let pi = response.data.data.readOneLocation.accessionsConnection.pageInfo;
