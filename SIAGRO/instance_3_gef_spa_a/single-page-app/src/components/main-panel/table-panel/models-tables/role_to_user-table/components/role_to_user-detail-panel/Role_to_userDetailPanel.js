...
export default function RoleToUserDetailPanel(props) {
  ...
  useEffect(() => {
    ...
    if(lastModelChanged&&
      ...
      lastModelChanged.role_to_user[String(itemState.id)]) {
          
        //updated item
        if(lastModelChanged.role_to_user[String(itemState.id)].op === "update"&&
            lastModelChanged.role_to_user[String(itemState.id)].newItem) {
              //replace item
              setItemState(lastModelChanged.role_to_user[String(itemState.id)].newItem);
              //show alert
              setUpdated(true);
        } else {
          //deleted item
          if(lastModelChanged.role_to_user[String(itemState.id)].op === "delete") {
              //show alert
              setDeleted(true);
          }
        }
