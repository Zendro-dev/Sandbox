...
export default {
   ...
   * 
   * Get accessions connection (cursor based) records associated to the given individual record
   ...
   * 
   * Get the accession-ids associated (by cursor based connection) to the given individual record 
   * through association 'Accession', from GraphQL Server.
   * 
   * @param {String} url GraphQL Server url
   * @param {Number} itemId Model item internalId.
   ...
   * 
   * Get measurements connection (cursor based) records associated to the given individual record
   ...
   * 
   * Get the measurement-ids associated (by cursor based connection) to the given individual record 
   * through association 'Measurements', from GraphQL Server.
   * 
   * @param {String} url GraphQL Server url
   * @param {Number} itemId Model item internalId.
