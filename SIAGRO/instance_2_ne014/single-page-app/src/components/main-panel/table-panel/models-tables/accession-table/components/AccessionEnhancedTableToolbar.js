...
export default function AccessionEnhancedTableToolbar(props) {
                        ...
                        <Grid item xs={12}>
                          <Grid container justify="center">
                            {/* Add */}
                            {
                              ...
                              &&(permissions.accession.includes('create') || permissions.accession.includes('*')))
                              &&(
                                <Grid item>
                                  <Tooltip title={t('modelPanels.addNew') + " accession"}>
                                    <IconButton
                                      color="primary"
                                  ...
                                  >
                                    ...
                                    <Grid item xs={12}>
                                      <Grid container justify='flex-start'>
                                        ...
                                        <input type="hidden" name="model" value='accession' />
                                          <ButtonBase
...
AccessionEnhancedTableToolbar.propTypes = {
