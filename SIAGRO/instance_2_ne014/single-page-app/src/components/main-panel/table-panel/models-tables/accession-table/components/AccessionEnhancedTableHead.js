    ...
    <TableHead>
      <TableRow>
        ...
        {/* Actions */}
        {
          ...
          &&(permissions.accession.includes('update') || permissions.accession.includes('delete') || permissions.accession.includes('*')))
          &&(
            <TableCell 
              padding="checkbox" 
              align='center' 
              ...
              colSpan={
                0 +
                ((permissions.accession.includes('update') || permissions.accession.includes('*')) ? 1 : 0) 
                +
                ((permissions.accession.includes('delete') || permissions.accession.includes('*')) ? 1 : 0)
              }
            >
