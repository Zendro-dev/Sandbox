...
export default function AccessionToAddTransferView(props) {
  ...
  */
  ...
  const getData = useCallback(() => {
    ...
    */
    let cancelableApiReq = makeCancelable(api.measurement.getAssociatedAccessionConnection(graphqlServerUrl, item.measurement_id));  
    ...
    cancelableApiReq
      ...
      (response) => {
        ...
        if(!response.data ||!response.data.data) {
          ...
          newError.locations=[{model: 'Measurement', association: 'accession', table:'A', query: 'readOneMeasurement', method: 'getData()', request: 'api.measurement.getAssociatedAccessionConnection'}];
        ...
        //get item
        let idso = readOneMeasurement.accession;
        ...
        cancelableApiReqB
          ...
          (response)=> {
            ...
            if(!response.data ||!response.data.data) {
              ...
              variant.current='error';
              newError.message = t('modelPanels.errors.data.e1', 'No data was received from the server.');
              newError.locations=[{model: 'Measurement', association: 'accession', table:'A', query: 'countAccessions', method: 'getData()', request: 'api.accession.getCountItems'}];
              newError.path=['add', 'accession'];
              newError.extensions = {graphqlResponse:{data:response.data.data, errors:response.data.errors}};
              errors.current.push(newError);
              console.log("Error: ", newError);
            ...
            cancelableApiReqC
              ...
              (response) => {
                ...
                if(!response.data ||!response.data.data) {
                  ...
                  variant.current='error';
                  newError.message = t('modelPanels.errors.data.e1', 'No data was received from the server.');
                  newError.locations=[{model: 'Measurement', association: 'accession', table:'A', query: 'accessionsConnection', method: 'getData()', request: 'api.accession.getItemsConnection'}];
                  newError.path=['add', 'accession'];
                  newError.extensions = {graphqlResponse:{data:response.data.data, errors:response.data.errors}};
                  errors.current.push(newError);
                  console.log("Error: ", newError);
                ...
                if(accessionsConnection === null) {
                  ...
                  */
                  ...
                  if(errors.current.length > 0) {
                    ...
                    newError.locations=[{model: 'Measurement', association: 'accession', table:'A', method: 'getData()'}];
                    newError.path=['add', 'accession'];
                    newError.extensions = {graphQL:{data:response.data.data, errors:response.data.errors}};
                    errors.current.push(newError);
                    console.log("Error: ", newError);
      ...
      //error
      .catch((err) => { //error: on api.measurement.getAssociatedAccessionConnection
        if(err.isCanceled) {
          return
        } else {
          let newError = {};
    ...
    cancelableApiReq
      ...
      (response) => {
        ...
        if(!response.data ||!response.data.data) {
          ...
          newError.message = t('modelPanels.errors.data.e1', 'No data was received from the server.');
          newError.locations=[{model: 'Measurement', association: 'accession', table:'B', query: 'countAccessions', method: 'getDataB()', request: 'api.accession.getCountItems'}];
          newError.path=['add', 'accession'];
          newError.extensions = {graphqlResponse:{data:response.data.data, errors:response.data.errors}};
          ...
          cancelableApiReqB
            ...
            (response) => {
              ...
              if(!response.data ||!response.data.data) {
                ...
                variantB.current='error';
                newError.message = t('modelPanels.errors.data.e1', 'No data was received from the server.');
                newError.locations=[{model: 'Measurement', association: 'accession', table:'B', query: 'accessionsConnection', method: 'getDataB()', request: 'api.accession.getItemsConnection'}];
                newError.path=['add', 'accession'];
                newError.extensions = {graphqlResponse:{data:response.data.data, errors:response.data.errors}};
                errorsB.current.push(newError);
                console.log("Error: ", newError);
              ...
              */
              ...
              if(errorsB.current.length > 0) {
                ...
                newError.locations=[{model: 'Measurement', association: 'accession', table:'B', method: 'getDataB()'}];
                newError.path=['add', 'accession'];
                newError.extensions = {graphQL:{data:response.data.data, errors:response.data.errors}};
                errorsB.current.push(newError);
                console.log("Error: ", newError);
  ...
  useEffect(() => {
    ...
    if(lastModelChanged.Measurement&&
        ...
        lastModelChanged.Measurement[String(item.measurement_id)].changedAssociations.accession&&
        (lastModelChanged.Measurement[String(item.measurement_id)].changedAssociations.accession.added ||
         lastModelChanged.Measurement[String(item.measurement_id)].changedAssociations.accession.removed)) {
          
          //remove any dis-associated internalId from idsToAdd[]
          let idsRemoved = lastModelChanged.Measurement[String(item.measurement_id)].changedAssociations.accession.idsRemoved;
          if(idsRemoved) {
