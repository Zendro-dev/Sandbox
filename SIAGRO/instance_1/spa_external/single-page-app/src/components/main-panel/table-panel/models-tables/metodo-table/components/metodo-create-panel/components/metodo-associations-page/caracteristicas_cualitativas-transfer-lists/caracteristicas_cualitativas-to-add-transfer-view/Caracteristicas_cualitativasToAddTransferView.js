  ...
  */
  ...
  const getCount = useCallback(async () => {
    ...
    */
    ...
    let cancelableApiReq = makeCancelable(api.caracteristica_cualitativa.getCountItems(graphqlServerUrl, search, ops));
      ...
      (response) => {
        ...
        if(response.message === 'ok') {
          ...
          if(response.graphqlErrors) {
            ...
            newError.locations=[{model: 'metodo', association: 'caracteristicas_cualitativas', table:'A', method: 'getCount()', request: 'api.caracteristica_cualitativa.getCountItems'}];
            newError.path=['add', 'caracteristicas_cualitativas'];
      ...
      (response) => {
        ...
        if(response.message === 'ok') {
          ...
          if(response.graphqlErrors) {
            ...
            newError.message = t('modelPanels.errors.data.e3', 'fetched with errors.');
            newError.locations=[{model: 'metodo', association: 'caracteristicas_cualitativas', table:'A', method: 'getData()', request: 'api.caracteristica_cualitativa.getItems'}];
            newError.path=['add', 'caracteristicas_cualitativas'];
            newError.extensions = {graphQL:{data:response.data, errors:response.graphqlErrors}};
