...
import CuadranteDetailPanel from './cuadrante-detail-panel/CuadranteDetailPanel'
...
export default function CuadranteDeleteConfirmationDialog(props) {
  ...
  return (
    ...
    >
      ...
      {(!deleted) && (
        <DialogActions>
          <Button 
          id='CuadranteDeleteConfirmationDialog-button-reject'
          ...
          <Button 
          id='CuadranteDeleteConfirmationDialog-button-accept'
...
CuadranteDeleteConfirmationDialog.propTypes = {
