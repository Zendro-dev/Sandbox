...
import CaracteristicasCuantitativasCompactViewToolbar from './components/Caracteristicas_cuantitativasCompactViewToolbar';
import CaracteristicasCuantitativasCompactViewCursorPagination from './components/Caracteristicas_cuantitativasCompactViewCursorPagination';
...
export default function CaracteristicasCuantitativasCompactView(props) {
      ...
      (response) => {
        ...
        if(response.message === 'ok') {
          ...
          if(response.graphqlErrors) {
            ...
            newError.path=['detail', `id:${item.id}`, 'caracteristicas_cuantitativas'];
  ...
  useEffect(() => {
     ...
     * 
     * Conditions:
     * A: the current item 'internalId' attribute is in the removedIds of the updated 'caracteristica_cuantitativa'.
     * B: the current item 'internalId' attribute is in the addedIds of the updated 'caracteristica_cuantitativa'.
     * 
     * Actions:
     * if A:
     * - reload table.
        ...
        <Grid item xs={12} >
          {(item!==undefined) && (
            <Card className={classes.card}>
              ...
              {/* Toolbar */}
              <CaracteristicasCuantitativasCompactViewToolbar 
              ...
              {(!isOnApiRequest && (!areItemsReady)) && (
                ...
                <Fade
                  ...
                  unmountOnExit
                >
                  <div id='CaracteristicasCuantitativasCompactView-div-noDataA'>
                    <Grid container>
                      <Grid item xs={12}>
              ...
              {(!isOnApiRequest && areItemsReady) && (
                ...
                >
                  <Box className={classes.listBox} ref={lref}>
                    <List id='CaracteristicasCuantitativasCompactView-list-listA'
                    dense component="div" role="list" >
                      {items.map(it => {
                        ...
                        return (
                          <ListItem 
                            id={'CaracteristicasCuantitativasCompactView-listA-listItem-'+it.id}
                            key={key} 
                            role="listitem" 
                            button 
                                ...
                                <React.Fragment>
                                  ...
                                  <Grid container alignItems='center' alignContent='center' wrap='nowrap' spacing={1}>
                                    <Grid item>
                                      <Tooltip title={ 'id' }>
                                        <Typography
                                        id={'CaracteristicasCuantitativasCompactView-listA-listItem-id-'+it.id}
                                ...
                                <React.Fragment>
                                  ...
                                  {(label) && (
                                    <Tooltip title={ 'nombre_corto' }>
                                      <Typography
                                      id={'CaracteristicasCuantitativasCompactView-listA-listItem-label-'+it.id}
                                  ...
                                  {(sublabel) && (
                                    <Tooltip title={ 'valor' }>
                                      <Typography
                                      id={'CaracteristicasCuantitativasCompactView-listA-listItem-sublabel-'+it.id}
              ...
              {/* Pagination */}
              <CaracteristicasCuantitativasCompactViewCursorPagination
                count={count}
...
CaracteristicasCuantitativasCompactView.propTypes = {
  item: PropTypes.object.isRequired,
  handleClickOnCaracteristicas_cuantitativasRow: PropTypes.func,
};