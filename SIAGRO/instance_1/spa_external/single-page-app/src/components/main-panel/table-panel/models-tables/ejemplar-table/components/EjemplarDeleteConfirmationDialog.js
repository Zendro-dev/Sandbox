...
//lazy loading
const EjemplarDetailPanel = lazy(() => import(/* webpackChunkName: "Delete-DetailEjemplar" */ './ejemplar-detail-panel/EjemplarDetailPanel'));
...
export default function EjemplarDeleteConfirmationDialog(props) {
  ...
  return (
    ...
    >
      ...
      {(!deleted) && (
        <DialogActions>
          <Button 
          id='EjemplarDeleteConfirmationDialog-button-reject'
          ...
          <Button 
          id='EjemplarDeleteConfirmationDialog-button-accept'
...
EjemplarDeleteConfirmationDialog.propTypes = {
