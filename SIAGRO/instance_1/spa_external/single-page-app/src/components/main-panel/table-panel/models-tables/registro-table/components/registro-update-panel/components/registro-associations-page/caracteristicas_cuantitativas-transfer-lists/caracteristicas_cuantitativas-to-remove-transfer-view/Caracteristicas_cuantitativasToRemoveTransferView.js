...
import CaracteristicasCuantitativasToRemoveTransferViewToolbar from './components/Caracteristicas_cuantitativasToRemoveTransferViewToolbar';
import CaracteristicasCuantitativasToRemoveTransferViewCursorPagination from './components/Caracteristicas_cuantitativasToRemoveTransferViewCursorPagination';
...
export default function CaracteristicasCuantitativasToRemoveTransferView(props) {
...
const showMessageB = useCallback((message, withDetail) => {
 ...
 /**
  ...
  const getCount = useCallback(async () => {
    ...
    /*
      API Request: api.registro.getCaracteristicas_cuantitativasCount
    */
    let api = await loadApi("registro");
    let cancelableApiReq = makeCancelable(api.registro.getCaracteristicas_cuantitativasCount(
      graphqlServerUrl, 
      item.conabio_id,
      search,
    ));
    ...
    await cancelableApiReq
      ...
      (response) => {
        ...
        if(response.message === 'ok') {
          ...
          if(response.graphqlErrors) {
            ...
            newError.locations=[{association: 'caracteristicas_cuantitativas', method: 'getCount()', request: 'api.registro.getCaracteristicas_cuantitativasCount'}];
            newError.path=['update', `conabio_id:${item.conabio_id}`, 'remove', 'caracteristicas_cuantitativas'];
      ...
      //error
      .catch((err) => { //error: on api.registro.getCaracteristicas_cuantitativasCount
        if(err.isCanceled) {
          return;
        } else {
          let newError = {};
  ...
  const getData = useCallback(async () => {
    ...
    /*
      API Request: api.registro.getCaracteristicas_cuantitativas
    */
    let variables = {
      pagination: {...paginationRef.current}
    };
    let api = await loadApi("registro");
    let cancelableApiReq = makeCancelable(api.registro.getCaracteristicas_cuantitativas(
      graphqlServerUrl, 
      item.conabio_id,
      search,
      variables,
    ...
    await cancelableApiReq
      ...
      (response) => {
        ...
        if(response.message === 'ok') {
          ...
          if(response.graphqlErrors) {
            ...
            newError.message = t('modelPanels.errors.data.e3', 'fetched with errors.');
            newError.locations=[{association: 'caracteristicas_cuantitativas', method: 'getData()', request: 'api.registro.getCaracteristicas_cuantitativas'}];
            newError.path=['update', `conabio_id:${item.conabio_id}`, 'remove', 'caracteristicas_cuantitativas'];
            newError.extensions = {graphQL:{data:response.data, errors:response.graphqlErrors}};
      ...
      //error
      .catch((err) => { //error: on api.registro.getCaracteristicas_cuantitativas
        if(err.isCanceled) {
          return;
        } else {
          let newError = {};
  ...
  useEffect(() => {
     ...
     * Actions:
     * if A:
     * - remove the internalId of the 'caracteristica_cuantitativa' from idsToRemove[].
     * - reload both transfer tables.
     * - return
     * 
     * else if B:
        ...
        <Grid item xs={12} sm={5} >
          {(item!==undefined) && (
            <Card className={classes.card}>
              ...
              {/* Toolbar */}
              <CaracteristicasCuantitativasToRemoveTransferViewToolbar
              ...
              {(!isOnApiRequest && (!areItemsReady)) && (
                ...
                <Fade
                  ...
                  unmountOnExit
                >
                  <div id='CaracteristicasCuantitativasToRemoveTransferView-div-noDataA'>
                    <Grid container>
                      <Grid item xs={12}>
              ...
              {(!isOnApiRequest && areItemsReady) && (
                ...
                >
                  <Box className={classes.listBox} ref={lref}>
                    <List id='CaracteristicasCuantitativasToRemoveTransferView-list-listA'
                      ...
                      {items.map(it => {
                        ...
                        return (
                          <ListItem 
                            id={'CaracteristicasCuantitativasToRemoveTransferView-listA-listItem-'+it.id}
                            key={key} 
                            role="listitem" 
                            button 
                          ...
                          >
                            ...
                            <ListItemSecondaryAction>
                              <Tooltip title={!disabled ? t('modelPanels.transferToRemove') : t('modelPanels.alreadyToRemove') }>
                                <span>
                                  <IconButton
                                    id={'CaracteristicasCuantitativasToRemoveTransferView-listA-listItem-'+it.id+'-button-remove'}
                                    color="primary"
              ...
              {/* Pagination */}
              <CaracteristicasCuantitativasToRemoveTransferViewCursorPagination
                count={count}
            ...
            <Card className={classes.card}>
              ...
              {(!thereAreItemsToAdd) && (
                ...
                <Fade
                  ...
                  unmountOnExit
                >
                  <div id='CaracteristicasCuantitativasToRemoveTransferView-div-noItemsB'>
                    <Grid container>
                      <Grid item xs={12}>
                        <Grid className={classes.noDataBox} container justify="center" alignItems="center">
                          <Grid item>
              ...
              {(thereAreItemsToAdd && !isOnApiRequestB && (!areItemsReadyB)) && (
                ...
                <Fade
                  ...
                  unmountOnExit
                >
                  <div id='CaracteristicasCuantitativasToRemoveTransferView-div-noDataB'>
                    <Grid container>
                      <Grid item xs={12}>
                        <Grid className={classes.noDataBox} container justify="center" alignItems="center">
                          <Grid item>
              ...
              {(thereAreItemsToAdd && !isOnApiRequestB && areItemsReadyB) && (
                ...
                >
                  <Box className={classes.listBox} ref={lrefB}>
                    <List id='CaracteristicasCuantitativasToRemoveTransferView-list-listB'
                      dense component="div" role="list">
                      {itemsB.map(it => {
                        let key = it.id;
                        let label = it.nombre_corto;
                        ...
                        return (
                          <ListItem 
                            id={'CaracteristicasCuantitativasToRemoveTransferView-listB-listItem-'+it.id}
                            key={key} 
                            role="listitem"
                            button
                            className={classes.row}
                          ...
                          >
                            ...
                            <ListItemSecondaryAction>
                              <Tooltip title={ t('modelPanels.untransferToRemove') }>
                                <IconButton
                                  id={'CaracteristicasCuantitativasToRemoveTransferView-listB-listItem-'+it.id+'-button-remove'}
                                  color="primary"
                                  onClick={(event) => {
                                    event.stopPropagation();
...
CaracteristicasCuantitativasToRemoveTransferView.propTypes = {
