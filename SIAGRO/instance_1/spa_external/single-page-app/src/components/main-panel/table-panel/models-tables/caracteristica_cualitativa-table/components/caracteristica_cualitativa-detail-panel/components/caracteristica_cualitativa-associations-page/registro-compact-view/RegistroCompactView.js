...
export default function RegistroCompactView(props) {
  ...
  const getData = useCallback(async () => {
    ...
    */
    ...
    let cancelableApiReq = makeCancelable(api.caracteristica_cualitativa.getRegistro(
      graphqlServerUrl, 
      item.id,
      search,
      variables,
      ...
      (response) => {
        ...
        if(response.message === 'ok') {
          ...
          if(response.graphqlErrors) {
            ...
            newError.locations=[{association: 'registro', method: 'getData()', request: 'api.caracteristica_cualitativa.getRegistro'}];
