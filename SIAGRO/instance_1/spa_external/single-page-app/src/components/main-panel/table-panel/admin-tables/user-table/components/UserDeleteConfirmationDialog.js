...
//lazy loading
const UserDetailPanel = lazy(() => import(/* webpackChunkName: "Delete-DetailUser" */ './user-detail-panel/UserDetailPanel'));
  ...
  return (
    ...
    >
      ...
      {(!deleted) && (
        <DialogActions>
          <Button 
          id='UserDeleteConfirmationDialog-button-reject'
          ...
          <Button 
          id='UserDeleteConfirmationDialog-button-accept'
