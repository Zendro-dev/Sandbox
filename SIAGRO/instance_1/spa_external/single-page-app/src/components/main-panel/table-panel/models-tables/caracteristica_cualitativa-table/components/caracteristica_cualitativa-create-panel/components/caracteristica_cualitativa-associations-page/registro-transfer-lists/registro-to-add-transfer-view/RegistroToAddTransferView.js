      ...
      (response) => {
        ...
        if(response.message === 'ok') {
          ...
          if(response.graphqlErrors) {
            ...
            newError.locations=[{model: 'caracteristica_cualitativa', association: 'registro', table:'A', method: 'getCount()', request: 'api.ejemplar.getCountItems'}];
      ...
      (response) => {
        ...
        if(response.message === 'ok') {
          ...
          if(response.graphqlErrors) {
            ...
            newError.message = t('modelPanels.errors.data.e3', 'fetched with errors.');
            newError.locations=[{model: 'caracteristica_cualitativa', association: 'registro', table:'A', method: 'getData()', request: 'api.ejemplar.getItems'}];
            newError.path=['add', 'registro'];
            newError.extensions = {graphQL:{data:response.data, errors:response.graphqlErrors}};
