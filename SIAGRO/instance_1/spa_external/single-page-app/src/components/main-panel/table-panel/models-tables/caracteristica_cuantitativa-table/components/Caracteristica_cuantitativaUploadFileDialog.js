...
export default function CaracteristicaCuantitativaUploadFileDialog(props) {
  ...
  const handleSubmit = (event) => {
    if(file.current !== undefined && file.current !== null) {
      ...
      let query = 'mutation{ bulkAddCaracteristica_cuantitativaCsv }'
  ...
  return (
    ...
    >
      <DialogTitle>
      { t('modelPanels.uploading') + ' Caracteristica_cuantitativas' }
        <div>
...
CaracteristicaCuantitativaUploadFileDialog.propTypes = {
