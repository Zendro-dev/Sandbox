...
//lazy loading
const RegistroDetailPanel = lazy(() => import(/* webpackChunkName: "Delete-DetailRegistro" */ './registro-detail-panel/RegistroDetailPanel'));
...
export default function RegistroDeleteConfirmationDialog(props) {
  ...
  return (
    ...
    >
      ...
      {(!deleted) && (
        <DialogActions>
          <Button 
          id='RegistroDeleteConfirmationDialog-button-reject'
          ...
          <Button 
          id='RegistroDeleteConfirmationDialog-button-accept'
...
RegistroDeleteConfirmationDialog.propTypes = {
