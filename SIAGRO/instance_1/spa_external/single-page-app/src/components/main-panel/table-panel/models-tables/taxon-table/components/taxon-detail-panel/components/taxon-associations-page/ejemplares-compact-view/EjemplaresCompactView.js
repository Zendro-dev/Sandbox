...
import EjemplaresCompactViewToolbar from './components/EjemplaresCompactViewToolbar';
import EjemplaresCompactViewCursorPagination from './components/EjemplaresCompactViewCursorPagination';
...
export default function EjemplaresCompactView(props) {
      ...
      (response) => {
        ...
        if(response.message === 'ok') {
          ...
          if(response.graphqlErrors) {
            ...
            newError.path=['detail', `id:${item.id}`, 'ejemplares'];
            ...
            <Card className={classes.card}>
              ...
              {(!isOnApiRequest && (!areItemsReady)) && (
                ...
                <Fade
                  ...
                  unmountOnExit
                >
                  <div id='EjemplaresCompactView-div-noDataA'>
                    <Grid container>
                      <Grid item xs={12}>
              ...
              {(!isOnApiRequest && areItemsReady) && (
                ...
                >
                  <Box className={classes.listBox} ref={lref}>
                    <List id='EjemplaresCompactView-list-listA'
                    dense component="div" role="list" >
                      {items.map(it => {
                        ...
                        return (
                          <ListItem 
                            id={'EjemplaresCompactView-listA-listItem-'+it.id}
                            key={key} 
                            role="listitem" 
                            button 
                                ...
                                <React.Fragment>
                                  ...
                                  <Grid container alignItems='center' alignContent='center' wrap='nowrap' spacing={1}>
                                    <Grid item>
                                      <Tooltip title={ 'id' }>
                                        <Typography
                                        id={'EjemplaresCompactView-listA-listItem-id-'+it.id}
                              ...
                              secondary={
                                <React.Fragment>
                                  ...
                                  {(label) && (
                                    <Tooltip title={ '' }>
                                      <Typography
                                      id={'EjemplaresCompactView-listA-listItem-label-'+it.id}
                                  ...
                                  {(sublabel) && (
                                    <Tooltip title={ '' }>
                                      <Typography
                                      id={'EjemplaresCompactView-listA-listItem-sublabel-'+it.id}
              ...
              {/* Pagination */}
              <EjemplaresCompactViewCursorPagination
                count={count}
...
EjemplaresCompactView.propTypes = {
  item: PropTypes.object.isRequired,
  handleClickOnEjemplaresRow: PropTypes.func,
};