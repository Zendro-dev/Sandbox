  ...
  */
  ...
  const getCount = useCallback(async () => {
    ...
    */
    ...
    let cancelableApiReq = makeCancelable(api.metodo.getCountItems(graphqlServerUrl, search, ops));
      ...
      (response) => {
        ...
        if(response.message === 'ok') {
          ...
          if(response.graphqlErrors) {
            ...
            newError.locations=[{model: 'caracteristica_cuantitativa', association: 'metodo', table:'A', method: 'getCount()', request: 'api.metodo.getCountItems'}];
            newError.path=['add', 'metodo'];
      ...
      (response) => {
        ...
        if(response.message === 'ok') {
          ...
          if(response.graphqlErrors) {
            ...
            newError.message = t('modelPanels.errors.data.e3', 'fetched with errors.');
            newError.locations=[{model: 'caracteristica_cuantitativa', association: 'metodo', table:'A', method: 'getData()', request: 'api.metodo.getItems'}];
            newError.path=['add', 'metodo'];
            newError.extensions = {graphQL:{data:response.data, errors:response.graphqlErrors}};
