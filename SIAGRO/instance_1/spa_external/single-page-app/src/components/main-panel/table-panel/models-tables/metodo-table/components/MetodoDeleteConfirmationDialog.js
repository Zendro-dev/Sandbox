...
//lazy loading
const MetodoDetailPanel = lazy(() => import(/* webpackChunkName: "Delete-DetailMetodo" */ './metodo-detail-panel/MetodoDetailPanel'));
...
export default function MetodoDeleteConfirmationDialog(props) {
  ...
  return (
    ...
    >
      ...
      {(!deleted) && (
        <DialogActions>
          <Button 
          id='MetodoDeleteConfirmationDialog-button-reject'
          ...
          <Button 
          id='MetodoDeleteConfirmationDialog-button-accept'
...
MetodoDeleteConfirmationDialog.propTypes = {
