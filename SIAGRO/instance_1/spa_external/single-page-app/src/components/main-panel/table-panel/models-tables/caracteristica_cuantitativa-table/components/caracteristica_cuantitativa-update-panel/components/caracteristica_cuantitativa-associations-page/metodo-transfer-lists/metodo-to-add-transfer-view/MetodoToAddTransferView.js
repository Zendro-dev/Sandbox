...
export default function MetodoToAddTransferView(props) {
  ...
  */
  ...
  const getAssociatedItem = useCallback(async () => {
    ...
    /*
      API Request: api.caracteristica_cuantitativa.getMetodo
    */
    let api = await loadApi("caracteristica_cuantitativa");
    let cancelableApiReq = makeCancelable(api.caracteristica_cuantitativa.getMetodo(graphqlServerUrl, item.id));
    ...
    await cancelableApiReq
      ...
      (response) => {
        ...
        if(response.message === 'ok') {
          ...
          if(response.graphqlErrors) {
            ...
            newError.locations=[{model: 'caracteristica_cuantitativa', association: 'metodo', table:'Associated Item', method: 'getAssociatedItem()', request: 'api.caracteristica_cuantitativa.getMetodo'}];
      ...
      //error
      .catch((err) => { //error: on api.caracteristica_cuantitativa.getMetodo
        if(err.isCanceled) {
          return
        } else {
          let newError = {};
  ...
  const getCount = useCallback(async () => {
    ...
    /*
      API Request: api.caracteristica_cuantitativa.getNotAssociatedMetodoCount
    */
    let api = await loadApi("caracteristica_cuantitativa");
    let cancelableApiReq = makeCancelable(api.caracteristica_cuantitativa.getNotAssociatedMetodoCount(graphqlServerUrl, item.id, search, ops));
    ...
    await cancelableApiReq
      ...
      (response) => {
        ...
        if(response.message === 'ok') {
          ...
          if(response.graphqlErrors) {
            ...
            newError.message = t('modelPanels.errors.data.e3', 'fetched with errors.');
            newError.locations=[{model: 'caracteristica_cuantitativa', association: 'metodo', table:'A', method: 'getCount()', request: 'api.caracteristica_cuantitativa.getNotAssociatedMetodoCount'}];
      ...
      //error
      .catch((err) => { //error: on api.caracteristica_cuantitativa.getNotAssociatedMetodoCount
        if(err.isCanceled) {
          return;
        } else {
          //show error
  ...
  const getData = useCallback(async () => {
    ...
    /*
      API Request: api.caracteristica_cuantitativa.getNotAssociatedMetodo
    */
    let api = await loadApi("caracteristica_cuantitativa");
    let cancelableApiReq = makeCancelable(api.caracteristica_cuantitativa.getNotAssociatedMetodo(
      graphqlServerUrl,
      item.id,
      search,
      variables,
    ...
    await cancelableApiReq
      ...
      (response) => {
        ...
        if(response.message === 'ok') {
          ...
          if(response.graphqlErrors) {
            ...
            newError.message = t('modelPanels.errors.data.e3', 'fetched with errors.');
            newError.locations=[{model: 'caracteristica_cuantitativa', association: 'metodo', table:'A', method: 'getData()', request: 'api.caracteristica_cuantitativa.getNotAssociatedMetodo'}];
            newError.path=['update', `id:${item.id}`, 'add', 'metodo'];
            newError.extensions = {graphQL:{data:response.data, errors:response.graphqlErrors}};
      ...
      //error
      .catch((err) => { //error: on api.caracteristica_cuantitativa.getNotAssociatedMetodo
        if(err.isCanceled) {
          return;
        } else {
          let newError = {};
      ...
      (response) => {
        ...
        if(response.message === 'ok') {
          ...
          if(response.graphqlErrors) {
            ...
            newError.message = t('modelPanels.errors.data.e3', 'fetched with errors.');
            newError.locations=[{model: 'caracteristica_cuantitativa', association: 'metodo', table:'B', method: 'getDataB()', request: 'api.metodo.getItems'}];
            newError.path=['update', `id:${item.id}`, 'add', 'metodo'];
            newError.extensions = {graphQL:{data:response.data, errors:response.graphqlErrors}};
  ...
  useEffect(() => {
    ...
    if(lastModelChanged.caracteristica_cuantitativa&&
        ...
        lastModelChanged.caracteristica_cuantitativa[String(item.id)].changedAssociations.caracteristica_cuantitativa_metodo_id&&
        (lastModelChanged.caracteristica_cuantitativa[String(item.id)].changedAssociations.caracteristica_cuantitativa_metodo_id.added ||
         lastModelChanged.caracteristica_cuantitativa[String(item.id)].changedAssociations.caracteristica_cuantitativa_metodo_id.removed)) {
          
          //remove any associated internalId from idsToAdd[] & update counts
          let idsAdded = lastModelChanged.caracteristica_cuantitativa[String(item.id)].changedAssociations.caracteristica_cuantitativa_metodo_id.idsAdded;
          if(idsAdded) {
          ...
          let idsRemoved = lastModelChanged.caracteristica_cuantitativa[String(item.id)].changedAssociations.caracteristica_cuantitativa_metodo_id.idsRemoved;
          if(idsRemoved) {
            //increment A
