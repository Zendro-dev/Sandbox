...
import ReferenciasCompactViewToolbar from './components/ReferenciasCompactViewToolbar';
import ReferenciasCompactViewCursorPagination from './components/ReferenciasCompactViewCursorPagination';
...
export default function ReferenciasCompactView(props) {
      ...
      (response) => {
        ...
        if(response.message === 'ok') {
          ...
          if(response.graphqlErrors) {
            ...
            newError.path=['detail', `conabio_id:${item.conabio_id}`, 'referencias'];
  ...
  }, [graphqlServerUrl, showMessageB, t, item.conabio_id, search]);
  ...
  useEffect(() => {
     ...
     * 
     * Conditions:
     * A: the current item 'internalId' attribute is in the removedIds of the updated 'referencia'.
     * B: the current item 'internalId' attribute is in the addedIds of the updated 'referencia'.
     * 
     * Actions:
     * if A:
     * - reload table.
  ...
  }, [lastModelChanged, lastChangeTimestamp, items, item.conabio_id, count, getCount, configurePagination]);
            ...
            <Card className={classes.card}>
              ...
              {(!isOnApiRequest && (!areItemsReady)) && (
                ...
                <Fade
                  ...
                  unmountOnExit
                >
                  <div id='ReferenciasCompactView-div-noDataA'>
                    <Grid container>
                      <Grid item xs={12}>
              ...
              {(!isOnApiRequest && areItemsReady) && (
                ...
                >
                  <Box className={classes.listBox} ref={lref}>
                    <List id='ReferenciasCompactView-list-listA'
                    dense component="div" role="list" >
                      {items.map(it => {
                        ...
                        return (
                          <ListItem 
                            id={'ReferenciasCompactView-listA-listItem-'+it.referencia_id}
                            key={key} 
                            role="listitem" 
                            button 
                                  ...
                                  <Grid container alignItems='center' alignContent='center' wrap='nowrap' spacing={1}>
                                    <Grid item>
                                      <Tooltip title={ 'referencia_id' }>
                                        <Typography
                                        id={'ReferenciasCompactView-listA-listItem-id-'+it.referencia_id}
                              ...
                              secondary={
                                <React.Fragment>
                                  ...
                                  {(label) && (
                                    <Tooltip title={ 'referencia' }>
                                      <Typography
                                      id={'ReferenciasCompactView-listA-listItem-label-'+it.referencia_id}
                                  ...
                                  {(sublabel) && (
                                    <Tooltip title={ '' }>
                                      <Typography
                                      id={'ReferenciasCompactView-listA-listItem-sublabel-'+it.referencia_id}
              ...
              {/* Pagination */}
              <ReferenciasCompactViewCursorPagination
                count={count}
...
ReferenciasCompactView.propTypes = {
  item: PropTypes.object.isRequired,
  handleClickOnReferenciasRow: PropTypes.func,
};