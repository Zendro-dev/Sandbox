...
export default function ReferenciaConfirmationDialog(props) {
  ...
  return (
    <div>
      <Dialog id='ReferenciaConfirmationDialog-create'
        open={open}
      ...
      >
        ...
        <DialogActions>
          ...
          {(acceptText !== '' && acceptText !== null && acceptText !== undefined) &&
            <Button
              id='ReferenciaConfirmationDialog-create-button-accept'
              color="primary"
              variant='contained'
          ...
          {(rejectText !== '' && acceptText !== null && acceptText !== undefined) &&
            ...
            <Button
              id='ReferenciaConfirmationDialog-create-button-reject'
              color="primary" 
...
ReferenciaConfirmationDialog.propTypes = {
