...
export default function GrupoEnfoqueUploadFileDialog(props) {
  ...
  const handleSubmit = (event) => {
    if(file.current !== undefined && file.current !== null) {
      ...
      let query = 'mutation{ bulkAddGrupo_enfoqueCsv{ grupo_id} }'
  ...
  return (
    ...
    >
      <DialogTitle>
      { t('modelPanels.uploading') + ' Grupo_enfoques' }
        <div>
...
GrupoEnfoqueUploadFileDialog.propTypes = {
