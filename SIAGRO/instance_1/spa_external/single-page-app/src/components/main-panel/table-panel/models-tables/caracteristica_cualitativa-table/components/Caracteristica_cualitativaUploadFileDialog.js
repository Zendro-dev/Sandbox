...
export default function CaracteristicaCualitativaUploadFileDialog(props) {
  ...
  const handleSubmit = (event) => {
    if(file.current !== undefined && file.current !== null) {
      ...
      let query = 'mutation{ bulkAddCaracteristica_cualitativaCsv }'
  ...
  return (
    ...
    >
      <DialogTitle>
      { t('modelPanels.uploading') + ' Caracteristica_cualitativas' }
        <div>
...
CaracteristicaCualitativaUploadFileDialog.propTypes = {
