...
import SitioAssociationsMenuTabs from './SitioAssociationsMenuTabs'
...
export default function SitioAssociationsPage(props) {
  const classes = useStyles();
  const {
    hidden,
    item,
    grupo_enfoqueIdsToAdd,
    grupo_enfoqueIdsToRemove,
    handleTransferToAdd,
          ...
          {(associationSelected === 'grupo_enfoque') && (
            <Grid item xs={12} sm={11}>
              <GrupoEnfoqueTransferLists
                ...
                idsToRemove={grupo_enfoqueIdsToRemove}
...
SitioAssociationsPage.propTypes = {
  hidden: PropTypes.bool.isRequired,
  item: PropTypes.object.isRequired,
  grupo_enfoqueIdsToAdd: PropTypes.array.isRequired,
  grupo_enfoqueIdsToRemove: PropTypes.array.isRequired,
