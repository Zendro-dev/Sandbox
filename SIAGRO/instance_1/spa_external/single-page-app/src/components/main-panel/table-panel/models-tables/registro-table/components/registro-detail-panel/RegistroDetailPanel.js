...
//lazy loading
const RegistroAttributesPage = lazy(() => import(/* webpackChunkName: "Detail-Attributes-Registro" */ './components/registro-attributes-page/RegistroAttributesPage'));
const RegistroAssociationsPage = lazy(() => import(/* webpackChunkName: "Detail-Associations-Registro" */ './components/registro-associations-page/RegistroAssociationsPage'));
const RegistroUpdatePanel = lazy(() => import(/* webpackChunkName: "Detail-Update-Registro" */ '../registro-update-panel/RegistroUpdatePanel'));
const RegistroDeleteConfirmationDialog = lazy(() => import(/* webpackChunkName: "Detail-Delete-Registro" */ '../RegistroDeleteConfirmationDialog'));
...
const ReferenciaDetailPanel = lazy(() => import(/* webpackChunkName: "Detail-Detail-Referencia" */ '../../../referencia-table/components/referencia-detail-panel/ReferenciaDetailPanel'));
...
export default function RegistroDetailPanel(props) {
      ...
      lastModelChanged['registro'][String(item['conabio_id'])]) {
        ...
        if(lastModelChanged['registro'][String(item['conabio_id'])].op === "update"&&
            lastModelChanged['registro'][String(item['conabio_id'])].newItem) {
              //replace item
              setItemState(lastModelChanged['registro'][String(item['conabio_id'])].newItem);
              //show alert
              setUpdated(true);
        } else {
          //deleted item
  ...
  const handleUpdateDialogClose = (event, status, item, newItem, changedAssociations) => {
    if(status) {
      dispatch(modelChange('registro', 'update', item, newItem, changedAssociations))
    }
  ...
  const onSuccessDelete = (event, item) => {
    dispatch(modelChange('registro', 'delete', item, null))
          ...
          <AppBar className={classes.appBar}>
            <Toolbar>
              <Tooltip title={ t('modelPanels.close') }>
                <IconButton
                  id='RegistroDetailPanel-button-close'
                  edge="start"
                  color="inherit"
                  onClick={(event) => {
                    if(!isCanceling.current){
              ...
              <Typography variant="h6" className={classes.title}>
                { t('modelPanels.detailOf') +  ": Registro | conabio_id: " + itemState['conabio_id'] }
              </Typography>
              {/*
                Actions:
                - Edit
              ...
              */}
              {
                ...
                &&(!deleted)&&(
                    ...
                    <Tooltip title={ t('modelPanels.edit') }>
                      <IconButton
                        id='RegistroDetailPanel-button-edit'
                        color='inherit'
                        onClick={(event) => {
              ...
              }
              {
                ...
                &&(!deleted)&&(
                    ...
                    <Tooltip title={ t('modelPanels.delete') }>
                      <IconButton
                        id='RegistroDetailPanel-button-delete'
                        color='inherit'
                        onClick={(event) => {
                          event.stopPropagation();
