      ...
      <TableRow>
        ...
        */}
        ...
        <TableCell
          ...
          align='left'
          padding="default"
          sortDirection={orderBy === 'categoriaSorter' ? order : false}
        >
          {/* categoriaSorter */}
          <TableSortLabel
              active={orderBy === 'categoriaSorter'}
              direction={order}
              onClick={(event) => {onRequestSort(event, 'categoriaSorter')}}
          >
            <Typography color="inherit" variant="caption">
              categoriaSorter
            </Typography>
        ...
        <TableCell
          ...
          align='left'
          padding="default"
          sortDirection={orderBy === 'bibliografia' ? order : false}
        >
          {/* bibliografia */}
          <TableSortLabel
              active={orderBy === 'bibliografia'}
              direction={order}
              onClick={(event) => {onRequestSort(event, 'bibliografia')}}
          >
            <Typography color="inherit" variant="caption">
              bibliografia
            </Typography>
