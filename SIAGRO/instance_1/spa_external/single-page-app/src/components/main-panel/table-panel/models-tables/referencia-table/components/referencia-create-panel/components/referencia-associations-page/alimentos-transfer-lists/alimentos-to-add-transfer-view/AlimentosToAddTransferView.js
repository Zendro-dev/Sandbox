      ...
      (response) => {
        ...
        if(response.message === 'ok') {
          ...
          if(response.graphqlErrors) {
            ...
            newError.locations=[{model: 'referencia', association: 'alimentos', table:'A', method: 'getCount()', request: 'api.registro.getCountItems'}];
            newError.path=['add', 'alimentos'];
      ...
      (response) => {
        ...
        if(response.message === 'ok') {
          ...
          if(response.graphqlErrors) {
            ...
            newError.message = t('modelPanels.errors.data.e3', 'fetched with errors.');
            newError.locations=[{model: 'referencia', association: 'alimentos', table:'A', method: 'getData()', request: 'api.registro.getItems'}];
            newError.path=['add', 'alimentos'];
            newError.extensions = {graphQL:{data:response.data, errors:response.graphqlErrors}};
