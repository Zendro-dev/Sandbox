...
export default function TaxonAttributesFormView(props) {
  ...
  return (
    <div id='TaxonAttributesFormView-div-root' className={classes.root}>
      <Grid container justify='center'>
        ...
        <Card className={classes.cardB} elevation={0}>
            ...
            <CardHeader
              ...
              subheader={getItemsOk()+' / 17 ' + t('modelPanels.completed')}
            >
            </CardHeader>
          </Card>
          ...
          <Card className={classes.card}>
            ...
            */}
            ...
            {/* categoriaSorter */}
            <CardContent key='categoriaSorter' className={classes.cardContent} >
              <StringField
                itemKey='categoriaSorter'
                name='categoriaSorter'
                label='categoriaSorter'
                text={item.categoriaSorter}
                valueOk={valueOkStates.categoriaSorter}
                valueAjv={valueAjvStates.categoriaSorter}
                handleSetValue={handleSetValue}
              />
            </CardContent>

            {/* bibliografia */}
            <CardContent key='bibliografia' className={classes.cardContent} >
              <ArrayField
                itemKey='bibliografia'
                name='bibliografia'
                label='bibliografia'
                text={item.bibliografia}
                valueOk={valueOkStates.bibliografia}
                valueAjv={valueAjvStates.bibliografia}
                handleSetValue={handleSetValue}
                arrayType='String'
              />
            </CardContent>
