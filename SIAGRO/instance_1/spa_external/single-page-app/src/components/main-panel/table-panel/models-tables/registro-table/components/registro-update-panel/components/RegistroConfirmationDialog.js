...
export default function RegistroConfirmationDialog(props) {
  ...
  return (
    <div>
      <Dialog id='RegistroConfirmationDialog-update'
        open={open}
      ...
      >
        ...
        <DialogActions>
          ...
          {(acceptText !== '' && acceptText !== null && acceptText !== undefined) &&
            <Button
              id='RegistroConfirmationDialog-update-button-accept'
              color="primary"
              variant='contained'
          ...
          {(rejectText !== '' && acceptText !== null && acceptText !== undefined) &&
            ...
            <Button
              id='RegistroConfirmationDialog-update-button-reject'
              color="primary" 
...
RegistroConfirmationDialog.propTypes = {
