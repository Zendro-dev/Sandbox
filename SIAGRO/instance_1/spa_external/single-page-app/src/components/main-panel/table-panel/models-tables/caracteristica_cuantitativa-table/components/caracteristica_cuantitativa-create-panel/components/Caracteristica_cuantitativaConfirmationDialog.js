...
export default function CaracteristicaCuantitativaConfirmationDialog(props) {
  ...
  return (
    <div>
      <Dialog id='CaracteristicaCuantitativaConfirmationDialog-create'
        open={open}
      ...
      >
        ...
        <DialogActions>
          ...
          {(acceptText !== '' && acceptText !== null && acceptText !== undefined) &&
            <Button
              id='CaracteristicaCuantitativaConfirmationDialog-create-button-accept'
              color="primary"
              variant='contained'
          ...
          {(rejectText !== '' && acceptText !== null && acceptText !== undefined) &&
            ...
            <Button
              id='CaracteristicaCuantitativaConfirmationDialog-create-button-reject'
              color="primary" 
