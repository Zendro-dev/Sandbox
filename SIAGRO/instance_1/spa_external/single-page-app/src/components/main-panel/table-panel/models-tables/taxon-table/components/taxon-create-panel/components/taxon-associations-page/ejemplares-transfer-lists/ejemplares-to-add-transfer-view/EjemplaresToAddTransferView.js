      ...
      (response) => {
        ...
        if(response.message === 'ok') {
          ...
          if(response.graphqlErrors) {
            ...
            newError.locations=[{model: 'Taxon', association: 'ejemplares', table:'A', method: 'getCount()', request: 'api.ejemplar.getCountItems'}];
            newError.path=['add', 'ejemplares'];
      ...
      (response) => {
        ...
        if(response.message === 'ok') {
          ...
          if(response.graphqlErrors) {
            ...
            newError.message = t('modelPanels.errors.data.e3', 'fetched with errors.');
            newError.locations=[{model: 'Taxon', association: 'ejemplares', table:'A', method: 'getData()', request: 'api.ejemplar.getItems'}];
            newError.path=['add', 'ejemplares'];
            newError.extensions = {graphQL:{data:response.data, errors:response.graphqlErrors}};
