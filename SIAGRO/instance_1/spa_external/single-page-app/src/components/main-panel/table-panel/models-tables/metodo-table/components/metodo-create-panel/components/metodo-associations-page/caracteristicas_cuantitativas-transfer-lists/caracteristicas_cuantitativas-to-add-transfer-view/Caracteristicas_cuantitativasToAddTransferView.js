  ...
  */
  ...
  const getCount = useCallback(async () => {
    ...
    */
    ...
    let cancelableApiReq = makeCancelable(api.caracteristica_cuantitativa.getCountItems(graphqlServerUrl, search, ops));
      ...
      (response) => {
        ...
        if(response.message === 'ok') {
          ...
          if(response.graphqlErrors) {
            ...
            newError.locations=[{model: 'metodo', association: 'caracteristicas_cuantitativas', table:'A', method: 'getCount()', request: 'api.caracteristica_cuantitativa.getCountItems'}];
            newError.path=['add', 'caracteristicas_cuantitativas'];
      ...
      (response) => {
        ...
        if(response.message === 'ok') {
          ...
          if(response.graphqlErrors) {
            ...
            newError.message = t('modelPanels.errors.data.e3', 'fetched with errors.');
            newError.locations=[{model: 'metodo', association: 'caracteristicas_cuantitativas', table:'A', method: 'getData()', request: 'api.caracteristica_cuantitativa.getItems'}];
            newError.path=['add', 'caracteristicas_cuantitativas'];
            newError.extensions = {graphQL:{data:response.data, errors:response.graphqlErrors}};
