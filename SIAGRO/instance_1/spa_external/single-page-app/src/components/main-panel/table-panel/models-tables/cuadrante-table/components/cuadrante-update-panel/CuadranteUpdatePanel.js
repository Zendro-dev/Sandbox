...
export default function CuadranteUpdatePanel(props) {
  ...
  function setAddRemoveInformacion_taxonomica(variables) {
    //data to notify changes
    changedAssociations.current.informacion_taxonomica = {added: false, removed: false};
    ...
    if(item.informacion_taxonomica&&item.informacion_taxonomica.id) {
      ...
      if(informacion_taxonomicaIdsToAdd.current.length>0) {
        ...
        if(item.informacion_taxonomica.id!== informacion_taxonomicaIdsToAdd.current[0]) {
          ...
          changedAssociations.current.informacion_taxonomica.added = true;
          changedAssociations.current.informacion_taxonomica.idsAdded = informacion_taxonomicaIdsToAdd.current;
          changedAssociations.current.informacion_taxonomica.removed = true;
          changedAssociations.current.informacion_taxonomica.idsRemoved = [item.informacion_taxonomica.id];
        } else {
          /*
           * Case I.a.2: The ID on toAdd list es equal to the current associated ID.
           */
