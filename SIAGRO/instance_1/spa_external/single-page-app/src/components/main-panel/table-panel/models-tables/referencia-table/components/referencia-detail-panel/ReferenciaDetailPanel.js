...
//lazy loading
const ReferenciaAttributesPage = lazy(() => import(/* webpackChunkName: "Detail-Attributes-Referencia" */ './components/referencia-attributes-page/ReferenciaAttributesPage'));
const ReferenciaAssociationsPage = lazy(() => import(/* webpackChunkName: "Detail-Associations-Referencia" */ './components/referencia-associations-page/ReferenciaAssociationsPage'));
const ReferenciaUpdatePanel = lazy(() => import(/* webpackChunkName: "Detail-Update-Referencia" */ '../referencia-update-panel/ReferenciaUpdatePanel'));
const ReferenciaDeleteConfirmationDialog = lazy(() => import(/* webpackChunkName: "Detail-Delete-Referencia" */ '../ReferenciaDeleteConfirmationDialog'));
...
export default function ReferenciaDetailPanel(props) {
      ...
      lastModelChanged['referencia'][String(item['referencia_id'])]) {
        ...
        if(lastModelChanged['referencia'][String(item['referencia_id'])].op === "update"&&
            lastModelChanged['referencia'][String(item['referencia_id'])].newItem) {
              //replace item
              setItemState(lastModelChanged['referencia'][String(item['referencia_id'])].newItem);
              //show alert
              setUpdated(true);
        } else {
          //deleted item
  ...
  const handleUpdateDialogClose = (event, status, item, newItem, changedAssociations) => {
    if(status) {
      dispatch(modelChange('referencia', 'update', item, newItem, changedAssociations))
    }
  ...
  const onSuccessDelete = (event, item) => {
    dispatch(modelChange('referencia', 'delete', item, null))
          ...
          <AppBar className={classes.appBar}>
            <Toolbar>
              <Tooltip title={ t('modelPanels.close') }>
                <IconButton
                  id='ReferenciaDetailPanel-button-close'
                  edge="start"
                  color="inherit"
                  onClick={(event) => {
                    if(!isCanceling.current){
              ...
              <Typography variant="h6" className={classes.title}>
                { t('modelPanels.detailOf') +  ": Referencia | referencia_id: " + itemState['referencia_id'] }
              </Typography>
              {/*
                Actions:
                - Edit
              ...
              */}
              {
                ...
                &&(!deleted)&&(
                    ...
                    <Tooltip title={ t('modelPanels.edit') }>
                      <IconButton
                        id='ReferenciaDetailPanel-button-edit'
                        color='inherit'
                        onClick={(event) => {
              ...
              }
              {
                ...
                &&(!deleted)&&(
                    ...
                    <Tooltip title={ t('modelPanels.delete') }>
                      <IconButton
                        id='ReferenciaDetailPanel-button-delete'
                        color='inherit'
                        onClick={(event) => {
                          event.stopPropagation();
...
ReferenciaDetailPanel.propTypes = {
