...
const ReferenciasToRemoveTransferView = lazy(() => import(/* webpackChunkName: "Create-TransferLists-ToRemove-Referencias" */ './referencias-to-remove-transfer-view/ReferenciasToRemoveTransferView'));
    ...
    <div id='ReferenciasTransferLists-div-root' className={classes.root}>
      <Fade in={true} timeout={500}>
        ...
        > 
          ...
          <Grid item xs={12}>
            <Suspense fallback={<div />}>
              <ReferenciasToRemoveTransferView
                item={item}
