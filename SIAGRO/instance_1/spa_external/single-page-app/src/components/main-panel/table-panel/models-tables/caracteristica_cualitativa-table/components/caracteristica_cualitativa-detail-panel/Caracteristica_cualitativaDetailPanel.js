...
//lazy loading
const CaracteristicaCualitativaAttributesPage = lazy(() => import(/* webpackChunkName: "Detail-Attributes-CaracteristicaCualitativa" */ './components/caracteristica_cualitativa-attributes-page/Caracteristica_cualitativaAttributesPage'));
const CaracteristicaCualitativaAssociationsPage = lazy(() => import(/* webpackChunkName: "Detail-Associations-CaracteristicaCualitativa" */ './components/caracteristica_cualitativa-associations-page/Caracteristica_cualitativaAssociationsPage'));
const CaracteristicaCualitativaUpdatePanel = lazy(() => import(/* webpackChunkName: "Detail-Update-CaracteristicaCualitativa" */ '../caracteristica_cualitativa-update-panel/Caracteristica_cualitativaUpdatePanel'));
const CaracteristicaCualitativaDeleteConfirmationDialog = lazy(() => import(/* webpackChunkName: "Detail-Delete-CaracteristicaCualitativa" */ '../Caracteristica_cualitativaDeleteConfirmationDialog'));
...
export default function CaracteristicaCualitativaDetailPanel(props) {
      ...
      lastModelChanged['caracteristica_cualitativa'][String(item['id'])]) {
        ...
        if(lastModelChanged['caracteristica_cualitativa'][String(item['id'])].op === "update"&&
            lastModelChanged['caracteristica_cualitativa'][String(item['id'])].newItem) {
              //replace item
              setItemState(lastModelChanged['caracteristica_cualitativa'][String(item['id'])].newItem);
              //show alert
              setUpdated(true);
        } else {
          //deleted item
  ...
  const handleUpdateDialogClose = (event, status, item, newItem, changedAssociations) => {
    if(status) {
      dispatch(modelChange('caracteristica_cualitativa', 'update', item, newItem, changedAssociations))
    }
  ...
  const onSuccessDelete = (event, item) => {
    dispatch(modelChange('caracteristica_cualitativa', 'delete', item, null))
          ...
          <AppBar className={classes.appBar}>
            <Toolbar>
              <Tooltip title={ t('modelPanels.close') }>
                <IconButton
                  id='CaracteristicaCualitativaDetailPanel-button-close'
                  edge="start"
                  color="inherit"
                  onClick={(event) => {
                    if(!isCanceling.current){
              ...
              <Typography variant="h6" className={classes.title}>
                { t('modelPanels.detailOf') +  ": Caracteristica_cualitativa | id: " + itemState['id'] }
              </Typography>
              {/*
                Actions:
                - Edit
              ...
              */}
              {
                ...
                &&(!deleted)&&(
                    ...
                    <Tooltip title={ t('modelPanels.edit') }>
                      <IconButton
                        id='CaracteristicaCualitativaDetailPanel-button-edit'
                        color='inherit'
                        onClick={(event) => {
              ...
              }
              {
                ...
                &&(!deleted)&&(
                    ...
                    <Tooltip title={ t('modelPanels.delete') }>
                      <IconButton
                        id='CaracteristicaCualitativaDetailPanel-button-delete'
                        color='inherit'
                        onClick={(event) => {
                          event.stopPropagation();
...
CaracteristicaCualitativaDetailPanel.propTypes = {
