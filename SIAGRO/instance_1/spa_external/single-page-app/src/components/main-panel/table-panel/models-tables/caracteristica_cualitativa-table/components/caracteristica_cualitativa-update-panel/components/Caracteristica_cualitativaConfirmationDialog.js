...
export default function CaracteristicaCualitativaConfirmationDialog(props) {
  ...
  return (
    <div>
      <Dialog id='CaracteristicaCualitativaConfirmationDialog-update'
        open={open}
      ...
      >
        ...
        <DialogActions>
          ...
          {(acceptText !== '' && acceptText !== null && acceptText !== undefined) &&
            <Button
              id='CaracteristicaCualitativaConfirmationDialog-update-button-accept'
              color="primary"
              variant='contained'
          ...
          {(rejectText !== '' && acceptText !== null && acceptText !== undefined) &&
            ...
            <Button
              id='CaracteristicaCualitativaConfirmationDialog-update-button-reject'
              color="primary" 
...
CaracteristicaCualitativaConfirmationDialog.propTypes = {
