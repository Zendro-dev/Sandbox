...
export default function CaracteristicaCualitativaConfirmationDialog(props) {
  ...
  return (
    <div>
      <Dialog id='CaracteristicaCualitativaConfirmationDialog-create'
        open={open}
      ...
      >
        ...
        <DialogActions>
          ...
          {(acceptText !== '' && acceptText !== null && acceptText !== undefined) &&
            <Button
              id='CaracteristicaCualitativaConfirmationDialog-create-button-accept'
              color="primary"
              variant='contained'
          ...
          {(rejectText !== '' && acceptText !== null && acceptText !== undefined) &&
            ...
            <Button
              id='CaracteristicaCualitativaConfirmationDialog-create-button-reject'
              color="primary" 
