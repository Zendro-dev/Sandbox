...
export default function EjemplarEnhancedTableToolbar(props) {
                    ...
                    <Grid container justify="flex-end" alignItems='center' wrap='wrap'>
                      ...
                      <Grid item>
                        <Tooltip title={ t('modelPanels.reloadList', "Reload list") }>
                          <IconButton
                            id='EjemplarEnhancedTableToolbar-iconButton-reloadTable'
                            color='inherit'
                            onClick={(event) => {
                              onReloadClick();
                            }}
                      ...
                      <Grid item>
                        ...
                        {/* Search field */}
                        <TextField
                          id='EjemplarEnhancedTableToolbar-textField-search'
                            ...
                            startAdornment: (
                              <InputAdornment position="start">
                                <Tooltip title={ t('modelPanels.search') }>
                                  <IconButton
                                    id='EjemplarEnhancedTableToolbar-iconButton-search'
                                    color='inherit'
                                    onClick={() => {
                              ...
                              <InputAdornment position="end">
                                <Tooltip title={ t('modelPanels.clearSearch') }>
                                  <span>
                                    ...
                                    {(search) && (
                                      <IconButton
                                        id='EjemplarEnhancedTableToolbar-iconButton-clearSearch'
                                        onClick={() => {
                                          onSearchEnter('');
                                          setDisplayedSearch('');
                                        }}
                          ...
                          <Grid item xs={12}>
                            <Grid container justify="center">
                              {/* Add */}
                              {
                                ...
                                &&(permissions.ejemplar.includes('create') || permissions.ejemplar.includes('*')))
                                &&(
                                  <Grid item>
                                    <Tooltip title={t('modelPanels.addNew') + " ejemplar"}>
                                      <IconButton
                                        id='EjemplarEnhancedTableToolbar-button-add'
                                        color="primary"
                                ...
                                &&(
                                  <Grid item>
                                    <Tooltip title={ t('modelPanels.importCSV') }>
                                      <IconButton
                                        id='EjemplarEnhancedTableToolbar-button-import'
                                        color="primary"
                                  ...
                                  <div>
                                    ...
                                    <Grid item>
                                      <Tooltip title={ t('modelPanels.downloadsOptions', 'Download options') }>
                                        <IconButton
                                          id='EjemplarEnhancedTableToolbar-button-downloadOptions'
                                          color="primary"
                                    ...
                                    >
                                      ...
                                      <Grid item xs={12}>
                                        <Grid container justify='flex-start'>
                                          ...
                                          <input type="hidden" name="model" value='ejemplar' />
                                            <ButtonBase
                                              id='EjemplarEnhancedTableToolbar-button-exportData'
                                      ...
                                      <Grid item xs={12}>
                                        <Grid container justify='flex-start'>
                                          <ButtonBase
                                            id='EjemplarEnhancedTableToolbar-button-exportTemplate'
                                            className={classes.textButton}
                                            color="default"
                                            onClick={()=>{
                                              if(!isDownloading.current) {
                                      ...
                                      <Grid item xs={12}>
                                        <Grid container justify='flex-end'>
                                          <Button
                                            id='EjemplarEnhancedTableToolbar-button-closeDownloadOptions'
...
EjemplarEnhancedTableToolbar.propTypes = {
