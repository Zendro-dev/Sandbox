...
export default function CaracteristicaCuantitativaCreatePanel(props) {
  ...
  function getInitialValues() {
    ...
    initialValues.nombre = null;
    initialValues.valor = null;
    initialValues.unidad = null;
    initialValues.nombre_corto = null;
    initialValues.comentarios = null;
    initialValues.metodo_id = null;
    initialValues.registro_id = null;
  ...
  function getInitialValueOkStates() {
    ...
    */
    ...
    initialValueOkStates.nombre = 0;
    initialValueOkStates.valor = 0;
    initialValueOkStates.unidad = 0;
    initialValueOkStates.nombre_corto = 0;
    initialValueOkStates.comentarios = 0;
  ...
  async function doSave(event) {
    ...
    */
    ...
    /*
      API Request: api.caracteristica_cuantitativa.createItem
    */
    let api = await loadApi("caracteristica_cuantitativa");
    let cancelableApiReq = makeCancelable(api.caracteristica_cuantitativa.createItem(graphqlServerUrl, variables));
    ...
    await cancelableApiReq
      ...
      (response) => {
        ...
        if(response.message === 'ok') {
          ...
          if(response.graphqlErrors) {
            ...
            newError.locations=[{model: 'caracteristica_cuantitativa', method: 'doSave()', request: 'api.caracteristica_cuantitativa.createItem'}];
            newError.path=['Caracteristica_cuantitativas', 'add'];
      ...
      //error
      .catch((err) => { //error: on api.caracteristica_cuantitativa.createItem
        if(err.isCanceled) {
          return
        } else {
          //set ajv errors
    ...
    switch(associationKey) {
      ...
      case 'metodo':
        if(metodoIdsToAdd.current.indexOf(itemId) === -1) {
          ...
          setMetodoIdsToAddState(metodoIdsToAdd.current);
  ...
  return (
    ...
    <Dialog id='CaracteristicaCuantitativaCreatePanel-dialog'  
      ...
      <AppBar>
        <Toolbar>
          <Tooltip title={ t('modelPanels.cancel') }>
            <IconButton
              id='CaracteristicaCuantitativaCreatePanel-button-cancel'
              edge="start" 
              color="inherit"
              onClick={(event) => {
                if(!isCanceling.current){
          ...
          <Typography variant="h6" className={classes.title}>
            {t('modelPanels.new') + ' Caracteristica_cuantitativa'}
          </Typography>
          <Tooltip title={ t('modelPanels.save') + " caracteristica_cuantitativa" }>
            <Fab
              id='CaracteristicaCuantitativaCreatePanel-fabButton-save' 
              color="secondary" 
...
CaracteristicaCuantitativaCreatePanel.propTypes = {
