...
const EjemplaresToRemoveTransferView = lazy(() => import(/* webpackChunkName: "Create-TransferLists-ToRemove-Ejemplares" */ './ejemplares-to-remove-transfer-view/EjemplaresToRemoveTransferView'));
    ...
    <div id='EjemplaresTransferLists-div-root' className={classes.root}>
      <Fade in={true} timeout={500}>
        ...
        > 
          ...
          <Grid item xs={12}>
            <Suspense fallback={<div />}>
              <EjemplaresToRemoveTransferView
                item={item}
