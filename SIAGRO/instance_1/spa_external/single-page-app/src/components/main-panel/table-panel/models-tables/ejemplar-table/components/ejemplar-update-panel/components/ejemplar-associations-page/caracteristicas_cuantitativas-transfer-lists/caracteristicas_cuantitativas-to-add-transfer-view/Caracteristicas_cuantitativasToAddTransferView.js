...
export default function CaracteristicasCuantitativasToAddTransferView(props) {
  ...
  */
  ...
  const getCount = useCallback(async () => {
    ...
    /*
      API Request: api.ejemplar.getNotAssociatedCaracteristicas_cuantitativasCount
    */
    let api = await loadApi("ejemplar");
    let cancelableApiReq = makeCancelable(api.ejemplar.getNotAssociatedCaracteristicas_cuantitativasCount(graphqlServerUrl, item.id, search, ops));
    ...
    await cancelableApiReq
      ...
      (response) => {
        ...
        if(response.message === 'ok') {
          ...
          if(response.graphqlErrors) {
            ...
            newError.locations=[{model: 'Ejemplar', association: 'caracteristicas_cuantitativas', table:'A', method: 'getCount()', request: 'api.ejemplar.getNotAssociatedCaracteristicas_cuantitativasCount'}];
      ...
      //error
      .catch((err) => { //error: on api.ejemplar.getNotAssociatedCaracteristicas_cuantitativasCount
        if(err.isCanceled) {
          return;
        } else {
          //show error
  ...
  const getData = useCallback(async () => {
    ...
    /*
      API Request: api.ejemplar.getNotAssociatedCaracteristicas_cuantitativas
    */
    let api = await loadApi("ejemplar");
    let cancelableApiReq = makeCancelable(api.ejemplar.getNotAssociatedCaracteristicas_cuantitativas(
      graphqlServerUrl,
      item.id,
      search,
      variables,
    ...
    await cancelableApiReq
      ...
      (response) => {
        ...
        if(response.message === 'ok') {
          ...
          if(response.graphqlErrors) {
            ...
            newError.message = t('modelPanels.errors.data.e3', 'fetched with errors.');
            newError.locations=[{model: 'Ejemplar', association: 'caracteristicas_cuantitativas', table:'A', method: 'getData()', request: 'api.ejemplar.getNotAssociatedCaracteristicas_cuantitativas'}];
            newError.path=['update', `id:${item.id}`, 'add', 'caracteristicas_cuantitativas'];
            newError.extensions = {graphQL:{data:response.data, errors:response.graphqlErrors}};
      ...
      //error
      .catch((err) => { //error: on api.ejemplar.getNotAssociatedCaracteristicas_cuantitativas
        if(err.isCanceled) {
          return;
        } else {
          let newError = {};
      ...
      (response) => {
        ...
        if(response.message === 'ok') {
          ...
          if(response.graphqlErrors) {
            ...
            newError.message = t('modelPanels.errors.data.e3', 'fetched with errors.');
            newError.locations=[{model: 'Ejemplar', association: 'caracteristicas_cuantitativas', table:'B', method: 'getCountB()', request: 'api.caracteristica_cuantitativa.getCountItems'}];
            newError.path=['update', `id:${item.id}`, 'add', 'caracteristicas_cuantitativas'];          
            newError.extensions = {graphQL:{data:response.data, errors:response.graphqlErrors}};
      ...
      (response) => {
        ...
        if(response.message === 'ok') {
          ...
          if(response.graphqlErrors) {
            ...
            newError.message = t('modelPanels.errors.data.e3', 'fetched with errors.');
            newError.locations=[{model: 'Ejemplar', association: 'caracteristicas_cuantitativas', table:'B', method: 'getDataB()', request: 'api.caracteristica_cuantitativa.getItems'}];
            newError.path=['update', `id:${item.id}`, 'add', 'caracteristicas_cuantitativas'];
            newError.extensions = {graphQL:{data:response.data, errors:response.graphqlErrors}};
  ...
  useEffect(() => {
    ...
    if(lastModelChanged.Ejemplar&&
        ...
        lastModelChanged.Ejemplar[String(item.id)].changedAssociations.caracteristica_cuantitativa_registro_id&&
        (lastModelChanged.Ejemplar[String(item.id)].changedAssociations.caracteristica_cuantitativa_registro_id.added ||
         lastModelChanged.Ejemplar[String(item.id)].changedAssociations.caracteristica_cuantitativa_registro_id.removed)) {
          
          //remove any associated internalId from idsToAdd[] & update counts
          let idsAdded = lastModelChanged.Ejemplar[String(item.id)].changedAssociations.caracteristica_cuantitativa_registro_id.idsAdded;
          if(idsAdded) {
          ...
          let idsRemoved = lastModelChanged.Ejemplar[String(item.id)].changedAssociations.caracteristica_cuantitativa_registro_id.idsRemoved;
          if(idsRemoved) {
            //increment A
