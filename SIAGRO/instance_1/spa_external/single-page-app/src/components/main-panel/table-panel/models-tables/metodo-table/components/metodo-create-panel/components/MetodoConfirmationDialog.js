...
export default function MetodoConfirmationDialog(props) {
  ...
  return (
    <div>
      <Dialog id='MetodoConfirmationDialog-create'
        open={open}
      ...
      >
        ...
        <DialogActions>
          ...
          {(acceptText !== '' && acceptText !== null && acceptText !== undefined) &&
            <Button
              id='MetodoConfirmationDialog-create-button-accept'
              color="primary"
              variant='contained'
          ...
          {(rejectText !== '' && acceptText !== null && acceptText !== undefined) &&
            ...
            <Button
              id='MetodoConfirmationDialog-create-button-reject'
              color="primary" 
...
MetodoConfirmationDialog.propTypes = {
