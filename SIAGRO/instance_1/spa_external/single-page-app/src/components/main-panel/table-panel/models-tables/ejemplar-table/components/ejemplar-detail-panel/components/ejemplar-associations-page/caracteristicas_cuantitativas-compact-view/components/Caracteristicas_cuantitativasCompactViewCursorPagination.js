...
export default function CaracteristicasCuantitativasCompactViewCursorPagination(props) {
...
CaracteristicasCuantitativasCompactViewCursorPagination.propTypes = {
