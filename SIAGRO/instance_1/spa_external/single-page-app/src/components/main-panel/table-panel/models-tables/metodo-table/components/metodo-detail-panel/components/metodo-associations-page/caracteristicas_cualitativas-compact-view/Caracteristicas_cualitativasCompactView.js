...
import CaracteristicasCualitativasCompactViewToolbar from './components/Caracteristicas_cualitativasCompactViewToolbar';
import CaracteristicasCualitativasCompactViewCursorPagination from './components/Caracteristicas_cualitativasCompactViewCursorPagination';
...
export default function CaracteristicasCualitativasCompactView(props) {
      ...
      (response) => {
        ...
        if(response.message === 'ok') {
          ...
          if(response.graphqlErrors) {
            ...
            newError.path=['detail', `id:${item.id}`, 'caracteristicas_cualitativas'];
  ...
  useEffect(() => {
     ...
     * 
     * Conditions:
     * A: the current item 'internalId' attribute is in the removedIds of the updated 'caracteristica_cualitativa'.
     * B: the current item 'internalId' attribute is in the addedIds of the updated 'caracteristica_cualitativa'.
     * 
     * Actions:
     * if A:
     * - reload table.
        ...
        <Grid item xs={12} >
          {(item!==undefined) && (
            <Card className={classes.card}>
              ...
              {/* Toolbar */}
              <CaracteristicasCualitativasCompactViewToolbar 
              ...
              {(!isOnApiRequest && (!areItemsReady)) && (
                ...
                <Fade
                  ...
                  unmountOnExit
                >
                  <div id='CaracteristicasCualitativasCompactView-div-noDataA'>
                    <Grid container>
                      <Grid item xs={12}>
              ...
              {(!isOnApiRequest && areItemsReady) && (
                ...
                >
                  <Box className={classes.listBox} ref={lref}>
                    <List id='CaracteristicasCualitativasCompactView-list-listA'
                    dense component="div" role="list" >
                      {items.map(it => {
                        ...
                        return (
                          <ListItem 
                            id={'CaracteristicasCualitativasCompactView-listA-listItem-'+it.id}
                            key={key} 
                            role="listitem" 
                            button 
                                ...
                                <React.Fragment>
                                  ...
                                  <Grid container alignItems='center' alignContent='center' wrap='nowrap' spacing={1}>
                                    <Grid item>
                                      <Tooltip title={ 'id' }>
                                        <Typography
                                        id={'CaracteristicasCualitativasCompactView-listA-listItem-id-'+it.id}
                                ...
                                <React.Fragment>
                                  ...
                                  {(label) && (
                                    <Tooltip title={ 'nombre_corto' }>
                                      <Typography
                                      id={'CaracteristicasCualitativasCompactView-listA-listItem-label-'+it.id}
                                  ...
                                  {(sublabel) && (
                                    <Tooltip title={ 'valor' }>
                                      <Typography
                                      id={'CaracteristicasCualitativasCompactView-listA-listItem-sublabel-'+it.id}
              ...
              {/* Pagination */}
              <CaracteristicasCualitativasCompactViewCursorPagination
                count={count}
...
CaracteristicasCualitativasCompactView.propTypes = {
  item: PropTypes.object.isRequired,
  handleClickOnCaracteristicas_cualitativasRow: PropTypes.func,
};