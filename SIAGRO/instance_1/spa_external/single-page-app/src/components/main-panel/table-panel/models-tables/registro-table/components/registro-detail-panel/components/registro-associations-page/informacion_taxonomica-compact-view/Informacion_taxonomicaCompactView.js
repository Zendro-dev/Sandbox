...
export default function InformacionTaxonomicaCompactView(props) {
  ...
  const getData = useCallback(async () => {
    ...
    */
    ...
    let cancelableApiReq = makeCancelable(api.registro.getInformacion_taxonomica(
      graphqlServerUrl, 
      item.conabio_id,
      search,
      variables,
      ...
      (response) => {
        ...
        if(response.message === 'ok') {
          ...
          if(response.graphqlErrors) {
            ...
            newError.locations=[{association: 'informacion_taxonomica', method: 'getData()', request: 'api.registro.getInformacion_taxonomica'}];
            newError.path=['detail', `conabio_id:${item.conabio_id}`, 'informacion_taxonomica'];
  ...
  }, [graphqlServerUrl, showMessage, clearRequestGetData, t, dataTrigger, item.conabio_id, search]);
  ...
  }, [lastModelChanged, lastChangeTimestamp, items, item.conabio_id]);
