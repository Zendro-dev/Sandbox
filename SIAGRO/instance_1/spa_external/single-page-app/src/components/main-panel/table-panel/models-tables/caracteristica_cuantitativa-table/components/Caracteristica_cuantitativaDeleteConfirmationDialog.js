...
//lazy loading
const CaracteristicaCuantitativaDetailPanel = lazy(() => import(/* webpackChunkName: "Delete-DetailCaracteristicaCuantitativa" */ './caracteristica_cuantitativa-detail-panel/Caracteristica_cuantitativaDetailPanel'));
...
export default function CaracteristicaCuantitativaDeleteConfirmationDialog(props) {
  ...
  return (
    ...
    >
      ...
      {(!deleted) && (
        <DialogActions>
          <Button 
          id='CaracteristicaCuantitativaDeleteConfirmationDialog-button-reject'
          ...
          <Button 
          id='CaracteristicaCuantitativaDeleteConfirmationDialog-button-accept'
...
CaracteristicaCuantitativaDeleteConfirmationDialog.propTypes = {
