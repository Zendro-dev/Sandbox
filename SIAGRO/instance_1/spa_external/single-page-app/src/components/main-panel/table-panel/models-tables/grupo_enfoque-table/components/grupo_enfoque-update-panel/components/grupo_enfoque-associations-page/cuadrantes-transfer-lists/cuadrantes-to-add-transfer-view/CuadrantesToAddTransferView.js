  ...
  */
  ...
  useEffect(() => {
    ...
    if(lastModelChanged.grupo_enfoque&&
        ...
        lastModelChanged.grupo_enfoque[String(item.grupo_id)].changedAssociations.cuadrantes&&
        (lastModelChanged.grupo_enfoque[String(item.grupo_id)].changedAssociations.cuadrantes.added ||
         lastModelChanged.grupo_enfoque[String(item.grupo_id)].changedAssociations.cuadrantes.removed)) {
          
          //remove any dis-associated internalId from idsToAdd[]
          let idsRemoved = lastModelChanged.grupo_enfoque[String(item.grupo_id)].changedAssociations.cuadrantes.idsRemoved;
          if(idsRemoved) {
