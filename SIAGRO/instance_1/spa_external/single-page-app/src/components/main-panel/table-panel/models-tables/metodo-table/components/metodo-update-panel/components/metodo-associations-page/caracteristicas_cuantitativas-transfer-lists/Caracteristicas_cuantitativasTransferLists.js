...
const CaracteristicasCuantitativasToRemoveTransferView = lazy(() => import(/* webpackChunkName: "Create-TransferLists-ToRemove-CaracteristicasCuantitativas" */ './caracteristicas_cuantitativas-to-remove-transfer-view/Caracteristicas_cuantitativasToRemoveTransferView'));
    ...
    <div id='CaracteristicasCuantitativasTransferLists-div-root' className={classes.root}>
      <Fade in={true} timeout={500}>
        ...
        > 
          ...
          <Grid item xs={12}>
            <Suspense fallback={<div />}>
              <CaracteristicasCuantitativasToRemoveTransferView
                item={item}
