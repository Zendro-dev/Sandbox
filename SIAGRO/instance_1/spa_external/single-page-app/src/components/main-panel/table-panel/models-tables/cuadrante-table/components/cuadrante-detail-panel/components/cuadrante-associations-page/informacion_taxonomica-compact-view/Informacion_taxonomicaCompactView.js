...
import InformacionTaxonomicaCompactViewToolbar from './components/Informacion_taxonomicaCompactViewToolbar';
import InformacionTaxonomicaCompactViewCursorPagination from './components/Informacion_taxonomicaCompactViewCursorPagination';
...
export default function InformacionTaxonomicaCompactView(props) {
  ...
  const getData = useCallback(() => {
    ...
    */
    ...
    let cancelableApiReq = makeCancelable(api.cuadrante.getInformacion_taxonomicaConnection(
      graphqlServerUrl, 
      item.cuadrante_id,
      label,
      sublabel,
    ...
    cancelableApiReq
      ...
      (response) => {
        ...
        if(!response.data ||!response.data.data) {
          ...
          newError.locations=[{association: 'informacion_taxonomica', query: 'readOneCuadrante', method: 'getData()', request: 'api.cuadrante.getInformacion_taxonomicaConnection'}];
          newError.path=['detail', `cuadrante_id:${item.cuadrante_id}`, 'informacion_taxonomica'];
        ...
        //get item
        let it = readOneCuadrante.informacion_taxonomica;
      ...
      //error
      .catch((err) => { //error: on api.cuadrante.getInformacion_taxonomicaConnection
        if(err.isCanceled) {
          return;
        } else {
          let newError = {};
        ...
        <Grid item xs={12} >
          {(item!==undefined) && (
            <Card className={classes.card}>
              ...
              {/* Toolbar */}
              <InformacionTaxonomicaCompactViewToolbar 
                title={'Taxon'}
                search={search}
              ...
              {(!isOnApiRequest && (!areItemsReady || !isCountReady)) && (
                ...
                <Fade
                  ...
                  unmountOnExit
                >
                  <div id='InformacionTaxonomicaCompactView-div-noDataA'>
                    <Grid container>
                      <Grid item xs={12}>
              ...
              {(!isOnApiRequest && areItemsReady && isCountReady) && (
                ...
                >
                  <Box className={classes.listBox} ref={lref}>
                    <List id='InformacionTaxonomicaCompactView-list-listA'
                    dense component="div" role="list" >
                      {items.map(it => {
                        ...
                        return (
                          <ListItem 
                            id={'InformacionTaxonomicaCompactView-listA-listItem-'+it.id}
                            key={key} 
                            role="listitem" 
                            button 
                                ...
                                <React.Fragment>
                                  ...
                                  <Grid container alignItems='center' alignContent='center' wrap='nowrap' spacing={1}>
                                    <Grid item>
                                      <Tooltip title={ 'id' }>
                                        <Typography
                                        id={'InformacionTaxonomicaCompactView-listA-listItem-id-'+it.id}
                              ...
                              secondary={
                                <React.Fragment>
                                  ...
                                  {(label) && (
                                    <Tooltip title={ 'taxon' }>
                                      <Typography
                                      id={'InformacionTaxonomicaCompactView-listA-listItem-label-'+it.id}
                                  ...
                                  {(sublabel) && (
                                    <Tooltip title={ '' }>
                                      <Typography
                                      id={'InformacionTaxonomicaCompactView-listA-listItem-sublabel-'+it.id}
              ...
              {(false) && (
                ...
                <InformacionTaxonomicaCompactViewCursorPagination
                  count={count}
...
InformacionTaxonomicaCompactView.propTypes = {
  item: PropTypes.object.isRequired,
  handleClickOnInformacion_taxonomicaRow: PropTypes.func,
};