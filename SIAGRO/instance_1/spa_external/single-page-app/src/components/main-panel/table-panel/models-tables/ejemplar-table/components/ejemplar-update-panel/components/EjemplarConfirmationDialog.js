...
export default function EjemplarConfirmationDialog(props) {
  ...
  return (
    <div>
      <Dialog id='EjemplarConfirmationDialog-update'
        open={open}
      ...
      >
        ...
        <DialogActions>
          ...
          {(acceptText !== '' && acceptText !== null && acceptText !== undefined) &&
            <Button
              id='EjemplarConfirmationDialog-update-button-accept'
              color="primary"
              variant='contained'
          ...
          {(rejectText !== '' && acceptText !== null && acceptText !== undefined) &&
            ...
            <Button
              id='EjemplarConfirmationDialog-update-button-reject'
              color="primary" 
...
EjemplarConfirmationDialog.propTypes = {
