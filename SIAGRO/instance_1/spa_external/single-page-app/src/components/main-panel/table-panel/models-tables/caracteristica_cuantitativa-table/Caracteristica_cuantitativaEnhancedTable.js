...
import CaracteristicaCuantitativaEnhancedTableHead from './components/Caracteristica_cuantitativaEnhancedTableHead'
import CaracteristicaCuantitativaEnhancedTableToolbar from './components/Caracteristica_cuantitativaEnhancedTableToolbar'
import CaracteristicaCuantitativaUploadFileDialog from './components/Caracteristica_cuantitativaUploadFileDialog'
import CaracteristicaCuantitativaCursorPagination from './components/Caracteristica_cuantitativaCursorPagination'
...
//lazy loading
const CaracteristicaCuantitativaCreatePanel = lazy(() => import(/* webpackChunkName: "Create-CaracteristicaCuantitativa" */ './components/caracteristica_cuantitativa-create-panel/Caracteristica_cuantitativaCreatePanel'));
const CaracteristicaCuantitativaUpdatePanel = lazy(() => import(/* webpackChunkName: "Update-CaracteristicaCuantitativa" */ './components/caracteristica_cuantitativa-update-panel/Caracteristica_cuantitativaUpdatePanel'));
const CaracteristicaCuantitativaDetailPanel = lazy(() => import(/* webpackChunkName: "Detail-CaracteristicaCuantitativa" */ './components/caracteristica_cuantitativa-detail-panel/Caracteristica_cuantitativaDetailPanel'));
const CaracteristicaCuantitativaDeleteConfirmationDialog = lazy(() => import(/* webpackChunkName: "Delete-CaracteristicaCuantitativa" */ './components/Caracteristica_cuantitativaDeleteConfirmationDialog'));
//Plotly
const CaracteristicaCuantitativaPlotly = lazy(() => import(/* webpackChunkName: "Plotly-CaracteristicaCuantitativa" */ '../../../../plots/Caracteristica_cuantitativaPlotly'));
...
export default function CaracteristicaCuantitativaEnhancedTable(props) {
  ...
  const getCount = useCallback(async () => {
    ...
    */
    ...
    let cancelableApiReq = makeCancelable(api.caracteristica_cuantitativa.getCountItems(graphqlServerUrl, search));
      ...
      (response) => {
        ...
        if(response.message === 'ok') {
          ...
          if(response.graphqlErrors) {
            ...
            newError.locations=[{model: 'caracteristica_cuantitativa', method: 'getCount()', request: 'api.caracteristica_cuantitativa.getCountItems'}];
            newError.path=['Caracteristica_cuantitativas'];
      ...
      (response) => {
        ...
        if(response.message === 'ok') {
          ...
          if(response.graphqlErrors) {
            ...
            newError.message = t('modelPanels.errors.data.e3', 'fetched with errors.');
            newError.locations=[{model: 'caracteristica_cuantitativa', method: 'getData()', request: 'api.caracteristica_cuantitativa.getItems'}];
            newError.path=['Caracteristica_cuantitativas'];
            newError.extensions = {graphQL:{data:response.data, errors:response.graphqlErrors}};
  ...
  useEffect(() => {
     ...
     */
    if(isNewChange&&!changes.changesCompleted&&changes.lastModelChanged&&changes.lastModelChanged['caracteristica_cuantitativa']
    &&(Object.keys(changes.lastModelChanged['caracteristica_cuantitativa']).length===1)
    &&(changes.lastModelChanged['caracteristica_cuantitativa'][Object.keys(changes.lastModelChanged['caracteristica_cuantitativa'])[0]].op === "delete")
    ) {
      //decrement count
      setCount(count-1);
      //count
  ...
  async function getCsvTemplate() {
    ...
    /*
      API Request: api.caracteristica_cuantitativa.tableTemplate
    */
    let api = await loadApi("caracteristica_cuantitativa");
    let cancelableApiReq = makeCancelable(api.caracteristica_cuantitativa.tableTemplate(graphqlServerUrl));
    cancelablePromises.current.push(cancelableApiReq);
    await cancelableApiReq
      .promise
      .then(
      ...
      (response) => {
        ...
        if(response.message === 'ok') {
          ...
          if(response.graphqlErrors) {
            ...
            variant.current='info';
            newError.message = t('modelPanels.errors.data.e3', 'fetched with errors.');
            newError.locations=[{model: 'caracteristica_cuantitativa', method: 'getCsvTemplate()', request: 'api.caracteristica_cuantitativa.tableTemplate'}];
            newError.path=['Caracteristica_cuantitativas', 'csvTemplate'];
            newError.extensions = {graphQL:{data:response.data, errors:response.graphqlErrors}};
            errors.current.push(newError);
            console.log("Error: ", newError);
        ...
        //download
        let file = response.data.data.csvTableTemplateCaracteristica_cuantitativa.join("\n");
        const url = window.URL.createObjectURL(new Blob([file]));
        const link = document.createElement("a");
        link.href = url;
        link.setAttribute("download", "caracteristica_cuantitativa-template.csv");
      ...
      //error
      .catch((err) => { //error: on api.caracteristica_cuantitativa.tableTemplate
        if(err.isCanceled) {
          return
        } else {
          let newError = {};
  ...
  return (
    <div className={classes.root}>
          ...
          <Grid container justify='center'>
            <Grid item xs={12}>
              <Paper className={classes.paper}>
                ...
                {/* Toolbar */}
                <CaracteristicaCuantitativaEnhancedTableToolbar
                ...
                >
                  ...
                  */}
                  <div>
                    ...
                    <div className={classes.tableWrapper} ref={twref}>
                      ...
                      >
                        <Box
                          id='CaracteristicaCuantitativaEnhancedTable-box-noData'
                          className={classes.tableBackdrop}
                          bgcolor='rgba(255, 255, 255, 0.0)'
                      ...
                      {/* Table */}
                      <Table id='CaracteristicaCuantitativaEnhancedTable-table' stickyHeader size='small' ref={tref}>

                        {/* Table Head */}
                        <CaracteristicaCuantitativaEnhancedTableHead
                          permissions={permissions}
                          order={order}
                          orderBy={orderBy}
                        ...
                        <Fade
                          in={(!isOnApiRequest && items.length > 0)}
                        >
                          <TableBody id='CaracteristicaCuantitativaEnhancedTable-tableBody'>
                            {
                              items.map((item, index) => {
                                return ([
                                  ...
                                  */
                                  <TableRow
                                    id={'CaracteristicaCuantitativaEnhancedTable-row-'+item.id}
                                    hover
                                  ...
                                  >
                                    ...
                                    <TableCell padding="checkbox">
                                      <Tooltip title={ t('modelPanels.viewDetails') }>
                                        <IconButton
                                          id={'CaracteristicaCuantitativaEnhancedTable-row-iconButton-detail-'+item.id}
                                          color="default"
                                          onClick={event => {
                                    ...
                                    */}
                                      ...
                                      &&(
                                        <TableCell padding='checkbox' align='center'>
                                          <Tooltip title={ t('modelPanels.edit') }>
                                            <IconButton
                                              id={'CaracteristicaCuantitativaEnhancedTable-row-iconButton-edit-'+item.id}
                                              color="default"
                                              onClick={(event) => {
                                                event.stopPropagation();
                                      ...
                                      &&(
                                        <TableCell padding='checkbox' align='center'>
                                          <Tooltip title={ t('modelPanels.delete') }>
                                            <IconButton
                                              id={'CaracteristicaCuantitativaEnhancedTable-row-iconButton-delete-'+item.id}
                                              color="default"
                                              onClick={(event) => {
                                                event.stopPropagation();
                                    ...
                                    <TableCell
                                      ...
                                      padding="default"
                                    >
                                      {String((item.unidad!==null)?item.unidad:'')}
                                    </TableCell>
                    ...
                    {/*
                      Pagination
                    */}
                    <CaracteristicaCuantitativaCursorPagination
                      count={count}
                  ...
                  */}
                  <div>
                    {(Boolean(CaracteristicaCuantitativaPlotly)) && (
                      <Suspense fallback={<div />}>
                        <CaracteristicaCuantitativaPlotly />
                      </Suspense>
                    )}
                  </div>
      ...
      {(createDialogOpen) && (
        <Suspense fallback={<div />}>
          <CaracteristicaCuantitativaCreatePanel
            permissions={permissions}
      ...
      {(uploadFileDialogOpen) && (
        <CaracteristicaCuantitativaUploadFileDialog
...
CaracteristicaCuantitativaEnhancedTable.propTypes = {
