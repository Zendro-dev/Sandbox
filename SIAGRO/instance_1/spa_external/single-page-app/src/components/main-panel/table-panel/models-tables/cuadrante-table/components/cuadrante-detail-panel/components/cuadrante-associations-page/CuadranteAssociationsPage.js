...
import TipoPlantaCompactView from './tipo_planta-compact-view/Tipo_plantaCompactView'
...
export default function CuadranteAssociationsPage(props) {
  ...
  return (
    <Fade in={!deleted} timeout={500}>
      <Grid
        id='CuadranteAssociationsPage-div-root'
      ...
      > 
        ...
        {/* Tipo_planta Compact View */}
        {(associationSelected === 'tipo_planta') && (
          <Grid item xs={12} sm={10} md={9} lg={8} xl={7}>
            <TipoPlantaCompactView
              item={item}
