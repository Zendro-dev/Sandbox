...
export default function CuadranteConfirmationDialog(props) {
  ...
  return (
    <div>
      <Dialog id='CuadranteConfirmationDialog-update'
        open={open}
      ...
      >
        ...
        <DialogActions>
          ...
          {(acceptText !== '' && acceptText !== null && acceptText !== undefined) &&
            <Button
              id='CuadranteConfirmationDialog-update-button-accept'
              color="primary"
              variant='contained'
          ...
          {(rejectText !== '' && acceptText !== null && acceptText !== undefined) &&
            ...
            <Button
              id='CuadranteConfirmationDialog-update-button-reject'
              color="primary" 
...
CuadranteConfirmationDialog.propTypes = {
