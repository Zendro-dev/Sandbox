...
//lazy loading
const TaxonDetailPanel = lazy(() => import(/* webpackChunkName: "Delete-DetailTaxon" */ './taxon-detail-panel/TaxonDetailPanel'));
...
export default function TaxonDeleteConfirmationDialog(props) {
  ...
  return (
    ...
    >
      ...
      {(!deleted) && (
        <DialogActions>
          <Button 
          id='TaxonDeleteConfirmationDialog-button-reject'
          ...
          <Button 
          id='TaxonDeleteConfirmationDialog-button-accept'
...
TaxonDeleteConfirmationDialog.propTypes = {
