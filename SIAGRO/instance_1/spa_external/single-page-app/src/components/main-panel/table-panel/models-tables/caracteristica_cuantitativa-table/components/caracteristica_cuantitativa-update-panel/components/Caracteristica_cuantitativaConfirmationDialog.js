...
export default function CaracteristicaCuantitativaConfirmationDialog(props) {
  ...
  return (
    <div>
      <Dialog id='CaracteristicaCuantitativaConfirmationDialog-update'
        open={open}
      ...
      >
        ...
        <DialogActions>
          ...
          {(acceptText !== '' && acceptText !== null && acceptText !== undefined) &&
            <Button
              id='CaracteristicaCuantitativaConfirmationDialog-update-button-accept'
              color="primary"
              variant='contained'
          ...
          {(rejectText !== '' && acceptText !== null && acceptText !== undefined) &&
            ...
            <Button
              id='CaracteristicaCuantitativaConfirmationDialog-update-button-reject'
              color="primary" 
...
CaracteristicaCuantitativaConfirmationDialog.propTypes = {
