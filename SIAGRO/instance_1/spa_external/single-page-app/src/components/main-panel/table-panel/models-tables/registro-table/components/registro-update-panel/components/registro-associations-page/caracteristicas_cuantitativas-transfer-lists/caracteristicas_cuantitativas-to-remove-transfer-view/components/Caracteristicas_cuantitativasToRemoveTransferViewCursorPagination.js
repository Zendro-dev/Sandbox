...
export default function CaracteristicasCuantitativasToRemoveTransferViewCursorPagination(props) {
  ...
  return (
    ...
    <Toolbar className={classes.root}>
      <Grid container>
        <Grid item xs={12}>
          <Grid container justify='space-between' alignItems='center' wrap='nowrap' spacing={1}>
...
CaracteristicasCuantitativasToRemoveTransferViewCursorPagination.propTypes = {
