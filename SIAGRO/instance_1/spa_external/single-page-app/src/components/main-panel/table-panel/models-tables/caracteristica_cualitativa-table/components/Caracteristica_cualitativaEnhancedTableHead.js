...
export default function CaracteristicaCualitativaEnhancedTableHead(props) {
    ...
    <TableHead>
      <TableRow>
        ...
        {/* Actions */}
        {
          ...
          &&(permissions.caracteristica_cualitativa.includes('update') || permissions.caracteristica_cualitativa.includes('delete') || permissions.caracteristica_cualitativa.includes('*')))
          &&(
            <TableCell 
              padding="checkbox" 
              align='center' 
              ...
              colSpan={
                0 +
                ((permissions.caracteristica_cualitativa.includes('update') || permissions.caracteristica_cualitativa.includes('*')) ? 1 : 0) 
                +
                ((permissions.caracteristica_cualitativa.includes('delete') || permissions.caracteristica_cualitativa.includes('*')) ? 1 : 0)
              }
            >
...
CaracteristicaCualitativaEnhancedTableHead.propTypes = {
