...
export default function TipoPlantaUploadFileDialog(props) {
  ...
  const handleSubmit = (event) => {
    if(file.current !== undefined && file.current !== null) {
      ...
      let query = 'mutation{ bulkAddTipo_plantaCsv }'
  ...
  return (
    ...
    >
      <DialogTitle>
      { t('modelPanels.uploading') + ' Tipo_planta' }
        <div>
...
TipoPlantaUploadFileDialog.propTypes = {
