      ...
      lastModelChanged['grupo_enfoque'][String(item['grupo_id'])]) {
        ...
        if(lastModelChanged['grupo_enfoque'][String(item['grupo_id'])].op === "update"&&
            lastModelChanged['grupo_enfoque'][String(item['grupo_id'])].newItem) {
              //replace item
              setItemState(lastModelChanged['grupo_enfoque'][String(item['grupo_id'])].newItem);
              //show alert
              setUpdated(true);
        } else {
          //deleted item
          ...
          <AppBar className={classes.appBar}>
            <Toolbar>
              <Tooltip title={ t('modelPanels.close') }>
                <IconButton
                  id='GrupoEnfoqueDetailPanel-button-close'
                  edge="start"
                  color="inherit"
                  onClick={(event) => {
                    if(!isCanceling.current){
              ...
              */}
              {
                ...
                &&(!deleted)&&(
                    ...
                    <Tooltip title={ t('modelPanels.edit') }>
                      <IconButton
                        id='GrupoEnfoqueDetailPanel-button-edit'
                        color='inherit'
                        onClick={(event) => {
              ...
              }
              {
                ...
                &&(!deleted)&&(
                    ...
                    <Tooltip title={ t('modelPanels.delete') }>
                      <IconButton
                        id='GrupoEnfoqueDetailPanel-button-delete'
                        color='inherit'
                        onClick={(event) => {
                          event.stopPropagation();
