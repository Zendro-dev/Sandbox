...
export default function CaracteristicaCualitativaPlotly(props) {
  ...
  */
  async function getBarchartData(attribute) {
    ...
    /*
      API Request: api.caracteristica_cualitativa.getBarchartData
    */
    let api = await loadApi("caracteristica_cualitativa");
    await api.caracteristica_cualitativa.getBarchartData(graphqlServerUrl, attribute)
      .then(
      //resolved
      (response) => {
        //check: response
        if(response.message === 'ok') {
          ...
          if(response.graphqlErrors) {
            ...
            newError.locations=[{model: 'caracteristica_cualitativa', method: 'getBarchartData()', request: 'api.caracteristica_cualitativa.getBarchartData'}];
            newError.path=['Caracteristica_cualitativas', 'Plot'];
      ...
      //error
      .catch((err) => { //error: on api.caracteristica_cualitativa.getBarchartData
        if(err.isCanceled) {
          return
        } else {
          let newError = {};
