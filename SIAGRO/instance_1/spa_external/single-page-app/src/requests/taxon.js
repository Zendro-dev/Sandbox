...
export default {
   ...
   * 
   * Get cuadrantes connection (cursor based) records associated to the given taxon record
   ...
   * 
   * Get the cuadrante-ids associated (by cursor based connection) to the given taxon record 
   * through association 'Cuadrantes', from GraphQL Server.
   * 
   * @param {String} url GraphQL Server url
   * @param {Number} itemId Model item internalId.
