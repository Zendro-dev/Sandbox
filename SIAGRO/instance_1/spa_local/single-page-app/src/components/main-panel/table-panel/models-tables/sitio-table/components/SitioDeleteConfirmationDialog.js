...
import SitioDetailPanel from './sitio-detail-panel/SitioDetailPanel'
...
export default function SitioDeleteConfirmationDialog(props) {
  ...
  return (
    ...
    >
      ...
      {(!deleted) && (
        <DialogActions>
          <Button 
          id='SitioDeleteConfirmationDialog-button-reject'
          ...
          <Button 
          id='SitioDeleteConfirmationDialog-button-accept'
...
SitioDeleteConfirmationDialog.propTypes = {
