...
export default function TaxonConfirmationDialog(props) {
  ...
  return (
    <div>
      <Dialog id='TaxonConfirmationDialog-create'
        open={open}
      ...
      >
        ...
        <DialogActions>
          ...
          {(acceptText !== '' && acceptText !== null && acceptText !== undefined) &&
            <Button
              id='TaxonConfirmationDialog-create-button-accept'
              color="primary"
              variant='contained'
          ...
          {(rejectText !== '' && acceptText !== null && acceptText !== undefined) &&
            ...
            <Button
              id='TaxonConfirmationDialog-create-button-reject'
              color="primary" 
...
TaxonConfirmationDialog.propTypes = {
