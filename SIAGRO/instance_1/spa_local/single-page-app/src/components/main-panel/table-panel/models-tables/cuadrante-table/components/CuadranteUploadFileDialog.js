...
export default function CuadranteUploadFileDialog(props) {
  ...
  const handleSubmit = (event) => {
    if(file.current !== undefined && file.current !== null) {
      ...
      let query = 'mutation{ bulkAddCuadranteCsv{ cuadrante_id} }'
  ...
  return (
    ...
    >
      <DialogTitle>
      { t('modelPanels.uploading') + ' Cuadrantes' }
        <div>
...
CuadranteUploadFileDialog.propTypes = {
