...
export default function CuadrantesToAddTransferView(props) {
  ...
  */
  ...
  const getData = useCallback(() => {
    ...
    */
    let cancelableApiReq = makeCancelable(api.grupo_enfoque.getAssociatedCuadrantesConnection(graphqlServerUrl, item.grupo_id));  
    ...
    cancelableApiReq
      ...
      (response) => {
        ...
        if(!response.data ||!response.data.data) {
          ...
          newError.locations=[{model: 'grupo_enfoque', association: 'cuadrantes', table:'A', query: 'readOneGrupo_enfoque', method: 'getData()', request: 'api.grupo_enfoque.getAssociatedCuadrantesConnection'}];
        ...
        || typeof readOneGrupo_enfoque.cuadrantesConnection !== 'object'
        || readOneGrupo_enfoque.cuadrantesConnection === null
        || !Array.isArray(readOneGrupo_enfoque.cuadrantesConnection.edges)) {
          let newError = {};
          let withDetails=true;
          variant.current='error';
        ...
        //get items
        let idso = readOneGrupo_enfoque.cuadrantesConnection.edges.map(o => o.node);

        //check: graphql errors
        if(response.data.errors) {
          let newError = {};
          newError.message = 'readOneGrupo_enfoque ' + t('modelPanels.errors.data.e3', 'fetched with errors.');
          newError.locations=[{model: 'grupo_enfoque', association: 'cuadrantes', table:'A', query: 'readOneGrupo_enfoque', method: 'getData()', request: 'api.grupo_enfoque.getAssociatedCuadrantesConnection'}];
          newError.path=['add', 'cuadrantes'];
        ...
        cancelableApiReqB
          ...
          (response)=> {
            ...
            if(!response.data ||!response.data.data) {
              ...
              variant.current='error';
              newError.message = t('modelPanels.errors.data.e1', 'No data was received from the server.');
              newError.locations=[{model: 'grupo_enfoque', association: 'cuadrantes', table:'A', query: 'countCuadrantes', method: 'getData()', request: 'api.cuadrante.getCountItems'}];
              newError.path=['add', 'cuadrantes'];
              newError.extensions = {graphqlResponse:{data:response.data.data, errors:response.data.errors}};
              errors.current.push(newError);
              console.log("Error: ", newError);
            ...
            cancelableApiReqC
              ...
              (response) => {
                ...
                if(!response.data ||!response.data.data) {
                  ...
                  variant.current='error';
                  newError.message = t('modelPanels.errors.data.e1', 'No data was received from the server.');
                  newError.locations=[{model: 'grupo_enfoque', association: 'cuadrantes', table:'A', query: 'cuadrantesConnection', method: 'getData()', request: 'api.cuadrante.getItemsConnection'}];
                  newError.path=['add', 'cuadrantes'];
                  newError.extensions = {graphqlResponse:{data:response.data.data, errors:response.data.errors}};
                  errors.current.push(newError);
                  console.log("Error: ", newError);
                ...
                if(cuadrantesConnection === null) {
                  ...
                  */
                  ...
                  if(errors.current.length > 0) {
                    ...
                    newError.locations=[{model: 'grupo_enfoque', association: 'cuadrantes', table:'A', method: 'getData()'}];
                    newError.path=['add', 'cuadrantes'];
                    newError.extensions = {graphQL:{data:response.data.data, errors:response.data.errors}};
                    errors.current.push(newError);
                    console.log("Error: ", newError);
      ...
      //error
      .catch((err) => { //error: on api.grupo_enfoque.getAssociatedCuadrantesConnection
        if(err.isCanceled) {
          return
        } else {
          let newError = {};
    ...
    cancelableApiReq
      ...
      (response) => {
        ...
        if(!response.data ||!response.data.data) {
          ...
          newError.message = t('modelPanels.errors.data.e1', 'No data was received from the server.');
          newError.locations=[{model: 'grupo_enfoque', association: 'cuadrantes', table:'B', query: 'countCuadrantes', method: 'getDataB()', request: 'api.cuadrante.getCountItems'}];
          newError.path=['add', 'cuadrantes'];
          newError.extensions = {graphqlResponse:{data:response.data.data, errors:response.data.errors}};
          ...
          cancelableApiReqB
            ...
            (response) => {
              ...
              if(!response.data ||!response.data.data) {
                ...
                variantB.current='error';
                newError.message = t('modelPanels.errors.data.e1', 'No data was received from the server.');
                newError.locations=[{model: 'grupo_enfoque', association: 'cuadrantes', table:'B', query: 'cuadrantesConnection', method: 'getDataB()', request: 'api.cuadrante.getItemsConnection'}];
                newError.path=['add', 'cuadrantes'];
                newError.extensions = {graphqlResponse:{data:response.data.data, errors:response.data.errors}};
                errorsB.current.push(newError);
                console.log("Error: ", newError);
              ...
              */
              ...
              if(errorsB.current.length > 0) {
                ...
                newError.locations=[{model: 'grupo_enfoque', association: 'cuadrantes', table:'B', method: 'getDataB()'}];
                newError.path=['add', 'cuadrantes'];
                newError.extensions = {graphQL:{data:response.data.data, errors:response.data.errors}};
                errorsB.current.push(newError);
                console.log("Error: ", newError);
  ...
  useEffect(() => {
    ...
    if(lastModelChanged.grupo_enfoque&&
        ...
        lastModelChanged.grupo_enfoque[String(item.grupo_id)].changedAssociations&&
        lastModelChanged.grupo_enfoque[String(item.grupo_id)].changedAssociations.cuadrante_grupo_enfoque_id&&
        (lastModelChanged.grupo_enfoque[String(item.grupo_id)].changedAssociations.cuadrante_grupo_enfoque_id.added ||
         lastModelChanged.grupo_enfoque[String(item.grupo_id)].changedAssociations.cuadrante_grupo_enfoque_id.removed)) {
          
          //remove any dis-associated internalId from idsToAdd[]
          let idsRemoved = lastModelChanged.grupo_enfoque[String(item.grupo_id)].changedAssociations.cuadrante_grupo_enfoque_id.idsRemoved;
          if(idsRemoved) {
  ...
  }, [lastModelChanged, lastChangeTimestamp, items, itemsB, item.grupo_id, handleUntransfer]);
