...
export default function GrupoEnfoqueConfirmationDialog(props) {
  ...
  return (
    <div>
      <Dialog id='GrupoEnfoqueConfirmationDialog-create'
        open={open}
      ...
      >
        ...
        <DialogActions>
          ...
          {(acceptText !== '' && acceptText !== null && acceptText !== undefined) &&
            <Button
              id='GrupoEnfoqueConfirmationDialog-create-button-accept'
              color="primary"
              variant='contained'
          ...
          {(rejectText !== '' && acceptText !== null && acceptText !== undefined) &&
            ...
            <Button
              id='GrupoEnfoqueConfirmationDialog-create-button-reject'
              color="primary" 
...
GrupoEnfoqueConfirmationDialog.propTypes = {
