...
export default function SitioConfirmationDialog(props) {
  ...
  return (
    <div>
      <Dialog id='SitioConfirmationDialog-update'
        open={open}
      ...
      >
        ...
        <DialogActions>
          ...
          {(acceptText !== '' && acceptText !== null && acceptText !== undefined) &&
            <Button
              id='SitioConfirmationDialog-update-button-accept'
              color="primary"
              variant='contained'
          ...
          {(rejectText !== '' && acceptText !== null && acceptText !== undefined) &&
            ...
            <Button
              id='SitioConfirmationDialog-update-button-reject'
              color="primary" 
...
SitioConfirmationDialog.propTypes = {
