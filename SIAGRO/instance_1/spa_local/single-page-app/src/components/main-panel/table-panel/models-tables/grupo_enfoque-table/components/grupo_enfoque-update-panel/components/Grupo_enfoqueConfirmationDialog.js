...
export default function GrupoEnfoqueConfirmationDialog(props) {
  ...
  return (
    <div>
      <Dialog id='GrupoEnfoqueConfirmationDialog-update'
        open={open}
      ...
      >
        ...
        <DialogActions>
          ...
          {(acceptText !== '' && acceptText !== null && acceptText !== undefined) &&
            <Button
              id='GrupoEnfoqueConfirmationDialog-update-button-accept'
              color="primary"
              variant='contained'
          ...
          {(rejectText !== '' && acceptText !== null && acceptText !== undefined) &&
            ...
            <Button
              id='GrupoEnfoqueConfirmationDialog-update-button-reject'
              color="primary" 
