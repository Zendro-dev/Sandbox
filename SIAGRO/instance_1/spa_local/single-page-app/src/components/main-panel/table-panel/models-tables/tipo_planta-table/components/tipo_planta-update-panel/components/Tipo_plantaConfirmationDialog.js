...
export default function TipoPlantaConfirmationDialog(props) {
  ...
  return (
    <div>
      <Dialog id='TipoPlantaConfirmationDialog-update'
        open={open}
      ...
      >
        ...
        <DialogActions>
          ...
          {(acceptText !== '' && acceptText !== null && acceptText !== undefined) &&
            <Button
              id='TipoPlantaConfirmationDialog-update-button-accept'
              color="primary"
              variant='contained'
          ...
          {(rejectText !== '' && acceptText !== null && acceptText !== undefined) &&
            ...
            <Button
              id='TipoPlantaConfirmationDialog-update-button-reject'
              color="primary" 
...
TipoPlantaConfirmationDialog.propTypes = {
