...
//Plotly
import GrupoEnfoquePlotly from '../../../../plots/Grupo_enfoquePlotly';
            ...
            <Grid item xs={12}>
              <Paper className={classes.paper}>
                ...
                <GrupoEnfoqueEnhancedTableToolbar
                  ...
                  search={search}
                  showToggleButtons={Boolean(GrupoEnfoquePlotly)}
                  ...
                  */}
                  <div>
                    ...
                    <div className={classes.tableWrapper} ref={twref}>
                      ...
                      >
                        <Box
                          id='GrupoEnfoqueEnhancedTable-box-noData'
                          className={classes.tableBackdrop}
                          bgcolor='rgba(255, 255, 255, 0.0)'
                      ...
                      {/* Table */}
                      <Table id='GrupoEnfoqueEnhancedTable-table' stickyHeader size='small' ref={tref}>
                        ...
                        <Fade
                          in={(!isOnApiRequest && count > 0)}
                        >
                          <TableBody id='GrupoEnfoqueEnhancedTable-tableBody'>
                            {
                              items.map((item, index) => {
                                return ([
                                  ...
                                  */
                                  <TableRow
                                    id={'GrupoEnfoqueEnhancedTable-row-'+item.grupo_id}
                                    hover
                                  ...
                                  >
                                    ...
                                    <TableCell padding="checkbox">
                                      <Tooltip title={ t('modelPanels.viewDetails') }>
                                        <IconButton
                                          id={'GrupoEnfoqueEnhancedTable-row-iconButton-detail-'+item.grupo_id}
                                          color="default"
                                          onClick={event => {
                                      ...
                                      &&(
                                        <TableCell padding='checkbox' align='center'>
                                          <Tooltip title={ t('modelPanels.edit') }>
                                            <IconButton
                                              id={'GrupoEnfoqueEnhancedTable-row-iconButton-edit-'+item.grupo_id}
                                              color="default"
                                              onClick={(event) => {
                                                event.stopPropagation();
                                      ...
                                      &&(
                                        <TableCell padding='checkbox' align='center'>
                                          <Tooltip title={ t('modelPanels.delete') }>
                                            <IconButton
                                              id={'GrupoEnfoqueEnhancedTable-row-iconButton-delete-'+item.grupo_id}
                                              color="default"
                                              onClick={(event) => {
                                                event.stopPropagation();
