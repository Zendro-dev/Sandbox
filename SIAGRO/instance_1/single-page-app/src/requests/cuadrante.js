...
export default {
      ...
      `mutation
        addCuadrante(
          ...
          $addTaxonomic_information: ID,
            ...
            addTaxonomic_information: $addTaxonomic_information,
          ) {
            cuadrante_id,
            tipo_planta,
            produccion_valor,
    ...
    var query = 
      `mutation
        updateCuadrante(
          ...
          $addTaxonomic_information: ID,
          $removeTaxonomic_information: ID,
          ) { updateCuadrante(
            cuadrante_id: $cuadrante_id
            tipo_planta: $tipo_planta,
            produccion_valor: $produccion_valor,
            ...
            addTaxonomic_information: $addTaxonomic_information,
            removeTaxonomic_information: $removeTaxonomic_information,
          ) {
            cuadrante_id,
            tipo_planta,
            produccion_valor,
  ...
  /**
   * getTaxonomic_informationConnection
   * 
   * Get taxons connection (cursor based) records associated to the given cuadrante record
   * through association 'Taxonomic_information', from GraphQL Server.
   * 
   * 
   * @param {String} url GraphQL Server url
   * @param {Number} itemId Model item internalId.
   ...
   * @param {String} ops Object with adittional query options.
   */
  getTaxonomic_informationConnection(url, itemId, label, sublabel, searchText, variables, ops) {
    var query = 
      `{ readOneCuadrante(cuadrante_id: "${itemId}") { 
   ...
   * 
   *  
   * getAssociatedTaxonomic_informationConnection
   * 
   ...
   * @param {Number} itemId Model item internalId.
   */
  getAssociatedTaxonomic_informationConnection(url, itemId) {
    var query = 
    `{ readOneCuadrante( cuadrante_id: "${itemId}" ){ 
      taxonomic_information{ id } } }`;
    /**
