...
export default {
   ...
   * 
   * Get locations connection (cursor based) records associated to the given grupo_enfoque record
   ...
   * 
   * Get the location-ids associated (by cursor based connection) to the given grupo_enfoque record 
   * through association 'Location', from GraphQL Server.
   * 
   * @param {String} url GraphQL Server url
   * @param {Number} itemId Model item internalId.
