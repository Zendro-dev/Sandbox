...
import TaxonomicInformationCompactView from './taxonomic_information-compact-view/Taxonomic_informationCompactView'
  ...
  return (
    <Fade in={!deleted} timeout={500}>
      ...
      > 
        ...
        {/* Taxonomic_information Compact View */}
        {(associationSelected === 'taxonomic_information') && (
          <Grid item xs={12} sm={10} md={9} lg={8} xl={7}>
            <TaxonomicInformationCompactView
              item={item}
