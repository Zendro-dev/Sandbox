...
export default function LocationCreatePanel(props) {
  ...
  function getInitialValues() {
    ...
    initialValues.location_id = null;
    initialValues.pais = null;
    initialValues.estado = null;
    initialValues.municipio = null;
  ...
  function getInitialValueOkStates() {
    ...
    */
    ...
    initialValueOkStates.location_id = 0;
    initialValueOkStates.pais = 0;
    initialValueOkStates.estado = 0;
    initialValueOkStates.municipio = 0;
  ...
  const handleUntransferFromAdd =(associationKey, itemId) => {
    if(associationKey === 'grupo_enfoque') {
      let iof = grupo_enfoqueIdsToAdd.current.indexOf(itemId);
      if(iof !== -1) {
        grupo_enfoqueIdsToAdd.current.splice(iof, 1);
      }
      return;
