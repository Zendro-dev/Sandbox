...
export default function LocationEnhancedTable(props) {
  ...
  const [orderBy, setOrderBy] = useState('location_id');
            ...
            (response) => {
              ...
              */
              ...
              if(errors.current.length > 0) {
                ...
                newError.locations=[{model: 'location', method: 'getData()'}];
                newError.path=['Locations'];
                newError.extensions = {graphQL:{data:response.data.data, errors:response.data.errors}};
                errors.current.push(newError);
                console.log("Error: ", newError);
                              ...
                              >
                                ...
                                */}
                                ...
                                <TableCell
                                  ...
                                  padding="checkbox"
                                >
                                  <Tooltip title={ 'location_id: ' + item.location_id}>
                                    <Typography variant='body2' color='textSecondary' display='block' noWrap={true}>{item.location_id}</Typography>
                                  </Tooltip>
                                </TableCell>
