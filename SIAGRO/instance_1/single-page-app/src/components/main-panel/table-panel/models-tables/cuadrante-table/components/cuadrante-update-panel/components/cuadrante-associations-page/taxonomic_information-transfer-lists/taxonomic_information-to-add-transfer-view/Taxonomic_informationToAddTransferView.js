...
import TaxonomicInformationToAddTransferViewToolbar from './components/Taxonomic_informationToAddTransferViewToolbar';
import TaxonomicInformationToAddTransferViewCursorPagination from './components/Taxonomic_informationToAddTransferViewCursorPagination';
...
export default function TaxonomicInformationToAddTransferView(props) {
  ...
  */
  ...
  const getData = useCallback(() => {
    ...
    */
    let cancelableApiReq = makeCancelable(api.cuadrante.getAssociatedTaxonomic_informationConnection(graphqlServerUrl, item.cuadrante_id));  
    ...
    cancelableApiReq
      ...
      (response) => {
        ...
        if(!response.data ||!response.data.data) {
          ...
          newError.locations=[{model: 'cuadrante', association: 'taxonomic_information', table:'A', query: 'readOneCuadrante', method: 'getData()', request: 'api.cuadrante.getAssociatedTaxonomic_informationConnection'}];
          newError.path=['add', 'taxonomic_information'];
        ...
        || typeof readOneCuadrante.taxonomic_information!== 'object' //can be null
        ) {
          let newError = {};
          let withDetails=true;
          variant.current='error';
        ...
        //get item
        let idso = readOneCuadrante.taxonomic_information;
        ...
        cancelableApiReqB
          ...
          (response)=> {
            ...
            if(!response.data ||!response.data.data) {
              ...
              variant.current='error';
              newError.message = t('modelPanels.errors.data.e1', 'No data was received from the server.');
              newError.locations=[{model: 'cuadrante', association: 'taxonomic_information', table:'A', query: 'countTaxons', method: 'getData()', request: 'api.taxon.getCountItems'}];
              newError.path=['add', 'taxonomic_information'];
              newError.extensions = {graphqlResponse:{data:response.data.data, errors:response.data.errors}};
              errors.current.push(newError);
              console.log("Error: ", newError);
            ...
            cancelableApiReqC
              ...
              (response) => {
                ...
                if(!response.data ||!response.data.data) {
                  ...
                  variant.current='error';
                  newError.message = t('modelPanels.errors.data.e1', 'No data was received from the server.');
                  newError.locations=[{model: 'cuadrante', association: 'taxonomic_information', table:'A', query: 'taxonsConnection', method: 'getData()', request: 'api.taxon.getItemsConnection'}];
                  newError.path=['add', 'taxonomic_information'];
                  newError.extensions = {graphqlResponse:{data:response.data.data, errors:response.data.errors}};
                  errors.current.push(newError);
                  console.log("Error: ", newError);
                ...
                if(taxonsConnection === null) {
                  ...
                  */
                  ...
                  if(errors.current.length > 0) {
                    ...
                    newError.locations=[{model: 'cuadrante', association: 'taxonomic_information', table:'A', method: 'getData()'}];
                    newError.path=['add', 'taxonomic_information'];
                    newError.extensions = {graphQL:{data:response.data.data, errors:response.data.errors}};
                    errors.current.push(newError);
                    console.log("Error: ", newError);
      ...
      //error
      .catch((err) => { //error: on api.cuadrante.getAssociatedTaxonomic_informationConnection
        if(err.isCanceled) {
          return
        } else {
          let newError = {};
    ...
    cancelableApiReq
      ...
      (response) => {
        ...
        if(!response.data ||!response.data.data) {
          ...
          newError.message = t('modelPanels.errors.data.e1', 'No data was received from the server.');
          newError.locations=[{model: 'cuadrante', association: 'taxonomic_information', table:'B', query: 'countTaxons', method: 'getDataB()', request: 'api.taxon.getCountItems'}];
          newError.path=['add', 'taxonomic_information'];
          newError.extensions = {graphqlResponse:{data:response.data.data, errors:response.data.errors}};
          ...
          cancelableApiReqB
            ...
            (response) => {
              ...
              if(!response.data ||!response.data.data) {
                ...
                variantB.current='error';
                newError.message = t('modelPanels.errors.data.e1', 'No data was received from the server.');
                newError.locations=[{model: 'cuadrante', association: 'taxonomic_information', table:'B', query: 'taxonsConnection', method: 'getDataB()', request: 'api.taxon.getItemsConnection'}];
                newError.path=['add', 'taxonomic_information'];
                newError.extensions = {graphqlResponse:{data:response.data.data, errors:response.data.errors}};
                errorsB.current.push(newError);
                console.log("Error: ", newError);
              ...
              */
              ...
              if(errorsB.current.length > 0) {
                ...
                newError.locations=[{model: 'cuadrante', association: 'taxonomic_information', table:'B', method: 'getDataB()'}];
                newError.path=['add', 'taxonomic_information'];
                newError.extensions = {graphQL:{data:response.data.data, errors:response.data.errors}};
                errorsB.current.push(newError);
                console.log("Error: ", newError);
  ...
  useEffect(() => {
    ...
    /*
     * Case 1: 
     * The relation 'taxonomic_information' for this item was updated.
    ...
    if(lastModelChanged.cuadrante&&
        ...
        lastModelChanged.cuadrante[String(item.cuadrante_id)].changedAssociations.taxonomic_information&&
        (lastModelChanged.cuadrante[String(item.cuadrante_id)].changedAssociations.taxonomic_information.added ||
         lastModelChanged.cuadrante[String(item.cuadrante_id)].changedAssociations.taxonomic_information.removed)) {
          
          //remove any dis-associated internalId from idsToAdd[]
          let idsRemoved = lastModelChanged.cuadrante[String(item.cuadrante_id)].changedAssociations.taxonomic_information.idsRemoved;
          if(idsRemoved) {
            idsRemoved.forEach( (idRemoved) => {
              ...
              handleUntransfer('taxonomic_information', idRemoved);
            });
          }
            ...
            if(entry[1].changedAssociations.cuadrantes.added) {
              ...
              if(idsAdded) {
                ...
                if(iof !== -1) {
                  ...
                  handleUntransfer('taxonomic_information', idAdded);
  ...
  const handleAddItem = (event, item) => {
    if(lidsToAdd.current.indexOf(item.id) === -1) {
      ...
      //reload B (full)
      resetReloadDataB();
      handleTransfer('taxonomic_information', item.id);
    }
  };
  ...
  const handleRemoveItem = (event, item) => {
    if(lidsToAdd.current.length > 0) {
      ...
      //reload B
      reloadDataB();
      handleUntransfer('taxonomic_information', item.id);
    }
  };
        ...
        <Grid item xs={12} sm={5} >
          {(item!==undefined) && (
            <Card className={classes.card}>
              ...
              {/* Toolbar */}
              <TaxonomicInformationToAddTransferViewToolbar
                title={'Taxons'}
                titleIcon={1}
                search={search}
              ...
              {/* Pagination */}
              <TaxonomicInformationToAddTransferViewCursorPagination
                count={count}
...
TaxonomicInformationToAddTransferView.propTypes = {
