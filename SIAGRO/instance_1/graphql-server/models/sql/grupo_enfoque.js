...
module.exports = class grupo_enfoque extends Sequelize.Model {
    ...
    static bulkAddCsv(context) {
        ...
        return `Bulk import of grupo_enfoque records started. You will be send an email to ${helpersAcl.getTokenFromContext(context).email} informing you about success or errors`;
    }
    ...
    static async add_sitio_id(grupo_id, sitio_id) {
        let updated = await grupo_enfoque.update({
            sitio_id: sitio_id
        }, {
            where: {
                grupo_id: grupo_id
    ...
    /**
     * bulkAssociateGrupo_enfoqueWithSitio_id - bulkAssociaton of given ids
     *
     * @param  {array} bulkAssociationInput Array of associations to add
     * @param  {BenignErrorReporter} benignErrorReporter Error Reporter used for reporting Errors from remote zendro services
     * @return {string} returns message on success
     */
    static async bulkAssociateGrupo_enfoqueWithSitio_id(bulkAssociationInput) {
        let mappedForeignKeys = helper.mapForeignKeysToPrimaryKeyArray(bulkAssociationInput, "grupo_id", "sitio_id");
        var promises = [];
    ...
    /**
     * bulkDisAssociateGrupo_enfoqueWithSitio_id - bulkDisAssociaton of given ids
     *
     * @param  {array} bulkAssociationInput Array of associations to remove
     * @param  {BenignErrorReporter} benignErrorReporter Error Reporter used for reporting Errors from remote zendro services
     * @return {string} returns message on success
     */
    static async bulkDisAssociateGrupo_enfoqueWithSitio_id(bulkAssociationInput) {
        let mappedForeignKeys = helper.mapForeignKeysToPrimaryKeyArray(bulkAssociationInput, "grupo_id", "sitio_id");
        var promises = [];
        mappedForeignKeys.forEach(({
            sitio_id,
