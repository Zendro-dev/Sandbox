...
module.exports = class tipo_planta extends Sequelize.Model {
    ...
    static init(sequelize, DataTypes) {
        return super.init({
            ...
            modelName: "tipo_planta",
            tableName: "tipo_planta",
            sequelize
        });
    }

    static associate(models) {
        tipo_planta.hasMany(models.cuadrante, {
            as: 'cuadrantes',
    ...
    static async readById(id) {
        let item = await tipo_planta.findByPk(id);
        if (item === null) {
    ...
    static readAll(search, order, pagination, benignErrorReporter) {
        ...
        return super.count(options).then(async items => {
            ...
            if (globals.LIMIT_RECORDS < options['limit']) {
                throw new Error(`Request of total tipo_planta exceeds max limit of ${globals.LIMIT_RECORDS}. Please use pagination.`);
            }
            ...
            if (pagination) {
                ...
                if (isForwardPagination) {
                    if (pagination.after) {
                        ...
                        options['where'] = {
                            ...options['where'],
                            ...helper.parseOrderCursor(options['order'], decoded_cursor, "tipo_planta_id", pagination.includeCursor)
                        };
                    }
                } else { //backward
                    if (pagination.before) {
                        ...
                        options['where'] = {
                            ...options['where'],
                            ...helper.parseOrderCursorBefore(options['order'], decoded_cursor, "tipo_planta_id", pagination.includeCursor)
                        };
                    }
                }
            }
    ...
    static bulkAddCsv(context) {
        ...
        return `Bulk import of tipo_planta records started. You will be send an email to ${helpersAcl.getTokenFromContext(context).email} informing you about success or errors`;
    }
    ...
    static idAttribute() {
        return tipo_planta.definition.id.name;
    }
    ...
    static idAttributeType() {
        return tipo_planta.definition.id.type;
    }

    /**
     * getIdValue - Get the value of the idAttribute ("id", or "internalId") for an instance of tipo_planta.
     *
     * @return {type} id value
     */

    getIdValue() {
        return this[tipo_planta.idAttribute()]
    }
    ...
    stripAssociations() {
        let attributes = Object.keys(tipo_planta.definition.attributes);
