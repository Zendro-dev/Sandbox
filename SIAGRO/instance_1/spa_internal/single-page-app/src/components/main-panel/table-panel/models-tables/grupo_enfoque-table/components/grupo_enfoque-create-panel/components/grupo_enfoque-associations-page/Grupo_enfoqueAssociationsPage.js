...
import SitioTransferLists from './sitio-transfer-lists/SitioTransferLists'
    ...
    <div hidden={hidden}>
      <Fade in={!hidden} timeout={500}>
        ...
        > 
          ...
          {/* Sitio Transfer Lists */}
          {(associationSelected === 'sitio') && (
            <Grid item xs={12} sm={10} md={9}>
              <SitioTransferLists
                idsToAdd={sitioIdsToAdd}
...
GrupoEnfoqueAssociationsPage.propTypes = {
  ...
  sitioIdsToAdd: PropTypes.array.isRequired,
