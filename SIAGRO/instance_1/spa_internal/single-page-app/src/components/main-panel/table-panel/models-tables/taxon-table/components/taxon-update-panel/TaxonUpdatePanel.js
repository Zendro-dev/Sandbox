  ...
  function doSave(event) {
    ...
    */
    ...
    if(cuadrantesIdsToAdd.current.length>0) {
      ...
      changedAssociations.current.cuadrante_taxon_id.idsAdded = cuadrantesIdsToAdd.current;
    }
    if(cuadrantesIdsToRemove.current.length>0) {
      ...
      changedAssociations.current.cuadrante_taxon_id.idsRemoved = cuadrantesIdsToRemove.current;
    }
