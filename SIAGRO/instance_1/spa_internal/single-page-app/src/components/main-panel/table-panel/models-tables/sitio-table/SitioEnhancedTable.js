...
//Plotly
import SitioPlotly from '../../../../plots/SitioPlotly';
            ...
            <Grid item xs={12}>
              <Paper className={classes.paper}>
                ...
                <SitioEnhancedTableToolbar
                  ...
                  search={search}
                  showToggleButtons={Boolean(SitioPlotly)}
                  ...
                  */}
                  <div>
                    ...
                    <div className={classes.tableWrapper} ref={twref}>
                      ...
                      >
                        <Box
                          id='SitioEnhancedTable-box-noData'
                          className={classes.tableBackdrop}
                          bgcolor='rgba(255, 255, 255, 0.0)'
                      ...
                      {/* Table */}
                      <Table id='SitioEnhancedTable-table' stickyHeader size='small' ref={tref}>
                        ...
                        <Fade
                          in={(!isOnApiRequest && count > 0)}
                        >
                          <TableBody id='SitioEnhancedTable-tableBody'>
                            {
                              items.map((item, index) => {
                                return ([
                                  ...
                                  */
                                  <TableRow
                                    id={'SitioEnhancedTable-row-'+item.sitio_id}
                                    hover
                                  ...
                                  >
                                    ...
                                    <TableCell padding="checkbox">
                                      <Tooltip title={ t('modelPanels.viewDetails') }>
                                        <IconButton
                                          id={'SitioEnhancedTable-row-iconButton-detail-'+item.sitio_id}
                                          color="default"
                                          onClick={event => {
                                    ...
                                    */}
                                      ...
                                      &&(
                                        <TableCell padding='checkbox' align='center'>
                                          <Tooltip title={ t('modelPanels.edit') }>
                                            <IconButton
                                              id={'SitioEnhancedTable-row-iconButton-edit-'+item.sitio_id}
                                              color="default"
                                              onClick={(event) => {
                                                event.stopPropagation();
                                      ...
                                      &&(
                                        <TableCell padding='checkbox' align='center'>
                                          <Tooltip title={ t('modelPanels.delete') }>
                                            <IconButton
                                              id={'SitioEnhancedTable-row-iconButton-delete-'+item.sitio_id}
                                              color="default"
                                              onClick={(event) => {
                                                event.stopPropagation();
                                    ...
                                    <TableCell
                                      ...
                                      padding="default"
                                    >
                                      {String((item.clave_estado!==null)?item.clave_estado:'')}
                                    </TableCell>
                                    ...
                                    <TableCell
                                      ...
                                      padding="default"
                                    >
                                      {String((item.clave_municipio!==null)?item.clave_municipio:'')}
                                    </TableCell>
                                    ...
                                    <TableCell
                                      ...
                                      padding="default"
                                    >
                                      {String((item.clave_localidad!==null)?item.clave_localidad:'')}
                                    </TableCell>
