...
import GrupoEnfoqueDetailPanel from './grupo_enfoque-detail-panel/Grupo_enfoqueDetailPanel'
...
export default function GrupoEnfoqueDeleteConfirmationDialog(props) {
  ...
  return (
    ...
    >
      ...
      {(!deleted) && (
        <DialogActions>
          <Button 
          id='GrupoEnfoqueDeleteConfirmationDialog-button-reject'
          ...
          <Button 
          id='GrupoEnfoqueDeleteConfirmationDialog-button-accept'
...
GrupoEnfoqueDeleteConfirmationDialog.propTypes = {
