...
import TipoPlantaDetailPanel from './tipo_planta-detail-panel/Tipo_plantaDetailPanel'
...
export default function TipoPlantaDeleteConfirmationDialog(props) {
  ...
  return (
    ...
    >
      ...
      {(!deleted) && (
        <DialogActions>
          <Button 
          id='TipoPlantaDeleteConfirmationDialog-button-reject'
          ...
          <Button 
          id='TipoPlantaDeleteConfirmationDialog-button-accept'
...
TipoPlantaDeleteConfirmationDialog.propTypes = {
