...
export default function SitioUploadFileDialog(props) {
  ...
  const handleSubmit = (event) => {
    if(file.current !== undefined && file.current !== null) {
      ...
      let query = 'mutation{ bulkAddSitioCsv{ sitio_id} }'
  ...
  return (
    ...
    >
      <DialogTitle>
      { t('modelPanels.uploading') + ' Sitios' }
        <div>
...
SitioUploadFileDialog.propTypes = {
