...
export default function GrupoEnfoqueToAddTransferView(props) {
  ...
  */
  ...
  const getData = useCallback(() => {
    ...
    */
    let cancelableApiReq = makeCancelable(api.sitio.getAssociatedGrupo_enfoqueConnection(graphqlServerUrl, item.sitio_id));  
    ...
    cancelableApiReq
      ...
      (response) => {
        ...
        if(!response.data ||!response.data.data) {
          ...
          newError.locations=[{model: 'sitio', association: 'grupo_enfoque', table:'A', query: 'readOneSitio', method: 'getData()', request: 'api.sitio.getAssociatedGrupo_enfoqueConnection'}];
        ...
        //get items
        let idso = readOneSitio.grupo_enfoqueConnection.edges.map(o => o.node);
        ...
        cancelableApiReqB
          ...
          (response)=> {
            ...
            if(!response.data ||!response.data.data) {
              ...
              variant.current='error';
              newError.message = t('modelPanels.errors.data.e1', 'No data was received from the server.');
              newError.locations=[{model: 'sitio', association: 'grupo_enfoque', table:'A', query: 'countGrupo_enfoques', method: 'getData()', request: 'api.grupo_enfoque.getCountItems'}];
              newError.path=['add', 'grupo_enfoque'];
              newError.extensions = {graphqlResponse:{data:response.data.data, errors:response.data.errors}};
              errors.current.push(newError);
              console.log("Error: ", newError);
            ...
            cancelableApiReqC
              ...
              (response) => {
                ...
                if(!response.data ||!response.data.data) {
                  ...
                  variant.current='error';
                  newError.message = t('modelPanels.errors.data.e1', 'No data was received from the server.');
                  newError.locations=[{model: 'sitio', association: 'grupo_enfoque', table:'A', query: 'grupo_enfoquesConnection', method: 'getData()', request: 'api.grupo_enfoque.getItemsConnection'}];
                  newError.path=['add', 'grupo_enfoque'];
                  newError.extensions = {graphqlResponse:{data:response.data.data, errors:response.data.errors}};
                  errors.current.push(newError);
                  console.log("Error: ", newError);
                ...
                if(grupo_enfoquesConnection === null) {
                  ...
                  */
                  ...
                  if(errors.current.length > 0) {
                    ...
                    newError.locations=[{model: 'sitio', association: 'grupo_enfoque', table:'A', method: 'getData()'}];
                    newError.path=['add', 'grupo_enfoque'];
                    newError.extensions = {graphQL:{data:response.data.data, errors:response.data.errors}};
                    errors.current.push(newError);
                    console.log("Error: ", newError);
      ...
      //error
      .catch((err) => { //error: on api.sitio.getAssociatedGrupo_enfoqueConnection
        if(err.isCanceled) {
          return
        } else {
          let newError = {};
    ...
    cancelableApiReq
      ...
      (response) => {
        ...
        if(!response.data ||!response.data.data) {
          ...
          newError.message = t('modelPanels.errors.data.e1', 'No data was received from the server.');
          newError.locations=[{model: 'sitio', association: 'grupo_enfoque', table:'B', query: 'countGrupo_enfoques', method: 'getDataB()', request: 'api.grupo_enfoque.getCountItems'}];
          newError.path=['add', 'grupo_enfoque'];
          newError.extensions = {graphqlResponse:{data:response.data.data, errors:response.data.errors}};
          ...
          cancelableApiReqB
            ...
            (response) => {
              ...
              if(!response.data ||!response.data.data) {
                ...
                variantB.current='error';
                newError.message = t('modelPanels.errors.data.e1', 'No data was received from the server.');
                newError.locations=[{model: 'sitio', association: 'grupo_enfoque', table:'B', query: 'grupo_enfoquesConnection', method: 'getDataB()', request: 'api.grupo_enfoque.getItemsConnection'}];
                newError.path=['add', 'grupo_enfoque'];
                newError.extensions = {graphqlResponse:{data:response.data.data, errors:response.data.errors}};
                errorsB.current.push(newError);
                console.log("Error: ", newError);
              ...
              */
              ...
              if(errorsB.current.length > 0) {
                ...
                newError.locations=[{model: 'sitio', association: 'grupo_enfoque', table:'B', method: 'getDataB()'}];
                newError.path=['add', 'grupo_enfoque'];
                newError.extensions = {graphQL:{data:response.data.data, errors:response.data.errors}};
                errorsB.current.push(newError);
                console.log("Error: ", newError);
  ...
  useEffect(() => {
    ...
    if(lastModelChanged.sitio&&
        ...
        lastModelChanged.sitio[String(item.sitio_id)].changedAssociations&&
        lastModelChanged.sitio[String(item.sitio_id)].changedAssociations.grupo_enfoque_sitio_id&&
        (lastModelChanged.sitio[String(item.sitio_id)].changedAssociations.grupo_enfoque_sitio_id.added ||
         lastModelChanged.sitio[String(item.sitio_id)].changedAssociations.grupo_enfoque_sitio_id.removed)) {
          
          //remove any dis-associated internalId from idsToAdd[]
          let idsRemoved = lastModelChanged.sitio[String(item.sitio_id)].changedAssociations.grupo_enfoque_sitio_id.idsRemoved;
          if(idsRemoved) {
  ...
  }, [lastModelChanged, lastChangeTimestamp, items, itemsB, item.sitio_id, handleUntransfer]);
