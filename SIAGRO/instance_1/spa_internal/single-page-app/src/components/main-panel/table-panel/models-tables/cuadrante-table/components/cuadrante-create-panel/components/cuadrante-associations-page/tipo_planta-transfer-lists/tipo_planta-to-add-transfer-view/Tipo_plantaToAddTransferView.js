...
export default function TipoPlantaToAddTransferView(props) {
  ...
  */
  ...
  const getData = useCallback(() => {
    ...
    */
    let cancelableApiReq = makeCancelable(api.tipo_planta.getCountItems(graphqlServerUrl, search, ops));
                                ...
                                <Grid container alignItems='center' alignContent='center' wrap='nowrap' spacing={1}>
                                  <Grid item>
                                    <Tooltip title={ 'tipo_planta_id' }>
                                      <Typography variant="body1" display="block" noWrap={true}>{it.tipo_planta_id}</Typography>
                                    </Tooltip>
                                  </Grid>
                                  {/*Key icon*/}
                                  <Grid item>
