...
export default function SitioCreatePanel(props) {
  ...
  function getInitialValues() {
    ...
    initialValues.clave_estado = null;
    initialValues.municipio = null;
    initialValues.clave_municipio = null;
    initialValues.localidad = null;
    initialValues.clave_localidad = null;
  ...
  function getInitialValueOkStates() {
    ...
    */
    ...
    initialValueOkStates.clave_estado = 0;
    initialValueOkStates.municipio = 0;
    initialValueOkStates.clave_municipio = 0;
    initialValueOkStates.localidad = 0;
    initialValueOkStates.clave_localidad = 0;
  ...
  return (
    ...
    <Dialog id='SitioCreatePanel-dialog'  
      ...
      <AppBar>
        <Toolbar>
          <Tooltip title={ t('modelPanels.cancel') }>
            <IconButton
              id='SitioCreatePanel-button-cancel'
              edge="start" 
              color="inherit"
              onClick={(event) => {
                if(!isCanceling.current){
          ...
          <Tooltip title={ t('modelPanels.save') + " sitio" }>
            <Fab
              id='SitioCreatePanel-fabButton-save' 
              color="secondary" 
