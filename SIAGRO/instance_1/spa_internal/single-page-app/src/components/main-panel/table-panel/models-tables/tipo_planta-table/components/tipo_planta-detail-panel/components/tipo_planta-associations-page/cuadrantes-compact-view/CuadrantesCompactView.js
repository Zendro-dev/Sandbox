...
import CuadrantesCompactViewToolbar from './components/CuadrantesCompactViewToolbar';
import CuadrantesCompactViewCursorPagination from './components/CuadrantesCompactViewCursorPagination';
...
export default function CuadrantesCompactView(props) {
  ...
  const getData = useCallback(() => {
    ...
    */
    ...
    let cancelableApiReq = makeCancelable(api.tipo_planta.getCuadrantesConnection(
      graphqlServerUrl, 
      item.tipo_planta_id,
      label,
      sublabel,
    ...
    cancelableApiReq
      ...
      (response) => {
        ...
        if(!response.data ||!response.data.data) {
          ...
          newError.locations=[{association: 'cuadrantes', query: 'readOneTipo_planta', method: 'getData()', request: 'api.tipo_planta.getCuadrantesConnection'}];
          newError.path=['detail', `tipo_planta_id:${item.tipo_planta_id}`, 'cuadrantes'];
        ...
        || !Number.isInteger(readOneTipo_planta.countFilteredCuadrantes)
        ...
        || typeof readOneTipo_planta.cuadrantesConnection.pageInfo !== 'object'
        || readOneTipo_planta.cuadrantesConnection.pageInfo === null) {
          let newError = {};
          let withDetails=true;
          variant.current='error';
        ...
        //get items
        let newCount = readOneTipo_planta.countFilteredCuadrantes;
        let its = readOneTipo_planta.cuadrantesConnection.edges.map(o => o.node);
        let pi = readOneTipo_planta.cuadrantesConnection.pageInfo;
      ...
      //error
      .catch((err) => { //error: on api.tipo_planta.getCuadrantesConnection
        if(err.isCanceled) {
          return;
        } else {
          let newError = {};
  ...
  useEffect(() => {
     ...
     * 
     * Conditions:
     * A: the current item 'internalId' attribute is in the removedIds of the updated 'cuadrante'.
     * B: the current item 'internalId' attribute is in the addedIds of the updated 'cuadrante'.
     * 
     * Actions:
     * if A:
     * - reload table.
  ...
  }, [lastModelChanged, lastChangeTimestamp, items, item.tipo_planta_id]);
            ...
            <Card className={classes.card}>
              ...
              {(!isOnApiRequest && (!areItemsReady || !isCountReady)) && (
                ...
                <Fade
                  ...
                  unmountOnExit
                >
                  <div id='CuadrantesCompactView-div-noDataA'>
                    <Grid container>
                      <Grid item xs={12}>
              ...
              {(!isOnApiRequest && areItemsReady && isCountReady) && (
                ...
                >
                  <Box className={classes.listBox} ref={lref}>
                    <List id='CuadrantesCompactView-list-listA'
                    dense component="div" role="list" >
                      {items.map(it => {
                        ...
                        return (
                          <ListItem 
                            id={'CuadrantesCompactView-listA-listItem-'+it.cuadrante_id}
                            key={key} 
                            role="listitem" 
                            button 
                                  ...
                                  <Grid container alignItems='center' alignContent='center' wrap='nowrap' spacing={1}>
                                    <Grid item>
                                      <Tooltip title={ 'cuadrante_id' }>
                                        <Typography
                                        id={'CuadrantesCompactView-listA-listItem-id-'+it.cuadrante_id}
                                ...
                                <React.Fragment>
                                  ...
                                  {(label) && (
                                    <Tooltip title={ 'nombre_comun_grupo_enfoque' }>
                                      <Typography
                                      id={'CuadrantesCompactView-listA-listItem-label-'+it.cuadrante_id}
                                  ...
                                  {(sublabel) && (
                                    <Tooltip title={ '' }>
                                      <Typography
                                      id={'CuadrantesCompactView-listA-listItem-sublabel-'+it.cuadrante_id}
              ...
              {(true) && (
                ...
                <CuadrantesCompactViewCursorPagination
                  count={count}
...
CuadrantesCompactView.propTypes = {
  item: PropTypes.object.isRequired,
  handleClickOnCuadrantesRow: PropTypes.func,
};