    ...
    cancelableApiReq
      ...
      .then(response => {
        ...
        if (
          ...
          //save response data
          //save response data
          let newCount = response.data.data.readOneTaxon.countFilteredAccessions;
          let its = response.data.data.readOneTaxon.accessionsConnection.edges.map(o => o.node);
          let pi = response.data.data.readOneTaxon.accessionsConnection.pageInfo;
