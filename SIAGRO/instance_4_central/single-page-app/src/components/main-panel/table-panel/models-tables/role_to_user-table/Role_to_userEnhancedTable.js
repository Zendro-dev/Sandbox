          ...
          cancelableApiReqB
            ...
            .then(response => {
              ...
              if (
                ...
                //save response data
                let its = response.data.data.role_to_usersConnection.edges.map(o => o.node);
                let pi = response.data.data.role_to_usersConnection.pageInfo;
    ...
    cancelableApiReq
      ...
      .then(response => {
        ...
        if(
          response.data &&
          response.data.data &&
          response.data.data.csvTableTemplateRole_to_user        ) {
          //notify graphql errors
          if(response.data.errors) {
            actionText.current = t('modelPanels.gotIt', "Got it");
            enqueueSnackbar( t('modelPanels.errors.e3', "The GraphQL query returned a response with errors. Please contact your administrator."), {
