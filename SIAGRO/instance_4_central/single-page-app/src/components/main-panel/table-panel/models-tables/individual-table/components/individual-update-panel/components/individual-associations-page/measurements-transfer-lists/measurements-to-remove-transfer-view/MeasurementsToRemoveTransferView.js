    ...
    cancelableApiReq
      ...
      .then(response => {
        ...
        if (
          ...
          //save response data
          let newCount = response.data.data.readOneIndividual.countFilteredMeasurements;
          let its = response.data.data.readOneIndividual.measurementsConnection.edges.map(o => o.node);
          let pi = response.data.data.readOneIndividual.measurementsConnection.pageInfo;
