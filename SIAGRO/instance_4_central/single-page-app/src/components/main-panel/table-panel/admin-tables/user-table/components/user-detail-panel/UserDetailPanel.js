...
export default function UserDetailPanel(props) {
  ...
  useEffect(() => {
    ...
    if(lastModelChanged&&
      ...
      lastModelChanged.user[String(itemState.id)]) {
          
        //updated item
        if(lastModelChanged.user[String(itemState.id)].op === "update"&&
            lastModelChanged.user[String(itemState.id)].newItem) {
              //replace item
              setItemState(lastModelChanged.user[String(itemState.id)].newItem);
              //show alert
              setUpdated(true);
        } else {
          //deleted item
          if(lastModelChanged.user[String(itemState.id)].op === "delete") {
              //show alert
              setDeleted(true);
          }
        }
