...
module.exports = {
    ...
    countLocations: async function({
        ...
        return await checkAuthorization(context, 'Location', 'read').then(async authorization => {
            if (authorization === true) {
                return await location.countRecords(search);
            } else {
                throw new Error("You don't have authorization to perform this action");
            }
        }).catch(error => {
    ...
    addLocation: async function(input, context) {
        try {
            ...
            if (authorization === true) {
                ...
                if (createdLocation) await createdLocation.handleAssociations(inputSanitized, context);
    ...
    updateLocation: async function(input, context) {
        try {
            ...
            if (authorization === true) {
                ...
                if (updatedLocation) await updatedLocation.handleAssociations(inputSanitized, context);
