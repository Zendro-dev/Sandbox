...
module.exports = class capital extends Sequelize.Model {
    ...
    static readAll(search, order, pagination) {
        ...
        return super.count(options).then(items => {
            ...
            if (globals.LIMIT_RECORDS < options['limit']) {
                throw new Error(`Request of total capitals exceeds max limit of ${globals.LIMIT_RECORDS}. Please use pagination.`);
            }
            ...
            if (pagination) {
                ...
                if (isForwardPagination) {
                    if (pagination.after) {
                        ...
                        options['where'] = {
                            ...options['where'],
                            ...helper.parseOrderCursor(options['order'], decoded_cursor, "capital_id", pagination.includeCursor)
                        };
                    }
                } else { //backward
                    if (pagination.before) {
                        ...
                        options['where'] = {
                            ...options['where'],
                            ...helper.parseOrderCursorBefore(options['order'], decoded_cursor, "capital_id", pagination.includeCursor)
                        };
                    }
                }
            }
    ...
    static csvTableTemplate() {
        return helper.csvTableTemplate(capital);
    }
