...
module.exports = class sample_string extends Sequelize.Model {
    ...
    static init(sequelize, DataTypes) {
        return super.init({
            ...
            modelName: "sample_string",
            tableName: "sample_strings",
            sequelize
        });
    }

    static associate(models) {
        sample_string.hasOne(models.sample_string, {
            as: 'parent',
            foreignKey: 'sample_id'
        });
        sample_string.hasMany(models.sample_string, {
            as: 'samples',
            foreignKey: 'sample_id'
        });
    }
    ...
    static async readById(id) {
        let item = await sample_string.findByPk(id);
        if (item === null) {
    ...
    static readAll(search, order, pagination, benignErrorReporter) {
        ...
        return super.count(options).then(async items => {
            ...
            if (globals.LIMIT_RECORDS < options['limit']) {
                throw new Error(`Request of total sample_strings exceeds max limit of ${globals.LIMIT_RECORDS}. Please use pagination.`);
            }
    ...
    static bulkAddCsv(context) {
        ...
        return `Bulk import of sample_string records started. You will be send an email to ${helpersAcl.getTokenFromContext(context).email} informing you about success or errors`;
    }
    ...
    static async add_sample_id(id, sample_id) {
        let updated = await sample_string.update({
            sample_id: sample_id
        }, {
            where: {
                id: id
    ...
    static idAttribute() {
        return sample_string.definition.id.name;
    }
    ...
    static idAttributeType() {
        return sample_string.definition.id.type;
    }

    /**
     * getIdValue - Get the value of the idAttribute ("id", or "internalId") for an instance of sample_string.
     *
     * @return {type} id value
     */

    getIdValue() {
        return this[sample_string.idAttribute()]
    }
    ...
    stripAssociations() {
        let attributes = Object.keys(sample_string.definition.attributes);
