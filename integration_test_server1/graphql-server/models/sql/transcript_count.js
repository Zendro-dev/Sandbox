...
module.exports = class transcript_count extends Sequelize.Model {
    ...
    static bulkAddCsv(context) {
        ...
        return `Bulk import of transcript_count records started. You will be send an email to ${helpersAcl.getTokenFromContext(context).email} informing you about success or errors`;
    }
