...
module.exports = class individual_test extends Sequelize.Model {
    ...
    static async readById(id) {
        let item = await individual_test.findByPk(id);
        if (item === null) {
    ...
    static readAll(search, order, pagination, benignErrorReporter) {
        ...
        return super.count(options).then(async items => {
            ...
            if (globals.LIMIT_RECORDS < options['limit']) {
                throw new Error(`Request of total individual_tests exceeds max limit of ${globals.LIMIT_RECORDS}. Please use pagination.`);
            }
    ...
    static bulkAddCsv(context) {
        ...
        return `Bulk import of individual_test records started. You will be send an email to ${helpersAcl.getTokenFromContext(context).email} informing you about success or errors`;
    }
    ...
    static idAttribute() {
        return individual_test.definition.id.name;
    }
    ...
    static idAttributeType() {
        return individual_test.definition.id.type;
    }

    /**
     * getIdValue - Get the value of the idAttribute ("id", or "internalId") for an instance of individual_test.
     *
     * @return {type} id value
     */

    getIdValue() {
        return this[individual_test.idAttribute()]
    }
    ...
    stripAssociations() {
        let attributes = Object.keys(individual_test.definition.attributes);
        attributes.push('id');
