...
module.exports = class sq_book extends Sequelize.Model {
    ...
    static async countRecords(search) {
        let options = {}
        options['where'] = helper.searchConditionsToSequelize(search, sq_book.definition.attributes);
    ...
    static async readAll(search, order, pagination, benignErrorReporter) {
        ...
        let options = helper.buildLimitOffsetSequelizeOptions(search, order, pagination, this.idAttribute(), sq_book.definition.attributes);
    ...
    static async readAllCursor(search, order, pagination, benignErrorReporter) {
        ...
        let options = helper.buildCursorBasedSequelizeOptions(search, order, pagination, this.idAttribute(), sq_book.definition.attributes);
        let records = await super.findAll(options);
        ...
        if (pagination && (pagination.after || pagination.before)) {
            let oppOptions = helper.buildOppositeSearchSequelize(search, order, {
                ...pagination,
                includeCursor: false
            }, this.idAttribute(), sq_book.definition.attributes);
