...
module.exports = class parrot_instance1 extends Sequelize.Model {
    ...
    static async readById(id) {
        let item = await parrot_instance1.findByPk(id);
        if (item === null) {
        ...
        return super.count(options).then(countA => {
            ...
            if (pagination) {
                ...
                if (isForwardPagination) {
                    if (pagination.after) {
                        ...
                        options['where'] = {
                            ...options['where'],
                            ...helper.parseOrderCursor(options['order'], decoded_cursor, "parrot_id", pagination.includeCursor)
                        };
                    }
                } else { //backward
                    if (pagination.before) {
                        ...
                        options['where'] = {
                            ...options['where'],
                            ...helper.parseOrderCursorBefore(options['order'], decoded_cursor, "parrot_id", pagination.includeCursor)
                        };
                    }
                }
            }
            ...
            return super.count(woptions).then(countB => {
                ...
                if (globals.LIMIT_RECORDS < options['limit']) {
                    throw new Error(`Request of total parrots exceeds max limit of ${globals.LIMIT_RECORDS}. Please use pagination.`);
                }
    ...
    static bulkAddCsv(context) {
        ...
        return `Bulk import of parrot_instance1 records started. You will be send an email to ${helpersAcl.getTokenFromContext(context).email} informing you about success or errors`;
    }
    ...
    static idAttribute() {
        return parrot_instance1.definition.id.name;
    }
    ...
    static idAttributeType() {
        return parrot_instance1.definition.id.type;
    }
    ...
    getIdValue() {
        return this[parrot_instance1.idAttribute()]
    }
    ...
    stripAssociations() {
        let attributes = Object.keys(parrot_instance1.definition.attributes);
