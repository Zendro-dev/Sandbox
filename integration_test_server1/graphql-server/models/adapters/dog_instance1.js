...
module.exports = class dog_instance1 extends Sequelize.Model {
    ...
    static bulkAddCsv(context) {
        ...
        return `Bulk import of dog_instance1 records started. You will be send an email to ${helpersAcl.getTokenFromContext(context).email} informing you about success or errors`;
    }
