...
module.exports = {
    ...
    sequencingExperiments: async function({
        ...
        if (await checkAuthorization(context, 'SequencingExperiment', 'read') === true) {
            helper.checkCountAndReduceRecordLimitHelper(pagination.limit, context, "sequencingExperiments")
    ...
    sequencingExperimentsConnection: async function({
        ...
        if (await checkAuthorization(context, 'SequencingExperiment', 'read') === true) {
            ...
            helper.checkCountAndReduceRecordLimitHelper(limit, context, "sequencingExperimentsConnection");
            let benignErrorReporter = new errorHelper.BenignErrorReporter(context);
    ...
    addSequencingExperiment: async function(input, context) {
        ...
        if (authorization === true) {
            ...
            await createdSequencingExperiment.handleAssociations(inputSanitized, benignErrorReporter);
    ...
    updateSequencingExperiment: async function(input, context) {
        ...
        if (authorization === true) {
            ...
            await updatedSequencingExperiment.handleAssociations(inputSanitized, benignErrorReporter);
