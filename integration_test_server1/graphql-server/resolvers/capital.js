...
module.exports = {
    ...
    capitals: async function({
        ...
        if (await checkAuthorization(context, 'capital', 'read') === true) {
            helper.checkCountAndReduceRecordLimitHelper(pagination.limit, context, "capitals")
    ...
    capitalsConnection: async function({
        ...
        if (await checkAuthorization(context, 'capital', 'read') === true) {
            ...
            helper.checkCountAndReduceRecordLimitHelper(limit, context, "capitalsConnection");
            let benignErrorReporter = new errorHelper.BenignErrorReporter(context);
