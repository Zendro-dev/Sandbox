...
module.exports = {
    ...
    transcript_counts: async function({
        ...
        if (await checkAuthorization(context, 'transcript_count', 'read') === true) {
            helper.checkCountAndReduceRecordLimitHelper(pagination.limit, context, "transcript_counts")
    ...
    transcript_countsConnection: async function({
        ...
        if (await checkAuthorization(context, 'transcript_count', 'read') === true) {
            ...
            helper.checkCountAndReduceRecordLimitHelper(limit, context, "transcript_countsConnection");
            let benignErrorReporter = new errorHelper.BenignErrorReporter(context);
