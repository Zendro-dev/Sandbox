...
module.exports = {
    ...
    aminoacidsequences: async function({
        ...
        if (await checkAuthorization(context, 'aminoacidsequence', 'read') === true) {
            helper.checkCountAndReduceRecordLimitHelper(pagination.limit, context, "aminoacidsequences")
    ...
    aminoacidsequencesConnection: async function({
        ...
        if (await checkAuthorization(context, 'aminoacidsequence', 'read') === true) {
            ...
            helper.checkCountAndReduceRecordLimitHelper(limit, context, "aminoacidsequencesConnection");
            let benignErrorReporter = new errorHelper.BenignErrorReporter(context);
