...
module.exports = {
    ...
    mariadb_books: async function({
        ...
        if (await checkAuthorization(context, 'mariadb_book', 'read') === true) {
            helper.checkCountAndReduceRecordsLimit(pagination.limit, context, "mariadb_books");
    ...
    mariadb_booksConnection: async function({
        ...
        if (await checkAuthorization(context, 'mariadb_book', 'read') === true) {
            ...
            helper.checkCountAndReduceRecordsLimit(limit, context, "mariadb_booksConnection");
            let benignErrorReporter = new errorHelper.BenignErrorReporter(context);
    ...
    readOneMariadb_book: async function({
        ...
        if (await checkAuthorization(context, 'mariadb_book', 'read') === true) {
            helper.checkCountAndReduceRecordsLimit(1, context, "readOneMariadb_book");
            let benignErrorReporter = new errorHelper.BenignErrorReporter(context);
