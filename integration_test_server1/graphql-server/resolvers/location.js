...
module.exports = {
    ...
    locations: async function({
        ...
        if (await checkAuthorization(context, 'Location', 'read') === true) {
            helper.checkCountAndReduceRecordLimitHelper(pagination.limit, context, "locations")
    ...
    locationsConnection: async function({
        ...
        if (await checkAuthorization(context, 'Location', 'read') === true) {
            ...
            helper.checkCountAndReduceRecordLimitHelper(limit, context, "locationsConnection");
            let benignErrorReporter = new errorHelper.BenignErrorReporter(context);
