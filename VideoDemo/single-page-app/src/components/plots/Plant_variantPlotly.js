...
export default function PlantVariantPlotly(props) {
  ...
  async function getItemsAttribute(attribute) {
    /**
      * API Request
      */
      api.plant_variant.getItemsAttribute(graphqlServerUrl, attribute)
    .then((response) => {
      
      //check data
      if(response.data.data.plant_variantsConnection) {
        //reduce to {x1:y1, x2:y2, ...}
        let result = response.data.data.plant_variantsConnection.edges.reduce((acc, item) => {
      ...
      if(response.data.errors) {
        ...
        newError.locations=[{model: 'Plant_variant', query: 'plant_variantsConnection', method: 'getItemsAttribute()', request: 'api.plant_variant.getItemsAttribute'}];
    ...
    .catch((error) => {
      ...
      newError.locations=[{model: 'Plant_variant', query: 'plant_variantsConnection', method: 'getItemsAttribute()', request: 'api.plant_variant.getItemsAttribute'}];
      newError.path=['Plant_variants', 'Plot'];
