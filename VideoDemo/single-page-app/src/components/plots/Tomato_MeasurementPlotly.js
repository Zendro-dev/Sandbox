...
export default function TomatoMeasurementPlotly(props) {
  ...
  async function getItemsAttribute(attribute) {
    /**
      * API Request
      */
      api.tomato_Measurement.getItemsAttribute(graphqlServerUrl, attribute)
    .then((response) => {
      
      //check data
      if(response.data.data.tomato_MeasurementsConnection) {
        //reduce to {x1:y1, x2:y2, ...}
        let result = response.data.data.tomato_MeasurementsConnection.edges.reduce((acc, item) => {
      ...
      if(response.data.errors) {
        ...
        newError.locations=[{model: 'Tomato_Measurement', query: 'tomato_MeasurementsConnection', method: 'getItemsAttribute()', request: 'api.tomato_Measurement.getItemsAttribute'}];
    ...
    .catch((error) => {
      ...
      newError.locations=[{model: 'Tomato_Measurement', query: 'tomato_MeasurementsConnection', method: 'getItemsAttribute()', request: 'api.tomato_Measurement.getItemsAttribute'}];
      newError.path=['Tomato_Measurements', 'Plot'];
