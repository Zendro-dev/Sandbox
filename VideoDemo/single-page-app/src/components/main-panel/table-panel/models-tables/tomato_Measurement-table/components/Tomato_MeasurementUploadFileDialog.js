...
export default function TomatoMeasurementUploadFileDialog(props) {
  ...
  const handleSubmit = (event) => {
    if(file.current !== undefined && file.current !== null) {
      ...
      let query = 'mutation{ bulkAddTomato_MeasurementCsv{ tomato_ID} }'
  ...
  return (
    ...
    >
      <DialogTitle>
      { t('modelPanels.uploading') + ' Tomato_Measurements' }
        <div>
...
TomatoMeasurementUploadFileDialog.propTypes = {
