...
export default function PlantVariantToAddTransferView(props) {
  ...
  */
  ...
  const getData = useCallback(() => {
    ...
    */
    let cancelableApiReq = makeCancelable(api.plant_variant.getCountItems(graphqlServerUrl, search, ops));
                  ...
                  <List dense component="div" role="list" >
                    {items.map(it => {
                      ...
                      return (
                        ...
                        >
                          <ListItemAvatar>
                            <Tooltip title={ 'Plant_variant' }>
                              <Avatar>{"plant_variant".slice(0,1)}</Avatar>
                            </Tooltip>
                          </ListItemAvatar>
