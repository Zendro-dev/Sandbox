...
import TomatoMeasurementsCompactViewToolbar from './components/Tomato_measurementsCompactViewToolbar';
import TomatoMeasurementsCompactViewCursorPagination from './components/Tomato_measurementsCompactViewCursorPagination';
...
export default function TomatoMeasurementsCompactView(props) {
    ...
    cancelableApiReq
      ...
      (response) => {
        ...
        if(!response.data ||!response.data.data) {
          ...
          newError.path=['detail', `plant_variant_ID:${item.plant_variant_ID}`, 'Tomato_measurements'];
  ...
  useEffect(() => {
     ...
     * 
     * Conditions:
     * A: the current item 'internalId' attribute is in the removedIds of the updated 'Tomato_Measurement'.
     * B: the current item 'internalId' attribute is in the addedIds of the updated 'Tomato_Measurement'.
     * 
     * Actions:
     * if A:
     * - reload table.
  ...
  }, [lastModelChanged, lastChangeTimestamp, items, item.plant_variant_ID]);
        ...
        <Grid item xs={12} >
          {(item!==undefined) && (
            <Card className={classes.card}>
              ...
              {/* Toolbar */}
              <TomatoMeasurementsCompactViewToolbar 
              ...
              {(true) && (
                ...
                <TomatoMeasurementsCompactViewCursorPagination
                  count={count}
...
TomatoMeasurementsCompactView.propTypes = {
  item: PropTypes.object.isRequired,
  handleClickOnTomato_measurementsRow: PropTypes.func,
};