...
import TomatoMeasurementsCompactView from './tomato_measurements-compact-view/Tomato_measurementsCompactView'
  ...
  return (
    <Fade in={!deleted} timeout={500}>
      ...
      > 
        ...
        {/* Tomato_measurements Compact View */}
        {(associationSelected === 'tomato_measurements') && (
          <Grid item xs={12} sm={10} md={9} lg={8} xl={7}>
            <TomatoMeasurementsCompactView
              item={item}
