...
export default function PlantVariantUploadFileDialog(props) {
  ...
  const handleSubmit = (event) => {
    if(file.current !== undefined && file.current !== null) {
      ...
      let query = 'mutation{ bulkAddPlant_variantCsv{ plant_variant_ID} }'
  ...
  return (
    ...
    >
      <DialogTitle>
      { t('modelPanels.uploading') + ' Plant_variants' }
        <div>
...
PlantVariantUploadFileDialog.propTypes = {
