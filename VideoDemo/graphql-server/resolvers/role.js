...
role.prototype.usersFilter = async function({
    ...
    if (await checkAuthorization(context, 'user', 'read') === true) {
        await checkCountAndReduceRecordsLimit(search, context, 'usersFilter', 'user');
...
role.prototype.usersConnection = async function({
    ...
    if (await checkAuthorization(context, 'user', 'read') === true) {
        await checkCountAndReduceRecordsLimit(search, context, 'usersConnection', 'user');
 ...
 */
async function checkCountAndReduceRecordsLimit(search, context, resolverName, modelName = 'role') {
...
module.exports = {
    ...
    roles: async function({
        ...
        if (await checkAuthorization(context, 'role', 'read') === true) {
            await checkCountAndReduceRecordsLimit(search, context, "roles");
