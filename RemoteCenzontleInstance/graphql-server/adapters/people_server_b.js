...
module.exports = class people_server_b extends Sequelize.Model {
    ...
    static idAttribute() {
        return people_server_b.definition.id.name;
    }
    ...
    static idAttributeType() {
        return people_server_b.definition.id.type;
    }
    ...
    getIdValue() {
        return this[people_server_b.idAttribute()]
    }
    ...
    stripAssociations() {
        let attributes = Object.keys(people_server_b.definition.attributes);
