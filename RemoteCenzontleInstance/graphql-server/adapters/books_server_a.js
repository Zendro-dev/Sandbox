...
const remoteCenzontleURL = "http://localcenzontleinstance_sdb_science_db_graphql_server_1:3000/graphql";
const iriRegex = new RegExp('_server_a');

module.exports = class books_server_a {
    ...
    static set_internalPersonId(internalBookId, internalPersonId) {
        /**
         * Debug
         */
        console.log("-@@@------ adapter: (", this.adapterType, ") : ", this.adapterName, "\n- on: set_internalPersonId \n- internalBookId: ", internalBookId, "\n- internalPersonId: ", internalPersonId, "\n- remoteCenzontleURL: ", remoteCenzontleURL);
